...
> S-8.01 v1.1 (status=draft, pass-1 fix burst applied 2026-04-30; pass-2 SUBSTANTIVE 2026-04-30). Pass-1: 14 findings closed (4H+6M+3L+1NIT); 344→380 lines (+36). Pass-2: 4 findings (0H+2M+2L); clock held 0_of_3. Key pass-2 findings: emit_event Rust call form not pinned (MED); [hooks.capabilities] full-block vs sub-key removal scope unspecified in AC-001 (MED); EC-005 CLAUDE_PLUGIN_ROOT bash-era premise (LOW); main.rs binary-pattern hedge (LOW). Pass-2 fix burst pending. adv-s8.01-p2.md persisted. D-174.
