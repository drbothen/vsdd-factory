...
W5 is independent of W4; W6 requires W5 (S-21.10) to merge first; W7 requires both S-21.10
and S-21.11 to merge first.
...
|---------|------|--------|---------|
| v1.13 | 2026-08-30 | story-writer | Frontmatter normalization: add level: L3 (story-writer spec-hygiene sweep). |
