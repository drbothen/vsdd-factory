...
inputs:
  ...
  - .factory/stories/S-21.09-wasm-artifact-restore-and-registry-parity.md
  - .factory/stories/S-21.10-failure-policy-registry-schema-extension.md
...
E-21 collects eleven hardening stories (S-21.01..S-21.06 founding scope W1-W3; S-21.07/S-21.09/S-21.10/S-21.11/S-21.12 added post-v1.6 W4-W6). The founding scope closes a compound of confirmed-live factory
...
|----|-----------|-------------------|----------------|
| EAC-001 | All eleven stories S-21.01..S-21.06, S-21.07, S-21.09, S-21.10, S-21.11, S-21.12 shipped and merged to `develop` within this epic's cycle | All story PRs CI-green and merged | S-21.01..S-21.06, S-21.07, S-21.09, S-21.10, S-21.11, S-21.12 PR merge confirmations |
...
**Total:** 11 stories, 83 story points.
...
- Wave 4 (S-21.07, S-21.09, S-21.12 — 27 pts): Three independent stories, all
  ...
  wasmtime >= 46.0.2, clearing RUSTSEC-2026-0188/CVE-2026-58494 (I:High) +
  RUSTSEC-2026-0222, and adds a `cargo deny check advisories` CI job (PR-007); placed in
  E-21 W4 per team-lead ruling (re-anchored from proposed E-22). Merge order within W4:
  S-21.12 → S-21.09 → S-21.07 (operator-coordinated via P0 priority; S-21.12 and S-21.07
  both modify `ci.yml` — deliberate accepted tradeoff to close CVE sooner; see R-S2112-03
  in S-21.12 Risk Register). All three can dispatch in parallel.

- Wave 5 (S-21.10 — 5 pts): `failure_policy` dispatcher registry schema extension
  (ADR-039 Decision 1+2 schema leg; Phase 1 — schema only, no enforcement change).
  `depends_on: []`; independent of W4 stories; can run after W4 starts.

- Wave 6 (S-21.11 — 16 pts): Per-plugin fuel-cap calibration + fail-closed enforcement
  flip (ADR-039 Phase 3+4; CWE-636 closure). `depends_on: [S-21.10]` — requires the
  W5 schema extension to be merged first.

**Wave model note:** W1..W6 group by risk tier and dependency; intra-wave sequencing is expressed
...
W5 is independent of W4; W6 requires W5 (S-21.10) to merge first.
...
S-21.10 merges. Acyclic confirmed.
