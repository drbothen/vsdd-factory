...
| factory-artifacts | 85371e0e | D-978-S-21.09-LOCAL-PASS-15-RECORD-AND-FIX-BURST burst. SHA-patch done 2026-08-12. |
...
| D-413..D-976 (see decision-log.md for full range) | **ARCHIVED** | Full detail in decision-log.md SoT. | ARCHIVED | 2026-06-14..2026-08-12 |
...
`/vsdd-factory:next-step` — LOCAL adversary pass-16 dispatch is the next substantive action, dispatched fresh-context reading only `adv-s21.09-local-pass-15.md` Part A per the Iron Law (D-978 hardening confirmation COMPLETE; SHA-patch DONE — Active Branches `factory-artifacts` row and this checkpoint's header now cite the actual commit HEAD `85371e0e`; no precondition blocks pass-16 dispatch).
