...
| factory-artifacts | [D-616-SHA] | D-616 E-18 STORY PASS-2 FIX WAVE INTEGRATION 2026-06-16 (SHA-patch follow-up per D-447(c)); prior: 77e62996 D-615 SHA-patch; prior-prior: 9d8f2d22 D-615-Commit-E |
...
- **factory-artifacts HEAD:** `[D-616-SHA]` (D-616 E-18 STORY PASS-2 FIX WAVE INTEGRATION 2026-06-16; prior: `77e62996` D-615 SHA-patch; prior-prior: `9d8f2d22` D-615-Commit-E)
...
- **Verify on resume:** `git rev-parse --short origin/develop` → expect `7e99f6ef`; `git rev-parse --short origin/main` → expect `caf06c68`; `git -C .factory log -1 --format='%h'` → expect D-616 SHA-patch HEAD (fill after commit)
