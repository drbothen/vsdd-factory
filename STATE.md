...
| Epic | E-N | `stories/epics/E-N-<short>.md` | 20 (E-22 DISSOLVED per D-961(c) — epic dissolved, file RETAINED per human ruling 2026-08-08; count stays at 20) |
...
## Session Resume Checkpoint (2026-08-08 — E-22-RETENTION-RULING-ERRATUM — PIPELINE PAUSED; pass-9 adversary NEXT; streak 0/3; trajectory-tail →25→24→20→16)
...
- **E-22 epic file** — originally blocked from deletion by permission classifier in D-961/B session; RETAINED per human ruling 2026-08-08 (supersedes D-961(c) deletion ruling).
