...
| factory-artifacts | **`1dd177ad`** | VALIDATION-INTEGRITY-LAYER1-F1F2F3-SPEC-BURST v9.34→v9.35 (this commit). Prior: 72ea0409 (SPEC-HYGIENE-SWEEP-2026-08-30). |
...
- `main`: **`89f6f87c`** (v1.0.0-rc.24 bundle commit, tagged 2026-08-26).
- `factory-artifacts`: **`1dd177ad`** (VALIDATION-INTEGRITY-LAYER1-F1F2F3-SPEC-BURST; this burst). Prior: `72ea0409` (SPEC-HYGIENE-SWEEP-2026-08-30).
