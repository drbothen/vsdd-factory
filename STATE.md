...
phase: D-580-F2-E18-PASS-17-NOT-CLEAN-FIX-BURST-2026-06-15
last_amended: 2026-06-15 (v3.30) — D-580 F2 E-18 ADV PASS-17 NOT-CLEAN FIX BURST: fresh-context adversary pass-17 NOT-CLEAN: 0 BLOCKER, 0 MAJOR, 1 load-bearing MEDIUM (genuine security/edge-case gap), 2 LOW. Fixed: (F-P17-001 MED security) wave_id=1 precompact_flush_sha null rule made WAVE-AGNOSTIC: ADR-026 v1.11→v1.12 + BC-5.41.001 v1.9→v1.10 (PC2/PC5/EC-001/EC-011 + test vectors + new TV wave-1-null-sha-log-present-hard-block); (F-P17-002 LOW) BC-5.41.001 EC table reordered ascending. VP-081 sibling update DECLINED (architect). New VP-087 DEFERRED (no adversary coverage finding; BC test vectors cover it). 4-index: BC-INDEX v2.85 / VP-INDEX v2.20 / STORY-INDEX v4.01 / ARCH-INDEX v2.40. 3-CLEAN streak 0/3. D-chain cite D-579 per D-419(b); parent-commit bde33ec5869110bd per D-419(b). [Prior: 2026-06-15 (v3.29) — D-579 F2 E-18 ADV PASS-16 NOT-CLEAN FIX BURST. See decision-log.md SoT.]
inputs: []
input-hash: "[live-state]"
traces_to: prd.md
project: vsdd-factory
mode: brownfield
current_step: "D-580 F2 E-18 ADV PASS-17 NOT-CLEAN FIX BURST 2026-06-15 — Fresh-context adversary pass-17 returned NOT-CLEAN: 0 BLOCKER, 0 MAJOR, 1 load-bearing MEDIUM (genuine security/edge-case gap), 2 LOW. Fixed: (F-P17-001 MED security) wave_id=1 precompact_flush_sha null rule made WAVE-AGNOSTIC: ADR-026 v1.11→v1.12 + BC-5.41.001 v1.9→v1.10 (PC2/PC5/EC-001/EC-011 + test vectors + new TV wave-1-null-sha-log-present-hard-block); (F-P17-002 LOW) BC-5.41.001 EC table reordered ascending. (F-P17-003 LOW PC6b sub-numbering) ACCEPTED as-is. VP-081 sibling update DECLINED (architect: wave_id>1 correctly scopes WASM-gate HandoffIncomplete). New VP-087 DEFERRED (no adversary coverage finding; BC test vectors cover it). 4-index: BC-INDEX v2.85 / VP-INDEX v2.20 / STORY-INDEX v4.01 / ARCH-INDEX v2.40. 3-CLEAN streak remains 0/3 (pass-17 NOT-CLEAN). Trajectory →P15 NOT-CLEAN(1med/4low)→P16 NOT-CLEAN(3med/2low)→P17 NOT-CLEAN(1med/2low). NEXT: adversary pass-18 (fresh-context). D-chain cite D-579 per D-419(b); parent-commit bde33ec5869110bd per D-419(b)"
...
| **Started** | 2026-04-25 |
| **Last Updated** | 2026-06-15 — D-580 F2 E-18 ADV PASS-17 NOT-CLEAN FIX BURST: ADR-026 v1.11→v1.12 (F-P17-001 MED: precompact_flush_sha null rule WAVE-AGNOSTIC); BC-5.41.001 v1.9→v1.10 (PC2/PC5/EC-001/EC-011 + test vectors + new TV wave-1-null-sha-log-present-hard-block; EC table reordered ascending F-P17-002 LOW). BC-INDEX v2.85; ARCH-INDEX v2.40. 3-CLEAN streak 0/3; NEXT: adversary pass-18. |
| **Current Phase** | D-580 F2 E-18 ADV PASS-17 NOT-CLEAN FIX BURST 2026-06-15 — Pass-17 NOT-CLEAN: 0B/0M/1med/2low. Fixed: ADR-026 v1.12 + BC-5.41.001 v1.10 (wave-agnostic null rule). 4-index BC v2.85/VP v2.20/STORY v4.01/ARCH v2.40. 3-CLEAN streak 0/3. NEXT: adversary pass-18. |
...
| **D-579 F2 E-18 ADV PASS-16 NOT-CLEAN FIX BURST 2026-06-15** | **COMPLETE** | Pass-16 NOT-CLEAN: 0B/0M/3med/2low. Findings clustered in NEW area (VP-layer subsystem anchoring). Fixed: (F-P16-001 MED mis-anchor) VP-084 v1.6→v1.7 (scope SS-05,SS-07→SS-05,SS-04 — validate-burst-log is WASM SS-04 not bash SS-07; self-contradiction with file's own F-P5-004 note corrected); (F-P16-002 MED) VP-085 v1.3→v1.4 (scope SS-07-only confirmed with justification — shell-hermeticity; WASM registration via VP-082/VP-086); (F-P16-003 MED traceability) VP-083 v1.4→v1.5 (title 'and'→'or': two independent sufficient no-op conditions; body aligned to VP-INDEX row); (F-P16-004 LOW) VP-082 v1.7→v1.8 (Postcondition F retry bats-comment tightened: pushes SHA_B; exits 0 if no new pending changes); (F-P16-005 LOW) invariants.md v1.18→v1.19 (DI-022 lock-renewal conditional: mandatory WHEN lock held; no-op when absent). VP-INDEX v2.19→v2.20. L2-INDEX v1.0.4→v1.0.5. 4-index BC v2.84/VP v2.20/STORY v4.01/ARCH v2.39. 3-CLEAN streak 0/3 (pass-16 NOT-CLEAN). Trajectory →P14 NOT-CLEAN(2med)→P15 NOT-CLEAN(1med/4low)→P16 NOT-CLEAN(3med/2low). NEXT: adversary pass-17. |
| **D-580 F2 E-18 ADV PASS-17 NOT-CLEAN FIX BURST 2026-06-15** | **COMPLETE** | Pass-17 NOT-CLEAN: 0B/0M/1med/2low. Fixed: ADR-026 v1.11→v1.12 (F-P17-001 MED: null rule WAVE-AGNOSTIC — log-present+valid → null HARD BLOCK ANY wave_id); BC-5.41.001 v1.9→v1.10 (PC2/PC5/EC-001/EC-011 + test vectors + TV wave-1-null-sha-log-present-hard-block; EC table reordered ascending F-P17-002 LOW). (F-P17-003 LOW) PC6b sub-numbering ACCEPTED as-is. VP-081 sibling DECLINED (architect). VP-087 DEFERRED. BC-INDEX v2.84→v2.85; ARCH-INDEX v2.39→v2.40. 3-CLEAN streak 0/3. Trajectory →P15(1med/4low)→P16(3med/2low)→P17(1med/2low). NEXT: adversary pass-18. |
| **D-578 F2 E-18 ADV PASS-15 NOT-CLEAN FIX BURST 2026-06-15** | **COMPLETE** | Pass-15 NOT-CLEAN: 0B/0M/1med/4low (adversary: 'one finding away from convergence'). Fixed: (F-P15-001 MED) VP-082 v1.6→v1.7 (Postcondition F push-failure leg formal Property block + F-P15-005 LOW: bats anchor scope note); (F-P15-002 LOW) ADR-026 v1.10→v1.11 (§Decision 2 precompact_flush_sha cite de-versioned → stable §PC2/§PC5/EC-006/EC-011 anchor; §Traceability provenance leg); (F-P15-003 LOW) VP-081 v1.3→v1.4 (volatile VP-INDEX v2.15 pin removed; stable Full Index row anchor); (F-P15-004 LOW) VP-083 v1.3→v1.4 (title + Property §2: 'HANDOFF.md Absent' → 'Non-HANDOFF.md Writes'). 4-index BC v2.84/VP v2.19/STORY v4.01/ARCH v2.39. 3-CLEAN streak 0/3 (pass-15 NOT-CLEAN). Trajectory →P13 NOT-CLEAN(4)→P14 NOT-CLEAN(2med)→P15 NOT-CLEAN(1med/4low). NEXT: adversary pass-16. |
...
| v1.0-brownfield-backfill | brownfield | **D-580 2026-06-15; F2 E-18 ADV PASS-17 NOT-CLEAN FIX BURST; develop 7e99f6ef; main caf06c68** | rc.21 100% COMPLETE D-560; D-579 PASS-16 FIX BURST COMPLETE; **D-580 ADV PASS-17 NOT-CLEAN FIX BURST** (1med+2low fixed; ADR-026 v1.12 null rule WAVE-AGNOSTIC; BC-5.41.001 v1.10 PC2/PC5/EC-001/EC-011 + test vectors; EC table reordered; VP-081 DECLINED; VP-087 DEFERRED; **BC-INDEX v2.85**; **ARCH-INDEX v2.40**; 3-CLEAN streak 0/3 unchanged); 4-index **BC v2.85**/VP v2.20/STORY v4.01/**ARCH v2.40**; trajectory →P15 NOT-CLEAN(1med/4low)→P16 NOT-CLEAN(3med/2low)→P17 NOT-CLEAN(1med/2low); **Next: adversary pass-18 → (need 3 consecutive clean) → F3 story decomposition (S-18.00..S-18.07+S-18.08).** |
...
> Latest: D-568..D-573 (F2 E-18 pass-7..12 fix+CLEAN) + D-574 (pass-13 NOT-CLEAN fix) + D-575 (consistency-sweep remediation) + D-576 (pass-14 NOT-CLEAN fix) + D-577 (pass-14 consistency-re-sweep remediation) + D-578 (pass-15 NOT-CLEAN fix) + D-579 (pass-16 NOT-CLEAN fix) + D-580 (pass-17 NOT-CLEAN fix) — in table below.
...
|----|----------|-------|------|
| D-580 | F2 E-18 ADV PASS-17 NOT-CLEAN FIX BURST 2026-06-15 — Fresh-context adversary pass-17 returned NOT-CLEAN: 0 BLOCKER, 0 MAJOR, 1 load-bearing MEDIUM (genuine security/edge-case gap), 2 LOW. Fixed: (F-P17-001 MED security) wave_id=1 precompact_flush_sha: null was permitted UNCONDITIONALLY when a real mid-wave-1 PreCompact flush left a valid log entry — reopening the fabricated/dropped-SHA class (DI-021/CAP-032) for the first wave. Made wave-agnostic: ADR-026 v1.11→v1.12 §Decision 2 + BC-5.41.001 v1.9→v1.10 (PC2/PC5/EC-001/EC-011 + test vectors) now apply a uniform three-state rule — log genuinely absent → null valid wave-1/advisory wave>1; log corrupt → EXEMPT (DI-025, any wave); log present+valid (FIELD-4==commit) → null HARD BLOCK (PrecompactShaMismatch) ANY wave_id incl wave-1. New TV wave-1-null-sha-log-present-hard-block. DI-025 corruption→EXEMPT + WASM-gate pure-parse boundary unchanged. (F-P17-002 LOW) BC-5.41.001 EC table reordered ascending (append-only IDs preserved). (F-P17-003 LOW PC6b sub-numbering) ACCEPTED as-is (stable load-bearing anchor; renumber would require sibling-sweep). VP-081 sibling update DECLINED (architect: (wave_id>1) correctly scopes WASM-gate HandoffIncomplete; null-SHA is shell-side BC-5.41.001 PC5). New VP-087 for null-SHA hard-block DEFERRED (no adversary coverage finding; BC test vectors cover it) — observation anchored for future VP-087 if a later pass flags it. 4-index: BC-INDEX v2.85 / VP-INDEX v2.20 / STORY-INDEX v4.01 / ARCH-INDEX v2.40. 3-CLEAN streak remains 0/3 (pass-17 NOT-CLEAN). Trajectory →P15 NOT-CLEAN(1med/4low)→P16 NOT-CLEAN(3med/2low)→P17 NOT-CLEAN(1med/2low). NEXT: adversary pass-18 (fresh-context). D-chain cite D-579 per D-419(b); parent-commit bde33ec5869110bd per D-419(b). | feature-mode-f2-e18-adv-pass-17-fix | 2026-06-15 |
| D-579 | F2 E-18 ADV PASS-16 NOT-CLEAN FIX BURST 2026-06-15 — Fresh-context adversary pass-16 returned NOT-CLEAN: 0 BLOCKER, 0 MAJOR, 3 MEDIUM (1 load-bearing mis-anchor), 2 LOW. Findings clustered in a NEW area (VP-layer subsystem anchoring — survived prior passes which focused on BC-layer fields). Fixed: (F-P16-001 MED mis-anchor) VP-084 v1.6→v1.7 — scope SS-05,SS-07→SS-05,SS-04 (validate-burst-log is a native WASM plugin, SS-04 not SS-07 bash; was self-contradiction with file's own F-P5-004 note); (F-P16-002 MED) VP-085 v1.3→v1.4 — scope confirmed SS-07-only with documented justification (shell-hermeticity property; WASM registration covered by VP-082/VP-086; sibling-scope divergence is intentional, not drift); (F-P16-003 MED traceability) VP-083 v1.4→v1.5 — title 'and'→'or' (Wave-1 OR Non-HANDOFF.md Writes; two independent sufficient no-op conditions; aligns body to VP-INDEX row); (F-P16-004 LOW) VP-082 v1.7→v1.8 — Postcondition F retry bats-comment tightened (pushes SHA_B, exits 0 if no new pending changes — was over-broad 'exits 0 once remote reachable'); (F-P16-005 LOW) invariants.md v1.18→v1.19 — DI-022 lock-renewal made conditional (mandatory WHEN a lock is held; skipped no-op when no lock held; per BC-7.07.001 PC3/Inv3/EC-009 + ADR-025 opt-in). Sibling-sweep: full VP-080..086 cluster verified correctly anchored (WASM→SS-04, bash→SS-07). 4-index: BC-INDEX v2.84 / VP-INDEX v2.20 / STORY-INDEX v4.01 / ARCH-INDEX v2.39. L2-INDEX synced to invariants.md v1.19 (v1.0.4→v1.0.5). 3-CLEAN streak remains 0/3 (pass-16 NOT-CLEAN). Trajectory →P14 NOT-CLEAN(2med)→P15 NOT-CLEAN(1med/4low)→P16 NOT-CLEAN(3med/2low). NEXT: adversary pass-17 (fresh-context; behavioral core converged, VP-anchoring shell remediated). D-chain cite D-578 per D-419(b); parent-commit a37c054813 per D-419(b). | feature-mode-f2-e18-adv-pass-16-fix | 2026-06-15 |
| D-578 | F2 E-18 ADV PASS-15 NOT-CLEAN FIX BURST 2026-06-15 — Fresh-context adversary pass-15 returned NOT-CLEAN: 0 BLOCKER, 0 MAJOR, 1 load-bearing MEDIUM, 4 LOW (adversary assessment: 'one finding away from convergence'). Fixed: (F-P15-001 MED) VP-082 v1.6→v1.7 — Postcondition F push-failure leg lifted into formal Property block (push-failure-after-successful-commit-and-append → exit 2; local commit + log entry retained; retry push-only per BC-7.07.001 PC6b / ADR-026 §F-P10-002); (F-P15-002 LOW) ADR-026 v1.10→v1.11 — §Decision 2 precompact_flush_sha cite de-versioned from volatile 'BC-5.41.001 v1.8' token to stable '§PC2/§PC5/EC-006/EC-011' anchor form per POLICY 19/TD-VSDD-091 anti-volatile-pin; §Traceability provenance leg appended (VP-INDEX v2.18→v2.19; VP-082 v1.7/VP-081 v1.4/VP-083 v1.4); (F-P15-003 LOW) VP-081 v1.3→v1.4 — VP-INDEX v2.15 volatile pin removed from Postcondition E bats comment → stable 'VP-INDEX VP-081 Full Index row' anchor; (F-P15-004 LOW) VP-083 v1.3→v1.4 — title + Property §2 corrected: 'Completeness Gate Is No-Op on Wave-1 or Non-HANDOFF.md Writes' (was 'HANDOFF.md Absent'; pre-payload-only residue; gate discriminates by wave_id and write target, not HANDOFF.md presence); (F-P15-005 LOW) VP-082 bats anchor scope note added. 4-index: BC-INDEX v2.84 / VP-INDEX v2.19 / STORY-INDEX v4.01 / ARCH-INDEX v2.39. 3-CLEAN streak 0/3 (pass-15 NOT-CLEAN; streak unchanged). Trajectory →P13 NOT-CLEAN(4)→P14 NOT-CLEAN(2med)→P15 NOT-CLEAN(1med/4low). NEXT: adversary pass-16. D-chain cite D-577 per D-419(b); parent-commit 5a9bb36e3baf46cf8bac899b510ab23c03aceac1 per D-419(b). | feature-mode-f2-e18-adv-pass-15-fix | 2026-06-15 |
...
## Session Resume Checkpoint (2026-06-15 — D-580 F2 E-18 ADV PASS-17 NOT-CLEAN FIX BURST; ADR-026 v1.12; BC-5.41.001 v1.10; BC-INDEX v2.85; ARCH-INDEX v2.40; 3-CLEAN streak 0/3; next: adversary pass-18 → 3-CLEAN → F3)
...
**E-18 CAP-032 context-durability (GitHub issue #173) — Feature Mode, Phase F2 (spec evolution) adversarial 3-CLEAN convergence cascade (BC-5.39.001). D-580 2026-06-15.**

F1-gate APPROVED. F2 spec evolution COMPLETE (D-561). F2 adversarial cascade passes 1-17 COMPLETE (D-562..D-580). Consistency-validator sweep D-575 COMPLETE (CLEAN). Pass-16 fix burst D-579 COMPLETE. Pass-17 fix burst D-580 COMPLETE. 17 adv passes done; pass-12 CLEAN (1/3 streak); pass-13 NOT-CLEAN (4 findings; streak RESET to 0/3); pass-14 NOT-CLEAN (2med+1low; streak remains 0/3); pass-15 NOT-CLEAN (1med+4low; streak remains 0/3); pass-16 NOT-CLEAN (3med+2low; streak remains 0/3); pass-17 NOT-CLEAN (1med+2low; streak remains 0/3).

**D-580 pass-17 fix-burst summary:**
- Pass-17 NOT-CLEAN: 0B/0M/1med/2low. 1 genuine security/edge-case gap (wave_id=1 null-SHA rule was wave-specific, not wave-agnostic).
- Fixed: (F-P17-001 MED security) ADR-026 v1.11→v1.12 §Decision 2 + BC-5.41.001 v1.9→v1.10 — precompact_flush_sha null rule made WAVE-AGNOSTIC. Three-state uniform rule: log genuinely absent → null valid (wave-1/advisory wave>1); log corrupt → EXEMPT (DI-025, any wave); log present+valid (FIELD-4==commit) → null HARD BLOCK (PrecompactShaMismatch) ANY wave_id incl wave-1. New TV wave-1-null-sha-log-present-hard-block.
- Fixed: (F-P17-002 LOW) BC-5.41.001 EC table reordered ascending (append-only IDs preserved).
- (F-P17-003 LOW PC6b sub-numbering) ACCEPTED as-is — stable load-bearing anchor; renumber would require sibling-sweep.
- VP-081 sibling update DECLINED — architect confirmed wave_id>1 correctly scopes WASM-gate HandoffIncomplete; null-SHA anti-forgery is shell-side BC-5.41.001 PC5.
- New VP-087 DEFERRED — no adversary coverage finding; BC test vectors cover the null-SHA hard-block path.

**3-CLEAN streak: 0/3** (pass-17 NOT-CLEAN; unchanged). Need 3 NEW consecutive clean passes for F2 convergence.

**Convergence trajectory (last 4 passes per D-433(e)+D-439(c)):** →P15 NOT-CLEAN(1med/4low)→P16 NOT-CLEAN(3med/2low)→P17 NOT-CLEAN(1med/2low).

**4-index at D-580:** BC-INDEX v2.85, VP-INDEX v2.20, STORY-INDEX v4.01, ARCH-INDEX v2.40.

**NEXT ACTION (explicit, in order):**
1. **START HERE: adversary pass-18** (fresh-context; reads package at D-580 versions). Need 3 CONSECUTIVE CLEAN passes for F2 convergence (BC-5.39.001). 3-CLEAN streak 0/3.
...
**Artifact versions at D-580:**
- ADR-026 v1.12; BC-1.15.001 v1.3; BC-4.14.001 v1.9; BC-7.07.001 v1.7; BC-5.41.001 v1.10; BC-5.41.002 v1.6; BC-5.41.003 v1.6; BC-6.24.001 v1.6; BC-7.07.002 v1.6; VP-081 v1.4; VP-082 v1.8; VP-083 v1.5; VP-084 v1.7; VP-085 v1.4; VP-086 (unchanged); invariants.md v1.19 (DI-022 conditional); capabilities.md v1.6 (CAP-032); BC-INDEX v2.85; VP-INDEX v2.20; ARCH-INDEX v2.40; STORY-INDEX v4.01; L2-INDEX v1.0.5.
...
- **D-580 carry:** F2 E-18 ADV PASS-17 NOT-CLEAN FIX BURST 2026-06-15. 1med+2low fixed (ADR-026 v1.12 null rule WAVE-AGNOSTIC; BC-5.41.001 v1.10 PC2/PC5/EC-001/EC-011 + test vectors; EC table reordered). VP-081 DECLINED (architect). VP-087 DEFERRED. BC-INDEX v2.85; ARCH-INDEX v2.40. 3-CLEAN 0/3 unchanged. 4-index BC v2.85/VP v2.20/STORY v4.01/ARCH v2.40. Trajectory →P15 NOT-CLEAN(1med/4low)→P16 NOT-CLEAN(3med/2low)→P17 NOT-CLEAN(1med/2low). NEXT: adversary pass-18. D-chain cite D-579. parent-commit bde33ec5869110bd.
- **D-579 carry:** F2 E-18 ADV PASS-16 NOT-CLEAN FIX BURST 2026-06-15. 3med+2low fixed (VP-084 v1.7 scope mis-anchor; VP-085 v1.4 SS-07 confirmed; VP-083 v1.5 'and'→'or'; VP-082 v1.8 bats-comment; invariants.md v1.19 DI-022 conditional; VP-INDEX v2.20; L2-INDEX v1.0.5). 3-CLEAN 0/3 unchanged. 4-index BC v2.84/VP v2.20/STORY v4.01/ARCH v2.39. Trajectory →P14 NOT-CLEAN(2med)→P15 NOT-CLEAN(1med/4low)→P16 NOT-CLEAN(3med/2low). NEXT: adversary pass-17. D-chain cite D-578. parent-commit a37c054813.
- **D-578 carry:** F2 E-18 ADV PASS-15 NOT-CLEAN FIX BURST 2026-06-15. 1med+4low fixed (VP-082 v1.7; ADR-026 v1.11; VP-081 v1.4; VP-083 v1.4; VP-INDEX v2.19; ARCH-INDEX v2.39). 3-CLEAN 0/3 unchanged. 4-index BC v2.84/VP v2.19/STORY v4.01/ARCH v2.39. Trajectory →P13 NOT-CLEAN(4)→P14 NOT-CLEAN(2med)→P15 NOT-CLEAN(1med/4low). NEXT: adversary pass-16. D-chain cite D-577. parent-commit 5a9bb36e3baf46cf8bac899b510ab23c03aceac1.
...
- **D-580 (2026-06-15):** F2 E-18 ADV PASS-17 NOT-CLEAN FIX BURST. Pass-17 NOT-CLEAN: 0B/0M/1med/2low. Fixed: ADR-026 v1.11→v1.12 (F-P17-001 MED: §Decision 2 precompact_flush_sha null rule WAVE-AGNOSTIC — three-state uniform rule ANY wave_id; new TV wave-1-null-sha-log-present-hard-block); BC-5.41.001 v1.9→v1.10 (PC2/PC5/EC-001/EC-011 + test vectors; F-P17-002 LOW: EC table reordered ascending). (F-P17-003 LOW) PC6b sub-numbering ACCEPTED as-is. VP-081 DECLINED (architect: wave_id>1 WASM-gate scope confirmed). VP-087 DEFERRED. BC-INDEX v2.84→v2.85; ARCH-INDEX v2.39→v2.40. 3-CLEAN streak 0/3. 4-index: BC v2.85/VP v2.20/STORY v4.01/ARCH v2.40. NEXT: adversary pass-18.
- **D-579 (2026-06-15):** F2 E-18 ADV PASS-16 NOT-CLEAN FIX BURST. Pass-16 NOT-CLEAN: 0B/0M/3med/2low. Findings in NEW area (VP-layer subsystem anchoring). Fixed: VP-084 v1.6→v1.7 (F-P16-001 MED: scope SS-05,SS-07→SS-05,SS-04 mis-anchor); VP-085 v1.3→v1.4 (F-P16-002 MED: SS-07 confirmed); VP-083 v1.4→v1.5 (F-P16-003 MED: title 'and'→'or'); VP-082 v1.7→v1.8 (F-P16-004 LOW: bats-comment tightened); invariants.md v1.18→v1.19 (F-P16-005 LOW: DI-022 conditional). VP-INDEX v2.19→v2.20; L2-INDEX v1.0.4→v1.0.5. BC-INDEX v2.84/ARCH-INDEX v2.39 UNCHANGED. 3-CLEAN streak 0/3. 4-index: BC v2.84/VP v2.20/STORY v4.01/ARCH v2.39. NEXT: adversary pass-17.
- **D-578 (2026-06-15):** F2 E-18 ADV PASS-15 NOT-CLEAN FIX BURST. Pass-15 NOT-CLEAN: 0B/0M/1med/4low. Fixed: VP-082 v1.6→v1.7 (F-P15-001 MED: Postcondition F formal Property block; F-P15-005 LOW: bats scope note); ADR-026 v1.10→v1.11 (F-P15-002 LOW: §Decision 2 de-versioned cite + §Traceability provenance leg); VP-081 v1.3→v1.4 (F-P15-003 LOW: volatile pin removed); VP-083 v1.3→v1.4 (F-P15-004 LOW: title corrected). VP-INDEX v2.18→v2.19; ARCH-INDEX v2.38→v2.39. BC-INDEX v2.84 UNCHANGED. 3-CLEAN streak 0/3. 4-index: BC v2.84/VP v2.19/STORY v4.01/ARCH v2.39. NEXT: adversary pass-16.
...
- Brownfield: D-001..D-580 — `cycles/v1.0-brownfield-backfill/decision-log.md`. Latest: **D-580 F2 E-18 ADV PASS-17 NOT-CLEAN FIX BURST 2026-06-15 — ADR-026 v1.12 + BC-5.41.001 v1.10 (null rule WAVE-AGNOSTIC; EC table reordered); BC-INDEX v2.85 / ARCH-INDEX v2.40; VP-INDEX v2.20 / STORY-INDEX v4.01 UNCHANGED; 3-CLEAN streak 0/3; adversary pass-18 NEXT.**
...
| Index | Version | Notes |
|-------|---------|-------|
| BC-INDEX | v2.85 | Changed D-580 (BC-5.41.001 v1.10; F-P17-001/002). total_bcs 1966 UNCHANGED. |
| VP-INDEX | v2.20 | UNCHANGED at D-580. total_vps 86 UNCHANGED. |
| STORY-INDEX | v4.01 | UNCHANGED at D-561..D-580. E-18 stories S-18.00..S-18.08 NOT YET AUTHORED (F3 next after 3-CLEAN). |
| ARCH-INDEX | v2.40 | Changed D-580 (ADR-026 v1.12 amendment row + provenance leg; F-P17-001). |

4-index at D-580 (literal-shell): `grep "^version:" .factory/specs/behavioral-contracts/BC-INDEX.md` → "2.85"; `grep "^version:" .factory/specs/verification-properties/VP-INDEX.md` → "2.20"; `grep "^version:" .factory/stories/STORY-INDEX.md` → "4.01"; `grep "^version:" .factory/specs/architecture/ARCH-INDEX.md` → "2.40".
...
- **ADR-026 v1.12:** `decisions/ADR-026-wave-boundary-checkpoint-reset-and-lossless-intra-wave-compaction.md` (F-P17-001 MED security: §Decision 2 precompact_flush_sha null rule WAVE-AGNOSTIC — three-state uniform rule any wave_id; new TV wave-1-null-sha-log-present-hard-block; DI-025 corruption→EXEMPT unchanged)
- **VP-082 v1.8:** `verification-properties/VP-082.md` (F-P16-004 LOW: Postcondition F retry bats-comment tightened — pushes SHA_B; exits 0 if no new pending changes)
- **VP-083 v1.5:** `verification-properties/VP-083.md` (F-P16-003 MED traceability: title 'and'→'or' — Wave-1 OR Non-HANDOFF.md Writes; body aligned to VP-INDEX row)
- **VP-084 v1.7:** `verification-properties/VP-084.md` (F-P16-001 MED mis-anchor: scope SS-05,SS-07→SS-05,SS-04 — validate-burst-log.wasm is SS-04 Plugin Ecosystem)
- **VP-085 v1.4:** `verification-properties/VP-085.md` (F-P16-002 MED: SS-07-only scope confirmed with documented justification)
- **invariants.md v1.19:** `domain-spec/invariants.md` (F-P16-005 LOW: DI-022 lock-renewal conditional — mandatory WHEN lock held; no-op when absent)
- **BC-5.41.001 v1.10:** `ss-05/BC-5.41.001.md` (F-P17-001/002: PC2/PC5/EC-001/EC-011 + test vectors + new TV wave-1-null-sha-log-present-hard-block; EC table reordered ascending)
...
### §11. Post-CLEAR/Post-RESET Resume Checklist (zero-context; D-580 refresh)

1. **Verify worktree state:** `git rev-parse --short origin/develop` → expect `7e99f6ef`. `git rev-parse --short origin/main` → expect `caf06c68`. `git -C .factory log -1` (expect D-580 pass-17 NOT-CLEAN fix burst commit; branch factory-artifacts; clean status).
2. **Read §1-§12 this checkpoint** (all of it; D-579 self-sufficient).
3. **Verify trajectory-tail PC4:** `grep "^current_step:" .factory/STATE.md | grep -oE "trajectory-tail [→0-9/a-zA-Z(]+"` → expect trajectory containing P17 NOT-CLEAN.
...
7. **D-580 F2 E-18 ADV PASS-17 NOT-CLEAN FIX BURST COMPLETE.** ADR-026 v1.12 (null rule WAVE-AGNOSTIC); BC-5.41.001 v1.10 (PC2/PC5/EC-001/EC-011 + test vectors + new TV wave-1-null-sha-log-present-hard-block; EC table reordered). VP-081 DECLINED; VP-087 DEFERRED. BC-INDEX v2.85; ARCH-INDEX v2.40. 3-CLEAN streak **0/3 unchanged**. 4-index BC v2.85/VP v2.20/STORY v4.01/ARCH v2.40. **NEXT: adversary pass-18 → (3 consecutive clean) → F3 story decomp (S-18.00..S-18.07+S-18.08).**
8. **4-index at D-580:** BC-INDEX v2.85, VP-INDEX v2.20, STORY-INDEX v4.01, ARCH-INDEX v2.40.
...
10. **Latest decision D-580.** F2 pass-17 NOT-CLEAN FIX BURST (ADR-026 v1.12/BC-5.41.001 v1.10; BC-INDEX v2.85/ARCH-INDEX v2.40; VP-INDEX v2.20/STORY-INDEX v4.01 UNCHANGED; streak 0/3). Adversary pass-18 NEXT. Then F3 S-18.00..S-18.08.

### §12. Pending Work Items — Strict Resume Ordering (refreshed 2026-06-15 D-580)
...
| **1** | **#173/E-18 F2 adversarial re-cascade (pass-18)** | **feature** | D-580 pass-17 fix complete | Fresh-context adversary reads package at D-580 versions: ADR-026 v1.12 + BC-5.41.001 v1.10 (+ all other E-18 artifacts at D-579 versions). **3-CLEAN streak 0/3**; need 3 consecutive clean for BC-5.39.001 convergence. **START HERE.** |
...
> Previous checkpoint (D-579 F2-E18-ADV-PASS-16-NOT-CLEAN-FIX-BURST-2026-06-15) archived to: `cycles/v1.0-brownfield-backfill/session-checkpoints.md`
