...
| factory-artifacts | `[D-532 burst SHA — SHA-patch follow-up per D-447(c)+D-449(e); prior: b12756e2 D-531 primary]` | D-532 SESSION-END DURABILITY BURST 2026-06-08 |
...
- **factory-artifacts HEAD:** `[D-532 burst SHA — fill after commit; prior: b12756e2 D-531 primary]` — SHA-patch follow-up per D-447(c)+D-449(e)
