...
phase: D-975-S-21.09-LOCAL-PASS-13-RECORD-AND-FIX-BURST
last_amended: "2026-08-12 (v7.23) — D-975-S-21.09-LOCAL-PASS-13-RECORD-AND-FIX-BURST (state-manager; single-commit TD-VSDD-053; parent-commit 3a7378b3): S-21.09 LOCAL cascade pass-13 persisted (NOT CLEAN 1H; streak 0/3 after 13 passes); INDEX.md S-21.09 LOCAL Adversary Reviews section extended (pass-13 row + Convergence Status update); F-1 HIGH (cross-file stale test-range cite T-050 vs T-051 — story AC-006 Tests bullet + test-file module docstring header, POLICY 13/count-parity) CLOSED via a documentary-only two-site range-cite correction (test-writer commit 46e334da, NOT pushed; story-writer story v1.24) — no code/test-logic change; adversary independently confirmed the gate/mutation machinery genuinely sound (no surviving-mutant, no fail-open, no path-normalization edge gap); pass-12's F-1 independently re-verified CLOSED; VP-TBD [process-gap] observation LINKED to existing Drift Item [D-945] — no new drift item opened; STORY-INDEX v4.302→v4.303 (S-21.09 catalog row v1.23→v1.24; 46 tests T-006..T-051, 40 owned; 16 pts UNCHANGED); 1 L-BB lesson appended (policy5-sweep-omits-tests-bullet-and-docstring-header); 4 pass-10 carry-over findings (MED-001, LOW-001/002/003) remain OPEN — anchor pass-14; feature/S-21.09 push status UNCHANGED (NOT PUSHED); STATE.md v7.22→v7.23. [Prior: 2026-08-12 (v7.22) — SHA-PATCH-2026-08-12 (state-manager): Active Branches SHA-patched factory-artifacts cd090a5b→768de245 (actual commit HEAD); Session Resume Checkpoint header + §1 parent-citation updated cd090a5b→768de245; v7.22 UNCHANGED. [Prior: 2026-08-12 (v7.22) — D-974-S-21.09-LOCAL-PASS-12-RECORD-AND-FIX-BURST (state-manager; single-commit TD-VSDD-053; parent-commit cd090a5b): S-21.09 LOCAL cascade pass-12 persisted (NOT CLEAN 1H; streak 0/3 after 12 passes); INDEX.md S-21.09 LOCAL Adversary Reviews section extended (pass-12 row + Convergence Status update); F-1 HIGH (containment predicate PREFIX conjunct un-isolated, POLICY 13 mutation-completeness) CLOSED via T-051 prefix-conjunct isolation control (test-writer commit a922ad82, NOT pushed), orthogonal sibling of pass-11's T-050; both pass-11 findings (F-1 length-conjunct, F-2 drift sweep) independently re-verified CLOSED; story v1.23 (story-writer); STORY-INDEX v4.301→v4.302 (S-21.09 catalog row v1.22→v1.23; 46 tests T-006..T-051, 40 owned; 16 pts UNCHANGED); 1 L-BB lesson appended (single-conjunct-isolation-does-not-close-multi-conjunct-gate); 4 pass-10 carry-over findings (MED-001, LOW-001/002/003) remain OPEN — anchor pass-13; feature/S-21.09 push status UNCHANGED (NOT PUSHED); STATE.md v7.21→v7.22. [Prior: full prior chain: git show ede18db0:.factory/STATE.md per D-430(a) compaction precedent.]]]"
inputs: []
...
mode: brownfield
pipeline: ACTIVE
current_step: "D-975-S-21.09-LOCAL-PASS-13-RECORD-AND-FIX-BURST (state-manager; parent-commit: 3a7378b3; D-chain cite D-975; S-21.09 LOCAL cascade pass-13 dispatched fresh-context per Iron Law — read only adv-s21.09-local-pass-12.md Part A; verdict NOT CLEAN 1H; streak 0/3 after 13 passes; F-1 HIGH (cross-file stale test-range cite T-050 vs T-051 in story AC-006 Tests bullet + test-file module docstring header, POLICY 13/count-parity — the pass-12 fix-burst's 5-site sweep did not cover these 2 sites) CLOSED via a documentary-only two-site range-cite correction (test-writer commit 46e334da on feature/S-21.09, NOT pushed — docstring-only, now the branch HEAD; story-writer story v1.24) — no code/test-logic change; adversary independently confirmed the gate/mutation machinery genuinely sound (no surviving-mutant, no fail-open, no path-normalization edge gap); pass-12's F-1 (T-051 prefix-conjunct isolation) independently re-verified CLOSED; VP-TBD [process-gap] observation LINKED to existing Drift Item [D-945] — no new drift item opened; STORY-INDEX v4.302→v4.303; INDEX.md S-21.09 LOCAL Adversary Reviews section extended (pass-13 row); 4 pass-10 carry-over findings (MED-001/LOW-001/LOW-002/LOW-003) remain OPEN, anchor pass-14; 4-INDEX BC v4.56/VP v2.76/STORY v4.303/ARCH v3.55; policies.yaml v1.4.23 UNCHANGED; trajectory-tail →20→16→8→10 UNCHANGED (S-21.07 cycle-level tail; unrelated to this LOCAL-cascade burst); feature/S-21.09 still NOT PUSHED (human ruling this session — hold); pass-14 adversary is the immediate NEXT step). SHA-patch PENDING — will update Active Branches factory-artifacts to the actual commit HEAD once this burst's commit lands."
...
<!--
  ...
  ~393 lines (estimated post-D-975-S-21.09-LOCAL-PASS-13-RECORD-AND-FIX-BURST 2026-08-12; pass-13 persisted NOT CLEAN 1H; F-1 CLOSED via story+test-file range-cite fix; STORY-INDEX v4.303; story v1.24; v7.22→v7.23; commit pending SHA-patch)
-->
...
| **Started** | 2026-04-25 |
| **Last Updated** | 2026-08-12 — D-975-S-21.09-LOCAL-PASS-13-RECORD-AND-FIX-BURST — S-21.09 LOCAL cascade pass-13 persisted (NOT CLEAN 1H; streak 0/3 after 13 passes; trajectory-tail →20→16→8→10 UNCHANGED [S-21.07 cycle-level]); F-1 HIGH (cross-file stale test-range cite T-050 vs T-051 in story AC-006 Tests bullet + test-file module docstring header) CLOSED this burst via a documentary-only two-site range-cite correction (commit 46e334da, NOT pushed) — no code/test-logic change; adversary independently confirmed the gate/mutation machinery genuinely sound; pass-12's F-1 independently re-verified CLOSED; story v1.24; STORY-INDEX v4.302→v4.303; INDEX.md S-21.09 LOCAL Adversary Reviews section extended; pass-14 adversary is the immediate NEXT step. [Prior 2026-08-12: SHA-patch 768de245: Active Branches factory-artifacts updated cd090a5b→768de245 (actual commit HEAD); Session Resume Checkpoint header + §1 parent-citation updated cd090a5b→768de245. [Prior 2026-08-12: D-974-S-21.09-LOCAL-PASS-12-RECORD-AND-FIX-BURST — S-21.09 LOCAL cascade pass-12 persisted (NOT CLEAN 1H; streak 0/3 after 12 passes; trajectory-tail →20→16→8→10 UNCHANGED [S-21.07 cycle-level]); F-1 HIGH (containment predicate PREFIX conjunct un-isolated, POLICY 13) CLOSED this burst via T-051 (orthogonal sibling of T-050; commit a922ad82, NOT pushed); both pass-11 findings independently re-verified CLOSED; story v1.23; STORY-INDEX v4.301→v4.302; INDEX.md S-21.09 LOCAL Adversary Reviews section extended; pass-13 adversary is the immediate NEXT step]] |
| **Current Phase** | **D-975-S-21.09-LOCAL-PASS-13-RECORD-AND-FIX-BURST (HEAD 3a7378b3; SHA-patch PENDING; D-chain cite D-975; PIPELINE ACTIVE). S-21.09 LOCAL cascade 13 passes streak 0/3 — story spec v1.24; impl 46e334da 46 tests T-006..T-051 all green; feature/S-21.09 NOT PUSHED (explicit human auth required). Pass-13 NOT CLEAN 1H — F-1 CLOSED this burst via a documentary-only two-site range-cite correction (story AC-006 Tests bullet + test-file module docstring); adversary independently confirmed the gate/mutation machinery genuinely sound; pass-12's F-1 independently re-verified CLOSED. 4 pass-10 carry-over findings (MED-001/LOW-001/LOW-002/LOW-003) remain OPEN — anchor pass-14. 4-INDEX BC v4.56/VP v2.76/STORY v4.303/ARCH v3.55. policies.yaml v1.4.23. trajectory-tail →20→16→8→10 UNCHANGED. LOCAL adversary pass-14 is the immediate NEXT step.** |
...
| Story | S-N.MM | `stories/S-N.MM-<short>.md` | 130 file-resident + 17 stub IDs (STORY-INDEX v4.303 D-975-S-21.09-LOCAL-PASS-13-RECORD-AND-FIX-BURST 2026-08-12) |
...
- **In-Flight (1):** S-21.09 (feature/S-21.09 @ 46e334da; story spec v1.24; 46 tests T-006..T-051 all green; 16 pts; BC-5.39.001 LOCAL streak 0/3 after 13 passes; pass 14 NEXT; human ruling: true 3-CLEAN required; adv-s21.09-local-pass-1..13.md; C-1/C-2/C-4/C-5 blocking issues open; 4 pass-10 carry-over findings open (MED-001, LOW-001/002/003); **NOT PUSHED**)
- **E-21:** S-21.07 (W4; pass-10 NOT-CLEAN 10 findings D-967; branch 5370db80 pushed; FROZEN; NO REBASE; MERGE-ORDER: S-21.09 first); S-21.09 (in-flight; 16 pts; feature/S-21.09 @ 46e334da; story spec v1.24; MUST land before S-21.07); S-21.10/S-21.11/S-21.12 per D-961; S-21.13 (W7 NEW D-964; depends_on S-21.10/S-21.11; draft); S-21.14 (W8 NEW D-972; 8 pts; release-pipeline predicate+gate sweep; draft); S-21.15 (W8 NEW D-972; 5 pts; compute-input-hash search-path + traces_to; draft).
...
| factory-artifacts | 3a7378b3 | D-974-S-21.09-LOCAL-PASS-12-RECORD-AND-FIX-BURST burst. SHA-patch done 2026-08-12. D-975-S-21.09-LOCAL-PASS-13-RECORD-AND-FIX-BURST burst committed this session — SHA-patch PENDING. |
...
| feature/S-21.09 | 46e334da | S-21.09 in-flight (story spec v1.24; 46 tests T-006..T-051 all green; 16 pts; LOCAL streak 0/3 after 13 passes; pass 14 NEXT; human ruling: true 3-CLEAN required; C-1/C-2/C-4/C-5 open; 4 pass-10 carry-over findings open). Docstring-only commit on top of `a922ad82` (where T-051 landed pass-12). **NOT PUSHED.** Requires explicit human auth: `git -C .worktrees/S-21.09 push -u origin feature/S-21.09`. |
...
| v1.0-brownfield-backfill | brownfield | D-975-S-21.09-LOCAL-PASS-13-RECORD-AND-FIX-BURST ACTIVE. S-21.09 LOCAL pass-13 persisted NOT CLEAN (1H; streak 0/3 after 13 passes); F-1 CLOSED this burst (documentary-only two-site range-cite correction; commit 46e334da); adversary independently confirmed gate/mutation machinery genuinely sound; pass-12's F-1 independently re-verified CLOSED. story spec v1.24; impl 46e334da NOT PUSHED. develop 62fbcf1a; main 80e5cd7b; merged_count 107; BC v4.56; VP v2.76; STORY v4.303; ARCH v3.55; ADR-043 proposed NOT RATIFIED; streak 0/3; total finding trajectory 3→3→2→13→11→9→9→8→8→15→2→1→1; trajectory-tail →20→16→8→10 UNCHANGED. F-001 redesign RATIFIED (ADR-040 v1.12; policies.yaml v1.4.23 ACTIVE; CI wiring PENDING). pass-14 adversary NEXT (4 pass-10 carry-over findings open — MED-001, LOW-001/002/003). | D-975-S-21.09-LOCAL-PASS-13-RECORD-AND-FIX-BURST 2026-08-12; SHA-patch 768de245 2026-08-12; D-974-S-21.09-LOCAL-PASS-12-RECORD-AND-FIX-BURST 2026-08-12; SHA-patch ede18db0 2026-08-12. |
...
> D-001..D-606 (see decision-log.md for full range): `cycles/v1.0-brownfield-backfill/decision-log.md` + `decisions-log-archive.md`. D-379..D-454 (see decision-log.md for full range) (F5): `cycles/v1.0-feature-engine-discipline-pass-1/decision-log.md`. D-607..D-975 (see decision-log.md for full range): this Decisions Log (D-960..D-975 (see decision-log.md for full range) live) + decision-log.md SoT.

| ID | Decision | Summary | Phase | Date |
|----|----------|---------|-------|------|
| D-975 | D-975-S-21.09-LOCAL-PASS-13-RECORD-AND-FIX-BURST (state-manager; single-commit TD-VSDD-053 2026-08-12; parent-commit 3a7378b3; commit pending SHA-patch). S-21.09 LOCAL cascade pass-13 persisted (NOT CLEAN 1H; streak 0/3 after 13 passes); INDEX.md S-21.09 LOCAL Adversary Reviews section extended (pass-13 row + Convergence Status update); F-1 HIGH (cross-file stale test-range cite T-050 vs T-051 in story AC-006 Tests bullet + test-file module docstring header, POLICY 13/count-parity — pass-12's 5-site sweep did not cover these 2 sites) CLOSED via a documentary-only two-site range-cite correction (test-writer commit 46e334da, NOT pushed; story-writer story v1.24) — no code/test-logic change; adversary independently confirmed the gate/mutation machinery genuinely sound (no surviving-mutant, no fail-open, no path-normalization edge gap); pass-12's F-1 (T-051 prefix-conjunct isolation) independently re-verified CLOSED; VP-TBD [process-gap] observation LINKED to existing Drift Item [D-945] — no new drift item opened; STORY-INDEX v4.302→v4.303 (S-21.09 catalog row v1.23→v1.24; 46 tests T-006..T-051, 40 owned; 16 pts UNCHANGED); 1 L-BB lesson appended (policy5-sweep-omits-tests-bullet-and-docstring-header); 4 pass-10 carry-over findings (MED-001, LOW-001/002/003) remain OPEN — anchor pass-14; feature/S-21.09 push status UNCHANGED (NOT PUSHED); STATE.md v7.22→v7.23. | S-21.09 LOCAL pass-13 NOT CLEAN 1H; F-1 CLOSED via documentary range-cite fix; adversary confirmed machinery sound; STORY-INDEX v4.303; INDEX.md extended | D-975-S-21.09-LOCAL-PASS-13-RECORD-AND-FIX-BURST | 2026-08-12 |
| D-974 | D-974-S-21.09-LOCAL-PASS-12-RECORD-AND-FIX-BURST (state-manager; single-commit TD-VSDD-053 2026-08-12; parent-commit cd090a5b; commit 768de245; SHA-patch done). S-21.09 LOCAL cascade pass-12 persisted (NOT CLEAN 1H; streak 0/3 after 12 passes); INDEX.md S-21.09 LOCAL Adversary Reviews section extended (pass-12 row + Convergence Status update); F-1 HIGH (containment predicate PREFIX conjunct un-isolated, POLICY 13 mutation-completeness) CLOSED via T-051 prefix-conjunct isolation control (test-writer commit a922ad82, NOT pushed), orthogonal sibling of pass-11's T-050; both pass-11 findings (F-1 length-conjunct, F-2 drift sweep) independently re-verified CLOSED; story v1.23 (story-writer); STORY-INDEX v4.301→v4.302 (S-21.09 catalog row v1.22→v1.23; 46 tests T-006..T-051, 40 owned; 16 pts UNCHANGED); 1 L-BB lesson appended (single-conjunct-isolation-does-not-close-multi-conjunct-gate); 4 pass-10 carry-over findings (MED-001, LOW-001/002/003) remain OPEN — anchor pass-13; feature/S-21.09 push status UNCHANGED (NOT PUSHED); STATE.md v7.21→v7.22. | S-21.09 LOCAL pass-12 NOT CLEAN 1H; F-1 CLOSED via T-051 (orthogonal sibling of T-050); STORY-INDEX v4.302; INDEX.md extended | D-974-S-21.09-LOCAL-PASS-12-RECORD-AND-FIX-BURST | 2026-08-12 |
| D-973 | D-973-S-21.09-LOCAL-PASS-11-RECORD-AND-FIX-BURST (state-manager; single-commit TD-VSDD-053 2026-08-12; parent-commit 424f59a4; commit ede18db0; SHA-patch done). S-21.09 LOCAL cascade pass-11 persisted (NOT CLEAN 1H/1M; streak 0/3 after 11 passes); INDEX.md S-21.09 LOCAL Adversary Reviews section created (backfilled passes 1-10 + pass-11 row; Convergence Status appended); F-1 HIGH (false M2 mutation-kill attestation on T-047/T-048/story lines 645, escalates pass-10 MED-004) CLOSED via T-050 length-conjunct isolation control (test-writer commit 69663255, NOT pushed); F-2 MEDIUM (5-site docstring/test-name/story-row drift) CLOSED; story v1.22 (story-writer); STORY-INDEX v4.300→v4.301 (S-21.09 catalog row v1.21→v1.22; 45 tests T-006..T-050, 39 owned; 16 pts UNCHANGED); 1 L-BB lesson appended (mutation-kill-attestation-requires-empirical-verification); 4 pass-10 carry-over findings (MED-001, LOW-001/002/003) remain OPEN — anchor pass-12; feature/S-21.09 push status UNCHANGED (NOT PUSHED); STATE.md v7.20→v7.21. | S-21.09 LOCAL pass-11 NOT CLEAN 1H/1M; F-1/F-2 CLOSED (T-050 + narrative correction); STORY-INDEX v4.301; INDEX.md section created; 4 carry-overs OPEN | D-973-S-21.09-LOCAL-PASS-11-RECORD-AND-FIX-BURST | 2026-08-12 |
| D-413..D-972 (see decision-log.md for full range) | **ARCHIVED** | Full detail in decision-log.md SoT. | ARCHIVED | 2026-06-14..2026-08-11 |
...
| **[P0] `validate-factory-path-staging` WASM guard inert since 2026-07-23** | **OPEN** | 0 fires vs ≥14,000 sibling invocations; `on_error = "continue"` masks absence. Fix story: S-21.09 (46e334da; story spec v1.24; 46 tests; LOCAL streak 0/3 after 13 passes; pass 14 NEXT). MUST land before S-21.07. |
...
| **[pass-10 carry-over] ADV-BB-P10-MED-001 directory-only `hook-plugins/sub/` staging control** | **OPEN — carried through pass-13 2026-08-12** | Gate (a)'s ">= 1 component after hook-plugins/" threshold admits directory-only declarations; spurious MISSING report possible. Anchor: pass-14. |
| **[pass-10 carry-over] ADV-BB-P10-LOW-001/002/003 (NUL/trailing-space names; fail-open arms; `workspace_root()` untested)** | **OPEN — carried through pass-13 2026-08-12** | Low-severity residuals from pass-10; not addressed in pass-11, pass-12, or pass-13 dispatch scope. Anchor: pass-14. |
...
## Session Resume Checkpoint (2026-08-12 — HEAD 3a7378b3; SHA-patch PENDING; PIPELINE ACTIVE; S-21.09 LOCAL 13 passes streak 0/3; story spec v1.24; impl 46e334da 46 tests T-006..T-051; NOT PUSHED)

> **SELF-SUFFICIENT RESUME CONTEXT — ASSUMES ZERO PRIOR CONTEXT. PIPELINE ACTIVE.**

### §1 Position

Cycle `v1.0-brownfield-backfill`. Pass count **13**, streak **0/3** (13 adversary passes, zero CLEAN). Total finding-count trajectory `3→3→2→13→11→9→9→8→8→15→2→1→1`, tail `→15→2→1→1`. Cycle-level trajectory-tail (S-21.07) `→20→16→8→10` UNCHANGED. 4-INDEX: BC v4.56 / VP v2.76 / **STORY v4.303** / ARCH v3.55. `policies.yaml` **v1.4.23**. factory-artifacts HEAD `3a7378b3` (D-975-S-21.09-LOCAL-PASS-13-RECORD-AND-FIX-BURST commit — SHA-patch PENDING; parent-commit cited until patched).

**Last decisions: D-974, D-975.** Pass-13 CLOSED this burst (F-1 resolved same-session; pass-12's F-1 independently re-verified). Pass-14 LOCAL adversary is now the immediate NEXT step.

### §2 S-21.09 (Session's Main Work)

In-flight. Branch `feature/S-21.09` at **`46e334da`** (docstring-only commit on top of `a922ad82`, where T-051 landed in the pass-12 fix-burst), **46 tests T-006..T-051** all green, `cargo fmt`/`clippy`/`cargo test --workspace --all-targets` all clean (no logic change this burst — test-writer attestation carried forward). Story spec **v1.24** (documents the AC-006 "Tests:" bullet range-cite correction `T-013..T-050`→`T-013..T-051`; story body cites `a922ad82` for T-051's test-landing provenance in narrative prose — this is acceptable and intentional, distinct from the branch HEAD SHA which advanced to `46e334da` for the docstring-only fix). Points **16** (UNCHANGED — documentary correction, no AC scope change).
...
**13 passes, all NOT CLEAN, streak 0/3.** Human ruling (twice): **true 3-CLEAN required**, not D-386 Option C asymptotic acceptance.

Total finding-count trajectory: `3→3→2→13→11→9→9→8→8→15→2→1→1`. Severity(HIGH) trajectory: `3→2→3→2→1→1→3→2→1→3→1→1→1`. All thirteen review files persisted as `cycles/v1.0-brownfield-backfill/adv-s21.09-local-pass-{1..13}.md`. `INDEX.md` `S-21.09 LOCAL Adversary Reviews` table extended this burst with the pass-13 row and an updated Convergence Status paragraph.

**Pass-13: NOT CLEAN — F-1 HIGH, CLOSED same-burst.**
- **F-1 [HIGH; POLICY 13 / count-parity; Partial-Fix Regression Discipline]**: cross-file stale test-range cite — story line 475 (AC-006 "Tests:" bullet) and test-file `bundle_orphan_check.rs` line 128 (module docstring) both still read `T-012..T-050`/`T-013..T-050`, omitting T-051 (pass-12's dedicated prefix-conjunct isolation control). The pass-12 fix-burst's 5-site sweep (Architecture Mapping, Purity Classification, Architecture Compliance Rules, File Structure Requirements, Token Budget Estimate) did not include these 2 sites as sweep targets. Impact documentary — correct range present elsewhere in both files; no code/test-logic defect. **CLOSED**: test-writer commit `46e334da` (docstring-only fix); story-writer story v1.24 (AC-006 Tests-bullet correction); POLICY 5 sibling-sweep confirmed zero further stale sites.

Part A fix-verification: the adversary independently confirmed the gate/mutation machinery genuinely sound — "no surviving-mutant, no fail-open, no path-normalization edge gap" — an independent fresh-context re-derivation, not merely a carry-forward check. Pass-12's F-1 (T-051 prefix-conjunct isolation) verified CLOSED this pass — no residual or reopened finding. VP-TBD [process-gap] observation (BC-4.16.001 4 TBD VP rows) confirmed to map to the existing **[D-945]** drift item — no new drift item opened.

**Open after `46e334da` (4 pass-10 carry-overs, NOT addressed pass-11/12/13):**
...
- **4 pass-10 carry-over findings** (MED-001, LOW-001/002/003) — anchor: pass-14.

### §7 Infrastructure Blockers

(a) **STATE.md narrative sections** — full-file Write convention continues (verify-state-timestamp-refresh guard requires a `timestamp:` advance within every individual Edit call's own diff; single-hunk Edit calls that touch two non-contiguous sections both require timestamp advance in the SAME call, which in practice means spanning the whole intervening text or using a full-file Write — this burst used full-file Write for the main record burst; the follow-up SHA-patch will use the same approach, continuing to confirm it remains the reliable path for any multi-section STATE.md update).
...
(c) **`decision-log.md`/`burst-log.md`/`lessons.md` >15,900/25,800/10,900 lines respectively** exhaust WASM validator fuel on every edit — confirmed again this burst (advisory only; writes land). Compaction gates rc.24 fuel-cap effectiveness + S-15.03 PRIORITY-A automation.
(d) **`adv-s21.09-local-pass-N.md` input-hash convention**: `compute-input-hash` resolves the review file's `inputs:` reference RELATIVE TO THE CURRENT WORKING-TREE STATE, not the state at review time. A manually-derived hash against a `/tmp`-staged historical copy of the reviewed content will NOT match the live `validate-input-hash` guard; always let the guard's own rejection message supply the correct value, or run `compute-input-hash` against the in-repo path after the referenced file's final committed state for this burst is in place. Confirmed again this burst: the literal placeholder `PENDING` was rejected with `input_hash_format`; the canonical `compute-input-hash` tool supplied the correct 7-char value (`c957256`) on first invocation.
(e) **`validate-trajectory-tail-cell-completeness` (D-453(d))**: requires a 4-value trajectory-tail arrow-sequence present in BOTH the frontmatter `current_step` AND the Project Metadata `Last Updated` cell on every STATE.md write, even for LOCAL-cascade bursts that do not touch the S-21.07 cycle-level trajectory. Include `trajectory-tail →20→16→8→10 UNCHANGED` (or the current cycle-level tail value) explicitly in both sites on every future burst, even when the burst's own subject is a different cascade. Applied again this burst.
...
4. **True 3-CLEAN ruling for S-21.09** — 13 passes, 0 clean, 46 tests, 16 pts; maintain true 3-CLEAN or accept D-386 asymptotic?
...
`/vsdd-factory:next-step` — LOCAL adversary pass-14 dispatch is the next substantive action (pass-13 CLOSED this burst; SHA-patch PENDING — will update Active Branches `factory-artifacts` row and this checkpoint's header to the actual commit HEAD once this burst's commit lands).
