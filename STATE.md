...
| factory-artifacts | see `git -C .factory log -1` | D-946-BURST: Commit A ed55ead1; Commit B 42eceee5; SHA-patch this-commit. NOTE: current HEAD not self-cited per TD-VSDD-053. |
