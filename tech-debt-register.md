...
| P1 (within 3 cycles) | +1 (enforcement implemented; Kani harness deferral noted) | TD-031 post-EC-012 line-drift enforcement — escalated P2→P1 fix-burst-15; ENFORCEMENT IMPLEMENTED fix-burst-16 + generalized+tightened this session (validate-stable-anchors WASM hook; source-code allowlist; 316 violations; 62 tests; chunked sweep complete; validate-artifact-path sibling fixed; Kani harness deferral pending) |
