...
**Cascade trajectory:** ~41 → 14 → 8 → 3 → 5. CRITICAL=0 sustained 5 passes. Slight uptick at pass-5 from cross-file propagation gap (F-BC006P5-001: BC-INDEX body table stale; F-BC006P5-002: last_amended: text-prefix stale across 3 BCs — INV-020 class). INV-019 RECURRENCE in same fix-burst that confirmed INV-019. Pass-5 PO fix-burst CLOSED D-491: 4/4 closures (+ F-BC006P5-001 closed at D-490 = 5/5 total); POLICY 14 5-leg parity validated production; ~46 bare→assoc-fn conversions; BC-006 v1.7 + BC-007 v1.5 + BC-008 v1.5 + BC-INDEX v2.43; STREAK 0/3 → pass-6 dispatch-ready.
