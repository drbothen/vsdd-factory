...
Wave 11 had the highest pass count (14) of all waves in the v1.0-brownfield-backfill cycle.
The pass-9 macOS APFS inode regression (uncommitted edits lost via `git rm` alias collision)
spiked findings to 8 at pass-10. The pass-11 D-118 exhaustive corpus sweep broke the
propagation-drift cycle; passes 12/13/14 were clean.
