...
**Anchors:** D-571 (this update; 3rd-occurrence escalation to MANDATORY; F2 pass-10 fix); D-569 (2nd-occurrence burst; F2 pass-8 fix); O-P8-002 process-gap candidate (adversary pass-8); F-P10-001 (MAJOR; 3rd occurrence; BC-4.14.001 v1.8 full PAYLOAD-ONLY closure); F-P8-001 (MAJOR; 2nd occurrence; BC-4.14.001 v1.7); F-P7-001 (1st occurrence; pass-7 MAJOR; ADR-026 §Decision 2); BC-4.14.001 v1.8 (corrected; full payload-only); VP-INDEX v2.15 (VP-083/VP-081 rows synced); S-18.08 (gate now MANDATORY).

**Cites:** D-571; D-569; O-P8-002; F-P10-001; F-P8-001; F-P7-001; D-568 (pass-7 fix); BC-4.14.001 Invariant 1; ADR-026 §Decision 8; ADR-026 §Decision 9 (payload wave_id per F-P10-001); S-7.02; S-18.08; BC-5.39.001 3-CLEAN.

**Closes:** D-571 O-P8-002 escalated to MANDATORY (3rd occurrence threshold met; S-18.08 pure-parse invariant gate is now a hard requirement); D-569 O-P8-002 original codification (2nd occurrence); VP-INDEX VP-083/VP-081 cross-doc sync confirmed. `[codified; escalated-to-mandatory]`
