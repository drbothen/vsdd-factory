...
phase: test-fixture-fail-row-coalescence
---
...
|-------|------|-------------|--------|
| D-490 | text about 490 | D-491 | text about 491 (row-coalescence D-431(a) violation) |
| D-492 | 2026-05-22 | Decision 492 | state-manager |
