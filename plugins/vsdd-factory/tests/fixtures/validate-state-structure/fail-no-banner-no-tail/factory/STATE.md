...
phase: test-fixture-fail-no-banner-no-tail
---

# Pipeline State: test-fixture

This STATE.md has no SIZE BUDGET banner and no trajectory tail.
EC-014: both banner-wc and trajectory-tail violations must fire.
Also: no dual-margin present. Total expected: 3 violations.
...
No trajectory tail present in this section.
