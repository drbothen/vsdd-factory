...
2. Run §G.1 preflight (BC-6.26.001 PC2): `find .worktrees/STORY-NNN/.factory -type f`; if non-empty
   HALT and follow `steps/step-g-cleanup.md §G.1`. Remove local worktree: `git worktree remove .worktrees/STORY-NNN`
