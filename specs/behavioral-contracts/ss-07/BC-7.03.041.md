...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:472"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.03.041: factory-branch-guard: skips paths outside .factory tree

## Description

factory-branch-guard: skips paths outside .factory tree. Exit 0 immediately. Most edits are unaffected.

**Source category:** Routing hooks (PreToolUse, PostToolUse, lifecycle).
**Audit ID:** `BC-AUDIT-1040` (extracted from `pass-3-deep-hooks.md` line 472).
**Hook script:** ``plugins/vsdd-factory/hooks/factory-branch-guard.sh``.

## Preconditions

1. Trigger: file_path does NOT contain `.factory/` or `.factory-project/`.

## Postconditions

1. Behavior: Exit 0 immediately. Most edits are unaffected.
2. Exit codes: 0.
...
| **Source Document** | `pass-3-deep-hooks.md` line 472 |
| **Audit ID** | `BC-AUDIT-1040` |
