...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:873"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.03.078: session-learning: skips when .factory/ absent

## Description

session-learning: skips when .factory/ absent. Exit 0 — projects without .factory/ get no marker.

**Source category:** Routing hooks (PreToolUse, PostToolUse, lifecycle).
**Audit ID:** `BC-AUDIT-1077` (extracted from `pass-3-deep-hooks.md` line 873).
**Hook script:** ``plugins/vsdd-factory/hooks/session-learning.sh``.

## Preconditions

1. Trigger: `.factory/` directory does not exist.

## Postconditions

1. Behavior: Exit 0 — projects without .factory/ get no marker.
2. Exit codes: 0.
...
| **Source Document** | `pass-3-deep-hooks.md` line 873 |
| **Audit ID** | `BC-AUDIT-1077` |
| **Source Line(s) (within hook)** | 16-17. |
