...
**Registry entry:** `hooks-registry.toml::validate-demo-evidence-story-scoped` (PostToolUse, tool=`Edit|Write`, priority=270, timeout_ms=5000, on_error=continue)..
...
| v1.2 | 2026-05-08 | implementer | TD-VSDD-091 Chunk 5 — migrated `hooks-registry.toml:176-194` → `hooks-registry.toml::validate-demo-evidence-story-scoped`. |
