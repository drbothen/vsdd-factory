...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1084"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.005: validate-bc-title: identity & registry binding

## Description

validate-bc-title: identity & registry binding. Policy 7 enforcer (BC H1 = source of truth). on_error=continue.
...
1. Behavior: Policy 7 enforcer (BC H1 = source of truth). on_error=continue.
2. Exit codes: 0 / 2.
...
| **Source Document** | `pass-3-deep-hooks.md` line 1084 |
| **Audit ID** | `BC-AUDIT-1096` |
