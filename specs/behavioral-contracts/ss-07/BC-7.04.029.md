...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1332"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.029: validate-novelty-assessment: scopes to adversarial review pass files; excludes index/findings

## Description

validate-novelty-assessment: scopes to adversarial review pass files; excludes index/findings

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1120` (extracted from `pass-3-deep-hooks.md` line 1332).
**Hook script:** ``plugins/vsdd-factory/hooks/validate-novelty-assessment.sh``.

## Preconditions

1. Trigger: file_path matches `*pass-N.md`, `*adversarial-*review*.md`, `*round-N*-review*.md`, `*gemini-review*.md`, `*spec-review-pass*.md`. Excludes INDEX/FINDINGS/ADV-/convergence-summary/convergence-trajectory.
...
| **Source Document** | `pass-3-deep-hooks.md` line 1332 |
| **Audit ID** | `BC-AUDIT-1120` |
| **Source Line(s) (within hook)** | 36-49. |
