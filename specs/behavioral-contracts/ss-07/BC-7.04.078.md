...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1807"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.078: validate-wave-gate-completeness: blocks when gate_report file not found

## Description

validate-wave-gate-completeness: blocks when gate_report file not found. Error "X: gate_report 'Y' not found".

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1169` (extracted from `pass-3-deep-hooks.md` line 1807).
**Hook script:** ``plugins/vsdd-factory/hooks/validate-wave-gate-completeness.sh``.

## Preconditions

1. Trigger: gate_report path neither absolute-existing nor present at `$FACTORY_DIR/$path`.

## Postconditions

1. Behavior: Error "X: gate_report 'Y' not found".
2. Exit codes: 2.
...
| **Source Document** | `pass-3-deep-hooks.md` line 1807 |
| **Audit ID** | `BC-AUDIT-1169` |
| **Source Line(s) (within hook)** | 91-102. |
