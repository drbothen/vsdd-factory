...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1647"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.061: validate-table-cell-count: scopes to .factory/*.md

## Description

validate-table-cell-count: scopes to .factory/*.md

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1152` (extracted from `pass-3-deep-hooks.md` line 1647).
...
| **Source Document** | `pass-3-deep-hooks.md` line 1647 |
| **Audit ID** | `BC-AUDIT-1152` |
| **Source Line(s) (within hook)** | 34-37. |
