...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1360"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.032: validate-pr-description-completeness: identity & registry binding

## Description

validate-pr-description-completeness: identity & registry binding

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1123` (extracted from `pass-3-deep-hooks.md` line 1360).
**Hook script:** ``plugins/vsdd-factory/hooks/validate-pr-description-completeness.sh``.
**Registry entry:** `hooks-registry.toml::validate-pr-description-completeness` (PostToolUse, tool=`Edit|Write`, priority=330, timeout_ms=5000, on_error=continue)..
...
| **Source Document** | `pass-3-deep-hooks.md` line 1360 |
| **Audit ID** | `BC-AUDIT-1123` |
...
| v1.2 | 2026-05-08 | implementer | TD-VSDD-091 Chunk 5 — migrated `hooks-registry.toml:296-314` → `hooks-registry.toml::validate-pr-description-completeness`. |
