...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1321"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.028: validate-novelty-assessment: identity & registry binding

## Description

validate-novelty-assessment: identity & registry binding. Novelty Assessment block format validator.

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1119` (extracted from `pass-3-deep-hooks.md` line 1321).
**Hook script:** ``plugins/vsdd-factory/hooks/validate-novelty-assessment.sh``.
**Registry entry:** `hooks-registry.toml::validate-novelty-assessment` (PostToolUse, tool=`Edit|Write`, priority=320, timeout_ms=5000, on_error=continue)..
...
1. Behavior: Novelty Assessment block format validator.
2. Exit codes: 0 / 2.
...
| Property | Value |
|----------|-------|
| **Path** | ``plugins/vsdd-factory/hooks/validate-novelty-assessment.sh`` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Document** | `pass-3-deep-hooks.md` line 1321 |
| **Audit ID** | `BC-AUDIT-1119` |
...
| v1.2 | 2026-05-08 | implementer | TD-VSDD-091 Chunk 5 — migrated `hooks-registry.toml:276-294` → `hooks-registry.toml::validate-novelty-assessment`. |
