...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1589"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.055: validate-story-bc-sync: blocks body-table BC missing from frontmatter array

## Description

validate-story-bc-sync: blocks body-table BC missing from frontmatter array. Per stray BC, error.

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1146` (extracted from `pass-3-deep-hooks.md` line 1589).
**Hook script:** ``plugins/vsdd-factory/hooks/validate-story-bc-sync.sh``.

## Preconditions

1. Trigger: BC in body BC table but not in frontmatter array.

## Postconditions

1. Behavior: Per stray BC, error.
2. Exit codes: 2.
...
| **Source Document** | `pass-3-deep-hooks.md` line 1589 |
| **Audit ID** | `BC-AUDIT-1146` |
| **Source Line(s) (within hook)** | 108-114. |
