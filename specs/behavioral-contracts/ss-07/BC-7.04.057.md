...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1610"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.057: validate-subsystem-names: scopes to BC-*.md and STORY-*.md, requires ARCH-INDEX

## Description

validate-subsystem-names: scopes to BC-*.md and STORY-*.md, requires ARCH-INDEX

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1148` (extracted from `pass-3-deep-hooks.md` line 1610).
**Hook script:** ``plugins/vsdd-factory/hooks/validate-subsystem-names.sh``.

## Preconditions

1. Trigger: file_path matches BC or STORY pattern AND ARCH-INDEX.md exists with Subsystem Registry.
...
| **Source Document** | `pass-3-deep-hooks.md` line 1610 |
| **Audit ID** | `BC-AUDIT-1148` |
| **Source Line(s) (within hook)** | 33-56. |
