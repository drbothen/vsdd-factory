...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1725"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.069: validate-vp-consistency: scopes to VP-INDEX.md, verification-architecture.md, verification-covera...

## Description

validate-vp-consistency: scopes to VP-INDEX.md, verification-architecture.md, verification-coverage-matrix.md

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1160` (extracted from `pass-3-deep-hooks.md` line 1725).
**Hook script:** ``plugins/vsdd-factory/hooks/validate-vp-consistency.sh``.

## Preconditions

1. Trigger: file_path matches one of three names; ALL THREE files must exist for validation to proceed.

## Postconditions

1. Exit codes: 0 (skip if any missing).
...
| **Source Document** | `pass-3-deep-hooks.md` line 1725 |
| **Audit ID** | `BC-AUDIT-1160` |
| **Source Line(s) (within hook)** | 42-72. |
