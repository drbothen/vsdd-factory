...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1518"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.048: validate-state-pin-freshness: identity & registry binding

## Description

validate-state-pin-freshness: identity & registry binding

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1139` (extracted from `pass-3-deep-hooks.md` line 1518).
**Hook script:** ``plugins/vsdd-factory/hooks/validate-state-pin-freshness.sh``.
**Registry entry:** `hooks-registry.toml::validate-state-pin-freshness` (PostToolUse, tool=`Edit|Write`, priority=350, timeout_ms=10000, on_error=continue)..
...
| **Source Document** | `pass-3-deep-hooks.md` line 1518 |
| **Audit ID** | `BC-AUDIT-1139` |
...
| v1.2 | 2026-05-08 | implementer | TD-VSDD-091 Chunk 5 — migrated `hooks-registry.toml:336-354` → `hooks-registry.toml::validate-state-pin-freshness`. |
