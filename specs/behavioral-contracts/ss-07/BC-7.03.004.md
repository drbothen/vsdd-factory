...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:75"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.03.004: block-ai-attribution: blocks "Generated with Claude Code" / generated-by-AI / noreply email

## Description

block-ai-attribution: blocks "Generated with Claude Code" / generated-by-AI / noreply email. grep -iE for `Generated with Claude Code|Generated by Claude|Generated by AI|noreply@anthropic\.com|noreply@openai\.com`. Block code: `ai_attribution_generated`.

**Source category:** Routing hooks (PreToolUse, PostToolUse, lifecycle).
**Audit ID:** `BC-AUDIT-1003` (extracted from `pass-3-deep-hooks.md` line 75).
**Hook script:** ``plugins/vsdd-factory/hooks/block-ai-attribution.sh``.

## Preconditions

1. Trigger: First check passed (no Co-Authored-By match).

## Postconditions

1. Behavior: grep -iE for `Generated with Claude Code|Generated by Claude|Generated by AI|noreply@anthropic\.com|noreply@openai\.com`. Block code: `ai_attribution_generated`.
...
|-------|-----------------|----------|
| Acceptance criterion (see below) | `git commit -m "fix: foo\n\nGenerated with Claude Code"` is rejected. | happy-path |
...
| **Source Document** | `pass-3-deep-hooks.md` line 75 |
| **Audit ID** | `BC-AUDIT-1003` |
| **Source Line(s) (within hook)** | 56-60. |
