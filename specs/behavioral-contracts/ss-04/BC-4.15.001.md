...
- VP-091 — (to be authored in same burst by architect; verifies: gate always returns Continue; advisory emitted on match; never blocks; pure-parse; non-Bash no-op)
