...
origin: brownfield
extracted_from: "pass-3-behavioral-contracts.md:292"
subsystem: "SS-03"
capability: "TBD"
...
# Behavioral Contract BC-3.01.003: Sink schema_version != 1 is a hard error

> Section: Sink registry and base contracts
> Source BC (audit ID): BC-AUDIT-043

## Description

`from_config` returns Err containing "schema_version".

## Preconditions

1. observability-config.toml with `schema_version = 99`.

## Postconditions

1. `from_config` returns Err containing "schema_version".
...
| **Source line(s)** | TBD |
| **Confidence** | high |
| **Original audit ID** | BC-AUDIT-043 |
| **Pass-3 source** | `pass-3-behavioral-contracts.md:292` |
| **Extraction Date** | 2026-04-25 |

**Evidence (from pass-3):**

> `sinks/mod.rs::tests::load_rejects_unsupported_schema_version`.
