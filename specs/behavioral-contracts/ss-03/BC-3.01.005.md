...
origin: brownfield
extracted_from: "pass-3-behavioral-contracts.md:304"
subsystem: "SS-03"
capability: "TBD"
...
# Behavioral Contract BC-3.01.005: SinkEvent serializes flat (transparent over Map)

> Section: Sink registry and base contracts
> Source BC (audit ID): BC-AUDIT-045

## Description

JSON has no `fields` wrapper; all keys top-level.

## Preconditions

1. SinkEvent with multiple inserted fields.

## Postconditions

1. JSON has no `fields` wrapper; all keys top-level.
...
| **Source line(s)** | TBD |
| **Confidence** | high |
| **Original audit ID** | BC-AUDIT-045 |
| **Pass-3 source** | `pass-3-behavioral-contracts.md:304` |
| **Extraction Date** | 2026-04-25 |

**Evidence (from pass-3):**

> `sink-core/lib.rs::tests::sink_event_serializes_as_flat_object`.
