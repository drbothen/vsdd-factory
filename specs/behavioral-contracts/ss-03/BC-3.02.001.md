...
origin: brownfield
extracted_from: "pass-3-deep-rust-tests.md:857"
subsystem: "SS-03"
capability: "TBD"
...
# Behavioral Contract BC-3.02.001: sink-file::template_date_only: `{date}` substitutes to YYYY-MM-DD

> Section: File sink behavior
> Source BC (audit ID): BC-AUDIT-2368

## Description

Given `path_template = ".factory/logs/events-{date}.jsonl"`, fixed_date = 2026-04-24. When `resolve_path_template`.. Then Returns `".factory/logs/events-2026-04-24.jsonl"`.

## Preconditions

1. `path_template = ".factory/logs/events-{date}.jsonl"`, fixed_date = 2026-04-24.

## Postconditions

1. Returns `".factory/logs/events-2026-04-24.jsonl"`.

## Invariants

1. Date templating produces ISO-8601 dates compatible with daily-rotation downstream tooling.
...
|-------|----------------|----------|
| `path_template = ".factory/logs/events-{date}.jsonl"`, fixed_date = 2026-04-24. | Returns `".factory/logs/events-2026-04-24.jsonl"`. | happy-path |
| TBD | TBD | edge-case |
| TBD | TBD | error |
...
| **Confidence** | high |
| **Original audit ID** | BC-AUDIT-2368 |
| **Pass-3 source** | `pass-3-deep-rust-tests.md:857` |
| **Extraction Date** | 2026-04-25 |
| **Pinned test** | ``crates/sink-file/src/lib.rs::tests::template_date_only`` |
| **Test type** | unit |
