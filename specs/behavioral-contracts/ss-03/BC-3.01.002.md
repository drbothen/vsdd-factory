...
origin: brownfield
extracted_from: "pass-3-behavioral-contracts.md:286"
subsystem: "SS-03"
capability: "TBD"
...
# Behavioral Contract BC-3.01.002: Unknown sink type warns to stderr but does not fail config load

> Section: Sink registry and base contracts
> Source BC (audit ID): BC-AUDIT-042

## Description

Warning to stderr; sink skipped; load returns Ok.

## Preconditions

1. observability-config.toml with `type = "datadog"` or other not-yet-implemented driver.

## Postconditions

1. Warning to stderr; sink skipped; load returns Ok.
...
| **Source line(s)** | TBD |
| **Confidence** | high |
| **Original audit ID** | BC-AUDIT-042 |
| **Pass-3 source** | `pass-3-behavioral-contracts.md:286` |
| **Extraction Date** | 2026-04-25 |

**Evidence (from pass-3):**

> `sinks/mod.rs::tests::load_warns_on_unknown_sink_type_but_still_succeeds`.
