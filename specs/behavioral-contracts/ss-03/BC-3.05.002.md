...
retired: 2026-05-06
removed: null
removal_reason: "ADR-015 (accepted 2026-05-04) retires the Router/SinkRegistry multi-sink architecture. This BC describes pre-ADR-015 multi-sink fan-out via registry (registry_fans_events_to_file_sinks_with_filter_and_tags) which is superseded. Wave 5 (S-10.09) will physically remove the multi-sink types. Preserved as audit trail per POLICY 1 (append-only numbering). D-312 corrigendum 2026-05-06."
