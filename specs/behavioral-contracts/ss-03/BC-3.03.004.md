...
> `crates/sink-otel-grpc/src/lib.rs::OtelGrpcSink::new_inner` (worker thread spawn; runtime build and block_on).
...
| v1.1 | 2026-05-08 | implementer | TD-VSDD-091 Chunk 6 — migrated 1 body cite: `sink-otel-grpc/src/lib.rs:307-335` + `:309-333` → `::OtelGrpcSink::new_inner`. |
