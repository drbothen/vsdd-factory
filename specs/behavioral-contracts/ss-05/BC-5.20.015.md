...
1. Step ``backup-extraction-validation` (line 87)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for ``backup-extraction-validation` (line 87)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for ``backup-extraction-validation` (line 87)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 154) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1314` |
| **Confidence** | high |
...
- **Step:** `backup-extraction-validation` (line 87)
- **Agent:** state-manager
