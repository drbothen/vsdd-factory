...
# Behavioral Contract BC-5.26.005: phase-6: failure semantics

## Description

Workflow contract: phase-6: failure semantics.
...
1. Step `phase-6: failure semantics` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-6: failure semantics` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1414 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-6: failure semantics`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 553; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1414` |
| **Confidence** | high |
...
- **Source line(s) in workflow YAML:** 9-12, 91
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — source-doc line 553
