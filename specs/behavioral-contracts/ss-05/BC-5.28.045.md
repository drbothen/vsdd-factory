...
1. Step `pre-phase-4-cicd-gate (line 616)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `pre-phase-4-cicd-gate (line 616)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `pre-phase-4-cicd-gate (line 616)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 811) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1504` |
| **Confidence** | high |
...
- **Step:** pre-phase-4-cicd-gate (line 616)
- **Type:** gate
