...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `pre-phase-4-cicd-gate (line 616)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `pre-phase-4-cicd-gate (line 616)`
