...
1. Step `phase-4-dtu-startup (line 1012)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-4-dtu-startup (line 1012)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-4-dtu-startup (line 1012)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 830) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1510` |
| **Confidence** | high |
...
- **Step:** phase-4-dtu-startup (line 1012)
- **Type:** agent
