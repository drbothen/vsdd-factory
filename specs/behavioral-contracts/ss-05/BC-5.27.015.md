...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `backup-visual-convergence (line 78)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `backup-visual-convergence (line 78)`
