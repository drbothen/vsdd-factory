...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `brownfield-to-greenfield-transition (line 301; lobster carve-out: stable anchor is step name `brownfield-to-greenfield-transition`, not line number)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `brownfield-to-greenfield-transition (line 301; lobster carve-out: stable anchor is step name `brownfield-to-greenfield-transition`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1002; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1564` |
| **Confidence** | high |
...
- **Step:** brownfield-to-greenfield-transition (line 301; lobster carve-out: stable anchor is step name `brownfield-to-greenfield-transition`, not line number)
- **Type:** agent
- **Agent:** state-manager
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`brownfield-to-greenfield-transition (line 301)`). Stable anchor is step name `brownfield-to-greenfield-transition`.
...
|---------|------|--------|--------|
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `brownfield-to-greenfield-transition`. |
