...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `pre-phase-4-dtu-gate (line 605)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `pre-phase-4-dtu-gate (line 605)`
