...
1. Step `pre-phase-4-dtu-gate (line 605)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `pre-phase-4-dtu-gate (line 605)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `pre-phase-4-dtu-gate (line 605)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 808) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1503` |
| **Confidence** | high |
...
- **Step:** pre-phase-4-dtu-gate (line 605)
- **Type:** gate
