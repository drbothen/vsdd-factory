...
# Behavioral Contract BC-5.21.005: phase-1: failure semantics
...
1. Defaults `on_failure: escalate`, `max_retries: 2`, `timeout: 2h`.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-1: failure semantics` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-1: failure semantics`
