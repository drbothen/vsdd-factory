...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for ``input-hash-drift-check` (line 127)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for ``input-hash-drift-check` (line 127)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 178) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1318` |
| **Confidence** | high |
...
- **Step:** `input-hash-drift-check` (line 127)
- **Type:** skill
