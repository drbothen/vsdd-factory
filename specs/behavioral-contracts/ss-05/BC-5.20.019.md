...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for ``input-hash-drift-check` (line 127)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for ``input-hash-drift-check` (line 127)`
