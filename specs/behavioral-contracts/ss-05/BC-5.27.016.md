...
1. Step `performance-convergence (line 87)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `performance-convergence (line 87)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `performance-convergence (line 87)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 635) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1445` |
| **Confidence** | high |
...
- **Step:** performance-convergence (line 87)
- **Type:** skill
