...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-1d-adversarial-spec-review (line 259)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-1d-adversarial-spec-review (line 259)`
