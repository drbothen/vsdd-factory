...
1. Step `session-review-approval (line 377)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `session-review-approval (line 377)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `session-review-approval (line 377)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1019) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1569` |
| **Confidence** | high |
...
- **Step:** session-review-approval (line 377)
- **Type:** human-approval
