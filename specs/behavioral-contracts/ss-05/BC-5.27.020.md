...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `convergence-gate (line 116)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `convergence-gate (line 116)`
