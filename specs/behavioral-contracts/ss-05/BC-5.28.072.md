...
1. Step `phase-6-human-approval (line 1310)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-6-human-approval (line 1310)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-6-human-approval (line 1310)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 893) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1531` |
| **Confidence** | high |
...
- **Step:** phase-6-human-approval (line 1310)
- **Type:** human-approval
