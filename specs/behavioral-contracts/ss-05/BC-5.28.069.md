...
1. Step `phase-6-final-demo (line 1275)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-6-final-demo (line 1275)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-6-final-demo (line 1275)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 884) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1528` |
| **Confidence** | high |
...
- **Step:** phase-6-final-demo (line 1275)
- **Type:** agent
- **Agent:** demo-recorder
