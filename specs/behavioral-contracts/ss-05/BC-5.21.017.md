...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for ``adversarial-spec-review` (line 108; lobster carve-out: stable anchor is step name `adversarial-spec-review`, not line number)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for ``adversarial-spec-review` (line 108; lobster carve-out: stable anchor is step name `adversarial-spec-review`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 298; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1336` |
| **Confidence** | high |
...
- **Step:** `adversarial-spec-review` (line 108; lobster carve-out: stable anchor is step name `adversarial-spec-review`, not line number)
- **Type:** loop
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`adversarial-spec-review (line 108)`). Stable anchor is step name `adversarial-spec-review`.
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — double-backtick VP/anchor: step `adversarial-spec-review` (line 108); double-backtick VP/anchor: step `adversarial-spec-review` (line 108); **Step:** bt form: step `adversarial-spec-review` (line 108)
...
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `adversarial-spec-review`. |
