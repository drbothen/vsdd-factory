...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-4-demo-recording (line 1044)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-4-demo-recording (line 1044)`
