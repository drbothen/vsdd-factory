...
# Behavioral Contract BC-5.26.001: phase-6-formal-hardening: identity

## Description

v2.0.0. Four verification techniques (Kani proofs, fuzz testing, mutation testing, security scanning) with state-manager backups for crash recovery.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-6-formal-hardening: identity` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1410 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-6-formal-hardening: identity`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 541; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1410` |
| **Confidence** | high |
...
- **Source line(s) in workflow YAML:** 1-7
- **Behavior:** v2.0.0. Four verification techniques (Kani proofs, fuzz testing, mutation testing, security scanning) with state-manager backups for crash recovery.
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — source-doc line 541
