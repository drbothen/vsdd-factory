...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `bugfix-demo-baseline (line 292)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `bugfix-demo-baseline (line 292)`
