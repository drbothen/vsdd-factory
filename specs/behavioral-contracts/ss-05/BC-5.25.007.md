...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `adversary-code-review (line 21)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `adversary-code-review (line 21)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 524) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1406` |
| **Confidence** | high |
...
- **Step:** adversary-code-review (line 21)
- **Type:** agent
- **Agent:** adversary
