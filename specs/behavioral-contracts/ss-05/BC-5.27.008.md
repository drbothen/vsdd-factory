...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `test-convergence (line 31)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `test-convergence (line 31)`
