...
1. Step ``backup-prd-revision` (line 84)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for ``backup-prd-revision` (line 84)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for ``backup-prd-revision` (line 84)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 286) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1334` |
| **Confidence** | high |
...
- **Step:** `backup-prd-revision` (line 84)
- **Agent:** state-manager
