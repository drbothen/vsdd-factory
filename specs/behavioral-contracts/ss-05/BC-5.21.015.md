...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for ``backup-prd-revision` (line 84)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for ``backup-prd-revision` (line 84)`
