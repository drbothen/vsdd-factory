...
1. Step `phase-f7-human-approval (line 1383)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f7-human-approval (line 1383)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f7-human-approval (line 1383)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1282) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1660` |
| **Confidence** | high |
...
- **Step:** phase-f7-human-approval (line 1383)
- **Type:** human-approval
