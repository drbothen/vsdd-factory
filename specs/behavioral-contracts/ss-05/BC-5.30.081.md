...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f7-human-approval (line 1383)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f7-human-approval (line 1383)`
