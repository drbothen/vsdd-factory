...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `convergence-demo (line 144)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `convergence-demo (line 144)`
