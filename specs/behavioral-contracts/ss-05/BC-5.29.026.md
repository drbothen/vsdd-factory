...
1. Step `greenfield-pipeline (line 335)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `greenfield-pipeline (line 335)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `greenfield-pipeline (line 335)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1006) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1565` |
| **Confidence** | high |
...
- **Step:** greenfield-pipeline (line 335)
- **Type:** sub-workflow
