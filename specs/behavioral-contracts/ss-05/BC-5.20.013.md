...
1. Step ``backup-coverage-audit` (line 71)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for ``backup-coverage-audit` (line 71)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for ``backup-coverage-audit` (line 71)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 142) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1312` |
| **Confidence** | high |
...
- **Step:** `backup-coverage-audit` (line 71)
- **Agent:** state-manager
