...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for ``backup-coverage-audit` (line 71)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for ``backup-coverage-audit` (line 71)`
