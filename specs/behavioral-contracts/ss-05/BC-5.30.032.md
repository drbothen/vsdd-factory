...
1. Step `bugfix-f7-human-approval (line 411)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `bugfix-f7-human-approval (line 411)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `bugfix-f7-human-approval (line 411)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1134) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1611` |
| **Confidence** | high |
...
- **Step:** bugfix-f7-human-approval (line 411)
- **Type:** human-approval
