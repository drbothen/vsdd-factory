...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for ``create-architecture` (line 63)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for ``create-architecture` (line 63)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 267) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1331` |
| **Confidence** | high |
...
- **Step:** `create-architecture` (line 63)
- **Type:** skill
