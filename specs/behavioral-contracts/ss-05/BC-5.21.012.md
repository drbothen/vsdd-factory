...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for ``create-architecture` (line 63)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for ``create-architecture` (line 63)`
