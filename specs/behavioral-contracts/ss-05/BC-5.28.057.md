...
1. Step `phase-4b-holdout-regression (line 1136)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-4b-holdout-regression (line 1136)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-4b-holdout-regression (line 1136)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 848) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1516` |
| **Confidence** | high |
...
- **Step:** phase-4b-holdout-regression (line 1136)
- **Type:** skill
