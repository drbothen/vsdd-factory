...
1. Step `factory-worktree-health (line 84)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `factory-worktree-health (line 84)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `factory-worktree-health (line 84)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 951) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1548` |
| **Confidence** | high |
...
- **Step:** factory-worktree-health (line 84)
- **Type:** skill
