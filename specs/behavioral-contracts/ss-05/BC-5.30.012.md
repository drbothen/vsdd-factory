...
# Behavioral Contract BC-5.30.012: feature:establish-demo-baseline

## Description

Independent root step running in parallel with worktree health.
...
1. Independent root step running in parallel with worktree health.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `establish-demo-baseline (line 162; lobster carve-out: stable anchor is step name `establish-demo-baseline`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1591 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `establish-demo-baseline (line 162; lobster carve-out: stable anchor is step name `establish-demo-baseline`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1073; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1591` |
| **Confidence** | high |
...
- **Step:** establish-demo-baseline (line 162; lobster carve-out: stable anchor is step name `establish-demo-baseline`, not line number)
- **Type:** agent
- **Agent:** orchestrator
- **Depends on:** `[]`
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`establish-demo-baseline (line 162)`). Stable anchor is step name `establish-demo-baseline`.
...
|---------|------|--------|--------|
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `establish-demo-baseline`. |
