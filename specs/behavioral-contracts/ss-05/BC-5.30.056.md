...
1. Step `phase-f4-state-backup (line 986)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f4-state-backup (line 986)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f4-state-backup (line 986)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1207) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1635` |
| **Confidence** | high |
...
- **Step:** phase-f4-state-backup (line 986)
- **Type:** agent
- **Agent:** state-manager
