...
1. Workflow `phase-1-spec-crystallization` (v2.0.0) transforms a product brief into domain spec, PRD, behavioral contracts, architecture, verification properties, and UX spec.
2. Acceptance: Loader returns `name=phase-1-spec-crystallization`, `version=2.0.0`.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-1-spec-crystallization: identity` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1320 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-1-spec-crystallization: identity`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 200; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1320` |
| **Confidence** | high |
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — source-doc line 200
