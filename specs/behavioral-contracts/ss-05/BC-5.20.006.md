...
# Behavioral Contract BC-5.20.006: phase-0:source-acquisition

## Description

Invokes step-a (source acquisition) — clones/identifies source tree, prepares analysis. After completion, the source corpus is available for downstream pass files.
...
1. Invokes step-a (source acquisition) — clones/identifies source tree, prepares analysis.
2. Acceptance: After completion, the source corpus is available for downstream pass files.
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1305 |
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 89; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1305` |
| **Confidence** | high |
