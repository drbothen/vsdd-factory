...
1. Step `bugfix-single-story-delivery (line 301)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `bugfix-single-story-delivery (line 301)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `bugfix-single-story-delivery (line 301)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1110) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1603` |
| **Confidence** | high |
...
- **Step:** bugfix-single-story-delivery (line 301)
- **Type:** sub-workflow
