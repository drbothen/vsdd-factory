...
1. Step `pr-lifecycle (line 91)` has run to completion and emitted any declared artifacts.
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 447) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1375` |
| **Confidence** | high |
