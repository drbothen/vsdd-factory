...
1. Step `brownfield-design-system-extract (line 280)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `brownfield-design-system-extract (line 280)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `brownfield-design-system-extract (line 280)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 996) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1562` |
| **Confidence** | high |
...
- **Step:** brownfield-design-system-extract (line 280)
- **Type:** skill
