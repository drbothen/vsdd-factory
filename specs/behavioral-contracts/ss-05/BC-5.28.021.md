...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-1-multi-variant-design (line 193)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-1-multi-variant-design (line 193)`
