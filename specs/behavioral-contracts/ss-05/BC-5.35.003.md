...
# Behavioral Contract BC-5.35.003: planning: terminal-step

## Description

Terminal step `process-review-decisions` (line 288; lobster carve-out: stable anchor is step name `process-review-decisions`, not line number). Agent: state-manager. Depends `[session-review-approval]`.
...
1. Decisions persisted; planning workflow returns control.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/workflows/planning.lobster` (lines 288; lobster path carve-out: line range is unstable as lobster files evolve) |
| **Confidence** | high |
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — desc step `process-review-decisions` (line 288); lobster path lines 288
