...
1. Step `holdout-evaluation (line 1042)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `holdout-evaluation (line 1042)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `holdout-evaluation (line 1042)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1219) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1639` |
| **Confidence** | high |
...
- **Step:** holdout-evaluation (line 1042)
- **Type:** skill
