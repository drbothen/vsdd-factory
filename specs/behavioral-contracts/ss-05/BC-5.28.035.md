...
1. Step `phase-2-consistency-check (line 423)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-2-consistency-check (line 423)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-2-consistency-check (line 423)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 781) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1494` |
| **Confidence** | high |
...
- **Step:** phase-2-consistency-check (line 423)
- **Type:** agent
