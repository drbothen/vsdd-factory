...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `bugfix-f6-scoped (line 368)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `bugfix-f6-scoped (line 368)`
