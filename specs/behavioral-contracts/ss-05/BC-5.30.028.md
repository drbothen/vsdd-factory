...
1. Step `bugfix-f6-scoped (line 368)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `bugfix-f6-scoped (line 368)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `bugfix-f6-scoped (line 368)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1122) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1607` |
| **Confidence** | high |
...
- **Step:** bugfix-f6-scoped (line 368)
- **Type:** skill
