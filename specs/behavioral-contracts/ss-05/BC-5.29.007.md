...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `environment-gate (line 43)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `environment-gate (line 43)`
