...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `multi-repo-topology-check (line 362)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `multi-repo-topology-check (line 362)`
