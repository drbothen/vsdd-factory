...
1. Step ``backup-create-brief` (line 23)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for ``backup-create-brief` (line 23)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for ``backup-create-brief` (line 23)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 238) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1326` |
| **Confidence** | high |
...
- **Step:** `backup-create-brief` (line 23)
- **Agent:** state-manager
