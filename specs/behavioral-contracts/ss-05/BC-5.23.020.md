...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `implementation-gate (line 121)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `implementation-gate (line 121)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 460) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1379` |
| **Confidence** | high |
...
- **Step:** implementation-gate (line 121)
- **Type:** gate
