...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `implementation-gate (line 121)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `implementation-gate (line 121)`
