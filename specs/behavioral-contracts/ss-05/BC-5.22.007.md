...
1. Step `backup-define-epics (line 23)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `backup-define-epics (line 23)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `backup-define-epics (line 23)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 350) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1346` |
| **Confidence** | high |
...
- **Step:** backup-define-epics (line 23)
- **Agent:** state-manager
