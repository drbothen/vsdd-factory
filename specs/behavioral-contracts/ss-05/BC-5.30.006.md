...
1. Step `factory-worktree-health (line 86)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `factory-worktree-health (line 86)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `factory-worktree-health (line 86)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1055) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1585` |
| **Confidence** | high |
...
- **Step:** factory-worktree-health (line 86)
- **Type:** skill
