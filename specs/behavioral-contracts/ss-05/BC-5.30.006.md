...
# Behavioral Contract BC-5.30.006: feature:factory-worktree-health

## Description

Workflow contract: feature:factory-worktree-health.
...
1. Step `factory-worktree-health (line 86; lobster carve-out: stable anchor is step name `factory-worktree-health`, not line number)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `factory-worktree-health (line 86; lobster carve-out: stable anchor is step name `factory-worktree-health`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1585 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `factory-worktree-health (line 86; lobster carve-out: stable anchor is step name `factory-worktree-health`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1055; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1585` |
| **Confidence** | high |
...
- **Step:** factory-worktree-health (line 86; lobster carve-out: stable anchor is step name `factory-worktree-health`, not line number)
- **Type:** skill
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`factory-worktree-health (line 86)`). Stable anchor is step name `factory-worktree-health`.
