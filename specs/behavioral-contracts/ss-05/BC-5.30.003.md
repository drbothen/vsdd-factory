...
1. Step ``process-review-decisions` (line 1479) — agent: state-manager, depends `[session-review-approval]`.` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for ``process-review-decisions` (line 1479) — agent: state-manager, depends `[session-review-approval]`.` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for ``process-review-decisions` (line 1479) — agent: state-manager, depends `[session-review-approval]`.`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1039) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1582` |
| **Confidence** | high |
