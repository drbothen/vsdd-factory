...
# Behavioral Contract BC-5.28.042: greenfield:dx-engineer-preflight

## Description

Workflow contract: greenfield:dx-engineer-preflight.

## Preconditions

1. Upstream dependencies completed successfully: `[phase-2-human-approval]`.

## Postconditions

1. Step `dx-engineer-preflight (line 568; lobster carve-out: stable anchor is step name `dx-engineer-preflight`, not line number)` has run to completion and emitted any declared artifacts.
<!-- F-P23-001: lobster-line-cite annotated per pass-23 carve-out; stable anchor is step name `dx-engineer-preflight`; line number is unstable as lobster files evolve -->
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `dx-engineer-preflight (line 568; lobster carve-out: stable anchor is step name `dx-engineer-preflight`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1501 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `dx-engineer-preflight (line 568; lobster carve-out: stable anchor is step name `dx-engineer-preflight`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 802; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1501` |
| **Confidence** | high |
...
- **Step:** dx-engineer-preflight (line 568; lobster carve-out: stable anchor is step name `dx-engineer-preflight`, not line number)
- **Type:** agent
- **Agent:** dx-engineer
- **Depends on:** `[phase-2-human-approval]`
- **Timeout:** 30m
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`dx-engineer-preflight (line 568)`). Stable anchor is step name `dx-engineer-preflight`.
...
|---------|------|--------|--------|
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `dx-engineer-preflight`. |
