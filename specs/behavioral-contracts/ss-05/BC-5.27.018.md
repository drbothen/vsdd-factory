...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `documentation-convergence (line 101)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `documentation-convergence (line 101)`
