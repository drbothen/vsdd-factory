...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-2-spec-review-gemini (line 498)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-2-spec-review-gemini (line 498)`
