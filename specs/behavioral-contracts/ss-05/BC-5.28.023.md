...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-1-heuristic-evaluation (line 213)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-1-heuristic-evaluation (line 213)`
