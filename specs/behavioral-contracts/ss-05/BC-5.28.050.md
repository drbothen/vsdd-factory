...
# Behavioral Contract BC-5.28.050: greenfield:phase-4-scenario-rotation

## Description

Workflow contract: greenfield:phase-4-scenario-rotation.

## Preconditions

1. Upstream dependencies completed successfully: `[phase-3-gate]`.
...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-4-scenario-rotation (line 998)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-4-scenario-rotation (line 998)`
