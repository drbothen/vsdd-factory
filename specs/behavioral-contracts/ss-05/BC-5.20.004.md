...
1. The 15 steps form an acyclic linear chain plus a fan-in to the gate.
2. Acceptance: Topological sort succeeds; reverse-DFS detects no cycles; for every step, `step.depends_on ⊆ {names of preceding steps}`.
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1303 |
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 69; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1303` |
| **Confidence** | high |
...
- **Step:** workflow-level
- **Source line(s) in workflow YAML:** 15-146
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — source-doc line 69
