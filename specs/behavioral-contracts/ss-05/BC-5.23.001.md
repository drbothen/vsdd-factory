...
# Behavioral Contract BC-5.23.001: phase-3-tdd-implementation: identity

## Description

v2.0.0. Per-story TDD delivery via specialist agents (devops, test-writer, implementer, demo-recorder, pr-manager). Workflow runs once per story.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-3-tdd-implementation: identity` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1360 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-3-tdd-implementation: identity`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 397; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1360` |
| **Confidence** | high |
...
- **Source line(s) in workflow YAML:** 1-8
- **Behavior:** v2.0.0. Per-story TDD delivery via specialist agents (devops, test-writer, implementer, demo-recorder, pr-manager). Workflow runs once per story.
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — source-doc line 397
