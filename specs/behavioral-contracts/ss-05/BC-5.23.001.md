...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-3-tdd-implementation: identity` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-3-tdd-implementation: identity`
