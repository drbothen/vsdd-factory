...
1. Step `phase-f3-state-backup (line 695)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f3-state-backup (line 695)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f3-state-backup (line 695)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1191) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1630` |
| **Confidence** | high |
...
- **Step:** phase-f3-state-backup (line 695)
- **Type:** agent
- **Agent:** state-manager
