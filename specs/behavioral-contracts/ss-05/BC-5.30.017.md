...
1. Step `quick-dev-single-story (line 237)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `quick-dev-single-story (line 237)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `quick-dev-single-story (line 237)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1089) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1596` |
| **Confidence** | high |
...
- **Step:** quick-dev-single-story (line 237)
- **Type:** sub-workflow
