...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `environment-check (line 120)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `environment-check (line 120)`
