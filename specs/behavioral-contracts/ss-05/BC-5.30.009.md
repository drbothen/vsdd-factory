...
1. Step `environment-check (line 120)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `environment-check (line 120)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `environment-check (line 120)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1064) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1588` |
| **Confidence** | high |
...
- **Step:** environment-check (line 120)
- **Type:** agent
- **Agent:** dx-engineer
