...
1. Step `phase-f3-human-approval (line 730)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f3-human-approval (line 730)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f3-human-approval (line 730)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1197) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1632` |
| **Confidence** | high |
...
- **Step:** phase-f3-human-approval (line 730)
- **Type:** human-approval
