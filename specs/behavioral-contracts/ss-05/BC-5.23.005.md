...
# Behavioral Contract BC-5.23.005: phase-3: failure semantics

## Description

Defaults `on_failure: escalate`, retries 2, timeout 4h. `implementation-gate.fail_action: block` over Red Gate proof, all tests pass, purity boundaries, no `unwrap()`, clippy clean, demo evidence per AC, PR merged, worktree cleaned.
...
1. Defaults `on_failure: escalate`, retries 2, timeout 4h.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-3: failure semantics` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1364 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-3: failure semantics`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 411; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1364` |
| **Confidence** | high |
...
- **Source line(s) in workflow YAML:** 10-13, 134
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — source-doc line 411
