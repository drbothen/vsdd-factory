...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `fuzz-testing (line 33)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `fuzz-testing (line 33)`
