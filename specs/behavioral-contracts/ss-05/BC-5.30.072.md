...
1. Step `phase-f6-visual-regression (line 1248)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f6-visual-regression (line 1248)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f6-visual-regression (line 1248)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1255) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1651` |
| **Confidence** | high |
...
- **Step:** phase-f6-visual-regression (line 1248)
- **Type:** agent
