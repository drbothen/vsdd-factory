...
# Behavioral Contract BC-5.30.072: feature:phase-f6-visual-regression

## Description

Workflow contract: feature:phase-f6-visual-regression.

## Preconditions

1. Upstream dependencies completed successfully: `[phase-f6-demo-recording]`.
2. Conditional gate evaluates true: `same`.

## Postconditions

1. Step `phase-f6-visual-regression (line 1248; lobster carve-out: stable anchor is step name `phase-f6-visual-regression`, not line number)` has run to completion and emitted any declared artifacts.
<!-- F-P23-001: lobster-line-cite annotated per pass-23 carve-out; stable anchor is step name `phase-f6-visual-regression`; line number is unstable as lobster files evolve -->
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f6-visual-regression (line 1248; lobster carve-out: stable anchor is step name `phase-f6-visual-regression`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1651 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f6-visual-regression (line 1248; lobster carve-out: stable anchor is step name `phase-f6-visual-regression`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1255; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1651` |
| **Confidence** | high |
...
- **Step:** phase-f6-visual-regression (line 1248; lobster carve-out: stable anchor is step name `phase-f6-visual-regression`, not line number)
- **Type:** agent
- **Agent:** visual-reviewer
- **Depends on:** `[phase-f6-demo-recording]`
- **Condition:** same
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`phase-f6-visual-regression (line 1248)`). Stable anchor is step name `phase-f6-visual-regression`.
...
|---------|------|--------|--------|
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `phase-f6-visual-regression`. |
