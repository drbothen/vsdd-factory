...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f6-visual-regression (line 1248)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f6-visual-regression (line 1248)`
