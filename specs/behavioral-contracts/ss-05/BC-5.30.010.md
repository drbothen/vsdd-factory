...
1. Step `feature-market-intel (line 136)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `feature-market-intel (line 136)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `feature-market-intel (line 136)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1067) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1589` |
| **Confidence** | high |
...
- **Step:** feature-market-intel (line 136)
- **Type:** skill
