...
1. Step `phase-f7-state-backup (line 1372)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f7-state-backup (line 1372)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f7-state-backup (line 1372)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1279) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1659` |
| **Confidence** | high |
...
- **Step:** phase-f7-state-backup (line 1372)
- **Type:** agent
- **Agent:** state-manager
