...
1. Step `phase-0-artifact-backup (line 143)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-0-artifact-backup (line 143)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-0-artifact-backup (line 143)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 967) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1553` |
| **Confidence** | high |
...
- **Step:** phase-0-artifact-backup (line 143)
- **Type:** agent
- **Agent:** state-manager
