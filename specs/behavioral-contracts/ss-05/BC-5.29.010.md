...
# Behavioral Contract BC-5.29.010: brownfield:factory-worktree-gate

## Description

Workflow contract: brownfield:factory-worktree-gate.
...
1. Step `factory-worktree-gate (line 90; lobster carve-out: stable anchor is step name `factory-worktree-gate`, not line number)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `factory-worktree-gate (line 90; lobster carve-out: stable anchor is step name `factory-worktree-gate`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1549 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `factory-worktree-gate (line 90; lobster carve-out: stable anchor is step name `factory-worktree-gate`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 954; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1549` |
| **Confidence** | high |
...
- **Step:** factory-worktree-gate (line 90; lobster carve-out: stable anchor is step name `factory-worktree-gate`, not line number)
- **Type:** gate
- **Depends on:** `[factory-worktree-health]`
- **Source line(s) in workflow YAML:** 90-97
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`factory-worktree-gate (line 90)`). Stable anchor is step name `factory-worktree-gate`.
