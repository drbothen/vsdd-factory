...
1. Step `phase-f2-state-backup (line 613)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f2-state-backup (line 613)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f2-state-backup (line 613)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1176) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1625` |
| **Confidence** | high |
...
- **Step:** phase-f2-state-backup (line 613)
- **Type:** agent
- **Agent:** state-manager
