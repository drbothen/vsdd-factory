...
1. Step `scaffold-claude-md (line 103)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `scaffold-claude-md (line 103)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `scaffold-claude-md (line 103)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 957) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1550` |
| **Confidence** | high |
...
- **Step:** scaffold-claude-md (line 103)
- **Type:** skill
