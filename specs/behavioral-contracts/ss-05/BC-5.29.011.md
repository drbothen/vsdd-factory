...
# Behavioral Contract BC-5.29.011: brownfield:scaffold-claude-md

## Description

Workflow contract: brownfield:scaffold-claude-md.
...
1. Step `scaffold-claude-md (line 103; lobster carve-out: stable anchor is step name `scaffold-claude-md`, not line number)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `scaffold-claude-md (line 103; lobster carve-out: stable anchor is step name `scaffold-claude-md`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1550 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `scaffold-claude-md (line 103; lobster carve-out: stable anchor is step name `scaffold-claude-md`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 957; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1550` |
| **Confidence** | high |
...
- **Step:** scaffold-claude-md (line 103; lobster carve-out: stable anchor is step name `scaffold-claude-md`, not line number)
- **Type:** skill
- **Skill:** `skills/scaffold-claude-md/SKILL.md`
- **Depends on:** `[factory-worktree-gate]`
- **Condition:** `!file_exists('CLAUDE.md')`
- **Source line(s) in workflow YAML:** 103-108
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`scaffold-claude-md (line 103)`). Stable anchor is step name `scaffold-claude-md`.
