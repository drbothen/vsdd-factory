...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `visual-review (line 151)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `visual-review (line 151)`
