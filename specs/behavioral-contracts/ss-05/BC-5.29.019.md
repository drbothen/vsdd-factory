...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `brownfield-market-review (line 226)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `brownfield-market-review (line 226)`
