...
1. Step `bugfix-f5-scoped (line 340)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `bugfix-f5-scoped (line 340)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `bugfix-f5-scoped (line 340)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1119) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1606` |
| **Confidence** | high |
...
- **Step:** bugfix-f5-scoped (line 340)
- **Type:** loop
