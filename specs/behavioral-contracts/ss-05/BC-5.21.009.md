...
1. Step ``backup-create-domain-spec` (line 38)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for ``backup-create-domain-spec` (line 38)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for ``backup-create-domain-spec` (line 38)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 250) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1328` |
| **Confidence** | high |
...
- **Step:** `backup-create-domain-spec` (line 38)
- **Agent:** state-manager
