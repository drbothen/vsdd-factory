...
1. Step `quick-dev-state-backup (line 280)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `quick-dev-state-backup (line 280)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `quick-dev-state-backup (line 280)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1104) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1601` |
| **Confidence** | high |
...
- **Step:** quick-dev-state-backup (line 280)
- **Type:** agent
- **Agent:** state-manager
