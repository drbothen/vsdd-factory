...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `repo-verification (line 58)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `repo-verification (line 58)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 947) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1547` |
| **Confidence** | high |
...
- **Step:** repo-verification (line 58)
- **Type:** agent
