...
1. Step `backup-wave-schedule (line 69)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `backup-wave-schedule (line 69)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `backup-wave-schedule (line 69)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 368) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1352` |
| **Confidence** | high |
...
- **Step:** backup-wave-schedule (line 69)
- **Agent:** state-manager
