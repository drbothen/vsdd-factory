...
1. Step ``holdout-gate` (line 28) — gate type, depends `[holdout-evaluation]`. Source 28-38.` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for ``holdout-gate` (line 28) — gate type, depends `[holdout-evaluation]`. Source 28-38.` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for ``holdout-gate` (line 28) — gate type, depends `[holdout-evaluation]`. Source 28-38.`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 479) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1392` |
| **Confidence** | high |
