...
1. Step `phase-6-ui-fix-delivery (line 1236)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-6-ui-fix-delivery (line 1236)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-6-ui-fix-delivery (line 1236)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 875) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1525` |
| **Confidence** | high |
...
- **Step:** phase-6-ui-fix-delivery (line 1236)
- **Type:** sub-workflow
