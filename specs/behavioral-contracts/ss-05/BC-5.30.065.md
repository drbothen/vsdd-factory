...
1. Step `phase-f6-security-scan (line 1171)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f6-security-scan (line 1171)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f6-security-scan (line 1171)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1234) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1644` |
| **Confidence** | high |
...
- **Step:** phase-f6-security-scan (line 1171)
- **Type:** agent
