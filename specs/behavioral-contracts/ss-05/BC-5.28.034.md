...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-2-story-decomposition (line 417)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-2-story-decomposition (line 417)`
