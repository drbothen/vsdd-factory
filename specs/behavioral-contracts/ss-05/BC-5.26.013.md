...
1. Step `backup-security-scan (line 70)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `backup-security-scan (line 70)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `backup-security-scan (line 70)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 577) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1422` |
| **Confidence** | high |
...
- **Step:** backup-security-scan (line 70)
- **Agent:** state-manager
