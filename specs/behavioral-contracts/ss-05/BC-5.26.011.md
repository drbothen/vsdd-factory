...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `backup-mutation-testing (line 55)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `backup-mutation-testing (line 55)`
