...
1. Step `backup-mutation-testing (line 55)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `backup-mutation-testing (line 55)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `backup-mutation-testing (line 55)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 571) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1420` |
| **Confidence** | high |
...
- **Step:** backup-mutation-testing (line 55)
- **Agent:** state-manager
