...
# Behavioral Contract BC-5.25.001: phase-5-adversarial-refinement: identity

## Description

v1.0.0. Multi-model adversarial review loop with GPT-5.4 primary and Gemini 3.1 Pro secondary pass.
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1400 |
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 505; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1400` |
| **Confidence** | high |
...
- **Source line(s) in workflow YAML:** 1-5
- **Behavior:** v1.0.0. Multi-model adversarial review loop with GPT-5.4 primary and Gemini 3.1 Pro secondary pass.
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — source-doc line 505
