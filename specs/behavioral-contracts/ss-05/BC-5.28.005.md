...
# Behavioral Contract BC-5.28.005: greenfield: failure semantics
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1464 |
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 688; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1464` |
| **Confidence** | high |
...
- **Source line(s) in workflow YAML:** 24-27
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — source-doc line 688
