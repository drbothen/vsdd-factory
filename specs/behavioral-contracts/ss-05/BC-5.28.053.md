...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-4-gate (line 1025)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-4-gate (line 1025)`
