...
1. Step `backup-pr-lifecycle (line 97)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `backup-pr-lifecycle (line 97)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `backup-pr-lifecycle (line 97)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 450) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1376` |
| **Confidence** | high |
...
- **Step:** backup-pr-lifecycle (line 97)
- **Agent:** state-manager
