...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `backup-spec-convergence (line 22)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `backup-spec-convergence (line 22)`
