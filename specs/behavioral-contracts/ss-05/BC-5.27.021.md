...
1. Step `input-hash-drift-check (line 134)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `input-hash-drift-check (line 134)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `input-hash-drift-check (line 134)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 652) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1450` |
| **Confidence** | high |
...
- **Step:** input-hash-drift-check (line 134)
- **Type:** skill
