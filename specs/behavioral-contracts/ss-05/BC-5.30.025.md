...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `bugfix-build-verification (line 319)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `bugfix-build-verification (line 319)`
