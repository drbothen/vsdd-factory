...
1. Step `phase-6-ui-quality-gate (line 1229)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-6-ui-quality-gate (line 1229)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-6-ui-quality-gate (line 1229)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 872) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1524` |
| **Confidence** | high |
...
- **Step:** phase-6-ui-quality-gate (line 1229)
- **Type:** skill
