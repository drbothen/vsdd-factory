...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-6-ui-quality-gate (line 1229)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-6-ui-quality-gate (line 1229)`
