...
# Behavioral Contract BC-5.28.001: greenfield-vsdd: identity

## Description

v2.1.0. Full VSDD pipeline transforming a product brief into verified, adversarially-reviewed, formally-proven code. Reference path; all other primary paths are subsets/variations. Includes adaptive planning, market intel, per-story delivery via `code-delivery.lobster`, 8 information-asymmetry walls, 4 security-review touchpoints, cost monitoring, fix-PR delivery, release pipeline, post-feature va
...
1. v2.1.0.
2. Acceptance: Loader reports `name=greenfield-vsdd`, `version=2.1.0`, `steps=72`.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `greenfield-vsdd: identity` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1460 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `greenfield-vsdd: identity`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 673; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1460` |
| **Confidence** | high |
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — source-doc line 673
