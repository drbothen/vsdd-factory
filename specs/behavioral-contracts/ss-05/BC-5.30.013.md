...
1. Step `phase-f1-delta-analysis (line 179)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f1-delta-analysis (line 179)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f1-delta-analysis (line 179)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1077) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1592` |
| **Confidence** | high |
...
- **Step:** phase-f1-delta-analysis (line 179)
- **Type:** skill
