...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f1-delta-analysis (line 179)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f1-delta-analysis (line 179)`
