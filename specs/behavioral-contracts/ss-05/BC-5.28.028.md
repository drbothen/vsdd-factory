...
1. Step `phase-1-state-backup (line 327)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-1-state-backup (line 327)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-1-state-backup (line 327)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 760) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1487` |
| **Confidence** | high |
...
- **Step:** phase-1-state-backup (line 327)
- **Type:** agent
- **Agent:** state-manager
