...
Terminal step `process-review-decisions` (line 425). Agent: state-manager. Depends `[session-review-approval]`.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/workflows/discovery.lobster` (line 425) |
| **Confidence** | high |
