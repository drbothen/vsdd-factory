...
1. Step `phase-f6-fix-delivery (line 1206)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f6-fix-delivery (line 1206)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f6-fix-delivery (line 1206)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1243) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1647` |
| **Confidence** | high |
...
- **Step:** phase-f6-fix-delivery (line 1206)
- **Type:** sub-workflow
