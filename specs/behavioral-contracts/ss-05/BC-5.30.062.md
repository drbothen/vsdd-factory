...
1. Step `phase-f5-scoped-adversarial (line 1069)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f5-scoped-adversarial (line 1069)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f5-scoped-adversarial (line 1069)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1225) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1641` |
| **Confidence** | high |
...
- **Step:** phase-f5-scoped-adversarial (line 1069)
- **Type:** loop
