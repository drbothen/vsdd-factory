...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-1-design-system-bootstrap (line 172)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-1-design-system-bootstrap (line 172)`
