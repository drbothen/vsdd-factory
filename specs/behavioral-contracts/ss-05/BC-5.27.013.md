...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `backup-verification-convergence (line 64)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `backup-verification-convergence (line 64)`
