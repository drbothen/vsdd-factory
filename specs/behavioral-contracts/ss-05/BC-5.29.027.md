...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `multi-repo-handoff-check (line 348)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `multi-repo-handoff-check (line 348)`
