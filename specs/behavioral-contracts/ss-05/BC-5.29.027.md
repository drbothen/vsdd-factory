...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `multi-repo-handoff-check (line 348)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `multi-repo-handoff-check (line 348)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1009) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1566` |
| **Confidence** | high |
...
- **Step:** multi-repo-handoff-check (line 348)
- **Type:** agent
- **Agent:** orchestrator
