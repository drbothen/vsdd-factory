...
1. Step `bugfix-holdout-scoped (line 326)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `bugfix-holdout-scoped (line 326)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `bugfix-holdout-scoped (line 326)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1116) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1605` |
| **Confidence** | high |
...
- **Step:** bugfix-holdout-scoped (line 326)
- **Type:** agent
