...
modified:
  - "2026-08-27 (v1.20) — F-P50-002 remediation + cross-check (product-owner), responding to adversarial spec-convergence pass 50 finding F-P50-002 (MED, POLICY 18): added .factory/stories/S-17.05-stamp-state-timestamp-hook.md to inputs: (cited by exact path with content claims — E-17 Wave 5, 8pts, tdd_mode: strict — in §Story Anchor and §Traceability Stories row); previously missing. Cross-check (in-scope, this pass): also added .factory/stories/S-17.01-factory-lock-schema-cas-push.md to inputs: (cited with content claims — PR #181 merged 2026-06-11, D-544 — in §Traceability Stories row and §Story Anchor); previously missing, newly noticed while re-auditing story citations for this finding. input-hash recompute and BC-INDEX title-cell sync deferred to state-manager same-burst per POLICY 7/8 (not applied by this amendment)."
  - "2026-08-27 (v1.19) — Cluster-wide inputs re-audit (product-owner): added .factory/stories/S-19.08-verify-state-timestamp-refresh-byte-cap.md to inputs: (cited in §Verification Properties/§VP Anchors AC-001..AC-005 attribution); previously missing. input-hash recompute and BC-INDEX title-cell sync deferred to state-manager same-burst per POLICY 7/8 (not applied by this amendment)."
...
|---------|------|-------------|
| 1.20 | 2026-08-27 | F-P50-002 remediation + cross-check (product-owner): added `.factory/stories/S-17.05-stamp-state-timestamp-hook.md` to `inputs:` (cited by exact path with content claims — E-17 Wave 5, 8pts, `tdd_mode: strict` — in §Story Anchor and §Traceability Stories row); also added `.factory/stories/S-17.01-factory-lock-schema-cas-push.md` (cited with content claims — PR #181, D-544 — in §Traceability Stories row/§Story Anchor, newly noticed cross-check gap); both previously missing. input-hash recompute and BC-INDEX title-cell sync deferred to state-manager same-burst per POLICY 7/8 (not applied by this amendment). |
| 1.19 | 2026-08-27 | Cluster-wide inputs re-audit (product-owner): added `.factory/stories/S-19.08-verify-state-timestamp-refresh-byte-cap.md` to `inputs:` (cited in §Verification Properties/§VP Anchors AC-001..AC-005 attribution); previously missing. input-hash recompute and BC-INDEX title-cell sync deferred to state-manager same-burst per POLICY 7/8 (not applied by this amendment). |
