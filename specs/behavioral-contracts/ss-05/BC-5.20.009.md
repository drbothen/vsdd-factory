...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for ``backup-broad-sweep` (line 39)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for ``backup-broad-sweep` (line 39)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 115) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1308` |
| **Confidence** | high |
...
- **Step:** `backup-broad-sweep` (line 39)
- **Type:** agent
- **Agent:** state-manager
