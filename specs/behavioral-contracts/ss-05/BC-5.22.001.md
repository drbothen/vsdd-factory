...
# Behavioral Contract BC-5.22.001: phase-2-story-decomposition: identity

## Description

v1.0.0. Breaks PRD/architecture into epics, stories, dependency graph, wave schedule, and holdout scenarios via the decompose-stories skill steps.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-2-story-decomposition: identity` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1340 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-2-story-decomposition: identity`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 322; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1340` |
| **Confidence** | high |
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — source-doc line 322
