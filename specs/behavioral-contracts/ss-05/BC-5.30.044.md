...
# Behavioral Contract BC-5.30.044: feature:phase-f2-adversarial-review

## Description

Workflow contract: feature:phase-f2-adversarial-review.

## Preconditions

1. Upstream dependencies completed successfully: `[phase-f2-spec-evolution, phase-f2-dtu-reassessment, phase-f2-gene-transfusion-assessment, phase-f2-ux-design]`.

## Postconditions

1. Step `phase-f2-adversarial-review (line 563; lobster carve-out: stable anchor is step name `phase-f2-adversarial-review`, not line number)` has run to completion and emitted any declared artifacts.
<!-- F-P23-001: lobster-line-cite annotated per pass-23 carve-out; stable anchor is step name `phase-f2-adversarial-review`; line number is unstable as lobster files evolve -->
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f2-adversarial-review (line 563; lobster carve-out: stable anchor is step name `phase-f2-adversarial-review`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1623 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f2-adversarial-review (line 563; lobster carve-out: stable anchor is step name `phase-f2-adversarial-review`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1170; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1623` |
| **Confidence** | high |
...
- **Step:** phase-f2-adversarial-review (line 563; lobster carve-out: stable anchor is step name `phase-f2-adversarial-review`, not line number)
- **Type:** agent
- **Agent:** adversary
- **Depends on:** `[phase-f2-spec-evolution, phase-f2-dtu-reassessment, phase-f2-gene-transfusion-assessment, phase-f2-ux-design]`
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`phase-f2-adversarial-review (line 563)`). Stable anchor is step name `phase-f2-adversarial-review`.
...
|---------|------|--------|--------|
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `phase-f2-adversarial-review`. |
