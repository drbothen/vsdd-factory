...
1. Step `phase-f2-adversarial-review (line 563)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f2-adversarial-review (line 563)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f2-adversarial-review (line 563)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1170) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1623` |
| **Confidence** | high |
...
- **Step:** phase-f2-adversarial-review (line 563)
- **Type:** agent
- **Agent:** adversary
