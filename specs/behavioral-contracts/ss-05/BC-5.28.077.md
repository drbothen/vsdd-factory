...
1. Step `session-review-approval (line 1385)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `session-review-approval (line 1385)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `session-review-approval (line 1385)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 908) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1536` |
| **Confidence** | high |
...
- **Step:** session-review-approval (line 1385)
- **Type:** human-approval
