...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-2: DAG integrity` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-2: DAG integrity`
