...
# Behavioral Contract BC-5.27.019: phase-7:backup-documentation-convergence

## Description

Commits the convergence report.
...
1. Commits the convergence report.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `backup-documentation-convergence (line 106; lobster carve-out: stable anchor is step name `backup-documentation-convergence`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1448 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `backup-documentation-convergence (line 106; lobster carve-out: stable anchor is step name `backup-documentation-convergence`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 644; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1448` |
| **Confidence** | high |
...
- **Step:** backup-documentation-convergence (line 106; lobster carve-out: stable anchor is step name `backup-documentation-convergence`, not line number)
- **Agent:** state-manager
- **Source line(s) in workflow YAML:** 106-112
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`backup-documentation-convergence (line 106)`). Stable anchor is step name `backup-documentation-convergence`.
...
|---------|------|--------|--------|
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `backup-documentation-convergence`. |
