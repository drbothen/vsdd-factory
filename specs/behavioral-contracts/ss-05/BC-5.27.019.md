...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `backup-documentation-convergence (line 106)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `backup-documentation-convergence (line 106)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 644) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1448` |
| **Confidence** | high |
...
- **Step:** backup-documentation-convergence (line 106)
- **Agent:** state-manager
