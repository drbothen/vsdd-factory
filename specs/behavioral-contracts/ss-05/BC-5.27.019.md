...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `backup-documentation-convergence (line 106)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `backup-documentation-convergence (line 106)`
