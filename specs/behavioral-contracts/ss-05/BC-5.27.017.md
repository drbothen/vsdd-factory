...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `backup-performance-convergence (line 92)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `backup-performance-convergence (line 92)`
