...
1. Step `backup-performance-convergence (line 92)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `backup-performance-convergence (line 92)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `backup-performance-convergence (line 92)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 638) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1446` |
| **Confidence** | high |
...
- **Step:** backup-performance-convergence (line 92)
- **Agent:** state-manager
