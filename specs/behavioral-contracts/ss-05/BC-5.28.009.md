...
1. Step `factory-worktree-gate (line 57)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `factory-worktree-gate (line 57)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `factory-worktree-gate (line 57)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 702) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1468` |
| **Confidence** | high |
...
- **Step:** factory-worktree-gate (line 57)
- **Type:** gate
