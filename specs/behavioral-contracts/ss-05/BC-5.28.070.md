...
# Behavioral Contract BC-5.28.070: greenfield:phase-6-visual-review

## Description

Workflow contract: greenfield:phase-6-visual-review.

## Preconditions

1. Upstream dependencies completed successfully: `[phase-6-final-demo]`.

## Postconditions

1. Step `phase-6-visual-review (line 1285; lobster carve-out: stable anchor is step name `phase-6-visual-review`, not line number)` has run to completion and emitted any declared artifacts.
<!-- F-P23-001: lobster-line-cite annotated per pass-23 carve-out; stable anchor is step name `phase-6-visual-review`; line number is unstable as lobster files evolve -->
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-6-visual-review (line 1285; lobster carve-out: stable anchor is step name `phase-6-visual-review`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1529 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-6-visual-review (line 1285; lobster carve-out: stable anchor is step name `phase-6-visual-review`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 887; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1529` |
| **Confidence** | high |
...
- **Step:** phase-6-visual-review (line 1285; lobster carve-out: stable anchor is step name `phase-6-visual-review`, not line number)
- **Type:** agent
- **Agent:** visual-reviewer
- **Depends on:** `[phase-6-final-demo]`
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`phase-6-visual-review (line 1285)`). Stable anchor is step name `phase-6-visual-review`.
...
|---------|------|--------|--------|
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `phase-6-visual-review`. |
