...
1. Step `phase-6-visual-review (line 1285)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-6-visual-review (line 1285)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-6-visual-review (line 1285)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 887) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1529` |
| **Confidence** | high |
...
- **Step:** phase-6-visual-review (line 1285)
- **Type:** agent
