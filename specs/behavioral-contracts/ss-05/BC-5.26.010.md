...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `mutation-testing (line 49)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `mutation-testing (line 49)`
