...
# Behavioral Contract BC-5.28.008: greenfield:factory-worktree-health

## Description

Workflow contract: greenfield:factory-worktree-health.

## Preconditions

1. Upstream dependencies completed successfully: `[repo-initialization]`.

## Postconditions

1. Step `factory-worktree-health (line 51; lobster carve-out: stable anchor is step name `factory-worktree-health`, not line number)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `factory-worktree-health (line 51; lobster carve-out: stable anchor is step name `factory-worktree-health`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1467 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `factory-worktree-health (line 51; lobster carve-out: stable anchor is step name `factory-worktree-health`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 699; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1467` |
| **Confidence** | high |
...
- **Step:** factory-worktree-health (line 51; lobster carve-out: stable anchor is step name `factory-worktree-health`, not line number)
- **Type:** skill
- **Skill:** `skills/factory-worktree-health/SKILL.md`
- **Agent:** devops-engineer
- **Depends on:** `[repo-initialization]`
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`factory-worktree-health (line 51)`). Stable anchor is step name `factory-worktree-health`.
...
|---------|------|--------|--------|
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `factory-worktree-health`. |
