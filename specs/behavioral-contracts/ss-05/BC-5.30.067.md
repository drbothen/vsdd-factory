...
1. Step `phase-f6-a11y-recheck (line 1193)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f6-a11y-recheck (line 1193)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f6-a11y-recheck (line 1193)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1240) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1646` |
| **Confidence** | high |
...
- **Step:** phase-f6-a11y-recheck (line 1193)
- **Type:** agent
