...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `bugfix-demo-comparison (line 391)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `bugfix-demo-comparison (line 391)`
