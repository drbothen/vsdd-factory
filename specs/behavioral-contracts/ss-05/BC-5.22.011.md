...
1. Step `backup-dependency-graph (line 54)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `backup-dependency-graph (line 54)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `backup-dependency-graph (line 54)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 362) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1350` |
| **Confidence** | high |
...
- **Step:** backup-dependency-graph (line 54)
- **Agent:** state-manager
