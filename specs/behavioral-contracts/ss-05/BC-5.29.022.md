...
1. Step `semport-validation-gate (line 264)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `semport-validation-gate (line 264)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `semport-validation-gate (line 264)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 993) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1561` |
| **Confidence** | high |
...
- **Step:** semport-validation-gate (line 264)
- **Type:** gate
