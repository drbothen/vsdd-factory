...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `semport-validation-gate (line 264)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `semport-validation-gate (line 264)`
