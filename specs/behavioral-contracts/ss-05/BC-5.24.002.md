...
1. Step ``scenario-rotation` (line 14) — `depends_on: []`. Agent: orchestrator.` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for ``scenario-rotation` (line 14) — `depends_on: []`. Agent: orchestrator.` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for ``scenario-rotation` (line 14) — `depends_on: []`. Agent: orchestrator.`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 476) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1391` |
| **Confidence** | high |
