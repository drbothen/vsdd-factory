...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for ``scenario-rotation` (line 14) — `depends_on: []`. Agent: orchestrator.` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for ``scenario-rotation` (line 14) — `depends_on: []`. Agent: orchestrator.`
