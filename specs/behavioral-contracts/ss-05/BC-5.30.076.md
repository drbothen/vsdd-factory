...
1. Step `phase-f7-ui-quality-gate (line 1297)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f7-ui-quality-gate (line 1297)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f7-ui-quality-gate (line 1297)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1267) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1655` |
| **Confidence** | high |
...
- **Step:** phase-f7-ui-quality-gate (line 1297)
- **Type:** skill
