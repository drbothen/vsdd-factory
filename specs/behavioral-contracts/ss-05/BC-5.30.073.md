...
1. Step `phase-f7-heuristic-evaluation (line 1274)` has run to completion and emitted any declared artifacts.
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1258) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1652` |
| **Confidence** | high |
...
- **Step:** phase-f7-heuristic-evaluation (line 1274)
- **Type:** skill
