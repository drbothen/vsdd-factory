...
1. Step `phase-4-holdout-evaluation (line 1020)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-4-holdout-evaluation (line 1020)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-4-holdout-evaluation (line 1020)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 833) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1511` |
| **Confidence** | high |
...
- **Step:** phase-4-holdout-evaluation (line 1020)
- **Type:** skill
