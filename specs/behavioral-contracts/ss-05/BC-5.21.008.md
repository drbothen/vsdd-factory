...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for ``create-domain-spec` (line 33)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for ``create-domain-spec` (line 33)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 243) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1327` |
| **Confidence** | high |
...
- **Step:** `create-domain-spec` (line 33)
- **Type:** skill
