...
# Behavioral Contract BC-5.21.008: phase-1:create-domain-spec

## Description

Produces L2 domain spec from the brief.

## Preconditions

1. Upstream dependencies completed successfully: `[backup-create-brief]`.

## Postconditions

1. Produces L2 domain spec from the brief.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for ``create-domain-spec` (line 33; lobster carve-out: stable anchor is step name `create-domain-spec`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1327 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for ``create-domain-spec` (line 33; lobster carve-out: stable anchor is step name `create-domain-spec`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 243; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1327` |
| **Confidence** | high |
...
- **Step:** `create-domain-spec` (line 33; lobster carve-out: stable anchor is step name `create-domain-spec`, not line number)
- **Type:** skill
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`create-domain-spec (line 33)`). Stable anchor is step name `create-domain-spec`.
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — double-backtick VP/anchor: step `create-domain-spec` (line 33); double-backtick VP/anchor: step `create-domain-spec` (line 33); **Step:** bt form: step `create-domain-spec` (line 33)
...
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `create-domain-spec`. |
