...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-2-consistency-audit (line 452)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-2-consistency-audit (line 452)`
