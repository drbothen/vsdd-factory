...
1. Step `phase-f3-spec-review-gemini (line 663)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f3-spec-review-gemini (line 663)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f3-spec-review-gemini (line 663)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1188) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1629` |
| **Confidence** | high |
...
- **Step:** phase-f3-spec-review-gemini (line 663)
- **Type:** loop
