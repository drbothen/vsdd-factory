...
1. Step `phase-6-heuristic-evaluation (line 1208)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-6-heuristic-evaluation (line 1208)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-6-heuristic-evaluation (line 1208)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 863) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1521` |
| **Confidence** | high |
...
- **Step:** phase-6-heuristic-evaluation (line 1208)
- **Type:** skill
