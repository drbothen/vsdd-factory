...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `build-gate (line 1029)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `build-gate (line 1029)`
