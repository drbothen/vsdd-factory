...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-1-design-system-approval (line 180)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-1-design-system-approval (line 180)`
