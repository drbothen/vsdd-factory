...
1. Step `triage-and-fix (line 36)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `triage-and-fix (line 36)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `triage-and-fix (line 36)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 528) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1407` |
| **Confidence** | high |
