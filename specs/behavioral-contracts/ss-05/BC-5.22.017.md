...
# Behavioral Contract BC-5.22.017: phase-2:adversarial-story-review

## Description

Adversary on `.factory/stories/**` and BCs/VPs/PRD/architecture; excludes holdout scenarios + prior adversarial reviews (information-asymmetry wall). `decompose-stories` skill fixes findings.
...
1. Adversary on `.factory/stories/**` and BCs/VPs/PRD/architecture; excludes holdout scenarios + prior adversarial reviews (information-asymmetry wall).
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `adversarial-story-review (line 109; lobster carve-out: stable anchor is step name `adversarial-story-review`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1356 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `adversarial-story-review (line 109; lobster carve-out: stable anchor is step name `adversarial-story-review`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 381; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1356` |
| **Confidence** | high |
...
- **Step:** adversarial-story-review (line 109; lobster carve-out: stable anchor is step name `adversarial-story-review`, not line number)
- **Type:** loop
- **Source line(s) in workflow YAML:** 109-145
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`adversarial-story-review (line 109)`). Stable anchor is step name `adversarial-story-review`.
...
|---------|------|--------|--------|
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `adversarial-story-review`. |
