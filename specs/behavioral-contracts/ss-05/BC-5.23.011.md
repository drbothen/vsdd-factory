...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `backup-failing-tests (line 52)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `backup-failing-tests (line 52)`
