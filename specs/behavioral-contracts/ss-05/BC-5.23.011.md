...
1. Step `backup-failing-tests (line 52)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `backup-failing-tests (line 52)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `backup-failing-tests (line 52)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 431) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1370` |
| **Confidence** | high |
...
- **Step:** backup-failing-tests (line 52)
- **Agent:** state-manager
