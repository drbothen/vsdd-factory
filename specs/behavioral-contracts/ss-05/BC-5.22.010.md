...
1. Step `dependency-graph (line 49)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `dependency-graph (line 49)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `dependency-graph (line 49)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 359) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1349` |
| **Confidence** | high |
