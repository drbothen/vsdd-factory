...
# Behavioral Contract BC-5.28.075: greenfield:post-feature-validation

## Description

Workflow contract: greenfield:post-feature-validation.

## Preconditions

1. Upstream dependencies completed successfully: `[steady-state-handoff]`.
...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `post-feature-validation (line 1364)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `post-feature-validation (line 1364)`
