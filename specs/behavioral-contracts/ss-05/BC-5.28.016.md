...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-1-dtu-assessment (line 131)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-1-dtu-assessment (line 131)`
