...
1. Step `phase-2-state-backup (line 530)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-2-state-backup (line 530)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-2-state-backup (line 530)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 796) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1499` |
| **Confidence** | high |
...
- **Step:** phase-2-state-backup (line 530)
- **Type:** agent
- **Agent:** state-manager
