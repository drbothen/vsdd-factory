...
1. Step `multi-repo-pipeline (line 359)` has run to completion and emitted any declared artifacts.
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1013) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1567` |
| **Confidence** | high |
...
- **Step:** multi-repo-pipeline (line 359)
- **Type:** sub-workflow
