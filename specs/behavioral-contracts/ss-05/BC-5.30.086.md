...
1. Step `session-review-approval (line 1466)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `session-review-approval (line 1466)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `session-review-approval (line 1466)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1297) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1665` |
| **Confidence** | high |
...
- **Step:** session-review-approval (line 1466)
- **Type:** human-approval
