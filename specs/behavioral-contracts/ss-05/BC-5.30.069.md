...
# Behavioral Contract BC-5.30.069: feature:phase-f6-gate

## Description

Workflow contract: feature:phase-f6-gate.

## Preconditions

1. Upstream dependencies completed successfully: `[phase-f6-targeted-hardening, phase-f6-security-scan, phase-f6-dtu-adversarial, phase-f6-a11y-recheck, phase-f6-fix-delivery]`.

## Postconditions

1. Step `phase-f6-gate (line 1212; lobster carve-out: stable anchor is step name `phase-f6-gate`, not line number)` has run to completion and emitted any declared artifacts.
<!-- F-P23-001: lobster-line-cite annotated per pass-23 carve-out; stable anchor is step name `phase-f6-gate`; line number is unstable as lobster files evolve -->
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f6-gate (line 1212; lobster carve-out: stable anchor is step name `phase-f6-gate`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1648 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f6-gate (line 1212; lobster carve-out: stable anchor is step name `phase-f6-gate`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1246; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1648` |
| **Confidence** | high |
...
- **Step:** phase-f6-gate (line 1212; lobster carve-out: stable anchor is step name `phase-f6-gate`, not line number)
- **Type:** gate
- **Depends on:** `[phase-f6-targeted-hardening, phase-f6-security-scan, phase-f6-dtu-adversarial, phase-f6-a11y-recheck, phase-f6-fix-delivery]`
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`phase-f6-gate (line 1212)`). Stable anchor is step name `phase-f6-gate`.
...
|---------|------|--------|--------|
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `phase-f6-gate`. |
