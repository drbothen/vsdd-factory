...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `multi-repo-human-confirmation (line 375)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `multi-repo-human-confirmation (line 375)`
