...
- VP-081 — Wave Cannot Close Without Verified Handoff: shell wave-gate returns `Error("HandoffMissing")` when HANDOFF.md is absent on factory-artifacts at wave-close (PC9 + EC-014); `validate-wave-handoff-completeness` WASM gate additionally blocks close unless HANDOFF.md exists with all required ADR-026 §D2 fields (PC7)
