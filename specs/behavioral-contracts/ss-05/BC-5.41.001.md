...
| ~~v1.5~~ | — | — | **[SKIP — coordinated-burst skip (F-P32-003):** v1.5 was not produced for this BC because only behaviorally-changed BCs were bumped in that burst; the jump v1.4→v1.6 is intentional. This row distinguishes a deliberate skip from a lost entry.] |
