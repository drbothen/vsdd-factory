...
1. Step `process-review-decisions (line 390)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `process-review-decisions (line 390)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `process-review-decisions (line 390)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1022) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1570` |
| **Confidence** | high |
...
- **Step:** process-review-decisions (line 390)
- **Type:** agent
- **Agent:** state-manager
