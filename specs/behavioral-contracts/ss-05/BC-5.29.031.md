...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `process-review-decisions (line 390)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `process-review-decisions (line 390)`
