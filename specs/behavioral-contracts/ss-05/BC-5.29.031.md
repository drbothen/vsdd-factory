...
# Behavioral Contract BC-5.29.031: brownfield:process-review-decisions

## Description

Workflow contract: brownfield:process-review-decisions.
...
1. Step `process-review-decisions (line 390; lobster carve-out: stable anchor is step name `process-review-decisions`, not line number)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `process-review-decisions (line 390; lobster carve-out: stable anchor is step name `process-review-decisions`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1570 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `process-review-decisions (line 390; lobster carve-out: stable anchor is step name `process-review-decisions`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1022; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1570` |
| **Confidence** | high |
...
- **Step:** process-review-decisions (line 390; lobster carve-out: stable anchor is step name `process-review-decisions`, not line number)
- **Type:** agent
- **Agent:** state-manager
- **Depends on:** `[session-review-approval]`
- **Source line(s) in workflow YAML:** 390-401
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`process-review-decisions (line 390)`). Stable anchor is step name `process-review-decisions`.
