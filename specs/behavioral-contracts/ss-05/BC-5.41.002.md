...
|---------|------|--------|--------|
| v1.9 | 2026-06-15 | product-owner | (F-P33-001 MEDIUM) §Changelog: defensive skip-marker annotation added for v1.5 absence — v1.5 was a coordinated-burst skip (only behaviorally-changed BCs were bumped at the pass-5 F-P5-002/003 burst; only BC-4.14.001 and BC-7.07.001 received behavioral changes that pass); the jump v1.4→v1.6 is intentional, not a lost row. Exhaustive sibling-sweep of all 8 E-18 BCs per F-P33-001 obligation. |
