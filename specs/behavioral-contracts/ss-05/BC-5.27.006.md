...
# Behavioral Contract BC-5.27.006: phase-7:spec-convergence

## Description

Workflow contract: phase-7:spec-convergence.
...
1. Step `spec-convergence (line 17; lobster carve-out: stable anchor is step name `spec-convergence`, not line number)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `spec-convergence (line 17; lobster carve-out: stable anchor is step name `spec-convergence`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1435 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `spec-convergence (line 17; lobster carve-out: stable anchor is step name `spec-convergence`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 605; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1435` |
| **Confidence** | high |
...
- **Step:** spec-convergence (line 17; lobster carve-out: stable anchor is step name `spec-convergence`, not line number)
- **Type:** skill
- **Skill:** `convergence-check/steps/step-a-spec-convergence.md`
- **Depends on:** `[]`
- **Source line(s) in workflow YAML:** 17-20
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`spec-convergence (line 17)`). Stable anchor is step name `spec-convergence`.
...
|---------|------|--------|--------|
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `spec-convergence`. |
