...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `spec-convergence (line 17)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `spec-convergence (line 17)`
