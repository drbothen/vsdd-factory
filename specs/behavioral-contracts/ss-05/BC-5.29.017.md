...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `post-phase-0-routing (line 194)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `post-phase-0-routing (line 194)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 977) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1556` |
| **Confidence** | high |
...
- **Step:** post-phase-0-routing (line 194)
- **Type:** agent
- **Agent:** orchestrator
