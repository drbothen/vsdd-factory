...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `backup-record-demos (line 82)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `backup-record-demos (line 82)`
