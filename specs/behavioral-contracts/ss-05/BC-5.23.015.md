...
1. Step `backup-record-demos (line 82)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `backup-record-demos (line 82)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `backup-record-demos (line 82)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 444) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1374` |
| **Confidence** | high |
...
- **Step:** backup-record-demos (line 82)
- **Agent:** state-manager
