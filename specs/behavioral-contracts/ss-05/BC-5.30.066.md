...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f6-dtu-adversarial (line 1183)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f6-dtu-adversarial (line 1183)`
