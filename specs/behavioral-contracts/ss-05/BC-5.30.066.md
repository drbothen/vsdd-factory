...
1. Step `phase-f6-dtu-adversarial (line 1183)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f6-dtu-adversarial (line 1183)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f6-dtu-adversarial (line 1183)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1237) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1645` |
| **Confidence** | high |
...
- **Step:** phase-f6-dtu-adversarial (line 1183)
- **Type:** agent
