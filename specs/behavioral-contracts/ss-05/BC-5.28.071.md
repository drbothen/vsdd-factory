...
1. Step `phase-6-state-backup (line 1302)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-6-state-backup (line 1302)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-6-state-backup (line 1302)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 890) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1530` |
| **Confidence** | high |
...
- **Step:** phase-6-state-backup (line 1302)
- **Type:** agent
- **Agent:** state-manager
