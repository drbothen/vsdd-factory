...
1. Step `process-review-decisions (line 1479)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `process-review-decisions (line 1479)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `process-review-decisions (line 1479)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1300) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1666` |
| **Confidence** | high |
...
- **Step:** process-review-decisions (line 1479)
- **Type:** agent
- **Agent:** state-manager
