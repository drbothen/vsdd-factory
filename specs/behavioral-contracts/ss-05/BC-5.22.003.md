...
1. Step ``human-approval` (line 158; lobster carve-out: stable anchor is step name `human-approval`, not line number) — 24h timeout, depends on `[input-hash-drift-check]`. Approves epics.md, STORY-INDEX.md, dependency-graph.md, wave-schedule.md, sprint-state.yaml, HS-INDEX.md.` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for ``human-approval` (line 158; lobster carve-out: stable anchor is step name `human-approval`, not line number) — 24h timeout, depends on `[input-hash-drift-check]`. Approves epics.md, STORY-INDEX.md, dependency-graph.md, wave-schedule.md, sprint-state.yaml, HS-INDEX.md.` | manual |
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 331; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1342` |
| **Confidence** | high |
...
- **Step:** `human-approval` (line 158; lobster carve-out: stable anchor is step name `human-approval`, not line number) — 24h timeout, depends on `[input-hash-drift-check]`. Approves epics.md, STORY-INDEX.md, dependency-graph.md, wave-schedule.md, sprint-state.yaml, HS-INDEX.md.
