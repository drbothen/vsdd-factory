...
1. Step `backup-holdout-scenarios (line 84)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `backup-holdout-scenarios (line 84)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `backup-holdout-scenarios (line 84)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 374) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1354` |
| **Confidence** | high |
...
- **Step:** backup-holdout-scenarios (line 84)
- **Agent:** state-manager
