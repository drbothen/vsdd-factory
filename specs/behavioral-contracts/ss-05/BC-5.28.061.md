...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-5-gate (line 1190)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-5-gate (line 1190)`
