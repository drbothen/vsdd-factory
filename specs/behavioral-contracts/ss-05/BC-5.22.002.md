...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for ``define-epics` (line 18) — `depends_on: []`` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for ``define-epics` (line 18) — `depends_on: []``
