...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-4-holdout-evaluation: identity` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-4-holdout-evaluation: identity`
