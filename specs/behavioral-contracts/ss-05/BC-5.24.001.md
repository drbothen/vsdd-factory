...
# Behavioral Contract BC-5.24.001: phase-4-holdout-evaluation: identity

## Description

v1.0.0. Reusable sub-workflow: scenario rotation + holdout evaluation with information asymmetry wall enforcement.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-4-holdout-evaluation: identity` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1390 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-4-holdout-evaluation: identity`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 473; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1390` |
| **Confidence** | high |
...
- **Source line(s) in workflow YAML:** 1-6
- **Behavior:** v1.0.0. Reusable sub-workflow: scenario rotation + holdout evaluation with information asymmetry wall enforcement.
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — source-doc line 473
