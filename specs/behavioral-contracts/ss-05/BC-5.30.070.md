...
1. Step `phase-f6-state-backup (line 1227)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f6-state-backup (line 1227)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f6-state-backup (line 1227)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1249) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1649` |
| **Confidence** | high |
...
- **Step:** phase-f6-state-backup (line 1227)
- **Type:** agent
- **Agent:** state-manager
