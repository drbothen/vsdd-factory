...
1. Step `phase-f7-ui-fix-delivery (line 1305)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f7-ui-fix-delivery (line 1305)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f7-ui-fix-delivery (line 1305)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1270) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1656` |
| **Confidence** | high |
...
- **Step:** phase-f7-ui-fix-delivery (line 1305)
- **Type:** sub-workflow
