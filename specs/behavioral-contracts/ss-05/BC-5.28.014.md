...
# Behavioral Contract BC-5.28.014: greenfield:architect-feasibility-review

## Description

Workflow contract: greenfield:architect-feasibility-review.
...
1. Step `architect-feasibility-review (line 115; lobster carve-out: stable anchor is step name `architect-feasibility-review`, not line number)` has run to completion and emitted any declared artifacts.
<!-- F-P23-001: lobster-line-cite annotated per pass-23 carve-out; stable anchor is step name `architect-feasibility-review`; line number is unstable as lobster files evolve -->
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `architect-feasibility-review (line 115; lobster carve-out: stable anchor is step name `architect-feasibility-review`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1473 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `architect-feasibility-review (line 115; lobster carve-out: stable anchor is step name `architect-feasibility-review`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 717; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1473` |
| **Confidence** | high |
...
- **Step:** architect-feasibility-review (line 115; lobster carve-out: stable anchor is step name `architect-feasibility-review`, not line number)
- **Type:** agent
- **Agent:** architect
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`architect-feasibility-review (line 115)`). Stable anchor is step name `architect-feasibility-review`.
...
|---------|------|--------|--------|
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `architect-feasibility-review`. |
