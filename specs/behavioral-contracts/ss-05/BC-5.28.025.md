...
# Behavioral Contract BC-5.28.025: greenfield:phase-1-gate

## Description

Phase 1 omnibus gate.

## Preconditions

1. Upstream dependencies completed successfully: `[phase-1-spec-crystallization, architect-feasibility-review, prd-revision, phase-1-dtu-assessment, phase-1-gene-transfusion-assessment, phase-1-cicd-setup, phase-1-design-system-approval, phase-1-heuristic-evaluation, phase-1-consistency-audit]` (9-parent fan-in).

## Postconditions

1. Phase 1 omnibus gate.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-1-gate (line 231; lobster carve-out: stable anchor is step name `phase-1-gate`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1484 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-1-gate (line 231; lobster carve-out: stable anchor is step name `phase-1-gate`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 750; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1484` |
| **Confidence** | high |
...
- **Step:** phase-1-gate (line 231; lobster carve-out: stable anchor is step name `phase-1-gate`, not line number)
- **Type:** gate
- **Depends on:** `[phase-1-spec-crystallization, architect-feasibility-review, prd-revision, phase-1-dtu-assessment, phase-1-gene-transfusion-assessment, phase-1-cicd-setup, phase-1-design-system-approval, phase-1-heuristic-evaluation, phase-1-consistency-audit]` (9-parent fan-in)
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`phase-1-gate (line 231)`). Stable anchor is step name `phase-1-gate`.
...
|---------|------|--------|--------|
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `phase-1-gate`. |
