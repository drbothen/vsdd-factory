...
1. Step `phase-f5-state-backup (line 1139)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f5-state-backup (line 1139)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f5-state-backup (line 1139)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1228) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1642` |
| **Confidence** | high |
...
- **Step:** phase-f5-state-backup (line 1139)
- **Type:** agent
- **Agent:** state-manager
