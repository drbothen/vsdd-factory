...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f5-state-backup (line 1139)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f5-state-backup (line 1139)`
