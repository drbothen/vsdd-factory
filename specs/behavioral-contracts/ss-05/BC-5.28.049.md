...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-3-gate (line 979)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-3-gate (line 979)`
