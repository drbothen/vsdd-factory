...
1. Step `detect-cross-language-porting (line 242)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `detect-cross-language-porting (line 242)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `detect-cross-language-porting (line 242)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 987) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1559` |
| **Confidence** | high |
...
- **Step:** detect-cross-language-porting (line 242)
- **Type:** agent
- **Agent:** architect
