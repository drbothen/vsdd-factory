...
# Behavioral Contract BC-5.29.005: brownfield: failure semantics

## Description

Workflow contract: brownfield: failure semantics.
...
1. Step `brownfield: failure semantics` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `brownfield: failure semantics` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1544 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `brownfield: failure semantics`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 935; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1544` |
| **Confidence** | high |
...
- **Source line(s) in workflow YAML:** 19-22
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — source-doc line 935
