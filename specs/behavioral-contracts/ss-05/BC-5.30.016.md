...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f1-human-approval (line 221)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f1-human-approval (line 221)`
