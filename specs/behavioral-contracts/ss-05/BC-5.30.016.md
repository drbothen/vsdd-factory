...
1. Step `phase-f1-human-approval (line 221)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f1-human-approval (line 221)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f1-human-approval (line 221)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1086) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1595` |
| **Confidence** | high |
...
- **Step:** phase-f1-human-approval (line 221)
- **Type:** human-approval
