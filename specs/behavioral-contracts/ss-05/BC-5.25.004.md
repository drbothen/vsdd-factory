...
# Behavioral Contract BC-5.25.004: phase-5: DAG integrity

## Description

Workflow contract: phase-5: DAG integrity.
...
1. Step `phase-5: DAG integrity` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-5: DAG integrity` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1403 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-5: DAG integrity`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 514; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1403` |
| **Confidence** | high |
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — source-doc line 514
