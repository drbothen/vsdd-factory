...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `decomposition-gate (line 94)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `decomposition-gate (line 94)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 377) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1355` |
| **Confidence** | high |
...
- **Step:** decomposition-gate (line 94)
- **Type:** gate
