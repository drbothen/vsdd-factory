...
# Behavioral Contract BC-5.30.005: feature: failure semantics

## Description

Workflow contract: feature: failure semantics.
...
1. Step `feature: failure semantics` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `feature: failure semantics` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1584 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `feature: failure semantics`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1050; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1584` |
| **Confidence** | high |
...
- **Source line(s) in workflow YAML:** 28-32
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — source-doc line 1050
