...
1. Step `phase-6-formal-hardening (line 1155)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-6-formal-hardening (line 1155)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-6-formal-hardening (line 1155)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 851) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1517` |
| **Confidence** | high |
...
- **Step:** phase-6-formal-hardening (line 1155)
- **Type:** skill
