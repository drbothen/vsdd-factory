...
# Behavioral Contract BC-5.20.020: phase-0:human-approval

## Description

Human reviews 6 listed artifacts; gate prompt asks about architecture accuracy, conventions correctness, restricted-area identification.
...
1. Human reviews 6 listed artifacts; gate prompt asks about architecture accuracy, conventions correctness, restricted-area identification.
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1319 |
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 185; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1319` |
| **Confidence** | high |
