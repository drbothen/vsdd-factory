...
# Behavioral Contract BC-5.23.009: phase-3:backup-generate-stubs

## Description

Workflow contract: phase-3:backup-generate-stubs.
...
1. Step `backup-generate-stubs (line 38; lobster carve-out: stable anchor is step name `backup-generate-stubs`, not line number)` has run to completion and emitted any declared artifacts.
<!-- F-P23-001: lobster-line-cite annotated per pass-23 carve-out; stable anchor is step name `backup-generate-stubs`; line number is unstable as lobster files evolve -->
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `backup-generate-stubs (line 38; lobster carve-out: stable anchor is step name `backup-generate-stubs`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1368 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `backup-generate-stubs (line 38; lobster carve-out: stable anchor is step name `backup-generate-stubs`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 424; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1368` |
| **Confidence** | high |
...
- **Step:** backup-generate-stubs (line 38; lobster carve-out: stable anchor is step name `backup-generate-stubs`, not line number)
- **Agent:** state-manager
- **Source line(s) in workflow YAML:** 38-43
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`backup-generate-stubs (line 38)`). Stable anchor is step name `backup-generate-stubs`.
...
|---------|------|--------|--------|
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `backup-generate-stubs`. |
