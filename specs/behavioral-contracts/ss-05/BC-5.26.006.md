...
# Behavioral Contract BC-5.26.006: phase-6:kani-proofs

## Description

Workflow contract: phase-6:kani-proofs.
...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `kani-proofs (line 17)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `kani-proofs (line 17)`
...
- **Depends on:** `[]`
- **Timeout:** 2h
- **Source line(s) in workflow YAML:** 17-21
