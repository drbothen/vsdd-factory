...
1. Step `phase-1-multi-variant-approval (line 200)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-1-multi-variant-approval (line 200)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-1-multi-variant-approval (line 200)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 741) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1481` |
| **Confidence** | high |
...
- **Step:** phase-1-multi-variant-approval (line 200)
- **Type:** human-approval
