...
1. Step `phase-f2-a11y-review (line 543)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f2-a11y-review (line 543)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f2-a11y-review (line 543)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1167) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1622` |
| **Confidence** | high |
...
- **Step:** phase-f2-a11y-review (line 543)
- **Type:** agent
