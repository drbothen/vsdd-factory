...
1. Step `phase-f2-human-approval (line 640)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f2-human-approval (line 640)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f2-human-approval (line 640)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1182) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1627` |
| **Confidence** | high |
...
- **Step:** phase-f2-human-approval (line 640)
- **Type:** human-approval
