...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `generate-stubs (line 33)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `generate-stubs (line 33)`
