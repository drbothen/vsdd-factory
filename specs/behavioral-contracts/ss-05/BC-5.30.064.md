...
1. Step `phase-f6-targeted-hardening (line 1157)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f6-targeted-hardening (line 1157)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f6-targeted-hardening (line 1157)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1231) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1643` |
| **Confidence** | high |
...
- **Step:** phase-f6-targeted-hardening (line 1157)
- **Type:** skill
