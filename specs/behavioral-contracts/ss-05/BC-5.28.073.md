...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `release (line 1327)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `release (line 1327)`
