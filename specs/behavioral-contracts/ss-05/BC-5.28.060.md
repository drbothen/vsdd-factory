...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-6-dtu-adversarial (line 1180)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-6-dtu-adversarial (line 1180)`
