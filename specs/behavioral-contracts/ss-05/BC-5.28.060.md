...
1. Step `phase-6-dtu-adversarial (line 1180)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-6-dtu-adversarial (line 1180)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-6-dtu-adversarial (line 1180)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 857) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1519` |
| **Confidence** | high |
...
- **Step:** phase-6-dtu-adversarial (line 1180)
- **Type:** agent
