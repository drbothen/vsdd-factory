...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-1-consistency-audit (line 220)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-1-consistency-audit (line 220)`
