...
1. Step `phase-1-consistency-audit (line 220)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-1-consistency-audit (line 220)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-1-consistency-audit (line 220)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 747) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1483` |
| **Confidence** | high |
...
- **Step:** phase-1-consistency-audit (line 220)
- **Type:** agent
