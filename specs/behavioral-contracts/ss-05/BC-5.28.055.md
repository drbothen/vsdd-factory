...
# Behavioral Contract BC-5.28.055: greenfield:phase-5-adversarial-refinement

## Description

Workflow contract: greenfield:phase-5-adversarial-refinement.
...
1. Step `phase-5-adversarial-refinement (line 1060; lobster carve-out: stable anchor is step name `phase-5-adversarial-refinement`, not line number)` has run to completion and emitted any declared artifacts.
<!-- F-P23-001: lobster-line-cite annotated per pass-23 carve-out; stable anchor is step name `phase-5-adversarial-refinement`; line number is unstable as lobster files evolve -->
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-5-adversarial-refinement (line 1060; lobster carve-out: stable anchor is step name `phase-5-adversarial-refinement`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1514 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-5-adversarial-refinement (line 1060; lobster carve-out: stable anchor is step name `phase-5-adversarial-refinement`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 842; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1514` |
| **Confidence** | high |
...
- **Step:** phase-5-adversarial-refinement (line 1060; lobster carve-out: stable anchor is step name `phase-5-adversarial-refinement`, not line number)
- **Type:** loop
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`phase-5-adversarial-refinement (line 1060)`). Stable anchor is step name `phase-5-adversarial-refinement`.
...
|---------|------|--------|--------|
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `phase-5-adversarial-refinement`. |
