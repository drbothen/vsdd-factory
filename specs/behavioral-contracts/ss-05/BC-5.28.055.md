...
1. Step `phase-5-adversarial-refinement (line 1060)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-5-adversarial-refinement (line 1060)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-5-adversarial-refinement (line 1060)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 842) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1514` |
| **Confidence** | high |
...
- **Step:** phase-5-adversarial-refinement (line 1060)
- **Type:** loop
