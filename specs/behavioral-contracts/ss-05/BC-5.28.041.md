...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-2-human-approval (line 538)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-2-human-approval (line 538)`
