...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `record-demos (line 77)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `record-demos (line 77)`
