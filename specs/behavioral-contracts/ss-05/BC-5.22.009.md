...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `backup-create-stories (line 39)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `backup-create-stories (line 39)`
