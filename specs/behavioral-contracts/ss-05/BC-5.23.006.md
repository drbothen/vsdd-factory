...
# Behavioral Contract BC-5.23.006: phase-3:create-worktree

## Description

Workflow contract: phase-3:create-worktree.

## Preconditions

1. Step has no upstream dependencies (root step).

## Postconditions

1. Step `create-worktree (line 18; lobster carve-out: stable anchor is step name `create-worktree`, not line number)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `create-worktree (line 18; lobster carve-out: stable anchor is step name `create-worktree`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1365 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `create-worktree (line 18; lobster carve-out: stable anchor is step name `create-worktree`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 415; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1365` |
| **Confidence** | high |
...
- **Step:** create-worktree (line 18; lobster carve-out: stable anchor is step name `create-worktree`, not line number)
- **Type:** skill
- **Skill:** `deliver-story/steps/step-a-create-worktree.md`
- **Depends on:** `[]`
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`create-worktree (line 18)`). Stable anchor is step name `create-worktree`.
...
|---------|------|--------|--------|
| v1.2 | 2026-05-08 | state-manager | F-P23-001 corpus-wide sweep: lobster-line-cite annotated with carve-out. Stable anchor is step name `create-worktree`. |
