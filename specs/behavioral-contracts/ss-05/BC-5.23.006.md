...
1. Step `create-worktree (line 18)` has run to completion and emitted any declared artifacts.
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 415) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1365` |
| **Confidence** | high |
