...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `holdout-scenarios (line 79)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `holdout-scenarios (line 79)`
