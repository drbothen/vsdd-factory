...
1. Step `holdout-scenarios (line 79)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `holdout-scenarios (line 79)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `holdout-scenarios (line 79)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 371) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1353` |
| **Confidence** | high |
...
- **Step:** holdout-scenarios (line 79)
- **Type:** skill
