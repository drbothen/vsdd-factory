...
1. Step ``backup-create-prd` (line 53)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for ``backup-create-prd` (line 53)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for ``backup-create-prd` (line 53)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 262) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1330` |
| **Confidence** | high |
...
- **Step:** `backup-create-prd` (line 53)
- **Agent:** state-manager
