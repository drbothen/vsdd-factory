...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `quick-dev-regression (line 247)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `quick-dev-regression (line 247)`
