...
1. Step `phase-f2-spec-review-gemini (line 583)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f2-spec-review-gemini (line 583)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f2-spec-review-gemini (line 583)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1173) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1624` |
| **Confidence** | high |
...
- **Step:** phase-f2-spec-review-gemini (line 583)
- **Type:** loop
