...
1. Step `post-feature-validation (line 1446)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `post-feature-validation (line 1446)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `post-feature-validation (line 1446)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1291) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1663` |
| **Confidence** | high |
...
- **Step:** post-feature-validation (line 1446)
- **Type:** skill
