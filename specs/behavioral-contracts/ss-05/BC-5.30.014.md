...
1. Step `phase-f1-state-backup (line 186)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `phase-f1-state-backup (line 186)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `phase-f1-state-backup (line 186)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 1080) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1593` |
| **Confidence** | high |
...
- **Step:** phase-f1-state-backup (line 186)
- **Type:** agent
- **Agent:** state-manager
