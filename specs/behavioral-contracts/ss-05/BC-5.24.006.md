...
# Behavioral Contract BC-5.24.006: phase-4:scenario-rotation
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `scenario-rotation (line 14; lobster carve-out: stable anchor is step name `scenario-rotation`, not line number)` | manual |
...
| Stories | TBD |
| Source BC-AUDIT ID | BC-AUDIT-1395 |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `scenario-rotation (line 14; lobster carve-out: stable anchor is step name `scenario-rotation`, not line number)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 488; source-doc carve-out: line in phase-0 ingestion doc, not lobster step line) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1395` |
| **Confidence** | high |
...
- **Step:** scenario-rotation (line 14; lobster carve-out: stable anchor is step name `scenario-rotation`, not line number)
- **Type:** agent
- **Agent:** orchestrator
- **Depends on:** `[]`
...
**Driver:** F-P23-001 pass-23 retroactive corpus-wide sweep (per L-P19-001 / L-P20-001 / L-P22-001) — lobster step cited by line number (`scenario-rotation (line 14)`). Stable anchor is step name `scenario-rotation`.
