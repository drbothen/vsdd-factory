...
1. Step `adaptive-planning (line 97)` has run to completion and emitted any declared artifacts.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Workflow YAML field shape matches declared schema for `adaptive-planning (line 97)` | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Workflow YAML field shape matches declared schema for `adaptive-planning (line 97)`
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 711) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1471` |
| **Confidence** | high |
...
- **Step:** adaptive-planning (line 97)
- **Type:** sub-workflow
