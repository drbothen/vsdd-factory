...
| [BC-5.39.009](ss-05/BC-5.39.009.md) | validate-trajectory-tail-cell-completeness WASM hook MUST block on STATE.md writes missing trajectory_tail in any of the 5 prescribed STATE.md cells (PC1/PC2 always-Block; PC3/PC4/PC5 cycle-conditional on per_pass_trajectory flag per ADR-023), and MUST emit advisory on INDEX.md / burst-log.md / lessons.md writes missing trajectory_tail in their prescribed cells | draft **(un-sealed D-525 human-authorized; ADR-023 Option (c) cycle-conditional site model; active on S-15.17 PR merge POL-14)** | E-12 | S-15.17 | v1.9 |
