...
| [BC-1.16.001](ss-01/BC-1.16.001.md) | Dispatcher injects git_context (HEAD/HEAD^ subject+SHA) into payload.extra on PostToolUse Bash git-commit events targeting factory-artifacts worktree — exec-free WASM boundary; fail-open on git error | draft | CAP-032 | S-18.04b-prereq | v1.0 |
