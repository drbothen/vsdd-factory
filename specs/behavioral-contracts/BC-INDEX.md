...
| [BC-5.41.004](ss-05/BC-5.41.004.md) | sprint-state.yaml producer emits per-story `{id, status}` list under `stories:` root key — wave-ascending topo-sort order, status mechanically derived from STORY-INDEX.md, no RAG | draft | CAP-032 | S-18.11 | v1.0 \| v1.1 \| v1.2 \| v1.3 \| v1.4 |
