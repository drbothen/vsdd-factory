...
| [BC-7.06.001](ss-07/BC-7.06.001.md) | hooks-registry.toml schema_version 2 — per-plugin `async: bool` field with CI lint invariant `on_error = "block"` implies `async = false` (v1.7: F5 fix-burst-8 — stale sibling note cleaned + E-REG-002 violation string canonicalized; F-P9-001) | draft | CAP-002 | S-15.01 |
