...
| [BC-1.08.002](ss-01/BC-1.08.002.md) | dispatcher exit code is 2 iff at least one block_intent recorded | draft | CAP-TBD | TBD |
...
| BC ID | Title | Status | Capability | Stories |
|-------|-------|--------|-----------|---------|
| [BC-9.01.001](ss-09/BC-9.01.001.md) | bump-version.sh accepts semver prerelease format (1.0.0-beta.N, 1.0.0-rc.N) | draft | CAP-028 | S-0.01, S-2.08, S-0.02, S-4.08, S-5.07 |
