...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Computes a 7-char short MD5 of the concatenated content of an artifact's `inputs:` frontmatter file list, used for drift | manual (existing test: `plugins/vsdd-factory/bin/compute-input-hash`) |
