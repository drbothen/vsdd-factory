...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2275
section: "Rules: story-completeness (14-check audit)"
type: rule
---

# Behavioral Contract BC-8.26.015: rules/story-completeness.md: check 14 — prerequisites listed (manual steps, repo creation, branch protection, secrets, external accounts)

## Description

Check 14: Manual steps that must happen before Phase 1 are called out in a Prerequisites section: repo creation, branch protection setup, secret configuration, external account setup (crates.io, npm, etc.).
...
1. Prerequisites section present and exhaustive.
...
**Source metadata:** `plugins/vsdd-factory/rules/story-completeness.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 112–119
