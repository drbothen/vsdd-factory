...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/module-criticality-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1925
section: "Discovery, project, config templates"
type: template
---

# Behavioral Contract BC-8.16.014: module-criticality-template: module criticality classification

## Description

Frontmatter `document_type: module-criticality`, `level: ops`. Required: `## Tier Definitions`, `## Module Inventory (Recommended)`, `## Module Classification`, `## Per-Module Risk Assessment (Recommended)`, `## Classification Summary`, `## Dependency Graph — Build Order (Recommended)`, `## Implementation Priority Order (Recommended)`, `## Cross-Cutting Concerns by Tier (Recommended)`, `## Anti-Patterns to Explicitly Not Port (Conditional — brownfield only)`. Tiers per `rules/spec-format.md`: CRITICAL / HIGH / MEDIUM / LOW.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/module-criticality-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All `##` headings present; tier values in enum.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/module-criticality-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/module-criticality-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
