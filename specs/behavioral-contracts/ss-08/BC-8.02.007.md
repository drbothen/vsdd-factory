...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/cycle-manifest-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1823
section: "Story, epic, and cycle templates"
type: template
---

# Behavioral Contract BC-8.02.007: cycle-manifest-template: per-cycle manifest identity

## Description

Cycle manifest. Frontmatter `document_type: cycle-manifest`, `cycle_id: vX.Y.Z-[type]-[name]`. Sections: `## Delivered`, `## Spec Changes`, `## Living Spec Snapshot`, `## Deprecations`, `## Tech Debt Created`, `## Governance Policies Adopted`, `## Notes`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/cycle-manifest-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 7 `##` headings present (some optional).
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/cycle-manifest-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/cycle-manifest-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
