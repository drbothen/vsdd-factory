...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/gene-transfusion-assessment-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1862
section: "Brownfield, discovery, extraction templates"
type: template
---

# Behavioral Contract BC-8.07.004: gene-transfusion-assessment-template: brownfield gene-transfusion candidate assessment

## Description

Frontmatter `document_type: gene-transfusion-assessment`, `level: L3`. Required: `## Summary`, `## Candidate Analysis`, `## Modules Without Candidates`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/gene-transfusion-assessment-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/gene-transfusion-assessment-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/gene-transfusion-assessment-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
