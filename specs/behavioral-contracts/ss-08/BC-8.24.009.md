...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2245
section: "Rules: spec-format (4-level hierarchy, BC/VP shape)"
type: rule
---

# Behavioral Contract BC-8.24.009: rules/spec-format.md: ARCH-NN section template — Overview/Decisions/Components/Data Flow/Constraints/Dependencies

## Description

Per-ARCH-NN: `# ARCH-NN: <Section Title>`, `## Overview`, `## Decisions` (ADR-style), `## Components`, `## Data Flow`, `## Constraints` (perf budgets, security), `## Dependencies` (forward + reverse).
...
1. All 6 `##` headings present per shard.
...
**Source metadata:** `plugins/vsdd-factory/rules/spec-format.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 119–139
