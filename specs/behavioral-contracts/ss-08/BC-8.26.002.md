...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2262
section: "Rules: story-completeness (14-check audit)"
type: rule
---

# Behavioral Contract BC-8.26.002: rules/story-completeness.md: check 1 — source-of-truth alignment (line-by-line vs architecture docs)

## Description

Check 1: Do embedded configs, dependency rules, and crate lists match the architecture docs they reference? Compare line by line — stale data is the #1 gap.
...
1. Story-vs-arch line diff yields no drift.
...
**Source metadata:** `plugins/vsdd-factory/rules/story-completeness.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 13–17
