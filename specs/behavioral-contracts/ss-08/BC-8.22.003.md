...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2221
section: "Rules: git-commits (Conventional Commits, no AI attribution)"
type: rule
---

# Behavioral Contract BC-8.22.003: rules/git-commits.md: description uses imperative present tense, lowercase initial, no period

## Description

Imperative ("add" not "added"); do NOT capitalize first letter; do NOT end with a period.
...
1. Commit description matches the 3 sub-rules.
...
**Source metadata:** `plugins/vsdd-factory/rules/git-commits.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 32–36
