...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/demo-tape-template.tape"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1870
section: "Demo evidence templates"
type: template
---

# Behavioral Contract BC-8.08.002: demo-tape-template: VHS .tape demo recording template

## Description

VHS recording scaffold for terminal demos. Best practices encoded as comments: ALWAYS use Wait+Line (not Sleep), produce both `.gif` + `.webm`, use Hide/Show for setup, use Require for deps, recordings under 15 seconds, TypingSpeed 50ms, terminal 1200x600. Output paths `docs/demo-evidence/{STORY_ID}/AC-NNN-{description}.{gif,webm}`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/demo-tape-template.tape` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. File contains `Output ... .gif` AND `Output ... .webm` lines; comment header includes "Best Practices".
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/demo-tape-template.tape` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/demo-tape-template.tape` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–20
