...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/feature-request-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1867
section: "Brownfield, discovery, extraction templates"
type: template
---

# Behavioral Contract BC-8.07.009: feature-request-template: feature-mode FR-NNN identity

## Description

Frontmatter `document_type: feature-request`, `title: "[Feature Name]"`. Required: `## Problem`, `## Proposed Solution`, `## Scope`, `## Constraints`, `## Success Criteria`, `## Example: Task Priority Feature` (informative).

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/feature-request-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. First 5 `##` headings present (Example optional).
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/feature-request-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/feature-request-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
