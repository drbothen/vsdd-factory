...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/brief-validation-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1924
section: "Discovery, project, config templates"
type: template
---

# Behavioral Contract BC-8.16.013: brief-validation-template: brief-quality gate report

## Description

Frontmatter `document_type: brief-validation`, `level: ops`. Required: `## Section Assessment`, `## Bloat Score`, `## Overall: VALID | NEEDS_WORK | INCOMPLETE | OVER_SPECIFIED`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/brief-validation-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 3 `##` headings present; verdict in 4-value enum.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/brief-validation-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/brief-validation-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
