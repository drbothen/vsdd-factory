...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2250
section: "Rules: step-decomposition (VSDD phase 0-7 protocol)"
type: rule
---

# Behavioral Contract BC-8.25.002: rules/step-decomposition.md: phase numbers are sequential integers; no fractional phases ("3.5")

## Description

Phase numbers are sequential integers 0–7. NO fractional phases. Feature-mode phases use `f` prefix: `phase-f1` through `phase-f7`.
...
1. No filenames matching `phase-N\.M-` pattern.
...
**Source metadata:** `plugins/vsdd-factory/rules/step-decomposition.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 28
