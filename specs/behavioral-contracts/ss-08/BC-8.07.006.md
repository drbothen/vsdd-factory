...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/research-index-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1864
section: "Brownfield, discovery, extraction templates"
type: template
---

# Behavioral Contract BC-8.07.006: research-index-template: per-cycle research index

## Description

Frontmatter `document_type: research-index`, `level: ops`. Required: `## Queries`, `## Key Findings`, `## Version Pins Discovered`, `## Research Methods`, `## Inconclusive Items`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/research-index-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/research-index-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/research-index-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
