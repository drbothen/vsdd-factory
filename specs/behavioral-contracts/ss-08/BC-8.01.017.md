...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/L4-verification-property-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1816
section: "Spec hierarchy templates (L1 through L4)"
type: template
---

# Behavioral Contract BC-8.01.017: L4-verification-property-template: VP-NNN identity + lifecycle

## Description

L4 VP file. Frontmatter `document_type: verification-property`, `level: L4`. Required sections: `## Property Statement`, `## Source Contract`, `## Proof Method`, `## Proof Harness Skeleton`, `## Feasibility Assessment`, `## Lifecycle`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/L4-verification-property-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 6 `##` headings present; once `Lifecycle.status: green`, file is immutable per `rules/spec-format.md` (BC-AUDIT-2249 below).
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/L4-verification-property-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/L4-verification-property-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3 (frontmatter), 5–7 (lifecycle), 9 (title)
