...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/ui-quality/{gate-report-template.md,heuristic-evaluation-template.md,responsive-report-template.md,completeness-report-template.md}"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1890
section: "Design system and UI quality templates"
type: template
---

# Behavioral Contract BC-8.12.006: ui-quality/: subdir governs UI quality gate + report templates

## Description

4 UI quality artifacts: gate-report (per-story / wave / build / convergence gate result with PASS/FAIL); heuristic-evaluation (10-Nielsen-heuristic scoring); responsive-report (per-breakpoint screen pass rates at 4 breakpoints 375/768/1024/1440); completeness-report (screens-specified vs implemented vs verified + fidelity score).

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/ui-quality/{gate-report-template.md,heuristic-evaluation-template.md,responsive-report-template.md,completeness-report-template.md}` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/ui-quality/{gate-report-template.md,heuristic-evaluation-template.md,responsive-report-template.md,completeness-report-template.md}` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/ui-quality/{gate-report-template.md,heuristic-evaluation-template.md,responsive-report-template.md,completeness-report-template.md}` | **Type:** template | **Confidence:** HIGH | **Source line(s):** dir listing
