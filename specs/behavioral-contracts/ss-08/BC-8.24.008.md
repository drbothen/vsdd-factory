...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2244
section: "Rules: spec-format (4-level hierarchy, BC/VP shape)"
type: rule
---

# Behavioral Contract BC-8.24.008: rules/spec-format.md: architecture is sharded into ARCH-NN sections, NOT a monolith

## Description

Architecture split into numbered sections: `ARCH-INDEX.md` (links), `ARCH-00-overview.md`, `ARCH-01-core-services.md`, `ARCH-02-data-layer.md`, `ARCH-03-api-layer.md`, `ARCH-04-agent-system.md`, `ARCH-05-workflow-engine.md`, `ARCH-06-integration.md`. Sections added as needed; not all required for every project.
...
1. ARCH files match `ARCH-NN-<section>.md`.
...
**Source metadata:** `plugins/vsdd-factory/rules/spec-format.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 100–117
