...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/wave-schedule-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1907
section: "State and workflow templates"
type: template
---

# Behavioral Contract BC-8.14.008: wave-schedule-template: per-cycle wave schedule

## Description

Frontmatter `document_type: wave-schedule`, `level: ops`. Required: `## Summary`, `## Wave Plan`, `## Pipeline Overlap Plan`, `## Critical Path`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/wave-schedule-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/wave-schedule-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/wave-schedule-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
