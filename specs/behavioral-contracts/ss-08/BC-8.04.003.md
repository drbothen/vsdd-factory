...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/adversarial-finding-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1837
section: "Adversarial-review templates"
type: template
---

# Behavioral Contract BC-8.04.003: adversarial-finding-template: per-finding ADV-N identity

## Description

Frontmatter `document_type: adversarial-finding`, `level: ops`. ID format `ADV-<CYCLE>-P[N]-[SEV]-NNN`. Required: `## Finding`, `## Affected Artifacts`, `## Recommendation`, `## Resolution (filled by fixing agent)`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/adversarial-finding-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/adversarial-finding-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/adversarial-finding-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
