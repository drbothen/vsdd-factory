...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/story-index-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1820
section: "Story, epic, and cycle templates"
type: template
---

# Behavioral Contract BC-8.02.004: story-index-template: STORY-INDEX identity

## Description

Story index document. Frontmatter `document_type: story-index`, `level: ops`. Single `# Story Index` heading; body is a table.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/story-index-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Frontmatter present; `# Story Index` heading present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/story-index-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/story-index-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3, 5
