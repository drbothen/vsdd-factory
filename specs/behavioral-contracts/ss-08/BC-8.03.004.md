...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1827
section: "Architecture templates"
type: template
---

# Behavioral Contract BC-8.03.004: architecture-template: Part 3 module specifications (15)

## Description

Part 3 single section `## 15. Module Specifications` — per-module implementation contracts.
