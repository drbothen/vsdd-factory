...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/policies-template.yaml"
subsystem: SS-08
capability: ""
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/policies-template.yaml` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/policies-template.yaml` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–40
