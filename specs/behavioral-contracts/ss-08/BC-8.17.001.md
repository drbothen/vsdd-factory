...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/skill-execution-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1926
section: "Skill and agent file templates"
type: template
---

# Behavioral Contract BC-8.17.001: skill-execution-template: SKILL.md (execution variant) shape

## Description

SKILL.md scaffold for execution skills. Required: `## Contract`, `## Procedure`, `## Quality Checks`, `## Failure Modes`, `## Reference Files`. Title `# [Capability Name]`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/skill-execution-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/skill-execution-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/skill-execution-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–4 (HTML comment header)
