...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/session-review-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1904
section: "State and workflow templates"
type: template
---

# Behavioral Contract BC-8.14.005: session-review-template: post-cycle session review

## Description

Frontmatter `document_type: session-review`, `date: YYYY-MM-DD`. Required: `## Executive Summary`, `## Run Overview`, `## 1. Cost Analysis`, `## 2. Timing Analysis`, `## 3. Convergence Analysis`, `## 4. Agent Behavior Analysis`, `## 5. Gate Outcome Analysis`, `## 6. Wall Integrity Analysis`, `## 7. Quality Signal Analysis`, `## 8. Pattern Detection`, `## 9. Governance Policy Audit`, `## Improvement Proposals`, `## Metrics for Next Run`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/session-review-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 13 numbered + named sections present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/session-review-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/session-review-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
