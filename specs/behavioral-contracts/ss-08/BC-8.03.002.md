...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/architecture-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1825
section: "Architecture templates"
type: template
---

# Behavioral Contract BC-8.03.002: architecture-template: Part 1 sections (1–9, system + data + integration)

## Description

Part 1 mandatory sections: `## 1. System Overview`, `## 1b. L2 Domain Capability Mapping`, `## 2. Architecture Patterns`, `## 3. System Components`, `## 3b. Component Map (Machine-Readable)`, `## 4. Interfaces`, `## 5. Data Models`, `## 6. Integration Contracts`, `## 7. Non-Functional Architecture`, `## 8. Architecture Decision Records`, `## 9. Deployment Topology`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/architecture-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/architecture-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/architecture-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** body
