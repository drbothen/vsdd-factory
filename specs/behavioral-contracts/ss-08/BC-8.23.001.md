...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2228
section: "Rules: rust (forbid unsafe, edition, lints)"
type: rule
---

# Behavioral Contract BC-8.23.001: rules/rust.md: every application crate MUST declare `#![forbid(unsafe_code)]`

## Description

Every application crate forbids unsafe code at the crate level. Library crates that genuinely need unsafe (e.g., FFI shims) document the exception.
...
1. Each `lib.rs` / `main.rs` has the lint declared.
...
**Source metadata:** `plugins/vsdd-factory/rules/rust.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 9
