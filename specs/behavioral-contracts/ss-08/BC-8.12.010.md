...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/ui-quality/completeness-report-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1894
section: "Design system and UI quality templates"
type: template
---

# Behavioral Contract BC-8.12.010: ui-quality/completeness-report-template: UI completeness fidelity report

## Description

Checked-by `consistency-validator`. Reports `Screens: specified / implemented / verified`, `Fidelity Score: %`, `Total Gaps: count`, plus `## Screen-by-Screen Status`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/ui-quality/completeness-report-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Summary block + screen status section present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/ui-quality/completeness-report-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/ui-quality/completeness-report-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–15
