...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/design-system/{constraints.yaml, tokens/*.json, components/component-registry.yaml, components/contracts/*.yaml, patterns/*.yaml}"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1885
section: "Design system and UI quality templates"
type: template
---

# Behavioral Contract BC-8.12.001: design-system/: subdir governs design-token + component-contract + pattern catalog
...
1. Template file at `plugins/vsdd-factory/templates/design-system/{constraints.yaml, tokens/*.json, components/component-registry.yaml, components/contracts/*.yaml, patterns/*.yaml}` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All listed sub-files present; `constraints.yaml` parseable; tokens reference well-formed JSON.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/design-system/{constraints.yaml, tokens/*.json, components/component-registry.yaml, components/contracts/*.yaml, patterns/*.yaml}` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/design-system/{constraints.yaml, tokens/*.json, components/component-registry.yaml, components/contracts/*.yaml, patterns/*.yaml}` | **Type:** template | **Confidence:** HIGH | **Source line(s):** subdir listing
