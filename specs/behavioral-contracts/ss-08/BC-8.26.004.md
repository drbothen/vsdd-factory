...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2264
section: "Rules: story-completeness (14-check audit)"
type: rule
---

# Behavioral Contract BC-8.26.004: rules/story-completeness.md: check 3 — technical gotchas documented in Dev Notes (API quirks, version-specific behavior, platform diffs)

## Description

Check 3: Are known pitfalls / quirks / non-obvious decisions documented in Dev Notes? Examples: API quirks (cargo subcommand argv duplication), library version-specific behavior (cargo_metadata feature resolution), platform differences (Windows archive format). Implementer should not discover these mid-implementation.
...
1. Story has Dev Notes covering known pitfalls.
...
**Source metadata:** `plugins/vsdd-factory/rules/story-completeness.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 27–33
