...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/domain-research-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1863
section: "Brownfield, discovery, extraction templates"
type: template
---

# Behavioral Contract BC-8.07.005: domain-research-template: L2 domain-research report

## Description

Frontmatter `document_type: domain-research`, `level: L2`. Required: `## 1. Competitive Landscape`, `## 2. Library/Package Ecosystem Analysis`, `## 3. Common Pitfalls & Mitigations`, `## 4. Recommended Technical Decisions`, `## 5. CI/CD Integration Patterns`, `## 6. Summary of Recommendations`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/domain-research-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 6 numbered `##` headings present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/domain-research-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/domain-research-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
