...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/spec-drift-report-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1897
section: "Spec lifecycle templates (changelog, drift, withdrawal, gates)"
type: template
---

# Behavioral Contract BC-8.13.002: spec-drift-report-template: spec-drift report

## Description

Frontmatter `document_type: spec-drift-report`, `level: ops`. Required: `## Summary`, `## Drift Details`, `## Recommendations`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/spec-drift-report-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/spec-drift-report-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/spec-drift-report-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
