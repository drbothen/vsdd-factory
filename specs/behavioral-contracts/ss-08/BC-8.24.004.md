...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2240
section: "Rules: spec-format (4-level hierarchy, BC/VP shape)"
type: rule
---

# Behavioral Contract BC-8.24.004: rules/spec-format.md: BC-INDEX.md format — table with ID/Title/Subsystem/Status/Stories columns

## Description

BC-INDEX.md is a markdown table with columns: ID / Title / Subsystem / Status / Stories. Status enum: `draft / reviewed / green`.
...
1. Index has matching column structure.
...
**Source metadata:** `plugins/vsdd-factory/rules/spec-format.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 55–63
