...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2270
section: "Rules: story-completeness (14-check audit)"
type: rule
---

# Behavioral Contract BC-8.26.010: rules/story-completeness.md: check 9 — test fixtures defined with directory/config/expected-behavior/AC-coverage
...
1. Each test fixture has all 4 sub-items.
...
**Source metadata:** `plugins/vsdd-factory/rules/story-completeness.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 78–86
