...
origin: brownfield
extracted_from: "plugins/vsdd-factory/rules/spec-format.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2237
section: "Rules: spec-format (4-level hierarchy, BC/VP shape)"
type: rule
---

# Behavioral Contract BC-8.24.001: rules/spec-format.md: 4-level spec hierarchy (L1 brief / L2 domain / L3 BC / L4 VP)

## Description

L1 = Product Brief (markdown, mutable, human input). L2 = Domain Specification (markdown, living, updated as domain understanding deepens). L3 = Behavioral Contracts (BC) (markdown, accumulating; new per story, existing versioned). L4 = Verification Properties (VP) (markdown, **immutable once green**; enforced by spec-steward hook).

## Preconditions

1. The rule from `plugins/vsdd-factory/rules/spec-format.md` is being applied to a code change, commit, or artifact.
2. The artifact under review falls within the scope of the rule ("Used by" field below).

## Postconditions

1. Spec hierarchy levels assignable; each lifecycle observed.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/rules/spec-format.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/rules/spec-format.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 7–13
