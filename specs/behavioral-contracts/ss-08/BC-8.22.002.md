...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2220
section: "Rules: git-commits (Conventional Commits, no AI attribution)"
type: rule
---

# Behavioral Contract BC-8.22.002: rules/git-commits.md: commit type SHALL be one of 10 known values (feat/fix/docs/style/refactor/perf/test/build/ci/chore)

## Description

`feat` (new feature, MINOR version); `fix` (bug fix, PATCH); `docs`; `style`; `refactor`; `perf`; `test`; `build`; `ci`; `chore`.
...
**Source metadata:** `plugins/vsdd-factory/rules/git-commits.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 17–30
