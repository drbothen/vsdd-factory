...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/review-findings-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1841
section: "Adversarial-review templates"
type: template
---

# Behavioral Contract BC-8.04.007: review-findings-template: PR-review findings per story

## Description

Frontmatter `document_type: pr-review-findings`, `story_id: STORY-NNN`. Required: `## Convergence Summary`, `## Finding Detail`, `## Triage Routing`, `## Review Cycle History`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/review-findings-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/review-findings-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/review-findings-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
