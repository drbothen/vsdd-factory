...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/findings-tracker-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1838
section: "Adversarial-review templates"
type: template
---

# Behavioral Contract BC-8.04.004: findings-tracker-template: cycle-level findings tracker

## Description

Frontmatter `document_type: findings-tracker`, `level: ops`. Required: `## Summary`, `## Finding Status`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/findings-tracker-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Both `##` headings present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/findings-tracker-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/findings-tracker-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
