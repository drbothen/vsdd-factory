...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/ux-spec-index-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1882
section: "UX templates"
type: template
---

# Behavioral Contract BC-8.11.002: ux-spec-index-template: sharded UX-spec index

## Description

Frontmatter `document_type: ux-spec-index`, `version: "1.0"`. Required: `## Screen Inventory`, `## Flow Inventory`, `## Cross-References`, `## Design System References`, `## Responsive Breakpoints`, `## Contextual Variants`, `## Accessibility Checklist (Global)`, `## Performance Targets`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/ux-spec-index-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/ux-spec-index-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/ux-spec-index-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
