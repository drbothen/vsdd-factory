...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/implementation-readiness-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1923
section: "Discovery, project, config templates"
type: template
---

# Behavioral Contract BC-8.16.012: implementation-readiness-template: pre-implementation readiness gate

## Description

Frontmatter `document_type: implementation-readiness`, `level: ops`. Required: `## Readiness Assessment`, `## Overall: READY | CONCERNS | NOT_READY`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/implementation-readiness-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Both `##` headings present; verdict in enum.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/implementation-readiness-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/implementation-readiness-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
