...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/factory-project-structure-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1919
section: "Discovery, project, config templates"
type: template
---

# Behavioral Contract BC-8.16.008: factory-project-structure-template: .factory-project/ multi-repo directory structure

## Description

Multi-repo `.factory-project/` documentation template. Required: `## Directory Layout`, `## Git Strategy`, `## Initialization`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/factory-project-structure-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/factory-project-structure-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/factory-project-structure-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1
