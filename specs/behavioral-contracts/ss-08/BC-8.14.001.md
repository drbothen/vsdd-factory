...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/state-template.md"
subsystem: SS-08
capability: ""
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/state-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/state-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
