...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/adversary-prompt-templates/{phase-1d-spec-review.md,phase-2-story-review.md,phase-5-code-review.md}"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1844
section: "Adversarial-review templates"
type: template
---

# Behavioral Contract BC-8.04.010: adversary-prompt-templates: subdir governs phase-specific adversary prompt scaffolds

## Description

Three subdir entries — phase-1d (spec review), phase-2 (story review), phase-5 (code review). Each prompt scaffold provides Review Focus + Not-Reviewing scope + Previous Findings Context Mustache template.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/adversary-prompt-templates/{phase-1d-spec-review.md,phase-2-story-review.md,phase-5-code-review.md}` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 3 files present; each has frontmatter with phase + focus + document_type.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/adversary-prompt-templates/{phase-1d-spec-review.md,phase-2-story-review.md,phase-5-code-review.md}` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/adversary-prompt-templates/{phase-1d-spec-review.md,phase-2-story-review.md,phase-5-code-review.md}` | **Type:** template | **Confidence:** HIGH | **Source line(s):** subdir listing; each file has frontmatter `document_type: adversary-prompt-template, phase: <N>, focus: <area>`
