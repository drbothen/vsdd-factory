...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/project-context-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1859
section: "Brownfield, discovery, extraction templates"
type: template
---

# Behavioral Contract BC-8.07.001: project-context-template: brownfield project context summary

## Description

Phase 0a output. Title `# Project Context: [PROJECT_NAME]`. Required: `## Identity`, `## Architecture`, `## Conventions`, `## Behavioral Contracts (Recovered)`, `## Verification Posture`, `## Gaps & Risks`, `## Restricted Areas`, `## Recent Changes (Last 3 Months)`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/project-context-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/project-context-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/project-context-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1 (title)
