...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2217
section: "Rules: factory-protocol (.factory worktree, governance)"
type: rule
---

# Behavioral Contract BC-8.21.007: rules/factory-protocol.md: STATE.md is the single source of truth for pipeline progress

## Description

Read STATE.md before starting any phase work. Single source of pipeline progress.
...
1. STATE.md read at session start by every orchestration session.
...
**Source metadata:** `plugins/vsdd-factory/rules/factory-protocol.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 80
