...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/verification-architecture-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1831
section: "Architecture templates"
type: template
---

# Behavioral Contract BC-8.03.008: verification-architecture-template: verification-arch shard

## Description

Frontmatter `document_type: architecture-section`, `level: L3`. Required: `## Provable Properties Catalog`, `## P0 Properties`, `## P1 Properties`, `## Purity Boundary`, `## Verification Tooling`. Each subsection MAY be inline or shard-referenced.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/verification-architecture-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/verification-architecture-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/verification-architecture-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
