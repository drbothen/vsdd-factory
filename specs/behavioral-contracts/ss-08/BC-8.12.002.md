...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/design-system/constraints.yaml"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1886
section: "Design system and UI quality templates"
type: template
---

# Behavioral Contract BC-8.12.002: design-system/constraints.yaml: global UI generation rules

## Description

Three top-level rules: `token_enforcement` (all styles MUST use design tokens; exceptions require log + commit-message justification + wave-gate review); `component_enforcement` (agents MUST use registered components; new component requires justification + contract + story); `semantic_html` (semantic HTML is mandatory; div is layout-only). Version `1.0.0`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/design-system/constraints.yaml` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 3 top-level keys present; `version: "1.0.0"` set.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/design-system/constraints.yaml` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/design-system/constraints.yaml` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–30
