...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/dtu-assessment-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1878
section: "DTU (Digital Twin Universe) templates"
type: template
---

# Behavioral Contract BC-8.10.001: dtu-assessment-template: DTU assessment for SUT

## Description

Frontmatter `document_type: dtu-assessment`, `level: L3`. Required: `## Summary`, `## Integration Surface Inventory (MANDATORY — all categories required)`, `## Dependency Summary`, `## Services NOT Requiring DTU`, `## DTU Architecture`, `## Clone Development Approach`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/dtu-assessment-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 6 `##` headings present; Integration Surface Inventory MUST cover all categories.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/dtu-assessment-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/dtu-assessment-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
