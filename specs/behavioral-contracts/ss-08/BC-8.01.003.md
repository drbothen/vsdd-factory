...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1802
section: "Spec hierarchy templates (L1 through L4)"
type: template
---

# Behavioral Contract BC-8.01.003: product-brief-template: required sections

## Description

Document MUST contain sections: `## What Is This?`, `## Who Is It For?`, `## Scope`, `## Success Criteria`, `## Constraints & Integration Points`. `## Overflow Context` is optional.
...
1. All 5 mandatory `##` headings present; document title `# Product Brief: [PRODUCT NAME]`.
...
**Source metadata:** `plugins/vsdd-factory/templates/product-brief-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 8–76
