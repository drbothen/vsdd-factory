...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/ui-quality/responsive-report-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1893
section: "Design system and UI quality templates"
type: template
---

# Behavioral Contract BC-8.12.009: ui-quality/responsive-report-template: 4-breakpoint responsive validation

## Description

Tested-by `e2e-tester`. Breakpoints: 4 (375, 768, 1024, 1440). Reports `screens tested`, `pass rate %`, `critical failures` count, plus `## Per-Screen Results`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/ui-quality/responsive-report-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Summary section + per-screen section present; 4 breakpoints fixed.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/ui-quality/responsive-report-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/ui-quality/responsive-report-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–15
