...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/L2-domain-spec-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1804
section: "Spec hierarchy templates (L1 through L4)"
type: template
---

# Behavioral Contract BC-8.01.005: L2-domain-spec-template: required sections (legacy 10-section schema)

## Description

Sections (legacy): 1. Domain Capabilities, 2. Domain Entities, 3. Domain Invariants, 4. Domain Events / Processing Stages, 5. Domain-Level Edge Cases, 6. Assumptions Requiring Validation, 7. Risk Register, 8. Failure Modes, 9. Competitive Differentiator Traceability, 10. Domain Event Flow (Optional).

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/L2-domain-spec-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. First 9 numbered `##` headings present (10 optional).
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/L2-domain-spec-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/L2-domain-spec-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** monolith body
