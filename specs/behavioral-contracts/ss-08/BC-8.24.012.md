...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2248
section: "Rules: spec-format (4-level hierarchy, BC/VP shape)"
type: rule
---

# Behavioral Contract BC-8.24.012: rules/spec-format.md: BC retirement requires updating ALL 5 artifacts in same burst
...
1. Retirement burst commits show all 5 artifacts updated.
...
**Source metadata:** `plugins/vsdd-factory/rules/spec-format.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 186–196
