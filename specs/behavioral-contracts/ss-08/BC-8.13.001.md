...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/spec-changelog-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1896
section: "Spec lifecycle templates (changelog, drift, withdrawal, gates)"
type: template
---

# Behavioral Contract BC-8.13.001: spec-changelog-template: spec-versioning changelog

## Description

Frontmatter `document_type: spec-changelog`, `project: "[Project Name]"`. Required: per-version sections `## [X.Y.Z] - YYYY-MM-DD`. Initial 1.0.0 baseline section required.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/spec-changelog-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Frontmatter present; at least one `## [version] - date` heading.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/spec-changelog-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/spec-changelog-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
