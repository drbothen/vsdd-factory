...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1803
section: "Spec hierarchy templates (L1 through L4)"
type: template
---

# Behavioral Contract BC-8.01.004: L2-domain-spec-template: deprecated monolithic L2 template kept for reference

## Description

Marked DEPRECATED in favor of the sharded `L2-domain-spec-index-template` + `L2-domain-spec-section-template`. New projects MUST use the sharded form.
...
1. File begins with `<!-- DEPRECATED: ... -->` comment block.
...
**Source metadata:** `plugins/vsdd-factory/templates/L2-domain-spec-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3 (DEPRECATED comment header)
