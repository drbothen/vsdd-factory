...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/prd-supplement-interface-definitions-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1811
section: "Spec hierarchy templates (L1 through L4)"
type: template
---

# Behavioral Contract BC-8.01.012: prd-supplement-interface-definitions-template: PRD CLI/JSON/Config supplement

## Description

Frontmatter `document_type: prd-supplement-interface-definitions`, `level: L3`. Required sections: `## CLI Interface`, `## Exit Code Semantics`, `## JSON Output Schema`, `## Config File Schema`, `## Flag Interactions`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/prd-supplement-interface-definitions-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 5 `##` headings present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/prd-supplement-interface-definitions-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/prd-supplement-interface-definitions-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
