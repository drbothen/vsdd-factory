...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/design-system/tokens/{accessibility,colors,elevation,motion,sizing,spacing,typography}.json"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1887
section: "Design system and UI quality templates"
type: template
---

# Behavioral Contract BC-8.12.003: design-system/tokens/: 7 token JSON catalogs

## Description

7 design-token JSON catalogs covering accessibility (focus rings, contrast pairs), colors (palette + semantic), elevation (shadow stack), motion (timing + easing), sizing (component radii + heights), spacing (scale), typography (type scale + family + weights). Token names cross-reference component contracts.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/design-system/tokens/{accessibility,colors,elevation,motion,sizing,spacing,typography}.json` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 7 files present and parseable as JSON.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/design-system/tokens/{accessibility,colors,elevation,motion,sizing,spacing,typography}.json` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/design-system/tokens/{accessibility,colors,elevation,motion,sizing,spacing,typography}.json` | **Type:** template | **Confidence:** HIGH | **Source line(s):** dir listing (7 files)
