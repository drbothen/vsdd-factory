...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2238
section: "Rules: spec-format (4-level hierarchy, BC/VP shape)"
type: rule
---

# Behavioral Contract BC-8.24.002: rules/spec-format.md: BC numbering — `BC-S.SS.NNN` (S=subsystem, SS=section, NNN=contract)

## Description

BC ID format: `S` = subsystem (01–99), `SS` = section within subsystem (01–99), `NNN` = contract number (001–999). Example: `BC-1.01.001` — Subsystem 1, Section 01, Contract 001.
...
1. Each BC has matching ID format.
...
**Source metadata:** `plugins/vsdd-factory/rules/spec-format.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 17–22
