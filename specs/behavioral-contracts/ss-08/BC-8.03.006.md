...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/architecture-section-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1829
section: "Architecture templates"
type: template
---

# Behavioral Contract BC-8.03.006: architecture-section-template: per-section ARCH-NN shard

## Description

Minimal shard. Frontmatter `document_type: architecture-section`, `level: L3`. Single `# [Section Title]` placeholder; content varies per section.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/architecture-section-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Frontmatter present; `#` title present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/architecture-section-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/architecture-section-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
