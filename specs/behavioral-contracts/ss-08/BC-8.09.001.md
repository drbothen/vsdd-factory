...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/formal-verification-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1873
section: "Verification and report templates"
type: template
---

# Behavioral Contract BC-8.09.001: formal-verification-template: formal-verify pass output

## Description

Frontmatter `document_type: formal-verification-report`, `level: ops`. Required: `## Summary`, `## Kani Results`, `## Fuzz Results`, `## Mutation Survivors`, `## Security Findings`, `## Gate: PASS | FAIL`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/formal-verification-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/formal-verification-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/formal-verification-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
