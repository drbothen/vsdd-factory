...
1. Shared-context exists for every step-decomposed skill; cross-step content is there.
...
**Source metadata:** `plugins/vsdd-factory/rules/step-decomposition.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 124–137
