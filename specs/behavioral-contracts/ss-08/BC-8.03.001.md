...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1824
section: "Architecture templates"
type: template
---

# Behavioral Contract BC-8.03.001: architecture-template: governs L3 architecture document identity

## Description

Canonical L3 architecture document. Frontmatter `document_type: architecture`, `level: L3`. Three parts spanning 15 numbered sections.
...
1. All `##` numbered headings present (1..15).
...
**Source metadata:** `plugins/vsdd-factory/templates/architecture-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
