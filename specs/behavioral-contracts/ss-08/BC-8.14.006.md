...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/lessons-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1905
section: "State and workflow templates"
type: template
---

# Behavioral Contract BC-8.14.006: lessons-template: cycle lessons-learned

## Description

Frontmatter `document_type: lessons-learned`, `level: ops`. Required: `## Agent-Level`, `## Process-Level`, `## Infrastructure-Level`, `## Policy Candidates`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/lessons-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/lessons-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/lessons-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
