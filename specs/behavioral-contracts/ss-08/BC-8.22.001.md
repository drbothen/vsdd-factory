...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2219
section: "Rules: git-commits (Conventional Commits, no AI attribution)"
type: rule
---

# Behavioral Contract BC-8.22.001: rules/git-commits.md: all commits MUST follow Conventional Commits
...
1. Each commit message parses against Conventional Commits grammar.
...
**Source metadata:** `plugins/vsdd-factory/rules/git-commits.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 5–15
