...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2247
section: "Rules: spec-format (4-level hierarchy, BC/VP shape)"
type: rule
---

# Behavioral Contract BC-8.24.011: rules/spec-format.md: STORY-NNN file format — Epic/Description/AC/BCs/VPs/Tasks/Strategy/Dependencies/Wave

## Description

Per-story file: `# STORY-NNN: <Title>`, `## Epic`, `## Description` (As a..., I want..., so that...), `## Acceptance Criteria`, `## Behavioral Contracts`, `## Verification Properties`, `## Tasks`, `## Implementation Strategy` (from-scratch | gene-transfusion), `## Dependencies`, `## Wave`.
...
1. All 10 sections present per story file.
...
**Source metadata:** `plugins/vsdd-factory/rules/spec-format.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 153–184
