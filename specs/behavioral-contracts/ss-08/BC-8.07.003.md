...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/extraction-validation-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1861
section: "Brownfield, discovery, extraction templates"
type: template
---

# Behavioral Contract BC-8.07.003: extraction-validation-template: brownfield extraction validation

## Description

Frontmatter `document_type: extraction-validation`, `level: ops`. Required: `## Phase 1 — Behavioral Verification`, `## Phase 2 — Metric Verification`, `## Refinement Iterations: [N]/3`, `## Inaccurate Items (Corrected)`, `## Hallucinated Items (Removed)`, `## Unverifiable Items`, `## Confidence Assessment`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/extraction-validation-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 7 `##` headings present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/extraction-validation-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/extraction-validation-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
