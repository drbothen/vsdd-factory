...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/discovery-report-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1865
section: "Brownfield, discovery, extraction templates"
type: template
---

# Behavioral Contract BC-8.07.007: discovery-report-template: discovery-engine periodic report

## Description

Frontmatter `document_type: discovery-report`, `date: YYYY-MM-DD`. Required: `## Summary`, `## Overall Health: [ACTIVE / QUIET / STALE]`, `## Customer Intelligence Summary`, `## Feature Discovery Results`, `## Product Discovery Results`, `## Rejected Ideas (Below Threshold)`, `## Deduplication Log`, `## Trend Analysis (Last 5 Runs)`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/discovery-report-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 8 `##` headings present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/discovery-report-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/discovery-report-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
