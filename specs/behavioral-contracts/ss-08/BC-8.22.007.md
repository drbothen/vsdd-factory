...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2225
section: "Rules: git-commits (Conventional Commits, no AI attribution)"
type: rule
---

# Behavioral Contract BC-8.22.007: rules/git-commits.md: breaking changes — `!` after type/scope OR `BREAKING CHANGE:` footer

## Description

Indicate breaking change with `!` after type/scope (`feat(api)!: remove endpoint`) OR with `BREAKING CHANGE:` footer.
...
1. Breaking changes use one of the two markers.
...
**Source metadata:** `plugins/vsdd-factory/rules/git-commits.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 53–57
