...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/ui-quality/gate-report-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1891
section: "Design system and UI quality templates"
type: template
---

# Behavioral Contract BC-8.12.007: ui-quality/gate-report-template: 4-gate-level UI quality gate

## Description

Per-gate-level UI quality report. Gate levels enumerated: `per-story | wave | build | convergence`. Result `PASS / FAIL`. Sections: `## Checklist` with subtables for `### Design System Compliance` (token / component / pattern compliance), `### Completeness` (screen / state / interaction / responsive coverage at 4 breakpoints), `### Quality`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/ui-quality/gate-report-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All checklist headings present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/ui-quality/gate-report-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/ui-quality/gate-report-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–25
