...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1806
section: "Spec hierarchy templates (L1 through L4)"
type: template
---

# Behavioral Contract BC-8.01.007: L2-domain-spec-index-template: required sections

## Description

Required sections: `## Domain Summary`, `## Document Map`, `## Cross-References`, `## ID Registry Summary`, `## Priority Distribution`.
...
**Source metadata:** `plugins/vsdd-factory/templates/L2-domain-spec-index-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** body
