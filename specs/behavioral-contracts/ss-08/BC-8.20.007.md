...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2207
section: "Rules: bash (no stderr suppression, no eval, dependency checks)"
type: rule
---

# Behavioral Contract BC-8.20.007: rules/bash.md: test headers SHALL state accurate test counts
...
1. Header count == actual test count.
...
**Source metadata:** `plugins/vsdd-factory/rules/bash.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 106–108
