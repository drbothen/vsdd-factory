...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2218
section: "Rules: factory-protocol (.factory worktree, governance)"
type: rule
---

# Behavioral Contract BC-8.21.008: rules/factory-protocol.md: specs are the product, code is disposable (SOUL.md #3 reified)

## Description

If specs and code conflict, the spec wins. Code can be regenerated from spec; spec cannot be regenerated from code.
...
1. Spec-vs-code conflicts resolved in spec's favor.
...
**Source metadata:** `plugins/vsdd-factory/rules/factory-protocol.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 81
