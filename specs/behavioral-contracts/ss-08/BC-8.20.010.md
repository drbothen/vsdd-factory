...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2210
section: "Rules: bash (no stderr suppression, no eval, dependency checks)"
type: rule
---

# Behavioral Contract BC-8.20.010: rules/bash.md: `just ci` MUST run the same commands as `.github/workflows/ci.yml`
...
1. ci.yml + justfile comparison shows command parity (or documented divergence).
...
**Source metadata:** `plugins/vsdd-factory/rules/bash.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 118–120
