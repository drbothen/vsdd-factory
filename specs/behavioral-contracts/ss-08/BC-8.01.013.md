...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/prd-supplement-nfr-catalog-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1812
section: "Spec hierarchy templates (L1 through L4)"
type: template
---

# Behavioral Contract BC-8.01.013: prd-supplement-nfr-catalog-template: PRD non-functional requirements supplement

## Description

Frontmatter `document_type: prd-supplement-nfr-catalog`, `level: L3`. Sections: `## NFR Registry`, `## NFR Categories`, `## NFR-to-Module Mapping`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/prd-supplement-nfr-catalog-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/prd-supplement-nfr-catalog-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/prd-supplement-nfr-catalog-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
