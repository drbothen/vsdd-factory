...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/L2-domain-spec-index-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1805
section: "Spec hierarchy templates (L1 through L4)"
type: template
---

# Behavioral Contract BC-8.01.006: L2-domain-spec-index-template: sharded L2 index identity

## Description

Index document for the sharded L2 domain spec. Frontmatter `document_type: domain-spec-index`, `level: L2`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/L2-domain-spec-index-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Frontmatter present; `## Document Map`, `## Cross-References`, `## ID Registry Summary`, `## Priority Distribution` headings present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/L2-domain-spec-index-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/L2-domain-spec-index-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
