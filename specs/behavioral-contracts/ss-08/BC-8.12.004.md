...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/design-system/components/{component-registry.yaml, contracts/{alert,button,card,data-table,dropdown,form-field,list,modal,navigation,tabs,toast}.yaml}"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1888
section: "Design system and UI quality templates"
type: template
---

# Behavioral Contract BC-8.12.004: design-system/components/: registry + 11 component contracts

## Description

`component-registry.yaml` is the index; 11 per-component contract YAMLs declare props / states / accessibility / visual / interaction contracts. Pattern: 1 registry + 11 contracts.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/design-system/components/{component-registry.yaml, contracts/{alert,button,card,data-table,dropdown,form-field,list,modal,navigation,tabs,toast}.yaml}` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 12 files present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/design-system/components/{component-registry.yaml, contracts/{alert,button,card,data-table,dropdown,form-field,list,modal,navigation,tabs,toast}.yaml}` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/design-system/components/{component-registry.yaml, contracts/{alert,button,card,data-table,dropdown,form-field,list,modal,navigation,tabs,toast}.yaml}` | **Type:** template | **Confidence:** HIGH | **Source line(s):** dir listing (1 + 11 files)
