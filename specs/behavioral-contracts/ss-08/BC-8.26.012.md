...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2272
section: "Rules: story-completeness (14-check audit)"
type: rule
---

# Behavioral Contract BC-8.26.012: rules/story-completeness.md: check 11 — `.claude/rules/_index.md` references EXACTLY the rules files that exist

## Description

Check 11: The `.claude/rules/_index.md` deliverable must reference EXACTLY the rules files that exist — no more, no fewer.
...
1. _index.md `@-references` count equals existing rules files count.
...
**Source metadata:** `plugins/vsdd-factory/rules/story-completeness.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 92–94
