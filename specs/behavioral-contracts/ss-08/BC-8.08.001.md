...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/demo-evidence-report-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1869
section: "Demo evidence templates"
type: template
---

# Behavioral Contract BC-8.08.001: demo-evidence-report-template: per-product demo evidence rollup

## Description

Frontmatter `document_type: demo-evidence-report`, `product: "{product_name}"`. Required: `## Product`, `## Pipeline Run`, `## Demo Type`, `## Per-AC Demo Recordings`, `## Full User Journey Demo`, `## Holdout Scenario Demos`, `## Visual Review Summary`, `## Regression Comparison (Feature Mode)`, `## Toolchain`, `## PR Embedding Snippet`, `## Notes`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/demo-evidence-report-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 11 `##` headings present (Regression Comparison optional / feature-mode-only).
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/demo-evidence-report-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/demo-evidence-report-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
