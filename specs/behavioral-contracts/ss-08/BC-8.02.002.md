...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1818
section: "Story, epic, and cycle templates"
type: template
---

# Behavioral Contract BC-8.02.002: story-template: required sections (10 mandatory)
...
1. Sections present per the audit checklist in `rules/story-completeness.md` (14 checks; see BC-AUDIT-2271..2284).
...
**Source metadata:** `plugins/vsdd-factory/templates/story-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** body headings
