...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/product-brief-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1800
section: "Spec hierarchy templates (L1 through L4)"
type: template
---

# Behavioral Contract BC-8.01.001: product-brief-template: governs L1 Product Brief artifact identity

## Description

Defines the canonical structure for Level-1 Product Brief documents — the human-input apex of the spec hierarchy. Frontmatter `document_type: product-brief` and `level: L1`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/product-brief-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. A document with frontmatter `document_type: product-brief` and the headings below validates against this template.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/product-brief-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/product-brief-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–4 (frontmatter), 8 (title)
