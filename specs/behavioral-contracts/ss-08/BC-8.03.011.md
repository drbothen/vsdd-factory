...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/recovered-architecture-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1834
section: "Architecture templates"
type: template
---

# Behavioral Contract BC-8.03.011: recovered-architecture-template: brownfield recovered architecture

## Description

Phase-0b output. Title `# Recovered Architecture: [PROJECT_NAME]`. Required: `## Components`, `## Component Map (Machine-Readable)`, `## Layers`, `## Dependencies (DAG)`, `## API Surface`, `## Data Models`, `## Integration Points`, `## Technology Stack`, `## Architecture Smells (Detected)`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/recovered-architecture-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/recovered-architecture-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/recovered-architecture-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
