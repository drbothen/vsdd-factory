...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/code-review-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1842
section: "Adversarial-review templates"
type: template
---

# Behavioral Contract BC-8.04.008: code-review-template: code-reviewer per-pass output

## Description

Frontmatter `document_type: code-review`, `level: ops`. Title `# Code Review: [Project Name] (Pass [N])`. Required: `## Part A — Fix Verification (pass >= 2 only)`, `## Part B — Findings`, `## Summary`, `## Convergence Verdict`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/code-review-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/code-review-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/code-review-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
