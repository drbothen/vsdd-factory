...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/security-review-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1876
section: "Verification and report templates"
type: template
---

# Behavioral Contract BC-8.09.004: security-review-template: security-review per-pass output

## Description

Frontmatter `document_type: security-review`, `level: ops`. Required: `## Executive Summary`, `## Findings`, `## Summary Table`, `## Positive Findings (Defensive Measures Present)`, `## Recommendations Priority`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/security-review-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/security-review-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/security-review-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
