...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/consistency-validation-report-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1856
section: "Convergence and traceability templates"
type: template
---

# Behavioral Contract BC-8.06.004: consistency-validation-report-template: minimal consistency-validation gate output

## Description

Slim variant of consistency-report. Frontmatter `document_type: consistency-validation-report`, `level: ops`. Required: `## Summary`, `## Detailed Findings`, `## Validation Gate: PASS | FAIL`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/consistency-validation-report-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/consistency-validation-report-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/consistency-validation-report-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
