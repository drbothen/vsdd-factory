...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2224
section: "Rules: git-commits (Conventional Commits, no AI attribution)"
type: rule
---

# Behavioral Contract BC-8.22.006: rules/git-commits.md: footers — `Refs:`, `Closes:`, `BREAKING CHANGE:`

## Description

`Refs: #123` (issue references); `Closes: #123` (issues closed); `BREAKING CHANGE:` (breaking change description).
...
**Source metadata:** `plugins/vsdd-factory/rules/git-commits.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 48–51
