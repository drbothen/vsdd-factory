...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/dtu-fidelity-report-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1880
section: "DTU (Digital Twin Universe) templates"
type: template
---

# Behavioral Contract BC-8.10.003: dtu-fidelity-report-template: DTU clone fidelity report

## Description

Frontmatter `document_type: dtu-fidelity-report`, `service_name: "[Service Name]"`. Required: `## Summary`, `## Endpoint Comparison`, `## State Transition Tests (L2+)`, `## Error Response Tests (L3+)`, `## Failure Injection Tests (L4)`, `## Deltas Requiring Attention`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/dtu-fidelity-report-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/dtu-fidelity-report-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/dtu-fidelity-report-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
