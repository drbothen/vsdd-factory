...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/ui-traceability-template.yaml"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1895
section: "Design system and UI quality templates"
type: template
---

# Behavioral Contract BC-8.12.011: ui-traceability-template: UI element → story → component → test → visual evidence matrix

## Description

Maintained by `ui-completeness-check` skill. Top-level keys: `version`, `product`, `last_updated`, `last_check`, `summary` (screens_specified / implemented / verified / fidelity_score / total_gaps), `screens[]` (each with id SCR-NNN, name, ux_spec_ref, wireframe_ref, story_ids, status enum {specified | story-created | implemented | tested | verified}, components[]).

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/ui-traceability-template.yaml` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Top-level keys present; status enum value valid.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/ui-traceability-template.yaml` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/ui-traceability-template.yaml` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–30
