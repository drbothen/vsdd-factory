...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2223
section: "Rules: git-commits (Conventional Commits, no AI attribution)"
type: rule
---

# Behavioral Contract BC-8.22.005: rules/git-commits.md: body separated from description with blank line; explains motivation + previous behavior contrast

## Description

Body is optional; when present, separated from description by blank line; explains motivation and contrasts with previous behavior.
...
**Source metadata:** `plugins/vsdd-factory/rules/git-commits.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 42–46
