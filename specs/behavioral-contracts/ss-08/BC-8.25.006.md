...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2254
section: "Rules: step-decomposition (VSDD phase 0-7 protocol)"
type: rule
---

# Behavioral Contract BC-8.25.006: rules/step-decomposition.md: step file structure includes `_shared-context.md` + per-step files

## Description

Per-step-decomposed skill: `skills/<work-skill>/steps/{_shared-context.md, step-a-<name>.md, step-b-<name>.md, ...}`. Every step file has frontmatter (`name`, `description`), opens with shared-context reference, contains FULL procedural content (no "see parent" deferrals for load-bearing clauses), ends with Artifacts/Commit message/Success Criteria sections.
...
1. Each decomposed skill has matching layout.
...
**Source metadata:** `plugins/vsdd-factory/rules/step-decomposition.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 95–107
