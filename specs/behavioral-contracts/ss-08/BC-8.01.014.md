...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/prd-supplement-test-vectors-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1813
section: "Spec hierarchy templates (L1 through L4)"
type: template
---

# Behavioral Contract BC-8.01.014: prd-supplement-test-vectors-template: canonical test vectors supplement

## Description

Frontmatter `document_type: prd-supplement-test-vectors`, `level: L3`. Sections: `## Per-Subsystem Test Vectors`, `## Cross-Subsystem Integration Vectors`, `## Golden File References`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/prd-supplement-test-vectors-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/prd-supplement-test-vectors-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/prd-supplement-test-vectors-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
