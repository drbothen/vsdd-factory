...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/ux-spec-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1881
section: "UX templates"
type: template
---

# Behavioral Contract BC-8.11.001: ux-spec-template: deprecated monolithic UX spec

## Description

DEPRECATED in favor of sharded ux-spec-index + screen + flow templates. Retained for reference. Sections: 1. Design System References, 2. Screen Definitions, 3. Interaction Flows, 4. Responsive Breakpoints, 5. Contextual Variants, 6. Accessibility Checklist, 7. Performance Targets.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/ux-spec-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. File begins with `<!-- DEPRECATED -->` comment.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/ux-spec-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/ux-spec-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3 (DEPRECATED comment)
