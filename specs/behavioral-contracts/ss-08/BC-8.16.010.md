...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/sweep-report-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1921
section: "Discovery, project, config templates"
type: template
---

# Behavioral Contract BC-8.16.010: sweep-report-template: maintenance sweep report

## Description

Frontmatter `document_type: maintenance-sweep-report`, `date: YYYY-MM-DD`. Required: `## Summary`, `## Overall Health: [HEALTHY / NEEDS_ATTENTION / DEGRADED]`, `## Dependency Audit`, `## Documentation Drift`, `## Pattern Consistency`, `## Holdout Scenario Freshness`, `## Performance Baseline`, `## Trend (Last 5 Sweeps)`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/sweep-report-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/sweep-report-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/sweep-report-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
