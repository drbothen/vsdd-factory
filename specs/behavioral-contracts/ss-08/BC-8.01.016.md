...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1815
section: "Spec hierarchy templates (L1 through L4)"
type: template
---

# Behavioral Contract BC-8.01.016: behavioral-contract-template: optional anchor sections

## Description

Recommended (not required) sections: `## Related BCs`, `## Architecture Anchors`, `## Story Anchor`, `## VP Anchors`. These enable forward/back traceability per `rules/spec-format.md`.
...
1. Sections present iff the BC has corresponding traceability data; absence does not invalidate.
...
**Source metadata:** `plugins/vsdd-factory/templates/behavioral-contract-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** body (Recommended subsections)
