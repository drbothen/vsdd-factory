...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2251
section: "Rules: step-decomposition (VSDD phase 0-7 protocol)"
type: rule
---

# Behavioral Contract BC-8.25.003: rules/step-decomposition.md: every phase has exactly two skill entry points (work skill + phase entry-point skill)

## Description

Two entry points: 1) **work skill** — functional name, command target (e.g., `/vsdd-factory:brownfield-ingest`); 2) **phase entry-point skill** — phase-numbered, lobster target (e.g., `phase-0-codebase-ingestion`). Phase entry-point skills are NOT command targets.
...
1. Each phase has both skill types in `skills/`.
...
**Source metadata:** `plugins/vsdd-factory/rules/step-decomposition.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 30
