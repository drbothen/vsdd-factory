...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/verification-gap-analysis-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1833
section: "Architecture templates"
type: template
---

# Behavioral Contract BC-8.03.010: verification-gap-analysis-template: brownfield verification gap report

## Description

Phase-0 verification gap analysis. Title `# Verification Gap Analysis: [PROJECT_NAME]`. Required: `## Test Coverage Baseline`, `## Purity Assessment`, `## Formal Verification Readiness`, `## Security Posture`, `## Mutation Testing Baseline`, `## Identified Gaps`, `## Remediation Plan`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/verification-gap-analysis-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/verification-gap-analysis-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/verification-gap-analysis-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
