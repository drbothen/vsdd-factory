...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2234
section: "Rules: rust (forbid unsafe, edition, lints)"
type: rule
---

# Behavioral Contract BC-8.23.007: rules/rust.md: dependencies declared at workspace level; Edition 2024, MSRV 1.85+; clippy warnings are errors

## Description

Workspace-level dependency declarations in root `Cargo.toml`. `edition = "2024"`. MSRV 1.85+. Use `cargo clippy -- -D warnings` — warnings are errors.
...
1. Dependencies in root manifest; Edition 2024; CI runs clippy with `-D warnings`.
...
**Source metadata:** `plugins/vsdd-factory/rules/rust.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 38–42
