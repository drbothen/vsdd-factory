...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/ux-spec-flow-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1884
section: "UX templates"
type: template
---

# Behavioral Contract BC-8.11.004: ux-spec-flow-template: per-flow FLOW-NNN spec

## Description

Frontmatter `document_type: ux-spec-flow`, `flow_id: "FLOW-NNN"`. Required: `## Flow Diagram`, `## Flow Steps`, `## Error Scenarios`, `## Screen References`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/ux-spec-flow-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/ux-spec-flow-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/ux-spec-flow-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
