...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2239
section: "Rules: spec-format (4-level hierarchy, BC/VP shape)"
type: rule
---

# Behavioral Contract BC-8.24.003: rules/spec-format.md: BC file format SHALL contain Subsystem/Section/Contract/Preconditions/Postconditions/Error Cases/Verification/Traceability sections

## Description

Per-BC file: `# BC-S.SS.NNN: <Title>`, `## Subsystem`, `## Section`, `## Contract` (clear testable statement), `## Preconditions`, `## Postconditions`, `## Error Cases`, `## Verification` (specific not vague), `## Traceability` (PRD/Stories/VPs refs).
...
1. All 8 sections present per BC file.
...
**Source metadata:** `plugins/vsdd-factory/rules/spec-format.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 24–53
