...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2214
section: "Rules: factory-protocol (.factory worktree, governance)"
type: rule
---

# Behavioral Contract BC-8.21.004: rules/factory-protocol.md: file lifecycle classification (Living / Accumulating / Cycle-scoped / Critical)
...
1. File-handling treats each category per its lifecycle.
...
**Source metadata:** `plugins/vsdd-factory/rules/factory-protocol.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 65–74
