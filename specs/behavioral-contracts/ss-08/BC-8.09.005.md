...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/security-scan-report-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1877
section: "Verification and report templates"
type: template
---

# Behavioral Contract BC-8.09.005: security-scan-report-template: static-analysis security scan

## Description

Frontmatter `document_type: security-scan-report`, `level: ops`. Required: `## Executive Summary`, `## 1. Vulnerability Scan`, `## 2. Unsafe Code Scan`, `## 3. Purity Enforcement`, `## 4. Dependency Review`, `## 5. License Compatibility`, `## Findings Summary`, `## Tool Versions`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/security-scan-report-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/security-scan-report-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/security-scan-report-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
