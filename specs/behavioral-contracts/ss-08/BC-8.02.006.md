...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/epic-index-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1822
section: "Story, epic, and cycle templates"
type: template
---

# Behavioral Contract BC-8.02.006: epic-index-template: EPIC-INDEX identity + epic-to-capability mapping

## Description

Epic index. Frontmatter `document_type: epic-index`, `level: ops`. Required: `## Epic-to-Capability Mapping`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/epic-index-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Frontmatter present; section heading present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/epic-index-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/epic-index-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3, 5
