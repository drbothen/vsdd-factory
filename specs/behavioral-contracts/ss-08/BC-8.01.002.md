...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1801
section: "Spec hierarchy templates (L1 through L4)"
type: template
---

# Behavioral Contract BC-8.01.002: product-brief-template: required frontmatter fields

## Description

Frontmatter MUST contain `document_type: product-brief` and `level: L1`.
...
1. YAML parser sees both keys with the listed values.
...
**Source metadata:** `plugins/vsdd-factory/templates/product-brief-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–4
