...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/verification-coverage-matrix-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1832
section: "Architecture templates"
type: template
---

# Behavioral Contract BC-8.03.009: verification-coverage-matrix-template: coverage matrix shard

## Description

Frontmatter `document_type: architecture-section`, `level: L3`. Required: `## Coverage by Module`, `## Summary by Method`, `## Coverage Gaps`, `## Domain Invariant Verification Map`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/verification-coverage-matrix-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/verification-coverage-matrix-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/verification-coverage-matrix-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
