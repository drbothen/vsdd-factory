...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2271
section: "Rules: story-completeness (14-check audit)"
type: rule
---

# Behavioral Contract BC-8.26.011: rules/story-completeness.md: check 10 — shell/script rules addressed (or `bash.md` excluded if no shell)

## Description

Check 10: If the project has no shell scripts, EXPLICITLY state that and exclude `bash.md` from rules. Don't leave the implementer wondering which rules files apply.
...
1. Story addresses shell rules or excludes them.
...
**Source metadata:** `plugins/vsdd-factory/rules/story-completeness.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 88–90
