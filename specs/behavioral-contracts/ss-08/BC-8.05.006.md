...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/holdout-evaluation-report-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1852
section: "Holdout-evaluation templates"
type: template
---

# Behavioral Contract BC-8.05.006: holdout-evaluation-report-template: cycle-level holdout report

## Description

Frontmatter `document_type: holdout-evaluation-report`, `level: ops`. Required: `## Overall Metrics`, `## Per-Scenario Scores`, `## Low-Satisfaction Scenarios (score < 0.85)`, `## Evidence Summary`, `## Final Verdict`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/holdout-evaluation-report-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/holdout-evaluation-report-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/holdout-evaluation-report-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
