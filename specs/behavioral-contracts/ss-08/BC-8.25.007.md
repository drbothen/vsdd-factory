...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2255
section: "Rules: step-decomposition (VSDD phase 0-7 protocol)"
type: rule
---

# Behavioral Contract BC-8.25.007: rules/step-decomposition.md: lobster step `name:` MUST match the step file ID (without `step-` prefix)

## Description

Lobster step name fields must match step file ID without `step-` prefix. Example: `name: broad-sweep` matches `step-a-broad-sweep.md`. State-manager backups follow `name: backup-<step-name>` pattern.
...
1. Cross-reference between lobster step names and step files passes (bats structural test).
...
**Source metadata:** `plugins/vsdd-factory/rules/step-decomposition.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 109–119
