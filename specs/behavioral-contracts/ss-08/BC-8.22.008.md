...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2226
section: "Rules: git-commits (Conventional Commits, no AI attribution)"
type: rule
---

# Behavioral Contract BC-8.22.008: rules/git-commits.md: NEVER include AI attribution in commit messages

## Description

Do NOT include: "Generated with Claude Code" line; "Co-Authored-By: Claude" line; any other AI attribution. Enforced by `block-ai-attribution.sh` hook (BC-AUDIT-063).
...
1. Each commit message scanned by block-ai-attribution; no AI strings present.
...
**Source metadata:** `plugins/vsdd-factory/rules/git-commits.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 59–64
