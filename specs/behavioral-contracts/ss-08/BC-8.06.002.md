...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/convergence-report-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1854
section: "Convergence and traceability templates"
type: template
---

# Behavioral Contract BC-8.06.002: convergence-report-template: 7 named dimensions

## Description

Dimension catalog (verbatim): D1 Spec Convergence, D2 Test Convergence, D3 Implementation Convergence, D4 Verification Convergence, D5 Holdout Scenario Convergence, D6 L3 BC Convergence, D7 L4 VP Convergence. Adversarial Convergence Metrics is a cross-cutting section between D3 and D4.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/convergence-report-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 7 `## Dimension N: <Name>` headings present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/convergence-report-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/convergence-report-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** body headings
