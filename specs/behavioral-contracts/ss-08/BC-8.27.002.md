...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2278
section: "Rules: worktree-protocol (branch hierarchy, merge protocol)"
type: rule
---

# Behavioral Contract BC-8.27.002: rules/worktree-protocol.md: story worktrees live in `.worktrees/STORY-NNN/`

## Description

All story worktrees live in `.worktrees/` at project root, one subdir per story. `.worktrees/STORY-001/` etc. (gitignored — ephemeral, not tracked).
...
1. Worktrees match `.worktrees/STORY-\d+/`.
...
**Source metadata:** `plugins/vsdd-factory/rules/worktree-protocol.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 17–28
