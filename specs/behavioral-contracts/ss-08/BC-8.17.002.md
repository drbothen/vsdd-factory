...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/skill-delegation-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1927
section: "Skill and agent file templates"
type: template
---

# Behavioral Contract BC-8.17.002: skill-delegation-template: SKILL.md (delegation variant) shape

## Description

SKILL.md scaffold for delegation/phase-entry skills. Required: `## Prerequisites`, `## Steps`, `## Quality Gate`, `## Failure & Escalation`, `## Output Artifacts`, `## Remediation Sequencing`. Title `# [Phase/Capability Name]`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/skill-delegation-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/skill-delegation-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/skill-delegation-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–4 (HTML comment header)
