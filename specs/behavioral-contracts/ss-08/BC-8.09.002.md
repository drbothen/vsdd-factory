...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/fuzz-report-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1874
section: "Verification and report templates"
type: template
---

# Behavioral Contract BC-8.09.002: fuzz-report-template: fuzz testing per-target report

## Description

Frontmatter `document_type: fuzz-report`, `level: ops`. Required: `## Summary`, `## Fuzz Targets`, `## Results Detail`, `## Corpus Summary`, `## Recommendations`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/fuzz-report-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/fuzz-report-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/fuzz-report-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
