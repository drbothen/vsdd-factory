...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/evaluation-summary-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1851
section: "Holdout-evaluation templates"
type: template
---

# Behavioral Contract BC-8.05.005: evaluation-summary-template: holdout evaluation final summary

## Description

Frontmatter `document_type: evaluation-summary`, `level: ops`. Required: `## Final Verdict: [PASS / FAIL]`, `## Aggregate Metrics`, `## Passes Required: [N]`, `## Scenario Results (Final)`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/evaluation-summary-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/evaluation-summary-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/evaluation-summary-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
