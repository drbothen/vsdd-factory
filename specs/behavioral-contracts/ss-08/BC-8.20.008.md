...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2208
section: "Rules: bash (no stderr suppression, no eval, dependency checks)"
type: rule
---

# Behavioral Contract BC-8.20.008: rules/bash.md: file-path references SHALL be validated by structural tests
...
1. Each doc-referenced path has a corresponding structural-test assertion.
...
**Source metadata:** `plugins/vsdd-factory/rules/bash.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 110–112
