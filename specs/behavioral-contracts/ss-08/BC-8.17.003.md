...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/agents-md-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1928
section: "Skill and agent file templates"
type: template
---

# Behavioral Contract BC-8.17.003: agents-md-template: AGENTS.md shape

## Description

Agent persona doc scaffold. Required: `## Contract`, `## Constraints`, `## Context Discipline`, `## Failure & Escalation`, `## Reporting`, `## Information Wall`, `## Tool Access`, `## Remember`. Title `# [Agent Name]`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/agents-md-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/agents-md-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/agents-md-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–4 (HTML comment header)
