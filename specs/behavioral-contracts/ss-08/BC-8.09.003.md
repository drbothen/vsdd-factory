...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/performance-report-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1875
section: "Verification and report templates"
type: template
---

# Behavioral Contract BC-8.09.003: performance-report-template: perf-check pass output

## Description

Frontmatter `document_type: performance-report`, `level: ops`. Required: `## Summary`, `## Benchmark Results`, `## Regressions Detected`, `## Recommendations`, `## Gate: PASS | WARN | FAIL`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/performance-report-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/performance-report-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/performance-report-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
