...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/dtu-clone-spec-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1879
section: "DTU (Digital Twin Universe) templates"
type: template
---

# Behavioral Contract BC-8.10.002: dtu-clone-spec-template: per-service DTU clone specification

## Description

Frontmatter `document_type: dtu-clone-spec`, `service_name: "[Service Name]"`. Required: `## Service Identity`, `## Endpoints Used by SUT`, `## State Model (L2+)`, `## Error Responses (L3+)`, `## Behavioral Sequences (L3+)`, `## Failure Injection (L4)`, `## Deterministic Mode`, `## Clone Validation`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/dtu-clone-spec-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/dtu-clone-spec-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/dtu-clone-spec-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
