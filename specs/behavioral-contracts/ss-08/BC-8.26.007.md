...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2267
section: "Rules: story-completeness (14-check audit)"
type: rule
---

# Behavioral Contract BC-8.26.007: rules/story-completeness.md: check 6 — hosting/infra decisions explicit (org/repo/visibility/branch-strategy/protection/secrets)

## Description

Check 6: State (don't imply): GitHub org and repo name, visibility (public/private), branch strategy (Git Flow vs trunk-based), branch protection / rulesets (with exact required status checks), required secrets (with setup instructions).
...
1. All 5 hosting decisions explicit.
...
**Source metadata:** `plugins/vsdd-factory/rules/story-completeness.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 52–60
