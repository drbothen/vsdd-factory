...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/convergence-trajectory-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1840
section: "Adversarial-review templates"
type: template
---

# Behavioral Contract BC-8.04.006: convergence-trajectory-template: pass-by-pass finding trajectory

## Description

Frontmatter `document_type: convergence-trajectory`, `level: ops`. Required: `## Finding Progression`, `## Trajectory Shorthand`, `## Per-Pass Details`, `## Frontmatter Fields (extracted from STATE.md)`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/convergence-trajectory-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/convergence-trajectory-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/convergence-trajectory-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
