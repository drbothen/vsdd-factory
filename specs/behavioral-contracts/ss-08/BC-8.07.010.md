...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/delta-analysis-report-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1868
section: "Brownfield, discovery, extraction templates"
type: template
---

# Behavioral Contract BC-8.07.010: delta-analysis-report-template: feature-mode delta analysis

## Description

Frontmatter `document_type: delta-analysis-report`, `feature_name: "[Feature Name]"`. Required: `## Feature Request`, `## Classifications`, `## Impact Assessment`, `## Files Changed`, `## Files NOT Changed (Regression Baseline)`, `## Risk Assessment`, `## Regression Baseline`, `## Scope Recommendation`, `## Open Questions`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/delta-analysis-report-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 9 `##` headings present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/delta-analysis-report-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/delta-analysis-report-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
