...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/session-checkpoints-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1903
section: "State and workflow templates"
type: template
---

# Behavioral Contract BC-8.14.004: session-checkpoints-template: cycle session resume checkpoints

## Description

Frontmatter `document_type: session-checkpoints`, `level: ops`. Required: `## Session Resume Checkpoint (YYYY-MM-DD) — [position label]` per checkpoint, accumulating.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/session-checkpoints-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Frontmatter present; at least one checkpoint heading.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/session-checkpoints-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/session-checkpoints-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
