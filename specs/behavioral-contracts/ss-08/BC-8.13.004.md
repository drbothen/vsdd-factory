...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/design-drift-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1899
section: "Spec lifecycle templates (changelog, drift, withdrawal, gates)"
type: template
---

# Behavioral Contract BC-8.13.004: design-drift-template: design-drift detection report

## Description

Frontmatter `document_type: design-drift-report`, `level: ops`. Required: `## Token Overrides: [N] found`, `## Component Misuse: [N] found`, `## Pattern Violations: [N] found`, `## Emergent Patterns: [N] detected`, `## Style Inconsistencies: [N] found`, `## Fix Actions`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/design-drift-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/design-drift-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/design-drift-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
