...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/state-manager-checklist-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1901
section: "State and workflow templates"
type: template
---

# Behavioral Contract BC-8.14.002: state-manager-checklist-template: wave-gate remediation-burst checklist
...
1. Template file at `plugins/vsdd-factory/templates/state-manager-checklist-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 12 `##` headings present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/state-manager-checklist-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/state-manager-checklist-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
