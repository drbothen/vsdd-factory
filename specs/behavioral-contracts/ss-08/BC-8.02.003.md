...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/story-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1819
section: "Story, epic, and cycle templates"
type: template
---

# Behavioral Contract BC-8.02.003: story-template: optional planning + ASM/R + lifecycle frontmatter blocks

## Description

Frontmatter MAY include `planning extensions (optional v1.1)`, `ASM/R traceability (optional)`, and `lifecycle fields (DF-030)`. Stories adopting wave scheduling, ASM/R back-link, or lifecycle gating fill these blocks.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/story-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Optional blocks parseable as YAML when present; absence does not invalidate.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/story-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/story-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 5–9 (planning extensions v1.1), 11+ (ASM/R traceability), 13+ (lifecycle DF-030)
