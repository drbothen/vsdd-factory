...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/architecture-index-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1828
section: "Architecture templates"
type: template
---

# Behavioral Contract BC-8.03.005: architecture-index-template: ARCH-INDEX governs sharded architecture index

## Description

Sharded architecture index. Frontmatter `document_type: architecture-index`, `level: L3`. Required: `## Document Map`, `## Cross-References`, `## Subsystem Registry`, `## Architecture Decisions`. If multi-service, `system-overview.md` MUST include a `Service Boundaries` section (orchestrator routes single-repo vs multi-repo from this).

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/architecture-index-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 4 sections present; multi-service condition checked when applicable.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/architecture-index-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/architecture-index-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–4 (frontmatter + multi-service comment)
