...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/evaluation-per-scenario-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1849
section: "Holdout-evaluation templates"
type: template
---

# Behavioral Contract BC-8.05.003: evaluation-per-scenario-template: HS-NNN per-scenario evaluation

## Description

Frontmatter `document_type: holdout-evaluation`, `level: ops`. Title `# Evaluation: HS-NNN -- [Scenario Title] (Pass [N])`. Required: `## Scenario Summary`, `## 5-Dimension Rubric Scores`, `## Weighted Score: 0.00`, `## Edge Conditions Tested`, `## Verdict`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/evaluation-per-scenario-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/evaluation-per-scenario-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/evaluation-per-scenario-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
