...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-1.md#L141"
subsystem: SS-06
capability: "TBD"
...
# Behavioral Contract BC-6.04.003: adversarial-review: minimum 3 consecutive clean passes for convergence

> Source: `pass-3-deep-skills-batch-1.md` line 141 (was `BC-AUDIT-208`)
> Subsystem: SS-06 — Skill Catalog
> Section: Adversarial and review skills

## Description

adversarial-review: minimum 3 consecutive clean passes for convergence. Convergence requires 3 consecutive clean passes (not 2). Maximum 10 passes before escalating to human. Minimum 3 enforced even when "Novelty is LOW after one pass.".

## Preconditions

1. Adversary returns "no findings" or low-novelty findings on a pass

## Postconditions

1. Pass count >=3 AND last 3 passes report no substantive findings before convergence is declared.
...
- `architecture/ss-06-skill-catalog.md#adversarial-review-minimum-3-consecutive-clean-passes-for-convergence` — TBD anchor
...
| **Source line(s) within skill** | 39-40, 165-168 |
