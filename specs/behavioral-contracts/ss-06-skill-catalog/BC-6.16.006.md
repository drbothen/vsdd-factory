...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-480"
ss_section: "Phase orchestration and mode skills"
skill: "next-step"
---

# Behavioral Contract BC-6.16.006: next-step: Identity — read STATE.md and propose next workflow step, do not execute

## Description

Cross-references pipeline state with workflow data. Reads STATE.md, determines mode/phase, resolves workflow file, enumerates completed steps, finds first uncompleted step with satisfied dependencies, reports proposal. Acceptance: Frontmatter `name: next-step`.

## Preconditions

1. Resuming work on an in-flight pipeline.

## Postconditions

1. Cross-references pipeline state with workflow data. Reads STATE.md, determines mode/phase, resolves workflow file, enumerates completed steps, finds first uncompleted step with satisfied dependencies, reports proposal.

## Invariants

1. Frontmatter `name: next-step`.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/next-step/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-480 |
| **Source Line(s)** | 1-5 |
