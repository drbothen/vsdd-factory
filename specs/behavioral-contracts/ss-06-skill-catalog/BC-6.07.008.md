...
|--------|----------|-------------|
| VP-001 | TBD — assertion derived from acceptance: "Uncovered clauses flagged with the documented severity; gap-register justification length validated." | manual |
