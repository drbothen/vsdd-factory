...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-470"
ss_section: "Brownfield, discovery, research skills"
skill: "multi-repo-phase-0-synthesis"
---

# Behavioral Contract BC-6.05.036: multi-repo-phase-0-synthesis: Identity — synthesizes per-repo ingestion outputs into unified project context

## Description

Produces 7 unified artifacts: cross-repo-dependencies.md, unified-architecture/, convention-reconciliation.md, unified-security-posture.md, cross-repo-holdout-scenarios/, project-context.md, synthesis-validation-report.md. Acceptance: Frontmatter `name: multi-repo-phase-0-synthesis`; 7 outputs declared; `gate: Human reviews and approves unified project context`.

## Preconditions

1. All per-repo ingestions complete.

## Postconditions

1. Produces 7 unified artifacts: cross-repo-dependencies.md, unified-architecture/, convention-reconciliation.md, unified-security-posture.md, cross-repo-holdout-scenarios/, project-context.md, synthesis-validation-report.md.

## Invariants

1. Frontmatter `name: multi-repo-phase-0-synthesis`; 7 outputs declared; `gate: Human reviews and approves unified project context`.
