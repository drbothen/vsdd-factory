...
validate-workflow: collects all errors (no early bail) + exit code. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-workflow/SKILL.md` (lines 26-41).
