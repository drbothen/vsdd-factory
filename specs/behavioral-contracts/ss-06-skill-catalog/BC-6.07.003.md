...
|--------|----------|-------------|
| VP-001 | TBD — assertion derived from acceptance: "No filesystem mutation observable until explicit `yes`; placeholder format matches the template literal `[TODO: populate this section per template]`." | manual |
