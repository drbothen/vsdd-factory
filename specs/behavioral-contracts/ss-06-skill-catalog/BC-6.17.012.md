...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-539"
ss_section: "Feature-mode phase skills (f1-f7)"
skill: "phase-f2-spec-evolution"
---

# Behavioral Contract BC-6.17.012: phase-f2-spec-evolution: Adversary reviews ONLY the delta (PRD + arch + VP + UX), not unchanged sections

## Description

Adversary (fresh context) reviews ONLY: PRD delta, architecture delta (if any), VP extensions, UX delta (if UI feature). Does NOT review unchanged sections. Provide only delta documents and surrounding context for coherence. Acceptance: Delta-scoped adversarial review.
...
1. Adversary (fresh context) reviews ONLY: PRD delta, architecture delta (if any), VP extensions, UX delta (if UI feature). Does NOT review unchanged sections. Provide only delta documents and surrounding context for coherence.

## Invariants

1. Delta-scoped adversarial review.
