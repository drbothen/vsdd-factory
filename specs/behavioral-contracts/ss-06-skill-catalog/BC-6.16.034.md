...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-522"
ss_section: "Phase orchestration and mode skills"
skill: "phase-6-formal-hardening"
---

# Behavioral Contract BC-6.16.034: phase-6-formal-hardening: Identity — Phase 6 entry point applying 4 verification techniques

## Description

Four steps A-D: kani-proofs, fuzz-testing, mutation-testing, security-scan. Direct command `/vsdd-factory:formal-verify`. Acceptance: Frontmatter `name: phase-6-formal-hardening`.

## Preconditions

1. Phase 5 adversarial converged + tools installed.

## Postconditions

1. Four steps A-D: kani-proofs, fuzz-testing, mutation-testing, security-scan. Direct command `/vsdd-factory:formal-verify`.

## Invariants

1. Frontmatter `name: phase-6-formal-hardening`.
