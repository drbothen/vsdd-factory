...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-471"
ss_section: "Brownfield, discovery, research skills"
skill: "multi-repo-phase-0-synthesis"
---

# Behavioral Contract BC-6.05.037: multi-repo-phase-0-synthesis: 8 sequential synthesis steps with named agent per step

## Description

Step 1 codebase-analyzer (deps), 2 architect (unified arch), 3 consistency-validator (conventions), 4 security-reviewer (security), 5 product-owner (holdout scenarios), 6 codebase-analyzer (project context), 7 adversary (review), 8 consistency-validator (validation). Acceptance: 8 steps, agent assignments.
...
1. Step 1 codebase-analyzer (deps), 2 architect (unified arch), 3 consistency-validator (conventions), 4 security-reviewer (security), 5 product-owner (holdout scenarios), 6 codebase-analyzer (project context), 7 adversary (review), 8 consistency-validator (validation).

## Invariants

1. 8 steps, agent assignments.
