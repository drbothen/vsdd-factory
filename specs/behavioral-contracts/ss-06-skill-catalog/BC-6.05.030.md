...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-451"
ss_section: "Brownfield, discovery, research skills"
skill: "market-intelligence-assessment"
---

# Behavioral Contract BC-6.05.030: market-intelligence-assessment: Identity — mandatory pre-spec gate producing GO/CAUTION/STOP

## Description

Produces GO / CAUTION / STOP recommendation. Researches competitive landscape, market size, customer pain validation, differentiation, risk signals. Acceptance: Frontmatter `name: market-intelligence-assessment`; `gate: Human reviews market intel before proceeding`.

## Preconditions

1. Before any spec work begins on a new product idea, feature request, or spec.

## Postconditions

1. Produces GO / CAUTION / STOP recommendation. Researches competitive landscape, market size, customer pain validation, differentiation, risk signals.

## Invariants

1. Frontmatter `name: market-intelligence-assessment`; `gate: Human reviews market intel before proceeding`.
