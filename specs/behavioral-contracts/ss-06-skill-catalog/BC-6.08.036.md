...
ui-completeness-check: ui-traceability.yaml schema (screens with components/interactions/responsive/a11y/perf). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ui-completeness-check/SKILL.md` (lines 36-81).
