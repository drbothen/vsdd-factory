...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-529"
ss_section: "Feature-mode phase skills (f1-f7)"
skill: "phase-f1-delta-analysis"
---

# Behavioral Contract BC-6.17.002: phase-f1-delta-analysis: Components classified NEW/MODIFIED/DEPENDENT by architect

## Description

architect agent maps existing components affected, identifies new components, determines structural vs. internal change, classifies each component as NEW, MODIFIED, or DEPENDENT. Acceptance: Three classification labels.
...
1. architect agent maps existing components affected, identifies new components, determines structural vs. internal change, classifies each component as NEW, MODIFIED, or DEPENDENT.

## Invariants

1. Three classification labels.
