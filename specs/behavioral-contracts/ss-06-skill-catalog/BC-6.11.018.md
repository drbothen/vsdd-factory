...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-417"
ss_section: "Factory operations and dashboards skills"
skill: "generate-pdf"
---

# Behavioral Contract BC-6.11.018: generate-pdf: Identity — convert markdown to 1898 & Co. branded PDF via pandoc + weasyprint

## Description

Generates a 1898 & Co. branded PDF from a markdown research document. Acceptance: Frontmatter `name: generate-pdf`; `tools: Read, Bash`; `disable-model-invocation: true`.

## Preconditions

1. User requests PDF / export report / convert markdown.

## Postconditions

1. Generates a 1898 & Co. branded PDF from a markdown research document.

## Invariants

1. Frontmatter `name: generate-pdf`; `tools: Read, Bash`; `disable-model-invocation: true`.
