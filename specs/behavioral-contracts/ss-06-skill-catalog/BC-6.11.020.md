...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-419"
ss_section: "Factory operations and dashboards skills"
skill: "generate-pdf"
---

# Behavioral Contract BC-6.11.020: generate-pdf: Output PDF defaults to <input>.pdf in same directory

## Description

If no `-o <output>` specified, default is `<input>.pdf`. Acceptance: Output filename rule.

## Preconditions

1. generate-pdf.sh invoked.

## Postconditions

1. If no `-o <output>` specified, default is `<input>.pdf`.

## Invariants

1. Output filename rule.
