...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-457"
ss_section: "Phase orchestration and mode skills"
skill: "mode-decision-guide"
---

# Behavioral Contract BC-6.16.001: mode-decision-guide: Identity — reference doc for orchestrator mode detection

## Description

Quick decision table maps scenarios to modes (Greenfield Phases 1-7, Brownfield Phase 0, Feature Mode F1-F7, Multi-Repo, Maintenance, Discovery). Acceptance: Frontmatter `name: mode-decision-guide`; document declares "Reference document — no quality gate.".

## Preconditions

1. Orchestrator runs mode detection.

## Postconditions

1. Quick decision table maps scenarios to modes (Greenfield Phases 1-7, Brownfield Phase 0, Feature Mode F1-F7, Multi-Repo, Maintenance, Discovery).

## Invariants

1. Frontmatter `name: mode-decision-guide`; document declares "Reference document — no quality gate."
