...
responsive-validation: identity, agents, conditional UI gating. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/responsive-validation/SKILL.md` (lines 1-17).
