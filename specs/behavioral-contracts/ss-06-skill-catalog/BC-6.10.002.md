...
1. Each step's exit condition independently verified before advancing; skill never skips a step.
...
|--------|----------|-------------|
| VP-001 | TBD — assertion derived from acceptance: "Each step's exit condition independently verified before advancing; skill never skips a step." | manual |
