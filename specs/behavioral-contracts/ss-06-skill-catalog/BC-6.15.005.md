...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1874"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.15.005: writing-skills: identity & TDD-for-skills mapping

## Description

writing-skills: identity & TDD-for-skills mapping. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/writing-skills/SKILL.md` (lines 1-15, 38-45).

## Preconditions

1. Creating/editing/verifying a skill.

## Postconditions

1. Treats skill creation as TDD: pressure scenario = test case; SKILL.md = production code; agent fails without skill = RED; agent complies = GREEN; close loopholes = REFACTOR.
...
| **Source Lines** | 1-15, 38-45 |
| **Audit ID** | BC-AUDIT-788 |
