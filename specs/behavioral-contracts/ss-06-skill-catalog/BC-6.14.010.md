...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-414"
ss_section: "Artifact and verification skills"
skill: "formal-verify"
---

# Behavioral Contract BC-6.14.010: formal-verify: Security scan clean = zero CRITICAL and zero HIGH

## Description

Clean means zero CRITICAL and zero HIGH. LOW findings documented but don't block. Acceptance: Gate: "no critical security findings".
...
1. Clean means zero CRITICAL and zero HIGH. LOW findings documented but don't block.

## Invariants

1. Gate: "no critical security findings".
