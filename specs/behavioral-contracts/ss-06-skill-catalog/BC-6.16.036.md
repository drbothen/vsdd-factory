...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-524"
ss_section: "Phase orchestration and mode skills"
skill: "phase-6-formal-hardening"
---

# Behavioral Contract BC-6.16.036: phase-6-formal-hardening: Prerequisites — cargo-kani, cargo-fuzz, cargo-mutants, semgrep installed

## Description

Verification tools must be installed. (Skill body ties to formal-verify which has same install commands.). Acceptance: Four required tools.
...
1. Verification tools must be installed. (Skill body ties to formal-verify which has same install commands.)

## Invariants

1. Four required tools.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/phase-7-convergence/SKILL.md` (51 LOC)` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-524 |
| **Source Line(s)** | 32-34 |
