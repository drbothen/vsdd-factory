...
|--------|----------|-------------|
| VP-001 | TBD — assertion derived from acceptance: "Frontmatter declares `disable-model-invocation: false`; allowed-tools include Read, Write, Edit, Bash, Glob, Grep." | manual |
