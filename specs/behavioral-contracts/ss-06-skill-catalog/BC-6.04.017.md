...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-1.md#L600"
subsystem: SS-06
capability: "TBD"
...
# Behavioral Contract BC-6.04.017: code-delivery: review convergence loop (max 10 cycles)

> Source: `pass-3-deep-skills-batch-1.md` line 600 (was `BC-AUDIT-255`)
> Subsystem: SS-06 — Skill Catalog
> Section: Adversarial and review skills

## Description

code-delivery: review convergence loop (max 10 cycles). Triage (pr-manager) → Fix (implementer/test-writer/demo-recorder) → Re-review (pr-reviewer). Tracked in `.factory/code-delivery/STORY-NNN/review-findings.md` with cycle/findings/blocking/fixed/remaining columns. Max 10 cycles before escalating to human.

## Preconditions

1. pr-reviewer returns REQUEST_CHANGES

## Postconditions

1. Cycle count ≤10; review-findings.md exists with the 5-column tracking table.
...
- `architecture/ss-06-skill-catalog.md#code-delivery-review-convergence-loop-(max-10-cycles)` — TBD anchor
...
| **Source line(s) within skill** | 119-134 |
