...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-564"
ss_section: "Feature-mode phase skills (f1-f7)"
skill: "phase-f6-targeted-hardening"
---

# Behavioral Contract BC-6.17.037: phase-f6-targeted-hardening: Information asymmetry wall — formal-verifier cannot see F5 adversarial findings

## Description

"The formal-verifier CANNOT see adversarial review findings from F5 (DF-025). This ensures independent verification — the formal-verifier should verify properties from the spec, not guided by what the adversary looked for.". Acceptance: Wall enforced; rationale explicit.

## Preconditions

1. formal-verifier dispatch.

## Postconditions

1. "The formal-verifier CANNOT see adversarial review findings from F5 (DF-025). This ensures independent verification — the formal-verifier should verify properties from the spec, not guided by what the adversary looked for."

## Invariants

1. Wall enforced; rationale explicit.
