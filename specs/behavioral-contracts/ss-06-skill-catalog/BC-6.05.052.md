...
|--------|----------|-------------|
| VP-001 | Acceptance: Same query yields same key; cached result reused on second invocation. | manual |
...
- [VP-001] — Same query yields same key; cached result reused on second invocation.
