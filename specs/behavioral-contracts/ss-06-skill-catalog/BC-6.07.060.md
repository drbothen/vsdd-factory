...
validate-consistency: report format with Failures/Warnings/All Passed. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-consistency/SKILL.md` (lines 65-87).
