...
recover-state: artifact directory probe table is exhaustive. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/recover-state/SKILL.md` (lines 34-52).
