...
storybook-mcp-integration: T1/T2/T3 access pattern via DF-023+DF-027. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/storybook-mcp-integration/SKILL.md` (lines 70-78).
