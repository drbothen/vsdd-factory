...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-462"
ss_section: "Factory operations and dashboards skills"
skill: "model-routing"
---

# Behavioral Contract BC-6.11.029: model-routing: Identity — LiteLLM model tier assignment reference

## Description

Documents 8 tiers (judgment, implementation, validation, adversary, review, fallback/fast, fallback/standard, fallback/reasoning) with cost and use case. Acceptance: Frontmatter `name: model-routing`.

## Preconditions

1. Orchestrator selects model tier for an agent.

## Postconditions

1. Documents 8 tiers (judgment, implementation, validation, adversary, review, fallback/fast, fallback/standard, fallback/reasoning) with cost and use case.

## Invariants

1. Frontmatter `name: model-routing`.
