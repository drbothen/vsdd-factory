...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-576"
ss_section: "Brownfield, discovery, research skills"
skill: "planning-research"
---

# Behavioral Contract BC-6.05.044: planning-research: Output is research-report.md + research-sources.md

## Description

Writes `.factory/planning/research-report.md` (structured findings per type) and `.factory/planning/research-sources.md` (citations and links). Acceptance: Two output files.
...
1. Writes `.factory/planning/research-report.md` (structured findings per type) and `.factory/planning/research-sources.md` (citations and links).
