...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-472"
ss_section: "Brownfield, discovery, research skills"
skill: "multi-repo-phase-0-synthesis"
---

# Behavioral Contract BC-6.05.038: multi-repo-phase-0-synthesis: Adversary review uses information asymmetry wall — cannot see raw codebase

## Description

"Cannot see raw codebase (per DF-025 wall). Reviews synthesized artifacts only. Challenges assumptions about cross-repo interactions. Flags missing integration concerns.". Acceptance: Asymmetry wall enforced.
...
1. "Cannot see raw codebase (per DF-025 wall). Reviews synthesized artifacts only. Challenges assumptions about cross-repo interactions. Flags missing integration concerns."

## Invariants

1. Asymmetry wall enforced.
