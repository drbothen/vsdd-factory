...
|--------|----------|-------------|
| VP-001 | Acceptance: formal-verifier never executes without toolchain-state.yaml; multi-repo writes per-repo state. | manual |
...
- [VP-001] — formal-verifier never executes without toolchain-state.yaml; multi-repo writes per-repo state.
