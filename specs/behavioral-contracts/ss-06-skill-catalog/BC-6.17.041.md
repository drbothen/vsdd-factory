...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-568"
ss_section: "Feature-mode phase skills (f1-f7)"
skill: "phase-f7-delta-convergence"
---

# Behavioral Contract BC-6.17.041: phase-f7-delta-convergence: Regression validation is binary pass/fail, not "convergence"

## Description

Run complete suite, compare against Phase F4 baseline. Verify zero regressions. "This is not 'convergence' — it is a binary pass/fail.". Acceptance: Binary semantics.
...
1. Run complete suite, compare against Phase F4 baseline. Verify zero regressions. "This is not 'convergence' — it is a binary pass/fail."
