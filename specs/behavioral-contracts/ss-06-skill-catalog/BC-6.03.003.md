...
|--------|----------|-------------|
| VP-001 | TBD — assertion derived from acceptance: "Warning string contains both `<persisted>` and `<current>` strings; settings.local.json is updated post-warning." | manual |
