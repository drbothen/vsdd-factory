...
|--------|----------|-------------|
| VP-001 | Acceptance: No top-level workflow can mark COMPLETE before this skill runs. | manual |
...
- [VP-001] — No top-level workflow can mark COMPLETE before this skill runs.
