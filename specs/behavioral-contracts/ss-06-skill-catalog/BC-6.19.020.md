...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L730"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.19.020: sdk-generation: outputs and quality gate

## Description

sdk-generation: outputs and quality gate. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/sdk-generation/SKILL.md` (lines 167-174, 372-383).
...
1. Outputs: `[sdk-repo]/src/generated/`, package metadata, `tests/`, `README.md`, `.factory-project/sdk-generation-report.md`. Quality gate: compiles, contract tests pass, idioms followed, report produced.
...
| **Source Lines** | 167-174, 372-383 |
| **Audit ID** | BC-AUDIT-672 |
