...
|--------|----------|-------------|
| VP-001 | TBD — assertion derived from acceptance: "First skill output line matches verbatim string AND TodoWrite list contains entries for all 5 phases." | manual |
