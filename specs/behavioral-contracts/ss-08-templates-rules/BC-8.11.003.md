...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/ux-spec-screen-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1883
section: "UX templates"
type: template
---

# Behavioral Contract BC-8.11.003: ux-spec-screen-template: per-screen SCR-NNN spec

## Description

Frontmatter `document_type: ux-spec-screen`, `screen_id: "SCR-NNN"`. Required: `## Wireframe`, `## Purpose and User Context`, `## Components`, `## Elements`, `## Interactions`, `## Accessibility`, `## Responsive Adaptations`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/ux-spec-screen-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/ux-spec-screen-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/ux-spec-screen-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
