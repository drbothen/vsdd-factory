...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2209
section: "Rules: bash (no stderr suppression, no eval, dependency checks)"
type: rule
---

# Behavioral Contract BC-8.20.009: rules/bash.md: every `2>/dev/null` MUST carry a `# STDERR-EXEMPT: <rationale>` tag
...
1. Untagged `2>/dev/null` instances absent from assertion code.
...
**Source metadata:** `plugins/vsdd-factory/rules/bash.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 114–116
