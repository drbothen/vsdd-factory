...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/pr-description-template.md"
subsystem: SS-08
capability: ""
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/pr-description-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/pr-description-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1, 3 (epic ref)
