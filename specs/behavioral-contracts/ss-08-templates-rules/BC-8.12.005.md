...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/design-system/patterns/{form,layout,navigation}-patterns.yaml"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1889
section: "Design system and UI quality templates"
type: template
---

# Behavioral Contract BC-8.12.005: design-system/patterns/: 3 cross-component pattern catalogs

## Description

3 pattern catalogs: `form-patterns.yaml`, `layout-patterns.yaml`, `navigation-patterns.yaml`. Each catalogues composite pattern definitions (e.g., card grid, side nav) that combine multiple components per `constraints.yaml` `component_enforcement` rule.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/design-system/patterns/{form,layout,navigation}-patterns.yaml` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. All 3 files present and YAML-parseable.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/design-system/patterns/{form,layout,navigation}-patterns.yaml` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/design-system/patterns/{form,layout,navigation}-patterns.yaml` | **Type:** template | **Confidence:** HIGH | **Source line(s):** dir listing
