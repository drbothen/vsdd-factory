...
1. Every phase sub-workflow lobster has matching block ordering.
...
**Source metadata:** `plugins/vsdd-factory/rules/step-decomposition.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 146–191
