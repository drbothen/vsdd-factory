...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/fix-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1839
section: "Adversarial-review templates"
type: template
---

# Behavioral Contract BC-8.04.005: fix-template: per-fix FIX-P[N]-NNN identity

## Description

Frontmatter `document_type: fix`, `level: ops`. ID format `FIX-P[N]-NNN`. Required: `## Source Finding`, `## Fix Description`, `## Files Changed`, `## Verification`, `## ID Format`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/fix-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/fix-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/fix-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
