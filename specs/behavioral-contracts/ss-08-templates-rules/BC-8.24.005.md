...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2241
section: "Rules: spec-format (4-level hierarchy, BC/VP shape)"
type: rule
---

# Behavioral Contract BC-8.24.005: rules/spec-format.md: VP numbering — sequential `VP-NNN`

## Description

Sequential: VP-001, VP-002, etc. No subsystem prefix.
...
**Source metadata:** `plugins/vsdd-factory/rules/spec-format.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 65–69
