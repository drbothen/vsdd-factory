...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2222
section: "Rules: git-commits (Conventional Commits, no AI attribution)"
type: rule
---

# Behavioral Contract BC-8.22.004: rules/git-commits.md: scope (optional) is parenthesized after type — `feat(api):`

## Description

`feat(api): add endpoint`. Scope is optional but, when present, must be in parentheses immediately after type.
...
1. `<type>(<scope>):` when scope present.
...
**Source metadata:** `plugins/vsdd-factory/rules/git-commits.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 38–40
