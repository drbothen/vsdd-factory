...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1808
section: "Spec hierarchy templates (L1 through L4)"
type: template
---

# Behavioral Contract BC-8.01.009: prd-template: governs L3 PRD identity

## Description

Canonical L3 PRD shape. Frontmatter `document_type: prd`, `level: L3`. PRD is an index document; supplements live in `prd-supplements/`.
...
1. Frontmatter + 7 `##` numbered sections present.
...
**Source metadata:** `plugins/vsdd-factory/templates/prd-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3, title line
