...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/traceability-matrix-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1857
section: "Convergence and traceability templates"
type: template
---

# Behavioral Contract BC-8.06.005: traceability-matrix-template: forward + reverse L1→Proof traceability

## Description

Frontmatter `document_type: traceability-matrix`, `level: ops`. Required: `## Forward Traceability (L1 → Proof)`, `## Reverse Traceability (Proof → L1)`, `## Coverage Summary`, `## VP Status Summary`, `## Gap Register`, `## Withdrawn VP Impact`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/traceability-matrix-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/traceability-matrix-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/traceability-matrix-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
