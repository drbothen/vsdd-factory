...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/factory-project-state-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1918
section: "Discovery, project, config templates"
type: template
---

# Behavioral Contract BC-8.16.007: factory-project-state-template: multi-repo project-level STATE.md

## Description

Project-level `.factory-project/STATE.md` (multi-repo). Required: `## Project`, `## Repo Status`, `## Repo Wave Plan`, `## Cost Summary`, `## Active Gates`, `## Product Backlog`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/factory-project-state-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/factory-project-state-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/factory-project-state-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1
