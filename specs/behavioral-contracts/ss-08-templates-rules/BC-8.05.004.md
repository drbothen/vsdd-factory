...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/evaluation-index-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1850
section: "Holdout-evaluation templates"
type: template
---

# Behavioral Contract BC-8.05.004: evaluation-index-template: per-pass holdout evaluation index

## Description

Frontmatter `document_type: evaluation-index`, `level: ops`. Required: `## Pass Summary`, `## Per-Scenario Scores`, `## Failed Scenarios Requiring Re-evaluation`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/evaluation-index-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/evaluation-index-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/evaluation-index-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
