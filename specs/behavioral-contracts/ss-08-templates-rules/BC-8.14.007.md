...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/blocking-issues-resolved-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1906
section: "State and workflow templates"
type: template
---

# Behavioral Contract BC-8.14.007: blocking-issues-resolved-template: cycle blockers-resolved log

## Description

Frontmatter `document_type: blocking-issues-resolved`, `level: ops`. Single title `# Resolved Blocking Issues — [cycle-name]` followed by content.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/blocking-issues-resolved-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Frontmatter present; title heading present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/blocking-issues-resolved-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/blocking-issues-resolved-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
