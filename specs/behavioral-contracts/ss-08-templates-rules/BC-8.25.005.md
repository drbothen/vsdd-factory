...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2253
section: "Rules: step-decomposition (VSDD phase 0-7 protocol)"
type: rule
---

# Behavioral Contract BC-8.25.005: rules/step-decomposition.md: step IDs are LOWERCASE ALPHABETIC ONLY — `step-a-`, `step-b-`, `step-c-`

## Description

Steps use lowercase alphabetic IDs only: `step-a-`, `step-b-`, `step-c-`. Always alphabetic (a..z). NEVER numeric (no `step-0-`/`step-1-`/`step-2-`). NEVER sub-stepped (no `step-b5-`/`step-b6-`; promote sub-steps to their own letter). Always descriptive (`step-a-broad-sweep`, not `step-a` or `step-1`).
...
1. Step filenames match `step-[a-z]-<name>.md`.
...
**Source metadata:** `plugins/vsdd-factory/rules/step-decomposition.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 85–91
