...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2236
section: "Rules: rust (forbid unsafe, edition, lints)"
type: rule
---

# Behavioral Contract BC-8.23.009: rules/rust.md: architecture — strictly acyclic dependency graph; no circular deps between crates

## Description

Dependency graph is strictly acyclic. No circular dependencies between crates. `lib.rs` is a pure re-export barrel — implementation in domain modules.
...
**Source metadata:** `plugins/vsdd-factory/rules/rust.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 53–57
