...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2269
section: "Rules: story-completeness (14-check audit)"
type: rule
---

# Behavioral Contract BC-8.26.009: rules/story-completeness.md: check 8 — generated output specified (format/sort-order/edge-cases/exit-codes)

## Description

Check 8: If the tool generates files (e.g., `generate` subcommand): exact output format with example; sort order and comment conventions; edge case behavior (empty workspace, zero deps); exit codes for the generation path.
...
1. Generated-output section has all 4 sub-items.
...
**Source metadata:** `plugins/vsdd-factory/rules/story-completeness.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 70–76
