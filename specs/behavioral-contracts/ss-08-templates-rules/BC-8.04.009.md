...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/agent-file-review-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1843
section: "Adversarial-review templates"
type: template
---

# Behavioral Contract BC-8.04.009: agent-file-review-template: agent persona doc review

## Description

Frontmatter `document_type: agent-file-review`, `level: ops`. Required: `## Results`, `## Recommendations`, plus a batch summary heading `# Agent File Review — Batch Summary`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/agent-file-review-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Both per-agent and batch headings present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/agent-file-review-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/agent-file-review-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
