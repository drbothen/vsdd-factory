...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/conventions-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1860
section: "Brownfield, discovery, extraction templates"
type: template
---

# Behavioral Contract BC-8.07.002: conventions-template: brownfield conventions extraction

## Description

Phase 0c output. Title `# Conventions: [PROJECT_NAME]`. Required: `## Naming Conventions`, `## Error Handling`, `## Testing Conventions`, `## Code Organization`, `## Documentation Style`, `## Summary for Agents`, `## Enforceable Rules (Machine-Readable)`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/conventions-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/conventions-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/conventions-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1, 3 (extracted-by attribution)
