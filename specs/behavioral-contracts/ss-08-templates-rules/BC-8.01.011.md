...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/prd-supplement-error-taxonomy-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1810
section: "Spec hierarchy templates (L1 through L4)"
type: template
---

# Behavioral Contract BC-8.01.011: prd-supplement-error-taxonomy-template: PRD error-taxonomy supplement

## Description

Frontmatter `document_type: prd-supplement-error-taxonomy`, `level: L3`. Sections: `## Error Categories`, `## Error Catalog`, `## Severity Definitions`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/prd-supplement-error-taxonomy-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/prd-supplement-error-taxonomy-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/prd-supplement-error-taxonomy-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
