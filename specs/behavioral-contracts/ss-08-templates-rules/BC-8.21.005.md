...
removed: null
removal_reason: null
audit_id: BC-AUDIT-2215
section: "Rules: factory-protocol (.factory worktree, governance)"
type: rule
---

# Behavioral Contract BC-8.21.005: rules/factory-protocol.md: NEVER put target project source code in `.factory/`

## Description

Only pipeline state, specs, and artifacts in `.factory/`. Code goes in product working dirs (root, `crates/`, etc.).
...
1. No source files (.rs/.ts/.py for the product) in `.factory/`.
...
**Source metadata:** `plugins/vsdd-factory/rules/factory-protocol.md` | **Type:** rule | **Confidence:** HIGH | **Source line(s):** 78
