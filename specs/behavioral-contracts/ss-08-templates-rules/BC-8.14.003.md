...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/burst-log-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1902
section: "State and workflow templates"
type: template
---

# Behavioral Contract BC-8.14.003: burst-log-template: state-burst log

## Description

Frontmatter `document_type: burst-log`, `level: ops`. Required: per-burst `## Burst N (YYYY-MM-DD)` heading, accumulating across cycle.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/burst-log-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Frontmatter present; at least one `## Burst N` heading.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/burst-log-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/burst-log-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
