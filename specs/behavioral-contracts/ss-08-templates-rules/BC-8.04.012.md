...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1846
section: "Adversarial-review templates"
type: template
---

# Behavioral Contract BC-8.04.012: adversary-prompt-templates: previous-findings handlebars template

## Description

Each prompt includes a `{{#if previous_pass}} ... {{/if}}` handlebars block that injects "do not re-report" guidance for fixed findings.
...
1. Handlebars block present in all 3 files.
