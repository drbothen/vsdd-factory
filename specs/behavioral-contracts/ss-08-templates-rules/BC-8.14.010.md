...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/red-gate-log-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1909
section: "State and workflow templates"
type: template
---

# Behavioral Contract BC-8.14.010: red-gate-log-template: TDD red-gate verification log

## Description

Frontmatter `document_type: red-gate-log`, `level: ops`. Title `# Red Gate Log: [Wave/Story identifier]`. Required: `## Summary`, `## Stubs Created`, `## Red Gate Verification`, `## Regression Check`, `## Hand-Off to Implementer`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/red-gate-log-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/red-gate-log-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/red-gate-log-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
