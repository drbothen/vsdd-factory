...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/vp-withdrawal-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1898
section: "Spec lifecycle templates (changelog, drift, withdrawal, gates)"
type: template
---

# Behavioral Contract BC-8.13.003: vp-withdrawal-template: green-VP retirement record

## Description

Frontmatter `document_type: vp-withdrawal`, `level: L4`. Required: `## Withdrawal Details`, `## Reason for Withdrawal`, `## Impact Assessment`, `## Replacement`, `## Approval`. Used to retire a green-status VP per `rules/spec-format.md` immutability rule.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/vp-withdrawal-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/vp-withdrawal-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/vp-withdrawal-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
