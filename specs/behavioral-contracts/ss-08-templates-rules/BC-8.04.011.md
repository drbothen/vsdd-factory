...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/adversary-prompt-templates/phase-1d-spec-review.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1845
section: "Adversarial-review templates"
type: template
---

# Behavioral Contract BC-8.04.011: adversary-prompt-templates: required Review Focus + Not-Reviewing sections

## Description

Each prompt declares `## Review Focus` (numbered list of review angles) and `## You Are NOT Reviewing` (negative scope). Phase-1d has 6 angles (contradictions, ambiguity, completeness, consistency, testability, feasibility); phase-2 / phase-5 vary.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/adversary-prompt-templates/phase-1d-spec-review.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Both headings present in all 3 files.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/adversary-prompt-templates/phase-1d-spec-review.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/adversary-prompt-templates/phase-1d-spec-review.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** phase-1d:9–24
