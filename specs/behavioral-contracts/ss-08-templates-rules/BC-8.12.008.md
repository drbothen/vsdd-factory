...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/ui-quality/heuristic-evaluation-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1892
section: "Design system and UI quality templates"
type: template
---

# Behavioral Contract BC-8.12.008: ui-quality/heuristic-evaluation-template: 10-heuristic UX evaluation

## Description

Nielsen-heuristic scoring scaffold. Evaluator triad: ux-designer (primary), accessibility-auditor, business-analyst. Scoring table for H1..H10 with `/1.0` score column.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/ui-quality/heuristic-evaluation-template.md` is being authored or validated.
2. Authoring agent or validation tool is reading the template definition.

## Postconditions

1. Heuristic table present.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/ui-quality/heuristic-evaluation-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/ui-quality/heuristic-evaluation-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–15
