...
origin: brownfield
extracted_from: "plugins/vsdd-factory/templates/adversarial-review-index-template.md"
subsystem: SS-08
capability: ""
...
removed: null
removal_reason: null
audit_id: BC-AUDIT-1836
section: "Adversarial-review templates"
type: template
---

# Behavioral Contract BC-8.04.002: adversarial-review-index-template: per-pass index of findings

## Description

Frontmatter `document_type: adversarial-review-index`, `level: ops`. Required: `## Finding Catalog`, `## Dependency Graph`, `## Category Groups`. Title `# Adversarial Review -- Pass [N]`.

## Preconditions

1. Template file at `plugins/vsdd-factory/templates/adversarial-review-index-template.md` is being authored or validated.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/templates/adversarial-review-index-template.md` |
| **Confidence** | HIGH |
| **Extraction Date** | 2026-04-25 |

**Source metadata:** `plugins/vsdd-factory/templates/adversarial-review-index-template.md` | **Type:** template | **Confidence:** HIGH | **Source line(s):** 1–3
