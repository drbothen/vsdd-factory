...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `repo-initialization (line 37)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `repo-initialization (line 37)`
