...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `state-initialization (line 110)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `state-initialization (line 110)`
