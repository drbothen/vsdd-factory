...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `quick-dev-f7-human-approval (line 262)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `quick-dev-f7-human-approval (line 262)`
