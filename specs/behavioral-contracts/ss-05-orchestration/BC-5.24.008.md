...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `holdout-gate (line 28)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `holdout-gate (line 28)`
