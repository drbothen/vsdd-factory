...
Step `state-backup-sweep-10` (line 251). Agent: state-manager. Source 251-256. Persists sweep-10 (design drift) artifacts.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/workflows/maintenance.lobster` (lines 251-256) |
| **Confidence** | high |
