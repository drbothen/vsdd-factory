...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `backup-dependency-graph (line 54)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `backup-dependency-graph (line 54)`
