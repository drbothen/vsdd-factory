...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `verification-convergence (line 59)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `verification-convergence (line 59)`
