...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `feature-market-review (line 146)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `feature-market-review (line 146)`
