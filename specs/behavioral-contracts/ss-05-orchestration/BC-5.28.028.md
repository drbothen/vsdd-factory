...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-1-state-backup (line 327)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-1-state-backup (line 327)`
