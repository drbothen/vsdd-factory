...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `post-phase-0-routing (line 194)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `post-phase-0-routing (line 194)`
