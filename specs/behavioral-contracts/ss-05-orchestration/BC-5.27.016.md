...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `performance-convergence (line 87)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `performance-convergence (line 87)`
