...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f4-state-backup (line 986)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f4-state-backup (line 986)`
