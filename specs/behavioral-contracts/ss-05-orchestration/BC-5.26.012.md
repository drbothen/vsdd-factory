...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `security-scan (line 65)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `security-scan (line 65)`
