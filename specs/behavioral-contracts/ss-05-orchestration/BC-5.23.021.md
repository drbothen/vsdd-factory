...
1. Step `input-hash-drift-check (line 138)` has run to completion and emitted any declared artifacts.
...
| **Source Document** | `.factory/phase-0-ingestion/pass-3-deep-workflows.md` (line 464) |
| **Source BC-AUDIT ID** | `BC-AUDIT-1380` |
| **Confidence** | high |
