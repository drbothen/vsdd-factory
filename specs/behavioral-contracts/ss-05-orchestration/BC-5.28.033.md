...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `multi-repo-state-migration (line 401)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `multi-repo-state-migration (line 401)`
