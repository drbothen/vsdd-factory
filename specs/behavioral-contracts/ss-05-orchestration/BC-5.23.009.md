...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `backup-generate-stubs (line 38)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `backup-generate-stubs (line 38)`
