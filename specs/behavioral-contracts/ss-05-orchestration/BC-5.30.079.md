...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f7-gate (line 1352)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f7-gate (line 1352)`
