...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for ``coverage-audit` (line 65)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for ``coverage-audit` (line 65)`
