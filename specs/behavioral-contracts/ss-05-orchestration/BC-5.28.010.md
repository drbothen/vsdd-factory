...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `scaffold-claude-md (line 70)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `scaffold-claude-md (line 70)`
