...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `quick-dev-state-backup (line 280)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `quick-dev-state-backup (line 280)`
