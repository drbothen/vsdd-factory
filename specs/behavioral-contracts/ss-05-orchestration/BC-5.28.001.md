...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `greenfield-vsdd: identity` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `greenfield-vsdd: identity`
