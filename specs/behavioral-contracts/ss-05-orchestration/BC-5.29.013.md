...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-0-codebase-ingestion (line 137)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-0-codebase-ingestion (line 137)`
