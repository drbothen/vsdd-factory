...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `backup-pr-lifecycle (line 97)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `backup-pr-lifecycle (line 97)`
