...
# Behavioral Contract BC-5.21.002: phase-1: entry-point
...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for ``create-brief` (line 18) — `depends_on: []`` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for ``create-brief` (line 18) — `depends_on: []``
