...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `backup-security-scan (line 70)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `backup-security-scan (line 70)`
