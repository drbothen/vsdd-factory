...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `holdout-evaluation (line 1042)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `holdout-evaluation (line 1042)`
