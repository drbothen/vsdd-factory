...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `bugfix-state-backup (line 432)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `bugfix-state-backup (line 432)`
