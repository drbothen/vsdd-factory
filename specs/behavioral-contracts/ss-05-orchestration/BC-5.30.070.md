...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f6-state-backup (line 1227)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f6-state-backup (line 1227)`
