...
Terminal step `process-review-decisions` (line 288). Agent: state-manager. Depends `[session-review-approval]`.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/workflows/planning.lobster` (line 288) |
| **Confidence** | high |
