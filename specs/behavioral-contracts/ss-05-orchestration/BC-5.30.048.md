...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f2-human-approval (line 640)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f2-human-approval (line 640)`
