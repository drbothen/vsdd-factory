...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for ``backup-create-brief` (line 23)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for ``backup-create-brief` (line 23)`
