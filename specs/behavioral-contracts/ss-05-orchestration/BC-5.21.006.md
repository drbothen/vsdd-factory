...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for ``create-brief` (line 18)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for ``create-brief` (line 18)`
