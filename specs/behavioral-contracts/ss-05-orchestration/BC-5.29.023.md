...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `brownfield-design-system-extract (line 280)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `brownfield-design-system-extract (line 280)`
