...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for ``repo-initialization` (line 37) — `depends_on: []`. Type: skill, skill: `skills/repo-initialization/SKILL.md`. Sole zero-in-degree node.` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for ``repo-initialization` (line 37) — `depends_on: []`. Type: skill, skill: `skills/repo-initialization/SKILL.md`. Sole zero-in-degree node.`
