...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for ``human-approval` (line 148)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for ``human-approval` (line 148)`
