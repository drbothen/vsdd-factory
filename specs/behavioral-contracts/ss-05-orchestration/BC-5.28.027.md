...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-1d-spec-review-gemini (line 297)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-1d-spec-review-gemini (line 297)`
