...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `bugfix-holdout-scoped (line 326)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `bugfix-holdout-scoped (line 326)`
