...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `feature-market-intel (line 136)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `feature-market-intel (line 136)`
