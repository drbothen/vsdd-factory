...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `steady-state-handoff (line 1343)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `steady-state-handoff (line 1343)`
