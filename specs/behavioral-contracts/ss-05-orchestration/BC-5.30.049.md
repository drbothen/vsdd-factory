...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f3-incremental-stories (line 657)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f3-incremental-stories (line 657)`
