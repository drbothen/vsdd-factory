...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f3-state-backup (line 695)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f3-state-backup (line 695)`
