...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-6-state-backup (line 1302)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-6-state-backup (line 1302)`
