...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `adaptive-planning (line 97)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `adaptive-planning (line 97)`
