...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f2-spec-evolution (line 466)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f2-spec-evolution (line 466)`
