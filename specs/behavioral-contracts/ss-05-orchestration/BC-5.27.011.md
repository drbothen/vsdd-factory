...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `backup-implementation-convergence (line 50)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `backup-implementation-convergence (line 50)`
