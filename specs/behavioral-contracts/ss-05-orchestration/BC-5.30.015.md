...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f1-gate (line 203)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f1-gate (line 203)`
