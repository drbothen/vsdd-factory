...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f1-state-backup (line 186)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f1-state-backup (line 186)`
