...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-4-dtu-startup (line 1012)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-4-dtu-startup (line 1012)`
