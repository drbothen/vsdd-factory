...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f7-delta-convergence (line 1319)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f7-delta-convergence (line 1319)`
