...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `bugfix-f6-a11y (line 381)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `bugfix-f6-a11y (line 381)`
