...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `feature-cycle-handoff (line 1425)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `feature-cycle-handoff (line 1425)`
