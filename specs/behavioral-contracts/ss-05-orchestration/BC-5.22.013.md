...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `backup-wave-schedule (line 69)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `backup-wave-schedule (line 69)`
