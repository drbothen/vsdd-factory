...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `holdout-evaluation (line 23)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `holdout-evaluation (line 23)`
