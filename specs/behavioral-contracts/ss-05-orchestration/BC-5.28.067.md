...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-7-convergence (line 1246)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-7-convergence (line 1246)`
