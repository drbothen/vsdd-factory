...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for ``prd-revision` (line 78)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for ``prd-revision` (line 78)`
