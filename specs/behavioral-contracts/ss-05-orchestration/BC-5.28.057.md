...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-4b-holdout-regression (line 1136)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-4b-holdout-regression (line 1136)`
