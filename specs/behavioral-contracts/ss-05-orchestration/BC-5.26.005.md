...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-6: failure semantics` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-6: failure semantics`
