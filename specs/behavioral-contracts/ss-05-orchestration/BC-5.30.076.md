...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f7-ui-quality-gate (line 1297)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f7-ui-quality-gate (line 1297)`
