...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for ``spec-convergence` (line 17) — `depends_on: []`.` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for ``spec-convergence` (line 17) — `depends_on: []`.`
