...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `build-verification (line 1020)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `build-verification (line 1020)`
