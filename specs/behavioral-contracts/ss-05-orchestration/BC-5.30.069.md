...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-f6-gate (line 1212)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-f6-gate (line 1212)`
