...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `dx-engineer-preflight-gate (line 587)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `dx-engineer-preflight-gate (line 587)`
