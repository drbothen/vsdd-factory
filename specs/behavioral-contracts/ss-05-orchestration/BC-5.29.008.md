...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `repo-verification (line 58)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `repo-verification (line 58)`
