...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for ``holdout-gate` (line 28) — gate type, depends `[holdout-evaluation]`. Source 28-38.` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for ``holdout-gate` (line 28) — gate type, depends `[holdout-evaluation]`. Source 28-38.`
