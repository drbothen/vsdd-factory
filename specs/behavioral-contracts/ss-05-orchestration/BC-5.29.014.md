...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `phase-0-artifact-backup (line 143)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `phase-0-artifact-backup (line 143)`
