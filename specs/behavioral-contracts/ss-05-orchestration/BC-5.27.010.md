...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `implementation-convergence (line 45)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `implementation-convergence (line 45)`
