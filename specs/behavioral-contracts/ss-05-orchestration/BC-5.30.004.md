...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `feature: DAG integrity` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `feature: DAG integrity`
