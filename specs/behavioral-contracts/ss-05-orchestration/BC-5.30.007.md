...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `factory-worktree-gate (line 92)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `factory-worktree-gate (line 92)`
