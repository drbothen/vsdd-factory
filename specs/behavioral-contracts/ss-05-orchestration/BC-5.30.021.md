...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `quick-dev-release (line 271)` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `quick-dev-release (line 271)`
