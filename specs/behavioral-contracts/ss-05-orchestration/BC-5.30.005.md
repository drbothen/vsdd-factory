...
|--------|----------|-------------|
| VP-001 | Workflow YAML field shape matches declared schema for `feature: failure semantics` | manual |
...
- [VP-001] — Workflow YAML field shape matches declared schema for `feature: failure semantics`
