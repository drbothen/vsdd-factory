...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1799"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.06.043: wave-scheduling: pipeline overlap (Wave N+1 stubs while Wave N implements)

## Description

wave-scheduling: pipeline overlap (Wave N+1 stubs while Wave N implements). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/wave-scheduling/SKILL.md` (lines 41-46; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Start Wave N+1 stubs while Wave N implementation runs (stubs depend only on types). Wave N+1 tests depend on Wave N types being available. `cargo check` between stub creation and test writing.
...
| Architecture Module | plugins/vsdd-factory/skills/wave-scheduling/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/wave-scheduling/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/wave-scheduling/SKILL.md` — defining skill body for this contract
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/wave-scheduling/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 41-46 |
| **Audit ID** | BC-AUDIT-781 |
