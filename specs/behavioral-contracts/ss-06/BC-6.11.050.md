...
quick-dev-routing: compressed pipeline preserves regression + adversary + human merge. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/quick-dev-routing/SKILL.md` (lines 54-72).
