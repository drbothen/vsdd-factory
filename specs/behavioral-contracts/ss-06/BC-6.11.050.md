...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L146"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.11.050: quick-dev-routing: compressed pipeline preserves regression + adversary + human merge

## Description

quick-dev-routing: compressed pipeline preserves regression + adversary + human merge. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/quick-dev-routing/SKILL.md` (lines 54-72; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Quick Dev or One-Shot route selected.

## Postconditions

1. Skips F2/F3/F6 only. Always preserved: full regression suite (F4), at least one adversarial review pass (F5), human merge authorization (F7).
