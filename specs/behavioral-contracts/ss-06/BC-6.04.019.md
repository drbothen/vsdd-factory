...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-404"
ss_section: "Adversarial and review skills"
skill: "fix-pr-delivery"
---

# Behavioral Contract BC-6.04.019: fix-pr-delivery: Identity — streamlined fix PR flow with same rigor minus stubs/Red Gate/wave gates

## Description

Same worktree + AI review + security review rigor as story PRs but skips stubs, Red Gate, and wave integration gates. Acceptance: Frontmatter `name: fix-pr-delivery`; description matches above.

## Preconditions

1. Adversarial refinement, formal hardening, or convergence finding produces a fix task.

## Postconditions

1. Same worktree + AI review + security review rigor as story PRs but skips stubs, Red Gate, and wave integration gates.

## Invariants

1. Frontmatter `name: fix-pr-delivery`; description matches above.
