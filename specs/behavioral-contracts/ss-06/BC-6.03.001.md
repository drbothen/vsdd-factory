...
|--------|----------|-------------|
| VP-001 | TBD — assertion derived from acceptance: "Frontmatter declares `name: activate`; description references "VSDD factory persona" + ".claude/settings.local.json" + "deactivate"." | manual |
