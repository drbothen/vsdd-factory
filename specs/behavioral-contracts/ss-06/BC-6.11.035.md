...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-468"
ss_section: "Factory operations and dashboards skills"
skill: "multi-repo-health"
---

# Behavioral Contract BC-6.11.035: multi-repo-health: Single-repo path — count == 0 reports "single-repo project" and stops

## Description

"If 0, report 'single-repo project' and stop.". Acceptance: Early termination on single-repo.

## Preconditions

1. `bin/multi-repo-scan --count` returns 0.

## Postconditions

1. "If 0, report 'single-repo project' and stop."

## Invariants

1. Early termination on single-repo.
