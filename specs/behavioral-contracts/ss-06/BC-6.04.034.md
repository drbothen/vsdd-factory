...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L819"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.04.034: session-review: 10 proposal categories with routing

## Description

session-review: 10 proposal categories with routing. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/session-review/SKILL.md` (lines 88-127; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Proposal generation + routing on approval.

## Postconditions

1. Categories: cost, timing, convergence, agent, gate, wall, quality, pattern, workflow, template. Each routes to a specific destination (model config, gate timeouts, adversary prompt, AGENTS.md, test suite, lobster context.exclude, mutation kill rate target, research task, story in dark-factory repo, template file).
