...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L694"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.19.016: sdk-generation: language idiom enforcement (TS async, Py snake_case, Go errors)

## Description

sdk-generation: language idiom enforcement (TS async, Py snake_case, Go errors). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/sdk-generation/SKILL.md` (lines 5-7, 53-119, 372-377).

## Preconditions

1. Per-language Step 3 generation.

## Postconditions

1. TypeScript: async/await + types + retry; Python: snake_case + Pydantic + httpx async; Go: idiomatic error returns + context. Quality gate requires "follows target language idioms".
...
| **Source Lines** | 5-7, 53-119, 372-377 |
| **Audit ID** | BC-AUDIT-668 |
