...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-466"
ss_section: "Factory operations and dashboards skills"
skill: "multi-repo-health"
---

# Behavioral Contract BC-6.11.033: multi-repo-health: Identity — scan .worktrees/ for multi-repo layout, report repos with manifests

## Description

Wraps `bin/multi-repo-scan`. Detects multi-repo layouts; reports per-repo name/path, manifest type (Cargo.toml/package.json/pyproject.toml/go.mod/unknown), branch, dirty/clean status. Acceptance: Frontmatter `name: multi-repo-health`.

## Preconditions

1. Before multi-repo phase-0 synthesis.

## Postconditions

1. Wraps `bin/multi-repo-scan`. Detects multi-repo layouts; reports per-repo name/path, manifest type (Cargo.toml/package.json/pyproject.toml/go.mod/unknown), branch, dirty/clean status.

## Invariants

1. Frontmatter `name: multi-repo-health`.
...
| Architecture Module | multi-repo-health |
| Stories | TBD |
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/multi-repo-health/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-466 |
| **Source Line(s)** | 1-5 |
