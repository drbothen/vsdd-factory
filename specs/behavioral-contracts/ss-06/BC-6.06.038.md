...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1750"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.06.038: wave-gate: 8-row red-flag rationalization table

## Description

wave-gate: 8-row red-flag rationalization table. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/wave-gate/SKILL.md` (lines 28-39; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Self-check during gate.

## Postconditions

1. Catches: skip = SKIP (with reason); flaky = re-run gate-1; HIGH = tech debt entry; missing demo = dispatch demo-recorder; 0.84 ≠ 0.85 (no rounding); fixed gate order; advance with failed gate = forbidden; develop run is required.
