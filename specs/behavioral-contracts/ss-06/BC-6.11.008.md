...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | TBD — assertion derived from acceptance: "Each check has explicit auto-repair OR explicit human-action recommendation; missing dirs auto-created." | manual |
