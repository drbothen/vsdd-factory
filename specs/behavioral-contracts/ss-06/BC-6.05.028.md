...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-442"
ss_section: "Brownfield, discovery, research skills"
skill: "intelligence-synthesis"
---

# Behavioral Contract BC-6.05.028: intelligence-synthesis: Routing — composite ≥0.7 AND evidence ≥0.6 → Brief; URGENT competitive HIGH triggers immediate human notification

## Description

Composite ≥0.7 + evidence ≥0.6 → Brief→Planning. 0.5-0.7 → Backlog. <0.5 + <0.4 evidence → Registry. Competitive HIGH + composite ≥0.7 → URGENT immediate human notification. Acceptance: Routing rules per the routing table.
...
1. Composite ≥0.7 + evidence ≥0.6 → Brief→Planning. 0.5-0.7 → Backlog. <0.5 + <0.4 evidence → Registry. Competitive HIGH + composite ≥0.7 → URGENT immediate human notification.

## Invariants

1. Routing rules per the routing table.
