...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-401"
ss_section: "Feature-mode scoping rules"
skill: "feature-mode-scoping-rules"
---

# Behavioral Contract BC-6.12.002: feature-mode-scoping-rules: Regression scope is the FULL test suite, never scoped

## Description

"The regression test suite always runs against the FULL existing test suite. Never skip existing tests because they are 'unrelated.'". Acceptance: Skip-existing-tests behavior is forbidden by Rule 1.

## Preconditions

1. Any phase that runs regression checks.

## Postconditions

1. "The regression test suite always runs against the FULL existing test suite. Never skip existing tests because they are 'unrelated.'"

## Invariants

1. Skip-existing-tests behavior is forbidden by Rule 1.
