...
validate-consistency: 7 cross-file checks (BC/VP/Story/Architecture/Counts/Status/Naming). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-consistency/SKILL.md` (lines 19-60).
