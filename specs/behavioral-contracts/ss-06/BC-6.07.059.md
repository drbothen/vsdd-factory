...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1572"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.059: validate-consistency: 7 cross-file checks (BC/VP/Story/Architecture/Counts/Status/Naming)

## Description

validate-consistency: 7 cross-file checks (BC/VP/Story/Architecture/Counts/Status/Naming). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-consistency/SKILL.md` (lines 19-60; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: Each check produces PASS/FAIL/WARN row in report. | manual |
...
| Architecture Module | plugins/vsdd-factory/skills/validate-consistency/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/validate-consistency/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/validate-consistency/SKILL.md` — defining skill body for this contract
...
- [TBD — to be assigned in Phase 1.6c] — Each check produces PASS/FAIL/WARN row in report.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/validate-consistency/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 19-60 |
| **Audit ID** | BC-AUDIT-758 |
