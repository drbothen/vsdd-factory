...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L703"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.19.017: sdk-generation: tool-format dispatch (OpenAPI/protobuf/GraphQL)

## Description

sdk-generation: tool-format dispatch (OpenAPI/protobuf/GraphQL). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/sdk-generation/SKILL.md` (lines 40-49, 121-140).

## Preconditions

1. Step 2 (Select Generation Tool).

## Postconditions

1. OpenAPI → Fern (default), Speakeasy, OpenAPI Generator; protobuf → Buf+protoc / grpc-tools; GraphQL → graphql-codegen / Apollo Codegen.
...
| **Source Lines** | 40-49, 121-140 |
| **Audit ID** | BC-AUDIT-669 |
