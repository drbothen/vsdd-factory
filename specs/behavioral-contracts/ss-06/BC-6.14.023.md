...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1135"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.14.023: systematic-debugging: identity + hard gate

## Description

systematic-debugging: identity + hard gate. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/systematic-debugging/SKILL.md` (lines 1-15; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Any technical bug, test failure, unexpected behavior — before proposing fixes.

## Postconditions

1. Hard Gate: NO FIXES WITHOUT ROOT CAUSE INVESTIGATION FIRST. Phase 1 must complete before fixes. Violating letter = violating spirit.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: Gate refuses Phase-4 work prior to Phase-1 sign-off. | manual |
...
| Architecture Module | plugins/vsdd-factory/skills/systematic-debugging/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/systematic-debugging/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/systematic-debugging/SKILL.md` — defining skill body for this contract
...
- [TBD — to be assigned in Phase 1.6c] — Gate refuses Phase-4 work prior to Phase-1 sign-off.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/systematic-debugging/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 1-15 |
| **Audit ID** | BC-AUDIT-713 |
