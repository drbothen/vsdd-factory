...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1015"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.06.030: state-burst: refuses 3rd commit + recovery via `git reset --soft HEAD~2`

## Description

state-burst: refuses 3rd commit + recovery via `git reset --soft HEAD~2`. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/state-burst/SKILL.md` (lines 156-205; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Stage 2 hook reports FAIL or any anti-pattern.

## Postconditions

1. DO NOT add a third commit; instead `git -C .factory reset --soft HEAD~2` and redo from Stage 1. Six anti-pattern detections: 3rd-commit chain, unbackfilled placeholder, in-progress voice, Stage-1 commit containing `backfill`, fabricated SHA (no git object), cross-record SHA drift.
...
| Architecture Module | plugins/vsdd-factory/skills/state-burst/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/state-burst/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/state-burst/SKILL.md` — defining skill body for this contract
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/state-burst/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 156-205 |
| **Audit ID** | BC-AUDIT-701 |
