...
state-burst: refuses 3rd commit + recovery via `git reset --soft HEAD~2`. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/state-burst/SKILL.md` (lines 156-205).
