...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L988"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.06.027: state-burst: announces protocol verbatim

## Description

state-burst: announces protocol verbatim. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/state-burst/SKILL.md` (lines 16-22; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Says verbatim: "I'm using the state-burst skill to execute the Single Canonical SHA + Two-Commit Protocol for this remediation burst. Stage 1 will write all fixes with the `15fa97e6` placeholder; Stage 2 will backfill the real SHA via global replace. No 3rd commit is permitted."
