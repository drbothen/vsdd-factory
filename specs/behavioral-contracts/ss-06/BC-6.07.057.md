...
validate-brief: market intel cross-check + report file + overall verdict. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-brief/SKILL.md` (lines 116-138; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: Report has all three sections + verdict. | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Report has all three sections + verdict.
