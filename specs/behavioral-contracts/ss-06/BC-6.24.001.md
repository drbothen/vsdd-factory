...
| ADR | ADR-026 v1.4 Decision 3 (prompt-the-human; operator clears session), Decision 4 (curated wave-state.yaml manifest; RAG deferred; reads from factory-artifacts via git; working-tree not authoritative) |
| Stories | S-18.03 |
