...
modified:
  - "2026-06-25 (v1.10) — D-699 post-merge burst (state-manager): lifecycle_status draft→active (POL-14 auto-promotion; S-18.03 PR #270 squash-merged bc9fc693 2026-06-25). No behavioral change."
  - "2026-06-16 (v1.10) — fix burst (product-owner): DEFERRED-VP (F3, S-18.03) resolved — §VP Anchors updated to active VP-088 reference; §Verification Properties row updated to VP-088 with verbatim title."
  - "2026-06-15 (v1.9) — fix burst (product-owner): (F-P35-002) §Changelog v1.5 skip-marker: de-enumerated explanatory clause (removed false BC-ID enumeration per F-P35-002 false-premise finding)."
...
|--------|----------|-------------|
| VP-088 | rehydrate-wave Reads wave-state.yaml From Git (Not Working Tree), Injects Exactly Listed Specs, Blocks on Missing Manifest, No RAG Fallback — rehydrate-wave reads wave-state.yaml from factory-artifacts via git (not working tree); injects exactly the union of stories[*].spec_files + arch_files + state_pointer; no stale prior-wave specs; hard-blocks with RehydrationError when wave-state.yaml missing; no RAG fallback; EPIC-COMPLETE path: reads HANDOFF.md only when epic_status:complete detected; context-injection LLM presentation step requires manual session test at F3 | integration (bats + manual session test for LLM presentation step) |
...
|---------|------|--------|--------|
| v1.10 | 2026-06-16 | product-owner | DEFERRED-VP (F3, S-18.03) resolved — VP-088 now exists per F2 gate human directive. §VP Anchors prose replaced with active bullet reference to VP-088; §Verification Properties row updated from DEFERRED-VP to VP-088 with verbatim H1 title "rehydrate-wave Reads wave-state.yaml From Git (Not Working Tree), Injects Exactly Listed Specs, Blocks on Missing Manifest, No RAG Fallback". Title-cite parity verified against VP-088 H1 verbatim. |
| v1.9 | 2026-06-15 | product-owner | (F-P35-002) §Changelog v1.5 skip-marker: de-enumerated explanatory clause — removed false BC-ID enumeration that claimed which specific BCs changed at the pass-5 burst (premise was false per F-P35-002); reworded to be self-contained without enumerating changed BCs, which makes the marker robust against premise errors. |
| v1.8 | 2026-06-15 | product-owner | (F-P33-001 MEDIUM) §Changelog: defensive skip-marker annotation added for v1.5 absence — v1.5 was a coordinated-burst skip; the jump v1.4→v1.6 is intentional, not a lost row. Exhaustive sibling-sweep of all 8 E-18 BCs per F-P33-001 obligation. |
