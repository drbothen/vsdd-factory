...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1483"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.049: ux-heuristic-evaluation: 0.7 threshold + remediation flagging

## Description

ux-heuristic-evaluation: 0.7 threshold + remediation flagging. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ux-heuristic-evaluation/SKILL.md` (lines 121-128, 152-157).
...
1. Threshold 0.7; scores below flagged for remediation; findings feed into adversarial review context.
...
| **Source Lines** | 121-128, 152-157 |
| **Audit ID** | BC-AUDIT-749 |
