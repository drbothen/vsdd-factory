...
# Behavioral Contract BC-6.06.041: wave-scheduling: identity & topo-sort algorithm

## Description

wave-scheduling: identity & topo-sort algorithm. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/wave-scheduling/SKILL.md` (lines 1-30; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Story decomposition complete.

## Postconditions

1. Reads STORY-INDEX.md dep graph; topo sort. Wave 1 = stories with `depends_on: []`. Wave N = stories whose deps are all in Waves 1..(N-1).
