...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | TBD — assertion derived from acceptance: "Resolve invocation always follows scan; UNRESOLVABLE>0 blocks proceeding without diagnosis." | manual |
