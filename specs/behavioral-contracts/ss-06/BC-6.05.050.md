...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L516"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.05.050: research-cache-ops: identity & wraps research-cache binary

## Description

research-cache-ops: identity & wraps research-cache binary. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/research-cache-ops/SKILL.md` (lines 1-8; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Cache inspection or invalidation request.

## Postconditions

1. Wraps `${CLAUDE_PLUGIN_ROOT}/bin/research-cache` operations.
