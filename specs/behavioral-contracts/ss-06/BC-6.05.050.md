...
research-cache-ops: identity & wraps research-cache binary. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/research-cache-ops/SKILL.md` (lines 1-8).
