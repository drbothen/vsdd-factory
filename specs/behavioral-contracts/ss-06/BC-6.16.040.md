...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L596"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.16.040: run-phase: identity & resolution rules

## Description

run-phase: identity & resolution rules. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/run-phase/SKILL.md` (lines 1-27; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. `/vsdd-factory:run-phase <phase-id>`.

## Postconditions

1. Argument is one of the 8 phase-* IDs or one of the 8 mode workflows (greenfield, brownfield, feature, maintenance, discovery, planning, multi-repo, code-delivery). Phase IDs resolve to `workflows/phases/<id>.lobster`; modes to `workflows/<id>.lobster`.
