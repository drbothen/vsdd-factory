...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1398"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.040: ui-quality-gate: identity, agents, UI conditional

## Description

ui-quality-gate: identity, agents, UI conditional. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ui-quality-gate/SKILL.md` (lines 1-17; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Primary consistency-validator; supporting accessibility-auditor/e2e-tester/performance-engineer/ux-designer/visual-reviewer.
