...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1113"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.032: storybook-mcp-integration: reuse-first enforcement before new components

## Description

storybook-mcp-integration: reuse-first enforcement before new components. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/storybook-mcp-integration/SKILL.md` (lines 113-119; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. implementer about to create a new component.

## Postconditions

1. (1) Call `list-all-documentation`; (2) search inventory for matching component; (3) if match, use existing with design-system tokens; (4) only create new with justification in commit message.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: New components carry justification commit message; reuse precedes creation. | manual |
...
- [TBD — to be assigned in Phase 1.6c] — New components carry justification commit message; reuse precedes creation.
...
| **Source Lines** | 113-119 |
| **Audit ID** | BC-AUDIT-711 |
