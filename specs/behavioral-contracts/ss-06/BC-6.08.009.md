...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | TBD — assertion derived from acceptance: "Tokens populated with documented neutral defaults; human-override path documented." | manual |
