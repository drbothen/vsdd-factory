...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-485"
ss_section: "Telemetry and analytics integration skills"
skill: "onboard-observability"
---

# Behavioral Contract BC-6.13.010: onboard-observability: Required announce-at-start verbatim message

## Description

Before any other action, says verbatim: "I'm using the onboard-observability skill to wire this project into the local observability stack.". Acceptance: Exact announce string.
...
1. Before any other action, says verbatim: "I'm using the onboard-observability skill to wire this project into the local observability stack."

## Invariants

1. Exact announce string.
