...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1318"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.14.030: track-debt: register format (Active vs Resolved sections)

## Description

track-debt: register format (Active vs Resolved sections). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/track-debt/SKILL.md` (lines 60-75; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Active table columns: ID, Severity, Category, Description, Effort, Source, Created. Resolved columns: ID, Description, Resolved By, Date.
