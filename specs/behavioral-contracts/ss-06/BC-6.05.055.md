...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L761"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.05.055: semport-analyze: full mode runs codebase-analyzer 6-pass protocol

## Description

semport-analyze: full mode runs codebase-analyzer 6-pass protocol. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/semport-analyze/SKILL.md` (lines 58-69; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Default (Full Ingestion).

## Postconditions

1. Six passes: (1) Inventory, (2) Architecture, (3) Domain Model, (4) Behavioral Contracts, (5) NFR Extraction, (6) Synthesis. All outputs write to `.factory/semport/`.
