...
semport-analyze: full mode runs codebase-analyzer 6-pass protocol. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/semport-analyze/SKILL.md` (lines 58-69).
