...
>25% degradation → open immediate PR (or flag if cause unclear). 10-25% → log with trend data. <10% → no action. Acceptance: Threshold table at lines 110-113.
...
1. Threshold table at lines 110-113.
