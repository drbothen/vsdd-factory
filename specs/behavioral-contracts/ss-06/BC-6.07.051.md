...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1287"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.051: traceability-extension: chain verification command

## Description

traceability-extension: chain verification command. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/traceability-extension/SKILL.md` (lines 136-149, 151-153).

## Preconditions

1. Phase F7 convergence pre-check.

## Postconditions

1. Pseudocode counts requirements with link_count<7 and emits "INCOMPLETE CHAIN: $line".
...
| **Source Lines** | 136-149, 151-153 |
| **Audit ID** | BC-AUDIT-729 |
