...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-575"
ss_section: "Brownfield, discovery, research skills"
skill: "planning-research"
---

# Behavioral Contract BC-6.05.043: planning-research: Cross-reference findings across ≥2 independent sources; date-stamp all findings

## Description

Cross-reference findings across at least 2 independent sources. Date-stamp all findings (technology landscapes change rapidly). Follow AGENTS.md query construction rules. Flag uncertainties. Acceptance: ≥2 sources; all findings date-stamped.
...
1. Cross-reference findings across at least 2 independent sources. Date-stamp all findings (technology landscapes change rapidly). Follow AGENTS.md query construction rules. Flag uncertainties.

## Invariants

1. ≥2 sources; all findings date-stamped.
