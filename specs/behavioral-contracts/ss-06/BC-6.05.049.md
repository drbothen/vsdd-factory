...
research: pre-run cache scan + post-run index update + factory commit. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/research/SKILL.md` (lines 46-64; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
