...
|--------|----------|-------------|
| VP-001 | TBD — assertion derived from acceptance: "Helper's stderr is shown verbatim; binary-missing case (exit 2) is documented as expected on fresh install pre-S-2.4." | manual |
