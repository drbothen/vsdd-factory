...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-474"
ss_section: "Brownfield, discovery, research skills"
skill: "multi-repo-phase-0-synthesis"
---

# Behavioral Contract BC-6.05.040: multi-repo-phase-0-synthesis: Quality Gate — unified project-context.md exists with cross-repo dependencies, conventions, validation

## Description

Quality Gate: unified project-context.md exists; cross-repo deps map all inter-repo API calls + shared types; per-repo files synthesized; convention conflicts have resolutions; synthesis validation report passes. Acceptance: Five checklist items.
...
1. Quality Gate: unified project-context.md exists; cross-repo deps map all inter-repo API calls + shared types; per-repo files synthesized; convention conflicts have resolutions; synthesis validation report passes.

## Invariants

1. Five checklist items.
