...
session-review: failure-mode safety (incomplete logs / missing cost / corrupt pattern db). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/session-review/SKILL.md` (lines 154-158).
