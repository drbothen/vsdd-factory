...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L846"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.04.037: session-review: failure-mode safety (incomplete logs / missing cost / corrupt pattern db)

## Description

session-review: failure-mode safety (incomplete logs / missing cost / corrupt pattern db). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/session-review/SKILL.md` (lines 154-158; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Incomplete logs → analyze available, document gaps. No cost data → skip cost dimension, note. Corrupt pattern-database.yaml → start fresh, flag for recovery.
...
| **Source Lines** | 154-158 |
| **Audit ID** | BC-AUDIT-684 |
