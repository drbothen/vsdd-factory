...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L966"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.047: spec-versioning: failure-mode safety (inconsistent versions / locked-VP modified / unparseable)

## Description

spec-versioning: failure-mode safety (inconsistent versions / locked-VP modified / unparseable). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/spec-versioning/SKILL.md` (lines 156-160; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Each named failure.

## Postconditions

1. Inconsistent history → flag, request human resolution before proceeding. Locked VP modified → CRITICAL, block pipeline, no auto-fix. Unparseable spec_version → flag story for manual review.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: No failure mode results in silent recovery; each gets explicit handling. | manual |
...
| Architecture Module | plugins/vsdd-factory/skills/spec-versioning/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/spec-versioning/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/spec-versioning/SKILL.md` — defining skill body for this contract
...
- [TBD — to be assigned in Phase 1.6c] — No failure mode results in silent recovery; each gets explicit handling.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/spec-versioning/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 156-160 |
| **Audit ID** | BC-AUDIT-696 |
