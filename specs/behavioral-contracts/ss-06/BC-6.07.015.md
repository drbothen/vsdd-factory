...
|--------|----------|-------------|
| VP-001 | TBD — assertion derived from acceptance: "Factory-health invoked first; existing brief triggers update-vs-fresh prompt; research reports consulted before redundant questions." | manual |
