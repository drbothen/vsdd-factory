...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-478"
ss_section: "Demo, UX, and design skills"
skill: "multi-variant-design"
---

# Behavioral Contract BC-6.08.015: multi-variant-design: Output is SCR-NNN-variants.md per complex screen

## Description

Writes `.factory/ui-quality/variants/SCR-NNN-variants.md` per screen with variant descriptions, scores, recommendation, and human decision tracker. Acceptance: Output path; document format.

## Preconditions

1. Variants generated.

## Postconditions

1. Writes `.factory/ui-quality/variants/SCR-NNN-variants.md` per screen with variant descriptions, scores, recommendation, and human decision tracker.

## Invariants

1. Output path; document format.
