...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L712"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.19.018: sdk-generation: contract-test integration (Pact / Specmatic / Schemathesis / openapi-diff)

## Description

sdk-generation: contract-test integration (Pact / Specmatic / Schemathesis / openapi-diff). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/sdk-generation/SKILL.md` (lines 175-260; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Validation step + Pipeline points table.

## Postconditions

1. Consumer-driven (Pact pattern); Specification-driven (Specmatic); Diff-based (openapi-diff/Optic); Generative (Schemathesis). Integrated at implementation, holdout, adversarial, F-modes.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: Contract testing role is documented at each pipeline point per the table. | manual |
...
| Architecture Module | plugins/vsdd-factory/skills/sdk-generation/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/sdk-generation/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/sdk-generation/SKILL.md` — defining skill body for this contract
...
- [TBD — to be assigned in Phase 1.6c] — Contract testing role is documented at each pipeline point per the table.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/sdk-generation/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 175-260 |
| **Audit ID** | BC-AUDIT-670 |
