...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | TBD — assertion derived from acceptance: "`.factory/current-cycle` exists with the cycle name and no trailing newline; cycle name passes the format validation." | manual |
