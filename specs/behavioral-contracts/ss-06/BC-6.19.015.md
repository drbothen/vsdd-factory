...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L685"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.19.015: sdk-generation: contract validation gates generation

## Description

sdk-generation: contract validation gates generation. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/sdk-generation/SKILL.md` (lines 28-38, 380-381).

## Preconditions

1. Step 1 (Read Contract).

## Postconditions

1. Reads source from `project.yaml`; runs `npx @apidevtools/swagger-cli validate "$CONTRACT_PATH"`; if validation fails, halt and report invalid contract to orchestrator.
...
| **Source Lines** | 28-38, 380-381 |
| **Audit ID** | BC-AUDIT-667 |
