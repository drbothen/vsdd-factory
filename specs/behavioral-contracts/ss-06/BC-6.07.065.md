...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1630"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.065: validate-template-compliance: documented limitations (no content quality, no value validation)

## Description

validate-template-compliance: documented limitations (no content quality, no value validation). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-template-compliance/SKILL.md` (lines 142-149; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Does NOT check content quality, does NOT validate frontmatter values, does NOT check table data correctness. INDEX files generally have no template (auto-generated, skipped).
...
| **Source Lines** | 142-149 |
| **Audit ID** | BC-AUDIT-764 |
