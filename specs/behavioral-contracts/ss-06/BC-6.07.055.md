...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1532"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.055: validate-brief: implementation-leakage tech-name scanner

## Description

validate-brief: implementation-leakage tech-name scanner. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-brief/SKILL.md` (lines 52-74; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
