...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-523"
ss_section: "Phase orchestration and mode skills"
skill: "phase-6-formal-hardening"
---

# Behavioral Contract BC-6.16.035: phase-6-formal-hardening: Gate — all proofs pass, fuzz 5min/target zero crashes, mutation >90%, zero CRIT/HIGH semgrep, cargo audit clean, purity intact

## Description

All Kani proofs pass; fuzz 5 min/target with zero crashes; mutation kill rate >90% (adjusted by criticality); zero critical/high Semgrep findings; cargo audit no known vulnerabilities; purity boundaries intact. Acceptance: Six gate items.
...
1. All Kani proofs pass; fuzz 5 min/target with zero crashes; mutation kill rate >90% (adjusted by criticality); zero critical/high Semgrep findings; cargo audit no known vulnerabilities; purity boundaries intact.
...
| Architecture Module | phase-6-formal-hardening |
| Stories | TBD |
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/phase-6-formal-hardening/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-523 |
