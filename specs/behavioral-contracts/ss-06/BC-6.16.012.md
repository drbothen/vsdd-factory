...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-497"
ss_section: "Phase orchestration and mode skills"
skill: "phase-0-codebase-ingestion"
---

# Behavioral Contract BC-6.16.012: phase-0-codebase-ingestion: Direct work skill is /vsdd-factory:brownfield-ingest <path>

## Description

Direct work command is `/vsdd-factory:brownfield-ingest <path>`. Acceptance: Command syntax.
...
1. Direct work command is `/vsdd-factory:brownfield-ingest <path>`.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/phase-1-prd-revision/SKILL.md` (60 LOC)` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-497 |
