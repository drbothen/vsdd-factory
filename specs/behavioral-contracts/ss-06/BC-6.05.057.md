...
semport-analyze: validate-extraction agent post-pass (max 3 iterations). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/semport-analyze/SKILL.md` (lines 92-99; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
