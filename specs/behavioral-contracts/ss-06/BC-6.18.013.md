...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L333"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.18.013: release: bootstrap detects markers across five project types

## Description

release: bootstrap detects markers across five project types. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/release/SKILL.md` (lines 49-66; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Bootstrap Mode Step 1.

## Postconditions

1. Scans for `Cargo.toml`, `package.json`, `pyproject.toml`, `plugins/*/.claude-plugin/plugin.json`, `go.mod` and matching publish/version conventions; also detects test scripts, CHANGELOG, CI workflows, README badge, marketplace.json.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: Generated config covers any markers found; absent markers do not appear. | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Generated config covers any markers found; absent markers do not appear.
