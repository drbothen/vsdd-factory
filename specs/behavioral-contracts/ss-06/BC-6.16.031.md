...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-519"
ss_section: "Phase orchestration and mode skills"
skill: "phase-5-adversarial-refinement"
---

# Behavioral Contract BC-6.16.031: phase-5-adversarial-refinement: Identity — multi-model adversarial loop until novelty=0

## Description

Two steps: adversarial review loop (fresh-context review + triage-and-fix, iterated until CONVERGENCE_REACHED) + optional secondary review (code-reviewer / Gemini). Acceptance: Frontmatter `name: phase-5-adversarial-refinement`.

## Preconditions

1. Phase 3 implementation complete + Phase 4 holdout passed.

## Postconditions

1. Two steps: adversarial review loop (fresh-context review + triage-and-fix, iterated until CONVERGENCE_REACHED) + optional secondary review (code-reviewer / Gemini).

## Invariants

1. Frontmatter `name: phase-5-adversarial-refinement`.
...
| Architecture Module | phase-5-adversarial-refinement |
| Stories | TBD |
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/phase-5-adversarial-refinement/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-519 |
| **Source Line(s)** | 1-5 |
