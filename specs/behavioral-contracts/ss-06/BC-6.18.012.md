...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L324"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.18.012: release: announces protocol verbatim

## Description

release: announces protocol verbatim. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/release/SKILL.md` (lines 18-22; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Skill start, before any other action.

## Postconditions

1. Says: "**Release Pipeline** — reading release config from `.factory/release-config.yaml`."
