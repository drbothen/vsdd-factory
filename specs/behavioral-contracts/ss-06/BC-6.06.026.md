...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L979"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.06.026: state-burst: identity & defect-class context

## Description

state-burst: identity & defect-class context. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/state-burst/SKILL.md` (lines 1-15; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Adversarial-pass remediation burst on factory-artifacts branch (STATE.md + SESSION-HANDOFF.md + wave-state.yaml in lockstep).

## Postconditions

1. Single Canonical SHA + Two-Commit Protocol; structural fix for defect class with 6 consecutive recurrences (case study: docs/lessons-learned/wave-gate-bookkeeping.md).
