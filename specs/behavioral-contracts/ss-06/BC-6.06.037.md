...
wave-gate: gate sequence is load-bearing (1→2→3→4→5→6, stop on first failure). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/wave-gate/SKILL.md` (lines 53-117; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
