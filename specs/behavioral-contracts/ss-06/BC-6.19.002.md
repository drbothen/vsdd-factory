...
repo-initialization: workspace-isolation guard refuses dark-factory cwd. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/repo-initialization/SKILL.md` (lines 81-91).
