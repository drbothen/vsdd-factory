...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | TBD — assertion derived from acceptance: "When config and AGENTS.md disagree, the check returns FAIL and identifies both stated values." | manual |
