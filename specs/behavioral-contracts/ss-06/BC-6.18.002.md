...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L39"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.18.002: pr-create: gathers story context before generating body

## Description

pr-create: gathers story context before generating body. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/pr-create/SKILL.md` (lines 24-30; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Skill running step 1 (Gather Context).

## Postconditions

1. Reads `.factory/stories/STORY-NNN.md`, the story's behavioral contracts, captures `git diff develop...HEAD` (in story worktree), counts tests added/modified.
