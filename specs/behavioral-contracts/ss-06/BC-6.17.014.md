...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-541"
ss_section: "Feature-mode phase skills (f1-f7)"
skill: "phase-f2-spec-evolution"
---

# Behavioral Contract BC-6.17.014: phase-f2-spec-evolution: Failure — missing F1 output halts F2; CRITICAL after 3 rounds escalates to human

## Description

Missing F1 delta-analysis.md → stop and report to orchestrator; F2 cannot proceed without F1. Conflicts with existing BCs → flag with before/after comparison and escalate to product-owner. Adversary CRITICAL after 3 rounds → escalate to human with unresolved findings. Acceptance: Three failure modes.

## Preconditions

1. F1 output missing or adversary finds CRITICAL after 3 rounds.

## Postconditions

1. Missing F1 delta-analysis.md → stop and report to orchestrator; F2 cannot proceed without F1. Conflicts with existing BCs → flag with before/after comparison and escalate to product-owner. Adversary CRITICAL after 3 rounds → escalate to human with unresolved findings.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/phase-f3-incremental-stories/SKILL.md` (148 LOC)` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-541 |
