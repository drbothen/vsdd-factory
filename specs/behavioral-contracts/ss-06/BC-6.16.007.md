...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-481"
ss_section: "Phase orchestration and mode skills"
skill: "next-step"
---

# Behavioral Contract BC-6.16.007: next-step: STATE.md missing → directs user to factory-health and stops

## Description

"If it doesn't exist, tell the user to run `/vsdd-factory:factory-health` and stop.". Acceptance: Stop-on-missing-state behavior.

## Preconditions

1. STATE.md does not exist.

## Postconditions

1. "If it doesn't exist, tell the user to run `/vsdd-factory:factory-health` and stop."

## Invariants

1. Stop-on-missing-state behavior.
