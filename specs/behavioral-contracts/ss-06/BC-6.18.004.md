...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L57"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.18.004: pr-create: PR creation targets develop with feat-prefixed title

## Description

pr-create: PR creation targets develop with feat-prefixed title. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/pr-create/SKILL.md` (lines 78-83; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Runs `gh pr create --title "feat(STORY-NNN): <title>" --body <generated> --base develop`.
