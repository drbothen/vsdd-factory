...
pr-create: PR creation targets develop with feat-prefixed title. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/pr-create/SKILL.md` (lines 78-83).
