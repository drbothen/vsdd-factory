...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-1.md#L1124"
subsystem: SS-06
capability: "TBD"
...
# Behavioral Contract BC-6.03.009: deactivate: empty-file disposition asks user

> Source: `pass-3-deep-skills-batch-1.md` line 1124 (was `BC-AUDIT-307`)
> Subsystem: SS-06 — Skill Catalog
> Section: Activation and deactivation skills

## Description

deactivate: empty-file disposition asks user. Skill asks user whether to delete the file or leave it as `{}` — does not silently choose.

## Preconditions

1. After `del(.agent) | del(.["vsdd-factory"])` produces empty object

## Postconditions

1. User prompt occurs when post-deletion JSON would be empty.
...
- `architecture/ss-06-skill-catalog.md#deactivate-empty-file-disposition-asks-user` — TBD anchor
...
| **Source line(s) within skill** | 25-28 |
