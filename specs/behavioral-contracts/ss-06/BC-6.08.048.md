...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1474"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.048: ux-heuristic-evaluation: cognitive walkthrough per key task

## Description

ux-heuristic-evaluation: cognitive walkthrough per key task. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ux-heuristic-evaluation/SKILL.md` (lines 94-119; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Per key user task in UX spec.

## Postconditions

1. Define task → walk steps (find/understand/confirm) → measure (steps required, error_potential, backtrack_points) → score 0.0-1.0. YAML schema: name/expected_steps/actual_steps/error_potential/backtrack_points/score/issues.
