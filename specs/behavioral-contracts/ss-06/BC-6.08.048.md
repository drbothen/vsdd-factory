...
ux-heuristic-evaluation: cognitive walkthrough per key task. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ux-heuristic-evaluation/SKILL.md` (lines 94-119).
