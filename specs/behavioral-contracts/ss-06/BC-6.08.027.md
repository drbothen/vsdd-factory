...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1068"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.027: storybook-mcp-integration: identity & UI-conditional invocation

## Description

storybook-mcp-integration: identity & UI-conditional invocation. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/storybook-mcp-integration/SKILL.md` (lines 1-22; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. `feature_type in ['ui', 'full-stack']`; UI framework present (React/Vue/Svelte/Angular).

## Postconditions

1. Primary dx-engineer; supporting devops-engineer/implementer/test-writer/e2e-tester/visual-reviewer. Outputs Storybook + addon-mcp + MCP server at http://localhost:6006/mcp.
