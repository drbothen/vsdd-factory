...
storybook-mcp-integration: identity & UI-conditional invocation. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/storybook-mcp-integration/SKILL.md` (lines 1-22).
