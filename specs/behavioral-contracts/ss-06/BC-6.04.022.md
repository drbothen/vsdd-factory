...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-407"
ss_section: "Adversarial and review skills"
skill: "fix-pr-delivery"
---

# Behavioral Contract BC-6.04.022: fix-pr-delivery: Max 10 review cycles before convergence or exhaustion

## Description

Cycle of post → triage → fix → re-review repeats until APPROVE or 10 cycles exhausted. Acceptance: Hard cap at 10 review cycles per fix PR.

## Preconditions

1. PR-Reviewer posts findings on a fix PR.

## Postconditions

1. Cycle of post → triage → fix → re-review repeats until APPROVE or 10 cycles exhausted.

## Invariants

1. Hard cap at 10 review cycles per fix PR.
