...
repo-initialization: CI/CD setup is deferred to post-architecture. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/repo-initialization/SKILL.md` (lines 182-187; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: No `.github/workflows/` is created at repo-initialization time. | manual |
...
- [TBD — to be assigned in Phase 1.6c] — No `.github/workflows/` is created at repo-initialization time.
