...
state-update: 4-step procedure (read → frontmatter → history → commit). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/state-update/SKILL.md` (lines 19-66).
