...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L387"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.18.019: release: error-handling catalog

## Description

release: error-handling catalog. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/release/SKILL.md` (lines 259-266; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Each named failure (unknown schema, unknown gate mode, pre-release fail, version bump fail, push fail, CI fail).

## Postconditions

1. Aborts with specific message; never retries push or re-tags on CI failure.
...
| **Source Lines** | 259-266 |
| **Audit ID** | BC-AUDIT-637 |
