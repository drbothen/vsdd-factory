...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L828"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.04.035: session-review: 72h non-blocking timeout

## Description

session-review: 72h non-blocking timeout. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/session-review/SKILL.md` (lines 128-132; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. No human response within 72h.

## Postconditions

1. All proposals auto-defer to backlog; pipeline marked COMPLETE regardless. Session review never blocks pipeline completion indefinitely.
...
| **Source Lines** | 128-132 |
| **Audit ID** | BC-AUDIT-682 |
