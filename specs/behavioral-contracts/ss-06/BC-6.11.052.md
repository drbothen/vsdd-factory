...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1843"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.11.052: worktree-manage: identity & 3 commands (create/list/cleanup)

## Description

worktree-manage: identity & 3 commands (create/list/cleanup). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/worktree-manage/SKILL.md` (lines 1-7; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. `/worktree-manage [create|list|cleanup] [STORY-NNN]`.

## Postconditions

1. disable-model-invocation true; allowed-tools Bash/Read.
