...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1407"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.041: ui-quality-gate: comprehensive checklist across 5 dimensions

## Description

ui-quality-gate: comprehensive checklist across 5 dimensions. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ui-quality-gate/SKILL.md` (lines 22-51; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Full checklist run.

## Postconditions

1. Design system (token/component/pattern); Completeness (screens/states/interactions/responsive); Quality (heuristic ≥0.7, task completion ≥0.8, axe zero, keyboard, perf LCP<2.5s/FID<100ms/CLS<0.1); Visual (regression/responsive/screenshots); States (loading/error/empty for each async view).
...
| Architecture Module | plugins/vsdd-factory/skills/ui-quality-gate/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/ui-quality-gate/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/ui-quality-gate/SKILL.md` — defining skill body for this contract
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/ui-quality-gate/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 22-51 |
| **Audit ID** | BC-AUDIT-741 |
