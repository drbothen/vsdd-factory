...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L293"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.14.021: register-artifact: refuses to create INDEX file (separation of concerns)

## Description

register-artifact: refuses to create INDEX file (separation of concerns). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/register-artifact/SKILL.md` (lines 65-69, 130-135).

## Preconditions

1. Step 3 INDEX existence check or out-of-scope guard.

## Postconditions

1. If INDEX missing, report and stop; do NOT create INDEX (creator agents own that), do NOT create the artifact file, do NOT update story frontmatter, do NOT validate content.
...
| **Source Lines** | 65-69, 130-135 |
| **Audit ID** | BC-AUDIT-627 |
