...
spec-drift: scans 4 spec dirs + checks naming + finds orphans. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/spec-drift/SKILL.md` (lines 10-46; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
