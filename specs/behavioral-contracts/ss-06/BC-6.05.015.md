...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-1.md#L1328"
subsystem: SS-06
capability: "TBD"
...
# Behavioral Contract BC-6.05.015: discovery-engine: skill identity (autonomous opportunity research)

> Source: `pass-3-deep-skills-batch-1.md` line 1328 (was `BC-AUDIT-327`)
> Subsystem: SS-06 — Skill Catalog
> Section: Brownfield, discovery, research skills

## Description

discovery-engine: skill identity (autonomous opportunity research). Continuously researches opportunities for new features (existing products) and net-new product concepts. Evaluates ideas against structured criteria. Facilitates planning document creation. Routes approved ideas to development pipeline. Orchestrator delegates to specialist agents (research-agent primarily) — does not execute steps directly.

## Preconditions

1. Scheduled (weekly features, bi-weekly products), manual, or event-driven

## Postconditions

1. Outputs feature-research, feature-ideas, product-research, product-concepts, briefs, and discovery-report files.
...
- `architecture/ss-06-skill-catalog.md#discovery-engine-skill-identity-(autonomous-opportunity-research)` — TBD anchor
...
| **Source line(s) within skill** | 1-13 |
