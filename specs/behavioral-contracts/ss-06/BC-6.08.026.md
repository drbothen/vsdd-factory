...
responsive-validation: failure modes (resize/screenshot/auth). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/responsive-validation/SKILL.md` (lines 124-128).
