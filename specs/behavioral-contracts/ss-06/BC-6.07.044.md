...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L939"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.044: spec-versioning: bump-type rules (MAJOR/MINOR/PATCH)

## Description

spec-versioning: bump-type rules (MAJOR/MINOR/PATCH). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/spec-versioning/SKILL.md` (lines 14-54; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. MAJOR = breaking (architectural rework, removed reqs, behavior change, renamed IDs). MINOR = backward-compat additions (new FRs, NFRs, VPs, new components). PATCH = clarifications/typos/example additions/correcting wrong constraint.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: Bump rationale references one of these three categories. | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Bump rationale references one of these three categories.
