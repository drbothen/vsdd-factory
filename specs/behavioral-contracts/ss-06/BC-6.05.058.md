...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L788"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.05.058: semport-analyze: outputs and post-skill report

## Description

semport-analyze: outputs and post-skill report. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/semport-analyze/SKILL.md` (lines 100-124; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Full mode: pass-0..pass-8 files + `<module>-target-design.md` per module + `semport-assessment.md`. Incremental: delta file + updated target designs. Reports mode, passes complete, modules analyzed, BC counts (HIGH/MEDIUM/LOW), validation result.
...
| **Source Lines** | 100-124 |
| **Audit ID** | BC-AUDIT-678 |
