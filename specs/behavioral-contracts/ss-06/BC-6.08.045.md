...
ui-quality-gate: gate-report.md structure (Gate Level + Result + Checklist + Failures + Perf table). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ui-quality-gate/SKILL.md` (lines 124-148).
