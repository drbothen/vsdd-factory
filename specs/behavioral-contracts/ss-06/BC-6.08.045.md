...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1443"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.045: ui-quality-gate: gate-report.md structure (Gate Level + Result + Checklist + Failures + Perf table)

## Description

ui-quality-gate: gate-report.md structure (Gate Level + Result + Checklist + Failures + Perf table). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ui-quality-gate/SKILL.md` (lines 124-148; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Output structure: ## UI Quality Gate Report → Gate Level → Result PASS/FAIL → Checklist table → Failures list (mapping to FIX-UI-NNN) → Performance Metrics table.
