...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | TBD — assertion derived from acceptance: "Stale-phase findings include exact line numbers; non-standard compound phases (e.g., `2-story-decomposition-patch-cycle`) flagged." | manual |
