...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-482"
ss_section: "Phase orchestration and mode skills"
skill: "next-step"
---

# Behavioral Contract BC-6.16.008: next-step: Does not execute — proposal only

## Description

"Do not execute. This skill only proposes. The user decides whether to run `/vsdd-factory:run-phase` or invoke the step manually.". Acceptance: Proposal-only mode.
...
1. "Do not execute. This skill only proposes. The user decides whether to run `/vsdd-factory:run-phase` or invoke the step manually."

## Invariants

1. Proposal-only mode.
