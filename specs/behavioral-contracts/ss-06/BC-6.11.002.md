...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-1.md#L1510"
subsystem: SS-06
capability: "TBD"
...
# Behavioral Contract BC-6.11.002: factory-cycles-bootstrap: archives via `git mv` (preserves history)

> Source: `pass-3-deep-skills-batch-1.md` line 1510 (was `BC-AUDIT-345`)
> Subsystem: SS-06 — Skill Catalog
> Section: Factory operations and dashboards skills

## Description

factory-cycles-bootstrap: archives via `git mv` (preserves history). Moves each file using `git mv` (preserves history): `specs/adversarial-review-pass-1.md` → `cycles/<historical-cycle>/adversarial-reviews/pass-1.md`. Renumbers if naming inconsistent. Creates INDEX.md in historical cycle dir listing all archived passes.

## Preconditions

1. Step 4 with historical files

## Postconditions

1. Git log shows the move (not delete + add); INDEX.md exists in historical cycle dir.
...
- `architecture/ss-06-skill-catalog.md#factory-cycles-bootstrap-archives-via-`git-mv`-(preserves-history)` — TBD anchor
...
| **Source line(s) within skill** | 53-62 |
