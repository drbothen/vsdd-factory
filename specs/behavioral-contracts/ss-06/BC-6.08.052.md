...
visual-companion: server lifecycle (start/url/state-dir/stop, 30-min auto-exit). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/visual-companion/SKILL.md` (lines 30-65).
