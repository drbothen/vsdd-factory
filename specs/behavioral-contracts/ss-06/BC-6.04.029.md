...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-516"
ss_section: "Adversarial and review skills"
skill: "phase-4-holdout-evaluation"
---

# Behavioral Contract BC-6.04.029: phase-4-holdout-evaluation: Identity — Phase 4 entry point with scenario rotation + holdout-eval skill

## Description

Two-step workflow: scenario rotation (orchestrator randomly selects 80% subset of holdout scenarios), then holdout-eval skill runs evaluation with different model family. Acceptance: Frontmatter `name: phase-4-holdout-evaluation`.

## Preconditions

1. Phase 3 wave complete (all wave stories merged).

## Postconditions

1. Two-step workflow: scenario rotation (orchestrator randomly selects 80% subset of holdout scenarios), then holdout-eval skill runs evaluation with different model family.

## Invariants

1. Frontmatter `name: phase-4-holdout-evaluation`.
