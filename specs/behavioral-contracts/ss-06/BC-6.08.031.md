...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1104"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.031: storybook-mcp-integration: self-healing loop with 10-iteration cap

## Description

storybook-mcp-integration: self-healing loop with 10-iteration cap. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/storybook-mcp-integration/SKILL.md` (lines 80-111; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Component test cycle.

## Postconditions

1. implementer writes Component.tsx → test-writer calls get-storybook-story-instructions → test-writer writes Component.stories.tsx → implementer calls preview-stories (fix loop) → test-writer calls run-story-tests → on FAIL, fix + re-run; max 10 iterations then escalate to human.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: Loop count is bounded at 10; escalation occurs at exhaustion. | manual |
...
| Architecture Module | plugins/vsdd-factory/skills/storybook-mcp-integration/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/storybook-mcp-integration/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/storybook-mcp-integration/SKILL.md` — defining skill body for this contract
...
- [TBD — to be assigned in Phase 1.6c] — Loop count is bounded at 10; escalation occurs at exhaustion.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/storybook-mcp-integration/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 80-111 |
| **Audit ID** | BC-AUDIT-710 |
