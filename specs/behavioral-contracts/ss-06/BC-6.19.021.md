...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L859"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.19.021: setup-env: identity & frontmatter

## Description

setup-env: identity & frontmatter. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/setup-env/SKILL.md` (lines 1-7; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. `/vsdd-factory:setup-env`.

## Postconditions

1. disable-model-invocation true; allowed-tools Bash/Read/Write.
