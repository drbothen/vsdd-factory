...
ux-heuristic-evaluation: identity, conditional, four pipeline points. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ux-heuristic-evaluation/SKILL.md` (lines 1-29).
