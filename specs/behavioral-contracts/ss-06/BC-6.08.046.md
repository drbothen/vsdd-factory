...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1456"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.046: ux-heuristic-evaluation: identity, conditional, four pipeline points

## Description

ux-heuristic-evaluation: identity, conditional, four pipeline points. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ux-heuristic-evaluation/SKILL.md` (lines 1-29; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Primary ux-designer; supporting accessibility-auditor/business-analyst. Runs at: after UX spec produced, after holdout evaluation, F2 (feature spec delta), wave gate.
