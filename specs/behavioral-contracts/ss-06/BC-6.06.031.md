...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1024"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.06.031: state-burst: documented bypass paths

## Description

state-burst: documented bypass paths. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/state-burst/SKILL.md` (lines 198-216; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. First state-manager burst on brand-new project (no wave-state.yaml) OR manual recovery after force-push.

## Postconditions

1. Bypass acceptable; document bypass reason in `SESSION-HANDOFF.md → Recent Burst Episodes`.
...
| **Source Lines** | 198-216 |
| **Audit ID** | BC-AUDIT-702 |
