...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-461"
ss_section: "Phase orchestration and mode skills"
skill: "mode-decision-guide"
---

# Behavioral Contract BC-6.16.005: mode-decision-guide: Human override always wins over auto-detection

## Description

"The Orchestrator respects explicit human mode selection over auto-detection.". Acceptance: Override rule.

## Preconditions

1. Human says "Run X mode".

## Postconditions

1. "The Orchestrator respects explicit human mode selection over auto-detection."
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/model-routing/SKILL.md` (70 LOC)` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-461 |
