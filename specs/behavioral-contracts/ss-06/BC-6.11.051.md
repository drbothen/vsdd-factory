...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L155"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.11.051: quick-dev-routing: writes routing-decision.md and falls back on regression failure

## Description

quick-dev-routing: writes routing-decision.md and falls back on regression failure. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/quick-dev-routing/SKILL.md` (lines 86-97; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. End of routing or regression failure mid-flight.

## Postconditions

1. Writes `.factory/phase-f1-delta-analysis/routing-decision.md` with qualification assessment, multi-goal result, route choice, compressed plan; if regression fails post-Quick-Dev, escalate to full F4.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: routing-decision.md exists with all four sections; regression failure routes back to full F4 with regression-log.md. | manual |
...
| Architecture Module | plugins/vsdd-factory/skills/quick-dev-routing/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/quick-dev-routing/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/quick-dev-routing/SKILL.md` — defining skill body for this contract
...
- [TBD — to be assigned in Phase 1.6c] — routing-decision.md exists with all four sections; regression failure routes back to full F4 with regression-log.md.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/quick-dev-routing/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 86-97 |
| **Audit ID** | BC-AUDIT-613 |
