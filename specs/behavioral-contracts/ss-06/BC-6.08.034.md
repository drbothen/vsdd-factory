...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1340"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.034: ui-completeness-check: identity, agents, UI gating, zero-gap rule

## Description

ui-completeness-check: identity, agents, UI gating, zero-gap rule. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ui-completeness-check/SKILL.md` (lines 1-23; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. `feature_type in ['ui', 'full-stack']`.

## Postconditions

1. Primary consistency-validator; supporting ux-designer/e2e-tester. Inputs design-system + UX-INDEX + stories + source code + tests + ui-evidence; outputs ui-traceability.yaml + completeness-report.md. Gate: ZERO gaps required before convergence.
