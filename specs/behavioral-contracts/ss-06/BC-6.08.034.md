...
ui-completeness-check: identity, agents, UI gating, zero-gap rule. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ui-completeness-check/SKILL.md` (lines 1-23).
