...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L168"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.017: record-demo: identity & template usage

## Description

record-demo: identity & template usage. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/record-demo/SKILL.md` (lines 1-19; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. `/vsdd-factory:record-demo STORY-NNN`.

## Postconditions

1. disable-model-invocation true, allowed-tools Read/Write/Bash/Glob; reads three templates (demo-evidence-report, demo-playwright-template.spec.ts, demo-tape-template.tape).
