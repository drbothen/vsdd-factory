...
|--------|----------|-------------|
| VP-001 | Acceptance: No re-scan of full codebase; existing pass files only appended. | manual |
...
- [VP-001] — No re-scan of full codebase; existing pass files only appended.
