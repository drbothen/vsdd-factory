...
semport-analyze: incremental protocol is delta-only (5 steps). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/semport-analyze/SKILL.md` (lines 39-56).
