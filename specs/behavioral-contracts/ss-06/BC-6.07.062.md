...
validate-template-compliance: template resolution by document_type then path. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-template-compliance/SKILL.md` (lines 27-58).
