...
validate-brief: information density anti-patterns (4 categories + thresholds). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-brief/SKILL.md` (lines 76-109; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
