...
modified:
  ...
  - "2026-07-28 (v1.13) — S-21.04 pass-23 F-S2104-P23-005 un-swept seventh site (product-owner; D-{TBD-pass-23-fix-burst}): EC-005 note corrected — retracted claim 'falls through to find which returns empty → false PC2a' replaced with verified mechanism: POSIX test -d follows symlinks (symlink-to-directory satisfies [ -d ] → [ ! -d ] is false → falls through to find); trailing-slash form dereferences symlink-to-directory via POSIX pathname resolution, enumerating files from target directory outside worktree boundary (out-of-scope traversal); empty target yields false PC2a(b) → teardown proceeds; symlink entry removed without operator notification; no target data loss (recursive-remove does not follow symlinks). Consistent with EC-008 contrast and T-7 contrast corrected at v1.12."
deprecated: null
deprecated_by: null
replacement: null
retired: null
...
bc_id: BC-6.26.001
section: "6.26"
last_amended: "(v1.13) — S-21.04 pass-23 F-S2104-P23-005 EC-005 seventh-site fix (product-owner; D-{TBD-pass-23-fix-burst}): EC-005 note corrected — 'falls through to find which returns empty → false PC2a' replaced with verified mechanism (trailing-slash find dereferences symlink-to-directory; out-of-scope traversal; empty target yields false PC2a(b); symlink entry removed without operator notification; no target data loss). [Prior: (v1.12) — F-S2104-P22-002. (v1.11) — F-S2104-P10-005. (v1.10) — F-S2104-P8-003. (v1.9) — F-S2104-P7-006. (v1.8) — F-S2104-P6-005(b). (v1.7) — F-S2104-P5-011/F-P5-009/F-P5-010. (v1.6) — F-S2104-P4-007. (v1.5) — F-002/O-005. (v1.4) — F-004/006/007/010. (v1.3) — F-P1-005. (v1.2) — research. (v1.1) — CAP-036. (v1.0) — Initial.]"
---
