...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L186"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.019: record-demo: writes demo-report.md with per-AC table

## Description

record-demo: writes demo-report.md with per-AC table. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/record-demo/SKILL.md` (lines 58-77; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Step 3 after all ACs captured.

## Postconditions

1. Writes `.factory/demo-evidence/STORY-NNN/demo-report.md` with per-AC method/evidence/result/notes, plus summary (criteria demonstrated count, missing list).
...
| Architecture Module | plugins/vsdd-factory/skills/record-demo/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/record-demo/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/record-demo/SKILL.md` — defining skill body for this contract
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/record-demo/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 58-77 |
| **Audit ID** | BC-AUDIT-616 |
