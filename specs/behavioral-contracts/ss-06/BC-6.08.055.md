...
visual-companion: excalidraw mode + composed views (screen.json manifest). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/visual-companion/SKILL.md` (lines 74-104).
