...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L128"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.11.048: quick-dev-routing: identity & qualification gate

## Description

quick-dev-routing: identity & qualification gate. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/quick-dev-routing/SKILL.md` (lines 1-31; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Phase F1 delta analysis flags trivial-scope change.

## Postconditions

1. All seven qualification criteria (files changed ≤3, new ≤2, modified ≤1 internal, dependents 0, no architecture impact, no security impact, zero blast radius) must hold; otherwise route to full F1-F7.
