...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-591"
ss_section: "Story delivery skills"
skill: "post-feature-validation"
---

# Behavioral Contract BC-6.10.015: post-feature-validation: Verdict thresholds — SUCCESS / PARTIAL / MISS based on adoption + feedback ratio + bugs

## Description

SUCCESS = adoption meets target AND positive ratio meets target AND no critical bugs. PARTIAL = adoption meets but feedback mixed, OR good feedback but low adoption. MISS = adoption below target AND/OR negative dominant AND/OR critical bugs. Acceptance: Three-tier verdict rubric.
...
1. SUCCESS = adoption meets target AND positive ratio meets target AND no critical bugs. PARTIAL = adoption meets but feedback mixed, OR good feedback but low adoption. MISS = adoption below target AND/OR negative dominant AND/OR critical bugs.

## Invariants

1. Three-tier verdict rubric.
