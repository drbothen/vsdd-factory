...
wave-gate: announces protocol verbatim + TodoWrite per gate. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/wave-gate/SKILL.md` (lines 14-27; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
