...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L204"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.021: record-demo: commits evidence to factory-artifacts

## Description

record-demo: commits evidence to factory-artifacts. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/record-demo/SKILL.md` (lines 79-85; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Step 4 after report written.

## Postconditions

1. Runs `git add demo-evidence/STORY-NNN/` + commit `factory(phase-3): demo evidence for STORY-NNN` on `.factory` worktree.
