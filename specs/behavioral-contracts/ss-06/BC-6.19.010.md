...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L636"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.19.010: scaffold-claude-md: identity & overwrite confirmation

## Description

scaffold-claude-md: identity & overwrite confirmation. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/scaffold-claude-md/SKILL.md` (lines 1-15; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. `/vsdd-factory:scaffold-claude-md`.

## Postconditions

1. If existing CLAUDE.md present, displays it and asks overwrite-or-cancel; on cancel, stops.
