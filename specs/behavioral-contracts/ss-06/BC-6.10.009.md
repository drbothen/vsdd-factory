...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-433"
ss_section: "Story delivery skills"
skill: "implementation-readiness"
---

# Behavioral Contract BC-6.10.009: implementation-readiness: Context budget warns when total exceeds 60% of agent context window

## Description

Sum all artifacts loaded into agent context during implementation. If total > 60% of agent's context window, flag for compression using Extended ToC pattern. Acceptance: Quality Gate: "Context budget within 60% of implementing agent's context window".
...
1. Sum all artifacts loaded into agent context during implementation. If total > 60% of agent's context window, flag for compression using Extended ToC pattern.

## Invariants

1. Quality Gate: "Context budget within 60% of implementing agent's context window".
