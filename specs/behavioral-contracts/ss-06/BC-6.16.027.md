...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-512"
ss_section: "Phase orchestration and mode skills"
skill: "phase-2-story-decomposition"
---

# Behavioral Contract BC-6.16.027: phase-2-story-decomposition: Direct command is /vsdd-factory:decompose-stories

## Description

Direct work command is `/vsdd-factory:decompose-stories`. Acceptance: Command syntax.
...
1. Direct work command is `/vsdd-factory:decompose-stories`.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/phase-3-tdd-implementation/SKILL.md` (49 LOC)` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-512 |
| **Source Line(s)** | 28-30 |
