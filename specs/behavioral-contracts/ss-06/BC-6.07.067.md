...
validate-workflow: 6 checks (required fields/agent/skill/depends_on/dup names/top-level). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-workflow/SKILL.md` (lines 14-23; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
