...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L79"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.18.006: pr-review-triage: identity & dispatch role

## Description

pr-review-triage: identity & dispatch role. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/pr-review-triage/SKILL.md` (lines 1-15; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. pr-manager invokes after pr-reviewer posts REQUEST_CHANGES.

## Postconditions

1. Classifies each finding and routes to fix agent.
