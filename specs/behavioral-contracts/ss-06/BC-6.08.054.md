...
visual-companion: visual-vs-terminal decision rule. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/visual-companion/SKILL.md` (lines 66-72; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: Rule explicitly cited when choosing browser vs terminal. | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Rule explicitly cited when choosing browser vs terminal.
