...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-1.md#L1377"
subsystem: SS-06
capability: "TBD"
...
# Behavioral Contract BC-6.05.020: disposition-pass: 4-bucket mandatory categorization

> Source: `pass-3-deep-skills-batch-1.md` line 1377 (was `BC-AUDIT-332`)
> Subsystem: SS-06 — Skill Catalog
> Section: Brownfield, discovery, research skills

## Description

disposition-pass: 4-bucket mandatory categorization. Every substantive capability sorts into EXACTLY one bucket: Model (adopt as-is), Take but reimplement (right idea, rebuild cleanly), Enhance (extend beyond source), Leave behind (explicitly reject — REASON REQUIRED).

## Preconditions

1. Per-repo categorization

## Postconditions

1. No capability appears in 2 buckets; every "Leave behind" entry has a reason.
...
- `architecture/ss-06-skill-catalog.md#disposition-pass-4-bucket-mandatory-categorization` — TBD anchor
...
| **Source line(s) within skill** | 30-40 |
