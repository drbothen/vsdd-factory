...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | TBD — assertion derived from acceptance: "Cluster size ≥2 means similarity computation succeeded; no inflated raw counts in digest." | manual |
