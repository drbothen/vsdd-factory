...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L494"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.05.048: research: domain vs general routing by first arg

## Description

research: domain vs general routing by first arg. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/research/SKILL.md` (lines 22-43; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. First word `domain` → produces `.factory/specs/research/domain-<slug>-<YYYY-MM-DD>.md`. Anything else → general → `general-<slug>-<YYYY-MM-DD>.md`.
