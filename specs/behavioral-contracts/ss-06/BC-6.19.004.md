...
repo-initialization: factory-artifacts orphan worktree pre-check (NOT dark-factory). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/repo-initialization/SKILL.md` (lines 146-172).
