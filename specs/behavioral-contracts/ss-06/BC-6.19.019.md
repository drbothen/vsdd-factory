...
sdk-generation: contract evolution (semver + breaking detection). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/sdk-generation/SKILL.md` (lines 298-345).
