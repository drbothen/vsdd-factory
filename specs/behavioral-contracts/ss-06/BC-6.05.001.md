...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | TBD — assertion derived from acceptance: "Frontmatter declares `name: brownfield-ingest`; argument-hint matches `[codebase-path] [--resume]`." | manual |
