...
semport-analyze: identity, two modes, reference resolution. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/semport-analyze/SKILL.md` (lines 1-28).
