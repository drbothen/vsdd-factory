...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L930"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.043: spec-versioning: identity & semver scheme

## Description

spec-versioning: identity & semver scheme. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/spec-versioning/SKILL.md` (lines 1-13; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Spec evolution events.

## Postconditions

1. Specs follow MAJOR.MINOR.PATCH semver.
