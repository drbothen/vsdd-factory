...
toolchain-provisioning: language detection cascade. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/toolchain-provisioning/SKILL.md` (lines 58-89).
