...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1193"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.19.026: toolchain-provisioning: precedence rule (architect > verification > manifest > human)

## Description

toolchain-provisioning: precedence rule (architect > verification > manifest > human). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/toolchain-provisioning/SKILL.md` (lines 35-46; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Tool-decision time.

## Postconditions

1. Order: (1) ARCH-INDEX.md Technology Stack, (2) verification-architecture/ARCH-INDEX.md Tooling Selection, (3) `config/verification-toolchains.yaml` defaults. Architect's "skip mutation testing" overrides manifest "required". Human-specified overrides have highest precedence.
