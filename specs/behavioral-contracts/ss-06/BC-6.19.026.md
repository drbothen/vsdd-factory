...
toolchain-provisioning: precedence rule (architect > verification > manifest > human). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/toolchain-provisioning/SKILL.md` (lines 35-46).
