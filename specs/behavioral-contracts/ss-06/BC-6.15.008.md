...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1901"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.15.008: writing-skills: SKILL.md structure with 6 mandatory sections

## Description

writing-skills: SKILL.md structure with 6 mandatory sections. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/writing-skills/SKILL.md` (lines 56-74; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Frontmatter (name with hyphens; description). Sections: 1 Hard Gate (if discipline); 2 When to Use (symptoms/triggers); 3 Core Process; 4 Red Flags (rationalization table; if discipline); 5 Reporting (status protocol); 6 Quick Reference (table for scanning).
