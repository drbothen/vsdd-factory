...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L654"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.19.012: scaffold-claude-md: CLAUDE.md does NOT duplicate plugin methodology

## Description

scaffold-claude-md: CLAUDE.md does NOT duplicate plugin methodology. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/scaffold-claude-md/SKILL.md` (lines 7-9, 119-122).
...
1. Output structure: Build & Test, Git Workflow, Project References. Do NOT add `@SOUL.md`, `@.claude/rules/`, or VSDD methodology — vsdd-factory plugin provides those.
...
| **Source Lines** | 7-9, 119-122 |
| **Audit ID** | BC-AUDIT-664 |
