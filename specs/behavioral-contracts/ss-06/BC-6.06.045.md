...
wave-scheduling: failure modes (cycle/missing dep/no roots). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/wave-scheduling/SKILL.md` (lines 68-72).
