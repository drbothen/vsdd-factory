...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-508"
ss_section: "Phase orchestration and mode skills"
skill: "phase-1d-adversarial-spec-review"
---

# Behavioral Contract BC-6.16.023: phase-1d-adversarial-spec-review: Convergence — adversary reports "CONVERGENCE REACHED — findings are cosmetic only"

## Description

"After fixes, spawn adversary AGAIN with fresh context. Repeat until adversary reports: 'CONVERGENCE REACHED — findings are cosmetic only.'". Acceptance: Exact convergence string.
...
1. "After fixes, spawn adversary AGAIN with fresh context. Repeat until adversary reports: 'CONVERGENCE REACHED — findings are cosmetic only.'"

## Invariants

1. Exact convergence string.
