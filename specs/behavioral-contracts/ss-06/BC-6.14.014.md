...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-491"
ss_section: "Artifact and verification skills"
skill: "perf-check"
---

# Behavioral Contract BC-6.14.014: perf-check: Regression threshold — flag > 10% vs baseline

## Description

Look for regressions > 10% vs baseline; new benchmarks for added functionality; P50/P95/P99 latency distributions. Acceptance: 10% regression threshold.

## Preconditions

1. Bench run completes.

## Postconditions

1. Look for regressions > 10% vs baseline; new benchmarks for added functionality; P50/P95/P99 latency distributions.

## Invariants

1. 10% regression threshold.
