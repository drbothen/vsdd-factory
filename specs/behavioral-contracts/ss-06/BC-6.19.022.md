...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L868"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.19.022: setup-env: tool-check tables (8 required + 8 optional)

## Description

setup-env: tool-check tables (8 required + 8 optional). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/setup-env/SKILL.md` (lines 13-41; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Required: rustc ≥1.85, cargo, nightly rustfmt, clippy, git, gh, just, jq. Optional: cargo-kani, cargo-fuzz, cargo-mutants, cargo-deny, semgrep, lefthook, asciinema, hyperfine.
