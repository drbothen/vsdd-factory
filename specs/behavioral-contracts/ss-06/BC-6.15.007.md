...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1892"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.15.007: writing-skills: when-to-create vs when-not catalogues

## Description

writing-skills: when-to-create vs when-not catalogues. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/writing-skills/SKILL.md` (lines 24-36; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Create when: not intuitively obvious / cross-project ref / broadly applicable / others benefit. Don't for: one-off / standard practice / project-specific (CLAUDE.md/rules) / mechanical constraints (hooks).
