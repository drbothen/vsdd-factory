...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | TBD — assertion derived from acceptance: "Each idea routes to exactly one bucket per the threshold rules; auto-brief requires evidence ≥0.6 (not just composite)." | manual |
