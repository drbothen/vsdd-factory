...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1643"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.066: validate-workflow: identity & static-only contract

## Description

validate-workflow: identity & static-only contract. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-workflow/SKILL.md` (lines 1-13; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. `/vsdd-factory:validate-workflow <file>`.

## Postconditions

1. Schema-checks .lobster file. Static — does not execute steps; does not modify file.
