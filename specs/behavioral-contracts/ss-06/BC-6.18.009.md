...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L106"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.18.009: pr-review-triage: ten-cycle escalation cap

## Description

pr-review-triage: ten-cycle escalation cap. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/pr-review-triage/SKILL.md` (lines 67).

## Preconditions

1. Reaching cycle 10 with blocking findings still open.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: Convergence table shows escalation row at cycle 10 (or earlier per table semantics). | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Convergence table shows escalation row at cycle 10 (or earlier per table semantics).
