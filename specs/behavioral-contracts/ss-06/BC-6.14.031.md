...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1327"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.14.031: track-debt: when-to-add catalogue (6 sources)

## Description

track-debt: when-to-add catalogue (6 sources). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/track-debt/SKILL.md` (lines 77-85; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Adversarial real issue (deferred); code-review shortcut for timeline; `// TODO`/`// HACK` comments; deferred performance issues; dependency version pinning needing update; accepted test coverage gaps for timeline.
