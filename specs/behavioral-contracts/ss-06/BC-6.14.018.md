...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L266"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.14.018: register-artifact: identity & justification

## Description

register-artifact: identity & justification. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/register-artifact/SKILL.md` (lines 1-15; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. New artifact file (BC, VP, story, holdout) just created.

## Postconditions

1. Appends INDEX row; exists to prevent orphan artifacts that fail consistency-validator criterion 23.
