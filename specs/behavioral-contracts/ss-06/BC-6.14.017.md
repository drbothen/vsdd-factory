...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-494"
ss_section: "Artifact and verification skills"
skill: "perf-check"
---

# Behavioral Contract BC-6.14.017: perf-check: No benchmarks → report and recommend creating them

## Description

"If no benchmarks exist yet, report that and recommend creating them.". Acceptance: Graceful fallback rule.

## Preconditions

1. Project has no benchmarks.

## Postconditions

1. "If no benchmarks exist yet, report that and recommend creating them."

## Invariants

1. Graceful fallback rule.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/phase-0-codebase-ingestion/SKILL.md` (47 LOC)` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-494 |
| **Source Line(s)** | 124 |
