...
ui-quality-gate: 4 strictness levels (per-story/wave/build/convergence). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ui-quality-gate/SKILL.md` (lines 53-96).
