...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | TBD — assertion derived from acceptance: "Output table contains exactly 36 numbered rule rows with Status (PASS/FAIL) and violation lists." | manual |
