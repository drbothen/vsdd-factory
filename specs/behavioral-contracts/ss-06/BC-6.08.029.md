...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1086"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.029: storybook-mcp-integration: 6 MCP tools mapped to agent roles

## Description

storybook-mcp-integration: 6 MCP tools mapped to agent roles. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/storybook-mcp-integration/SKILL.md` (lines 59-69; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. `list-all-documentation` (implementer reuse), `get-documentation` (implementer ref), `get-documentation-for-story` (test-writer), `get-storybook-story-instructions` (test-writer MUST call before writing stories), `preview-stories` (implementer/visual-reviewer), `run-story-tests` (test-writer/e2e-tester).
