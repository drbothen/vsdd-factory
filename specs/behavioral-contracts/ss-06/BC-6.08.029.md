...
storybook-mcp-integration: 6 MCP tools mapped to agent roles. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/storybook-mcp-integration/SKILL.md` (lines 59-69).
