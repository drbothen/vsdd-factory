...
toolchain-provisioning: quality-gate criteria. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/toolchain-provisioning/SKILL.md` (lines 369-377; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: Each gate item resolves PASS/FAIL with explicit evidence. | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Each gate item resolves PASS/FAIL with explicit evidence.
