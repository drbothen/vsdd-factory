...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-450"
ss_section: "Factory operations and dashboards skills"
skill: "maintenance-sweep"
---

# Behavioral Contract BC-6.11.028: maintenance-sweep: Output is sweep-report-YYYY-MM-DD.md plus per-sweep findings files

## Description

Writes sweep-report-YYYY-MM-DD.md, dependency-audit.log, doc-drift-findings.md, pattern-findings.md, holdout-freshness.md, performance-baseline.md to `.factory/maintenance/`. Acceptance: All 6 artifact paths listed.

## Preconditions

1. All sweeps complete.

## Postconditions

1. Writes sweep-report-YYYY-MM-DD.md, dependency-audit.log, doc-drift-findings.md, pattern-findings.md, holdout-freshness.md, performance-baseline.md to `.factory/maintenance/`.

## Invariants

1. All 6 artifact paths listed.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/market-intelligence-assessment/SKILL.md` (250 LOC)` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-450 |
