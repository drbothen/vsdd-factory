...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L997"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.06.028: state-burst: Stage 1 with `15fa97e6` placeholder + tense rule

## Description

state-burst: Stage 1 with `15fa97e6` placeholder + tense rule. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/state-burst/SKILL.md` (lines 53-100; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
