...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L837"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.04.036: session-review: cross-run pattern database + benchmarks

## Description

session-review: cross-run pattern database + benchmarks. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/session-review/SKILL.md` (lines 134-146; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Maintains `.factory/session-reviews/{review-YYYY-MM-DD-[run-id].md, improvement-proposals-[run-id].md, improvement-backlog.md, pattern-database.yaml, benchmarks.yaml}`. Tracks self-cost; flags if >5% of pipeline cost.
