...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1300"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.14.028: track-debt: identity & three commands (add/list/resolve)

## Description

track-debt: identity & three commands (add/list/resolve). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/track-debt/SKILL.md` (lines 1-7; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. `/vsdd-factory:track-debt [add|list|resolve] [description]`.

## Postconditions

1. disable-model-invocation true; allowed-tools Read/Write/Edit/Bash. Manages `.factory/tech-debt-register.md`.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: Frontmatter matches; only three commands recognized. | manual |
...
| Architecture Module | plugins/vsdd-factory/skills/track-debt/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/track-debt/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/track-debt/SKILL.md` — defining skill body for this contract
...
- [TBD — to be assigned in Phase 1.6c] — Frontmatter matches; only three commands recognized.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/track-debt/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 1-7 |
| **Audit ID** | BC-AUDIT-730 |
