...
release: per-format version-bump dispatch (json/toml/yaml/regex). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/release/SKILL.md` (lines 142-156).
