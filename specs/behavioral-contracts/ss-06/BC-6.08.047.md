...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1465"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.047: ux-heuristic-evaluation: Nielsen 10 heuristics with explicit subchecks

## Description

ux-heuristic-evaluation: Nielsen 10 heuristics with explicit subchecks. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ux-heuristic-evaluation/SKILL.md` (lines 31-93; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Heuristic eval phase.

## Postconditions

1. Score each 0.0-1.0: H1 Visibility of System Status; H2 Match real-world; H3 User Control & Freedom (undo/cancel/back/exit); H4 Consistency & Standards; H5 Error Prevention; H6 Recognition over Recall; H7 Flexibility & Efficiency; H8 Aesthetic & Minimalist; H9 Help recover from Errors; H10 Help & Documentation.
...
| Architecture Module | plugins/vsdd-factory/skills/ux-heuristic-evaluation/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/ux-heuristic-evaluation/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/ux-heuristic-evaluation/SKILL.md` — defining skill body for this contract
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/ux-heuristic-evaluation/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 31-93 |
| **Audit ID** | BC-AUDIT-747 |
