...
ux-heuristic-evaluation: Nielsen 10 heuristics with explicit subchecks. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ux-heuristic-evaluation/SKILL.md` (lines 31-93).
