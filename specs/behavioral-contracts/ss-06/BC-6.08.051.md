...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1674"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.051: visual-companion: identity, prerequisites, optional setup

## Description

visual-companion: identity, prerequisites, optional setup. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/visual-companion/SKILL.md` (lines 1-28; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Brainstorming, brief creation, architecture design (visual content).

## Postconditions

1. Local Node.js server (ES2020+); user consents to URL. Optional excalidraw setup via `setup.sh`. Without setup, `.excalidraw` shows "run setup" message; HTML still works.
