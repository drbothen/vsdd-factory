...
visual-companion: identity, prerequisites, optional setup. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/visual-companion/SKILL.md` (lines 1-28).
