...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L770"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.05.056: semport-analyze: language idiom mapping table (Python/TS/Rust pairs)

## Description

semport-analyze: language idiom mapping table (Python/TS/Rust pairs). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/semport-analyze/SKILL.md` (lines 70-91; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Phase 2 (Target Language Design).

## Postconditions

1. Documents Python→Rust, TypeScript→Rust, Python→TypeScript idiom mappings (dataclass→struct, generator→Iterator, decorator→proc macro, etc.).
