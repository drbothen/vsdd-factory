...
semport-analyze: language idiom mapping table (Python/TS/Rust pairs). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/semport-analyze/SKILL.md` (lines 70-91).
