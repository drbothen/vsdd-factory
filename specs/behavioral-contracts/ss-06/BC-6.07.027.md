...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | TBD — assertion derived from acceptance: "BCs derived from reference repos cite source path:function in traceability." | manual |
