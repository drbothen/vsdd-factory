...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-500"
ss_section: "Phase orchestration and mode skills"
skill: "phase-1-prd-revision"
---

# Behavioral Contract BC-6.16.015: phase-1-prd-revision: 3-round deadlock escalates to human with both positions

## Description

"Escalate to human with both positions." Feasibility report references missing BCs → route to PO to create them first. NFR conflicts unresolvable without scope reduction → present trade-offs to human. Acceptance: Three failure-mode escalation paths.

## Preconditions

1. Architect and PO disagree after 3 rounds.

## Postconditions

1. "Escalate to human with both positions." Feasibility report references missing BCs → route to PO to create them first. NFR conflicts unresolvable without scope reduction → present trade-offs to human.

## Invariants

1. Three failure-mode escalation paths.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/phase-1-prd-revision/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-500 |
