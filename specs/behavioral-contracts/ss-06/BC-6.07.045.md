...
spec-versioning: per-story spec_version + drift detection. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/spec-versioning/SKILL.md` (lines 60-105).
