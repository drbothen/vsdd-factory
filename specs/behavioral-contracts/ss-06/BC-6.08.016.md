...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-479"
ss_section: "Demo, UX, and design skills"
skill: "multi-variant-design"
---

# Behavioral Contract BC-6.08.016: multi-variant-design: Failure — score deadlock (within 0.05) presents both with dimension breakdown

## Description

"Present both to human with dimension-level breakdown for tiebreaking." Fewer than 2 distinct variants → report constraint, proceed with single design. Missing scorer → skip dimension, reweight. Acceptance: Three failure-mode behaviors.

## Preconditions

1. Two variants within 0.05 composite score.

## Postconditions

1. "Present both to human with dimension-level breakdown for tiebreaking." Fewer than 2 distinct variants → report constraint, proceed with single design. Missing scorer → skip dimension, reweight.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/next-step/SKILL.md` (40 LOC)` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-479 |
