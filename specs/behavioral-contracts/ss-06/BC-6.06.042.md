...
wave-scheduling: parallel groups (≤2 S/M or ≤1 L/XL per group). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/wave-scheduling/SKILL.md` (lines 32-39).
