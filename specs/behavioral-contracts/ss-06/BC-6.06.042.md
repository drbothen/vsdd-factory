...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1790"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.06.042: wave-scheduling: parallel groups (≤2 S/M or ≤1 L/XL per group)

## Description

wave-scheduling: parallel groups (≤2 S/M or ≤1 L/XL per group). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/wave-scheduling/SKILL.md` (lines 32-39; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Step 3 (Parallel Group Sub-Partitioning).

## Postconditions

1. Within each wave: max 2 S/M stories per group; max 1 L/XL per group. Each group has its own test-writer→implementer sequence.
