...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-542"
ss_section: "Feature-mode phase skills (f1-f7)"
skill: "phase-f3-incremental-stories"
---

# Behavioral Contract BC-6.17.015: phase-f3-incremental-stories: Identity — adds new stories integrated into existing dependency graph without cycles

## Description

Creates new stories for the feature; integrates them into existing dependency graph without cycles. Acceptance: Frontmatter `name: phase-f3-incremental-stories`.

## Preconditions

1. Phase F2 complete and human-approved.

## Postconditions

1. Creates new stories for the feature; integrates them into existing dependency graph without cycles.

## Invariants

1. Frontmatter `name: phase-f3-incremental-stories`.
