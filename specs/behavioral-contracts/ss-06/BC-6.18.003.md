...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L48"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.18.003: pr-create: PR body must follow templated structure with mermaid + traceability table

## Description

pr-create: PR body must follow templated structure with mermaid + traceability table. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/pr-create/SKILL.md` (lines 14-16, 32-74).

## Preconditions

1. Step 2 (Generate PR Body).

## Postconditions

1. PR body follows `templates/pr-description-template.md` and includes Summary, Behavioral Contracts table (Contract / Status), Changes, Dependency Diagram (mermaid), Test Plan, TDD Evidence sections.
...
- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/pr-create/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/pr-create/SKILL.md` — defining skill body for this contract
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/pr-create/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 14-16, 32-74 |
| **Audit ID** | BC-AUDIT-602 |
