...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-425"
ss_section: "Spec creation and validation skills"
skill: "guided-brief-creation"
---

# Behavioral Contract BC-6.07.039: guided-brief-creation: Failure mode — contradictory requirements halt elicitation for human resolution

## Description

Flag the specific contradictions and ask the human to resolve before proceeding. Acceptance: Behavior is "flag + ask", not "make a guess".

## Preconditions

1. Human provides contradictory requirements during elicitation.

## Postconditions

1. Flag the specific contradictions and ask the human to resolve before proceeding.

## Invariants

1. Behavior is "flag + ask", not "make a guess".
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/holdout-eval/SKILL.md` (78 LOC)` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-425 |
