...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L378"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.18.018: release: dry-run produces complete plan with no side effects

## Description

release: dry-run produces complete plan with no side effects. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/release/SKILL.md` (lines 230-256; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Prints version bump, files to update, CHANGELOG plan, commit/tag/push intent, CI workflow ref, publish plan, gates mode, pre-release checks list — without changing any file.
...
| **Source Lines** | 230-256 |
| **Audit ID** | BC-AUDIT-636 |
