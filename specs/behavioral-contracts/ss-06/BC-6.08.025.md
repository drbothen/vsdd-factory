...
responsive-validation: screenshot evidence + per-screen pass/fail matrix. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/responsive-validation/SKILL.md` (lines 70-115; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
