...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-538"
ss_section: "Feature-mode phase skills (f1-f7)"
skill: "phase-f2-spec-evolution"
---

# Behavioral Contract BC-6.17.011: phase-f2-spec-evolution: Spec version bump per semver — MAJOR/MINOR/PATCH

## Description

MAJOR (architectural rework, removed features, breaking changes), MINOR (new features, new requirements — most common for Feature Mode), PATCH (wording fixes, edge cases, clarifications). Update PRD frontmatter version + write changelog entry. Acceptance: Three semver tiers + changelog entry.
...
1. MAJOR (architectural rework, removed features, breaking changes), MINOR (new features, new requirements — most common for Feature Mode), PATCH (wording fixes, edge cases, clarifications). Update PRD frontmatter version + write changelog entry.

## Invariants

1. Three semver tiers + changelog entry.
