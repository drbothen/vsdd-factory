...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1278"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.050: traceability-extension: architecture-section-level references (DF-021)

## Description

traceability-extension: architecture-section-level references (DF-021). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/traceability-extension/SKILL.md` (lines 30-39; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Trace references to architecture.

## Postconditions

1. Use specific section paths (`module-decomposition.md`, `api-surface.md`, `verification-architecture/ARCH-INDEX.md`, `purity-boundary-map.md`, `dependency-graph.md`) instead of monolithic `architecture/ARCH-INDEX.md`.
