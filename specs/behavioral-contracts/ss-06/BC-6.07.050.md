...
traceability-extension: architecture-section-level references (DF-021). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/traceability-extension/SKILL.md` (lines 30-39).
