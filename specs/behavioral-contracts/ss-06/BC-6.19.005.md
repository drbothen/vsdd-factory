...
repo-initialization: architect signal table for multi-vs-single-repo. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/repo-initialization/SKILL.md` (lines 49-75).
