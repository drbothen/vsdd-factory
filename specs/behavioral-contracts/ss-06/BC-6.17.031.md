...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-558"
ss_section: "Feature-mode phase skills (f1-f7)"
skill: "phase-f5-scoped-adversarial"
---

# Behavioral Contract BC-6.17.031: phase-f5-scoped-adversarial: Secondary review (Gemini/review-tier) optional for security-critical or large delta

## Description

Optional secondary using review/primary (review-tier model) for cognitive diversity. Recommended for security-critical delta or large delta (Gemini's 1M context). Not for trivial bug fixes or cosmetic changes. Secondary findings additive — they extend, not replace. Acceptance: Conditional secondary; additive (not replacement).

## Preconditions

1. Primary adversary converges.

## Postconditions

1. Optional secondary using review/primary (review-tier model) for cognitive diversity. Recommended for security-critical delta or large delta (Gemini's 1M context). Not for trivial bug fixes or cosmetic changes. Secondary findings additive — they extend, not replace.

## Invariants

1. Conditional secondary; additive (not replacement).
