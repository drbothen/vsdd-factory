...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1309"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.14.029: track-debt: add assigns next TD-NNN with full metadata

## Description

track-debt: add assigns next TD-NNN with full metadata. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/track-debt/SKILL.md` (lines 22-35; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Read register, assign next ID `TD-NNN`, capture severity (critical/high/medium/low), category (design/performance/security/testing/documentation/dependency), source (story/PR/review), impact, effort (S/M/L/XL); append + commit on factory-artifacts.
