...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1808"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.06.044: wave-scheduling: wave-schedule.md output + quality gate

## Description

wave-scheduling: wave-schedule.md output + quality gate. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/wave-scheduling/SKILL.md` (lines 47-66; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Writes `wave-schedule.md` under `.factory/cycles/**/implementation/` per template. Quality gate: all stories assigned, deps respected, no cycles, group sizes respected.
