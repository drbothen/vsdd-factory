...
storybook-mcp-integration: install + config + register procedure. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/storybook-mcp-integration/SKILL.md` (lines 22-58).
