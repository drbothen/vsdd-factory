...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-440"
ss_section: "Brownfield, discovery, research skills"
skill: "intelligence-synthesis"
---

# Behavioral Contract BC-6.05.026: intelligence-synthesis: Themes formed by semantic clustering across sources, not per-source listing

## Description

Cluster related signals across sources (semantic clustering). Cross-source correlation strengthens themes. Quality criterion: "Theme extraction clusters related signals (not just lists).". Acceptance: Themes are clusters, not flat per-source lists.
...
1. Cluster related signals across sources (semantic clustering). Cross-source correlation strengthens themes. Quality criterion: "Theme extraction clusters related signals (not just lists)."

## Invariants

1. Themes are clusters, not flat per-source lists.
