...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-435"
ss_section: "Story delivery skills"
skill: "implementation-readiness"
---

# Behavioral Contract BC-6.10.011: implementation-readiness: PRD information density — Critical >10, Warning 5-10, Pass <5 issues per page

## Description

Scans for conversational filler, wordy phrases, redundant phrases, hedge words. Severity thresholds: Critical (>10), Warning (5-10), Pass (<5). Acceptance: Density findings categorized by threshold.
...
1. Scans for conversational filler, wordy phrases, redundant phrases, hedge words. Severity thresholds: Critical (>10), Warning (5-10), Pass (<5).

## Invariants

1. Density findings categorized by threshold.
