...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-436"
ss_section: "Story delivery skills"
skill: "implementation-readiness"
---

# Behavioral Contract BC-6.10.012: implementation-readiness: Story tokens 300-800; total context ≤60% of agent window

## Description

Each story 300-800 tokens covering AC, architectural constraints, 1-2 code references, and explicit non-goals. Each story's total context 20-30% of implementing agent's window. Acceptance: Story content density check.
...
1. Each story 300-800 tokens covering AC, architectural constraints, 1-2 code references, and explicit non-goals. Each story's total context 20-30% of implementing agent's window.

## Invariants

1. Story content density check.
