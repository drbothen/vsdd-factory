...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1830"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.06.046: wave-status: identity & read-only contract

## Description

wave-status: identity & read-only contract. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/wave-status/SKILL.md` (lines 1-23; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. "What wave are we on, is it ready to ship?"

## Postconditions

1. Wraps `bin/wave-state` (summary, current, stories, ready). Reports current wave/total, story list, readiness breakdown (ready/in-progress/blocked/not-ready), recommendation (run `/vsdd-factory:wave-gate` if all ready; else list blockers). Does NOT mutate sprint-state.yaml.
...
| Architecture Module | plugins/vsdd-factory/skills/wave-status/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/wave-status/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/wave-status/SKILL.md` — defining skill body for this contract
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/wave-status/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 1-23 |
| **Audit ID** | BC-AUDIT-784 |
