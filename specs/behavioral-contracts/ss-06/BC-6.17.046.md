...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-573"
ss_section: "Feature-mode phase skills (f1-f7)"
skill: "phase-f7-delta-convergence"
---

# Behavioral Contract BC-6.17.046: phase-f7-delta-convergence: Max 5 convergence cycles before cost-benefit escalation

## Description

"Max 5 convergence cycles with cost-benefit escalation.". Acceptance: Cycle cap at 5.

## Preconditions

1. Convergence loop iterations.

## Postconditions

1. "Max 5 convergence cycles with cost-benefit escalation."
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/planning-research/SKILL.md` (66 LOC)` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-573 |
