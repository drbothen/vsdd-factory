...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | TBD — assertion derived from acceptance: "Story has Library Requirements with verbatim version pins, Forbidden Dependencies section, and error codes from existing taxonomy or flagged NEW." | manual |
