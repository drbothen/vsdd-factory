...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L97"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.18.008: pr-review-triage: size-blocking finding STOPS pr-manager

## Description

pr-review-triage: size-blocking finding STOPS pr-manager. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/pr-review-triage/SKILL.md` (lines 43, 67-68).

## Preconditions

1. Finding with category=size and severity=blocking.

## Postconditions

1. pr-manager STOPS the review loop and returns to orchestrator with story split recommendation.
...
| **Source Lines** | 43, 67-68 |
| **Audit ID** | BC-AUDIT-607 |
