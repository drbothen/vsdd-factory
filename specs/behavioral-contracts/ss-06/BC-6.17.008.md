...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-535"
ss_section: "Feature-mode phase skills (f1-f7)"
skill: "phase-f2-spec-evolution"
---

# Behavioral Contract BC-6.17.008: phase-f2-spec-evolution: Identity — incremental spec updates (PRD + arch + VPs), delta only

## Description

Updates specs incrementally — PRD, architecture, verification properties — delta only, not full rewrite. Acceptance: Frontmatter `name: phase-f2-spec-evolution`.

## Preconditions

1. Phase F1 delta analysis approved.

## Postconditions

1. Updates specs incrementally — PRD, architecture, verification properties — delta only, not full rewrite.

## Invariants

1. Frontmatter `name: phase-f2-spec-evolution`.
