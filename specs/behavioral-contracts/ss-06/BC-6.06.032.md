...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1037"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.06.032: state-update: identity & internal-only contract

## Description

state-update: identity & internal-only contract. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/state-update/SKILL.md` (lines 1-7; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Internal call from another skill (not direct user invocation).

## Postconditions

1. disable-model-invocation true; user-invocable false; allowed-tools Bash/Read/Edit. Updates `.factory/STATE.md` to reflect pipeline progress.
