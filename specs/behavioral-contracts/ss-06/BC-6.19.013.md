...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L663"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.19.013: scaffold-claude-md: present-confirm-write loop

## Description

scaffold-claude-md: present-confirm-write loop. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/scaffold-claude-md/SKILL.md` (lines 124-145; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Present in fenced markdown block; user can request changes (apply, re-present, ask again); only writes after approval. Reports file path written, TODO count, regeneration reminder.
