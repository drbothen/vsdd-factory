...
systematic-debugging: BC-aware mode + status-protocol reporting. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/systematic-debugging/SKILL.md` (lines 119-134).
