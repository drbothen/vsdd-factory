...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1367"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.037: ui-completeness-check: 7-axis gap detection (screens/components/states/interactions/responsive/a1...

## Description

ui-completeness-check: 7-axis gap detection (screens/components/states/interactions/responsive/a11y/perf). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ui-completeness-check/SKILL.md` (lines 83-94; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Detects: screens without stories, components without impl, required states (from contract) not implemented, UX interactions without e2e tests, breakpoints without coverage, axe-core/keyboard/screen-reader fails, perf metrics exceeding targets.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: Each axis is a separate finding category in report. | manual |
...
| Architecture Module | plugins/vsdd-factory/skills/ui-completeness-check/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/ui-completeness-check/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/ui-completeness-check/SKILL.md` — defining skill body for this contract
...
- [TBD — to be assigned in Phase 1.6c] — Each axis is a separate finding category in report.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/ui-completeness-check/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 83-94 |
| **Audit ID** | BC-AUDIT-737 |
