...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1095"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.030: storybook-mcp-integration: T1/T2/T3 access pattern via DF-023+DF-027

## Description

storybook-mcp-integration: T1/T2/T3 access pattern via DF-023+DF-027. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/storybook-mcp-integration/SKILL.md` (lines 70-78; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. T3 agents (implementer/test-writer/e2e-tester) call directly via `mcporter call`; T2 agents (ux-designer/accessibility-auditor/visual-reviewer) delegate; T1 agents (orchestrator) call MCP tools directly.
