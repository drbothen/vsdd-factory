...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-438"
ss_section: "Brownfield, discovery, research skills"
skill: "intelligence-synthesis"
---

# Behavioral Contract BC-6.05.024: intelligence-synthesis: Identity — correlates market/feedback/competitive/analytics into scored insights

## Description

Correlates signals across market research, customer feedback, competitive monitoring, and usage analytics. Clusters into themes, scores evidence strength, formats insights for DF-017. Acceptance: Frontmatter `name: intelligence-synthesis`; primary agent `business-analyst`; supporting `[research-agent]`.

## Preconditions

1. Scheduled (weekly), manual, or after discovery.lobster ingestion completes.

## Postconditions

1. Correlates signals across market research, customer feedback, competitive monitoring, and usage analytics. Clusters into themes, scores evidence strength, formats insights for DF-017.

## Invariants

1. Frontmatter `name: intelligence-synthesis`; primary agent `business-analyst`; supporting `[research-agent]`.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/intelligence-synthesis/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-438 |
| **Source Line(s)** | 1-18 |
