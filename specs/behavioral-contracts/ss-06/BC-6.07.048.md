...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1260"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.048: traceability-extension: identity & chain semantics

## Description

traceability-extension: identity & chain semantics. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/traceability-extension/SKILL.md` (lines 1-19; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Feature mode adding incremental traceability.

## Postconditions

1. Reference document. The chain: L1 Brief Section ↔ L2 CAP-NNN ↔ L3 BC-S.SS.NNN ↔ L4 VP-NNN ↔ Story ↔ AC-NNN ↔ Test Case ↔ Implementation ↔ Adversarial Review ↔ Formal Proof.
