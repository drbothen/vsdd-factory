...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L302"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.14.022: register-artifact: batch mode aggregates results

## Description

register-artifact: batch mode aggregates results. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/register-artifact/SKILL.md` (lines 110-122; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. `$ARGUMENTS` contains multiple space-separated paths.

## Postconditions

1. Processes each path, reports summary (Registered N artifacts, Skipped K already registered) at end.
...
| **Source Lines** | 110-122 |
| **Audit ID** | BC-AUDIT-628 |
