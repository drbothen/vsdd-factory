...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1514"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.053: validate-brief: structure check requires 6 sections each meeting minimums

## Description

validate-brief: structure check requires 6 sections each meeting minimums. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-brief/SKILL.md` (lines 16-28; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. What Is This (≥2 sentences); Who Is It For (≥1 specific persona + pain + workaround); Scope In (3-7 capabilities); Scope Out (≥1 exclusion); Success Criteria (≥2 measurable + numeric); Constraints (≥1).
