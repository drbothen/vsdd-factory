...
validate-brief: structure check requires 6 sections each meeting minimums. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-brief/SKILL.md` (lines 16-28).
