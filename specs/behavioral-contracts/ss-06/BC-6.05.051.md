...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L525"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.05.051: research-cache-ops: six operations (stats/key/has/get/put/clear)

## Description

research-cache-ops: six operations (stats/key/has/get/put/clear). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/research-cache-ops/SKILL.md` (lines 10-17; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Operation-name argument.

## Postconditions

1. stats, key, has, get, put, clear with documented exit-code semantics (`has` exit 0 if present).
