...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L284"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.14.020: register-artifact: idempotent (refuses duplicate ID)

## Description

register-artifact: idempotent (refuses duplicate ID). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/register-artifact/SKILL.md` (lines 71-77; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Step 4 duplicate check.

## Postconditions

1. Reads INDEX, checks if artifact ID already has a row; if yes, reports "<ID> already registered" and skips.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: No duplicate row is appended. | manual |
...
| Architecture Module | plugins/vsdd-factory/skills/register-artifact/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/register-artifact/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/register-artifact/SKILL.md` — defining skill body for this contract
...
- [TBD — to be assigned in Phase 1.6c] — No duplicate row is appended.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/register-artifact/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 71-77 |
| **Audit ID** | BC-AUDIT-626 |
