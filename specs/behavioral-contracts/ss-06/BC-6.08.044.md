...
ui-quality-gate: performance targets (D8 LCP/FID/CLS/TTI/bundle/images). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ui-quality-gate/SKILL.md` (lines 107-122).
