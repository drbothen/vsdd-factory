...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1434"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.044: ui-quality-gate: performance targets (D8 LCP/FID/CLS/TTI/bundle/images)

## Description

ui-quality-gate: performance targets (D8 LCP/FID/CLS/TTI/bundle/images). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ui-quality-gate/SKILL.md` (lines 107-122; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Performance dimension check.

## Postconditions

1. LCP <2.5s, FID <100ms, CLS <0.1, TTI <3.8s, bundle <200KB JS per route, images WebP+responsive+lazy. Perceived: skeleton screens, loading indicators, optimistic updates, progressive loading, image optimization.
...
| **Source Lines** | 107-122 |
| **Audit ID** | BC-AUDIT-744 |
