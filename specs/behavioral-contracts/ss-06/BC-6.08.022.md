...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L547"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.022: responsive-validation: identity, agents, conditional UI gating

## Description

responsive-validation: identity, agents, conditional UI gating. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/responsive-validation/SKILL.md` (lines 1-17; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Primary e2e-tester, supporting visual-reviewer; inputs `.factory/ui-traceability.yaml` + `.factory/design-system/tokens/sizing.json`; outputs `.factory/ui-evidence/SCR-NNN/` + `.factory/ui-quality/responsive-report.md`.
