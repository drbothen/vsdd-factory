...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L88"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.18.007: pr-review-triage: classification table is complete and exhaustive

## Description

pr-review-triage: classification table is complete and exhaustive. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/pr-review-triage/SKILL.md` (lines 36-49; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Step 2 (Classify and Route) for each finding.

## Postconditions

1. Maps (category × severity) to a fix route per the explicit 12-row table covering coherence/coverage/description/size/missing/dependency.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: Every finding maps to exactly one row of the routing table. | manual |
...
| Architecture Module | plugins/vsdd-factory/skills/pr-review-triage/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/pr-review-triage/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/pr-review-triage/SKILL.md` — defining skill body for this contract
...
- [TBD — to be assigned in Phase 1.6c] — Every finding maps to exactly one row of the routing table.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/pr-review-triage/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 36-49 |
| **Audit ID** | BC-AUDIT-606 |
