...
pr-review-triage: classification table is complete and exhaustive. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/pr-review-triage/SKILL.md` (lines 36-49).
