...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L917"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.042: spec-drift: writes spec-drift-report.md to current cycle

## Description

spec-drift: writes spec-drift-report.md to current cycle. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/spec-drift/SKILL.md` (lines 48-80; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Writes `.factory/cycles/<current>/spec-drift-report.md` with summary counts, drift details (severity critical/important/cosmetic), architecture violations, recommendations.
