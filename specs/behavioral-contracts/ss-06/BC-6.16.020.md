...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-505"
ss_section: "Phase orchestration and mode skills"
skill: "phase-1d-adversarial-spec-review"
---

# Behavioral Contract BC-6.16.020: phase-1d-adversarial-spec-review: Identity — adversary reviews spec package with fresh context

## Description

Presents complete spec package (PRD, architecture, UX, BCs, VPs) to adversary (different model family, fresh context) for adversarial review. Acceptance: Frontmatter `name: phase-1d-adversarial-spec-review`.

## Preconditions

1. Phase 1 spec artifacts complete.

## Postconditions

1. Presents complete spec package (PRD, architecture, UX, BCs, VPs) to adversary (different model family, fresh context) for adversarial review.

## Invariants

1. Frontmatter `name: phase-1d-adversarial-spec-review`.
