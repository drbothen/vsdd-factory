...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1768"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.06.040: wave-gate: outputs and post-pass guidance

## Description

wave-gate: outputs and post-pass guidance. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/wave-gate/SKILL.md` (lines 134-180; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Gate completion (pass or fail).

## Postconditions

1. Output: human-readable summary (Gate 1..6 with check/skip/cross + GATE_CHECK lines). PASS → tells user wave complete, next-wave stories unblocked, next: `/deliver-story` or `/adversarial-review implementation` if last wave. FAIL → "Wave Gate FAILED at Gate N", lists blocking findings, instructs to fix and retry.
...
| **Source Lines** | 134-180 |
| **Audit ID** | BC-AUDIT-778 |
