...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1883"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.15.006: writing-skills: hard gate (NO SKILL WITHOUT FAILING TEST FIRST)

## Description

writing-skills: hard gate (NO SKILL WITHOUT FAILING TEST FIRST). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/writing-skills/SKILL.md` (lines 18-22; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Skill creation begins.

## Postconditions

1. Hard Gate: NO SKILL WITHOUT FAILING TEST FIRST. "Write skill before testing? Delete it. Start over." Editing skill without testing = same violation. No exceptions.
