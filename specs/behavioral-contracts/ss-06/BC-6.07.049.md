...
traceability-extension: 7 extension rules (IDs new, links append-only, deprecated stays). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/traceability-extension/SKILL.md` (lines 41-134; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
