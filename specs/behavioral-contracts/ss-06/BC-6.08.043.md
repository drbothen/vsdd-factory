...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1425"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.043: ui-quality-gate: failure → FIX-UI-NNN routing

## Description

ui-quality-gate: failure → FIX-UI-NNN routing. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ui-quality-gate/SKILL.md` (lines 98-105; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Log failure in gate-report.md; create FIX-UI-NNN; route through code-delivery.lobster; re-run gate after fix.
