...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-493"
ss_section: "Artifact and verification skills"
skill: "perf-check"
---

# Behavioral Contract BC-6.14.016: perf-check: Output is performance-report.md with PASS|WARN|FAIL gate

## Description

Writes `.factory/cycles/<current>/performance-report.md` with summary table (Metric | Budget | Measured | Status), benchmark results, regressions, recommendations, and Gate: PASS | WARN | FAIL. Acceptance: Output path; three-state gate.
...
1. Writes `.factory/cycles/<current>/performance-report.md` with summary table (Metric | Budget | Measured | Status), benchmark results, regressions, recommendations, and Gate: PASS | WARN | FAIL.

## Invariants

1. Output path; three-state gate.
