...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-554"
ss_section: "Feature-mode phase skills (f1-f7)"
skill: "phase-f5-scoped-adversarial"
---

# Behavioral Contract BC-6.17.027: phase-f5-scoped-adversarial: Identity — adversary reviews only delta files, fresh context, different model family

## Description

Adversarial review scoped to changed/new code only. Fresh context, different model family. Acceptance: Frontmatter `name: phase-f5-scoped-adversarial`.

## Preconditions

1. Phase F4 complete (all tests green, regression clean).

## Postconditions

1. Adversarial review scoped to changed/new code only. Fresh context, different model family.

## Invariants

1. Frontmatter `name: phase-f5-scoped-adversarial`.
