...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-416"
ss_section: "Artifact and verification skills"
skill: "formal-verify"
---

# Behavioral Contract BC-6.14.012: formal-verify: Missing tools must be reported, never silently skipped

## Description

"If a tool is not installed, report which tools are missing and skip that section. Never fail silently (SOUL.md #4).". Acceptance: Missing tool produces an explicit report, not silent skip.

## Preconditions

1. Tool not found at runtime.

## Postconditions

1. "If a tool is not installed, report which tools are missing and skip that section. Never fail silently (SOUL.md #4)."

## Invariants

1. Missing tool produces an explicit report, not silent skip.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/generate-pdf/SKILL.md` (117 LOC)` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-416 |
