...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L66"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.18.005: pr-create: post-creation report includes URL + next steps

## Description

pr-create: post-creation report includes URL + next steps. Confidence: MEDIUM. Extracted from `plugins/vsdd-factory/skills/pr-create/SKILL.md` (lines 85-87; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Reports PR URL plus next steps (review, holdout evaluation if wave complete).
