...
worktree-manage: create produces `.worktrees/STORY-NNN/` on `feature/STORY-NNN-<desc>`. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/worktree-manage/SKILL.md` (lines 17-47).
