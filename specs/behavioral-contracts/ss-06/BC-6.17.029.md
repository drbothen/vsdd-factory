...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-556"
ss_section: "Feature-mode phase skills (f1-f7)"
skill: "phase-f5-scoped-adversarial"
---

# Behavioral Contract BC-6.17.029: phase-f5-scoped-adversarial: 5 review categories — spec fidelity, regression risk, convention, security, test quality

## Description

Adversary evaluates: 3a Spec Fidelity, 3b Regression Risk, 3c Convention Adherence, 3d Security Review, 3e Test Quality. Acceptance: Five named categories.

## Preconditions

1. Adversary spawned with review package.

## Postconditions

1. Adversary evaluates: 3a Spec Fidelity, 3b Regression Risk, 3c Convention Adherence, 3d Security Review, 3e Test Quality.

## Invariants

1. Five named categories.
