...
quick-dev-routing: multi-goal detection precedes routing. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/quick-dev-routing/SKILL.md` (lines 33-52).
