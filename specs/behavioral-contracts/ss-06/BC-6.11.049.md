...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L137"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.11.049: quick-dev-routing: multi-goal detection precedes routing

## Description

quick-dev-routing: multi-goal detection precedes routing. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/quick-dev-routing/SKILL.md` (lines 33-52; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Before committing to a route.

## Postconditions

1. Detects multi-goal signals; if found, presents Split (`S`)/Keep (`K`) prompt to human; on split, creates separate feature requests.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: Routing decision records the multi-goal detection result and chosen path. | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Routing decision records the multi-goal detection result and chosen path.
