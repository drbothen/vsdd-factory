...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1563"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.058: validate-consistency: identity & frontmatter

## Description

validate-consistency: identity & frontmatter. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-consistency/SKILL.md` (lines 1-7; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. `/vsdd-factory:validate-consistency`.

## Postconditions

1. disable-model-invocation true; allowed-tools Read/Bash/Glob/Grep.
