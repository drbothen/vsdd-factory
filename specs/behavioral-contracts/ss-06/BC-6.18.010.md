...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L115"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.18.010: pr-review-triage: writes review-findings.md with cycle row + triage table

## Description

pr-review-triage: writes review-findings.md with cycle row + triage table. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/pr-review-triage/SKILL.md` (lines 60-64, 73-83).

## Preconditions

1. Step 4 (Update Convergence Tracking) and final output.

## Postconditions

1. Updates `.factory/code-delivery/STORY-NNN/review-findings.md` with new cycle row and triage routing table.
...
| **Source Lines** | 60-64, 73-83 |
| **Audit ID** | BC-AUDIT-609 |
