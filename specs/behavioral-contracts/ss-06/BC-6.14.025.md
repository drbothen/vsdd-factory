...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1153"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.14.025: systematic-debugging: Phase 4.5 — 3+ failed fixes = STOP and escalate

## Description

systematic-debugging: Phase 4.5 — 3+ failed fixes = STOP and escalate. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/systematic-debugging/SKILL.md` (lines 86-104; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Three or more failed fix attempts.

## Postconditions

1. STOP and escalate. Report BLOCKED with: investigated findings, hypotheses tested, why architectural, recommended discussion topics. Do NOT attempt Fix #4 without human approval.
