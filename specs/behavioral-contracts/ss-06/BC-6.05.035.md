...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-456"
ss_section: "Brownfield, discovery, research skills"
skill: "market-intelligence-assessment"
---

# Behavioral Contract BC-6.05.035: market-intelligence-assessment: Quality Gate — assumptions explicitly flagged for human validation

## Description

Quality Gate items: GO/CAUTION/STOP with confidence; supporting evidence cited (not opinion); all sections per depth config; assumptions explicitly flagged. Acceptance: Four-item Quality Gate.
...
1. Quality Gate items: GO/CAUTION/STOP with confidence; supporting evidence cited (not opinion); all sections per depth config; assumptions explicitly flagged.

## Invariants

1. Four-item Quality Gate.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/mode-decision-guide/SKILL.md` (151 LOC)` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-456 |
