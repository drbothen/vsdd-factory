...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-510"
ss_section: "Phase orchestration and mode skills"
skill: "phase-2-story-decomposition"
---

# Behavioral Contract BC-6.16.025: phase-2-story-decomposition: Identity — Phase 2 entry point delegating to decompose-stories sub-workflow

## Description

Five steps A-E: define-epics, create-stories, dependency-graph, wave-schedule (with index + sprint state), holdout-scenarios. Acceptance: Frontmatter `name: phase-2-story-decomposition`.
...
1. Five steps A-E: define-epics, create-stories, dependency-graph, wave-schedule (with index + sprint state), holdout-scenarios.

## Invariants

1. Frontmatter `name: phase-2-story-decomposition`.
