...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L177"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.018: record-demo: per-AC evidence capture (CLI vs web)

## Description

record-demo: per-AC evidence capture (CLI vs web). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/record-demo/SKILL.md` (lines 32-56; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. For each acceptance criterion in the story.

## Postconditions

1. CLI: `script` or `asciinema`; web: Playwright MCP — navigate, act, screenshot to `.factory/demo-evidence/STORY-NNN/AC-<N>.png`.
