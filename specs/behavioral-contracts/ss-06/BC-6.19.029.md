...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1220"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.19.029: toolchain-provisioning: writes detailed toolchain-state.yaml

## Description

toolchain-provisioning: writes detailed toolchain-state.yaml. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/toolchain-provisioning/SKILL.md` (lines 184-274; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Step 6 (Write Provisioning Report).

## Postconditions

1. `.factory/toolchain-state.yaml` lists per-language per-category per-tool: status (installed / already_present / skipped / failed / added_to_cargo_toml / builtin / added_to_package_json), version, verify_output. Summary: total/installed/already/skipped/failed.
...
| **Source Lines** | 184-274 |
| **Audit ID** | BC-AUDIT-722 |
