...
toolchain-provisioning: writes detailed toolchain-state.yaml. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/toolchain-provisioning/SKILL.md` (lines 184-274).
