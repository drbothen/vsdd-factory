...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L565"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.024: responsive-validation: critical-failure list is blocking

## Description

responsive-validation: critical-failure list is blocking. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/responsive-validation/SKILL.md` (lines 84-90; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Detection of any blocking failure.

## Postconditions

1. Horizontal scroll, touch <48px, text <14px, unusable nav, content overflow/cropping at any breakpoint = blocking.
