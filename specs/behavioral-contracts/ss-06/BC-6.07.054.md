...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1523"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.054: validate-brief: bloat check (<500/<800/<1500 token bands)

## Description

validate-brief: bloat check (<500/<800/<1500 token bands). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-brief/SKILL.md` (lines 41-50; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Context-engineering phase.

## Postconditions

1. Core sections <500 words ideal; flag if >800 (becoming PRD); flag narrative padding/business justification/competitive analysis/market research; flag requirements leakage (FR-XXX, ACs, architecture decisions); estimate tokens; warn if >1,500.
