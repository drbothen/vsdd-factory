...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L253"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.06.025: recover-state: documented limitations are honored (no fabrication)

## Description

recover-state: documented limitations are honored (no fabrication). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/recover-state/SKILL.md` (lines 149-164; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Decisions Log, Skip Log, Blocking Issues, Current Phase Steps, cost data left empty (cannot be reconstructed from artifacts). Read-only on artifacts; does NOT commit STATE.md.
...
| **Source Lines** | 149-164 |
| **Audit ID** | BC-AUDIT-623 |
