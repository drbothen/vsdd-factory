...
recover-state: documented limitations are honored (no fabrication). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/recover-state/SKILL.md` (lines 149-164).
