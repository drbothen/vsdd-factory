...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-496"
ss_section: "Phase orchestration and mode skills"
skill: "phase-0-codebase-ingestion"
---

# Behavioral Contract BC-6.16.011: phase-0-codebase-ingestion: Gate — context doc, criticality, BCs (origin: recovered), coverage PASS, drift clean, human approval

## Description

Project context document exists; module criticality classification exists; BCs extracted with `origin: recovered`; coverage audit PASS; extraction validation PASS; input-hash drift check clean; human approval. Acceptance: Seven gate items.

## Preconditions

1. Phase 0 sub-workflow complete.

## Postconditions

1. Project context document exists; module criticality classification exists; BCs extracted with `origin: recovered`; coverage audit PASS; extraction validation PASS; input-hash drift check clean; human approval.
