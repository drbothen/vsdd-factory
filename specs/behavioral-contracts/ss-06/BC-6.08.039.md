...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1385"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.039: ui-completeness-check: 100% fidelity target + fix story generation

## Description

ui-completeness-check: 100% fidelity target + fix story generation. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ui-completeness-check/SKILL.md` (lines 119-128, 150-156).
...
1. Each gap → FIX-UI-NNN story → routes through code-delivery.lobster → re-runs check after fixes. Fidelity = (implemented elements / specified elements) × 100; target 100% before convergence.
...
| **Source Lines** | 119-128, 150-156 |
| **Audit ID** | BC-AUDIT-739 |
