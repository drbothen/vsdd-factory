...
validate-template-compliance: 3-level compliance check (frontmatter/sections/tables). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-template-compliance/SKILL.md` (lines 60-96; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: Per-file report has the three levels. | manual |
...
- [TBD — to be assigned in Phase 1.6c] — Per-file report has the three levels.
