...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-413"
ss_section: "Artifact and verification skills"
skill: "formal-verify"
---

# Behavioral Contract BC-6.14.009: formal-verify: Mutation kill rate target is ≥90%

## Description

Goal mutation kill rate ≥ 90%. Surviving mutants must be classified (only verified-equivalent excluded). Acceptance: Gate criterion: "mutation kill ≥90%".

## Preconditions

1. Mutation testing step.

## Postconditions

1. Goal mutation kill rate ≥ 90%. Surviving mutants must be classified (only verified-equivalent excluded).

## Invariants

1. Gate criterion: "mutation kill ≥90%".
