...
ui-completeness-check: 3 pipeline points with strictness gradient. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ui-completeness-check/SKILL.md` (lines 27-34).
