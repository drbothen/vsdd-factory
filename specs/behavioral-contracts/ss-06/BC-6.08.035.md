...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1349"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.035: ui-completeness-check: 3 pipeline points with strictness gradient

## Description

ui-completeness-check: 3 pipeline points with strictness gradient. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/ui-completeness-check/SKILL.md` (lines 27-34; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. After story creation / after each wave gate / before convergence.

## Postconditions

1. After story creation → screens + interactions covered. After wave gate → states + tests exist. Before convergence → full traceability matrix + zero gaps.
