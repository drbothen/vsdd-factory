...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L226"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.06.022: recover-state: artifact directory probe table is exhaustive

## Description

recover-state: artifact directory probe table is exhaustive. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/recover-state/SKILL.md` (lines 34-52; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Step 2 (Scan artifact directories).

## Postconditions

1. Probes each row of the 12-row scan table (product-brief, domain-spec, prd, behavioral-contracts, architecture, verification-properties, dtu-assessment, stories, sprint-state, cycles, holdout-scenarios, current-cycle).
...
| Architecture Module | plugins/vsdd-factory/skills/recover-state/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/recover-state/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/recover-state/SKILL.md` — defining skill body for this contract
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/recover-state/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 34-52 |
| **Audit ID** | BC-AUDIT-620 |
