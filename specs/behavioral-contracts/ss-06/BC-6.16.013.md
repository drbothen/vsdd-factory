...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-498"
ss_section: "Phase orchestration and mode skills"
skill: "phase-1-prd-revision"
---

# Behavioral Contract BC-6.16.013: phase-1-prd-revision: Identity — PO revises PRD per architect feasibility report; max 3 iterations

## Description

product-owner revises PRD and BCs to address architect concerns. Max 3 iterations before escalation. Acceptance: Frontmatter `name: phase-1-prd-revision`; `gate: Architect approves or max 3 iterations reached`.

## Preconditions

1. Architect feasibility report flags issues.

## Postconditions

1. product-owner revises PRD and BCs to address architect concerns. Max 3 iterations before escalation.

## Invariants

1. Frontmatter `name: phase-1-prd-revision`; `gate: Architect approves or max 3 iterations reached`.
