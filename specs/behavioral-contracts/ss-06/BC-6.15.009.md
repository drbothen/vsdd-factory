...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1910"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.15.009: writing-skills: CSO description rules (Use when… , no workflow summary, <500 chars)

## Description

writing-skills: CSO description rules (Use when… , no workflow summary, <500 chars). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/writing-skills/SKILL.md` (lines 76-92; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Start with "Use when..." (triggering conditions only); do NOT summarize workflow; specific symptoms + keywords; <500 chars. BAD: "Use for TDD - write test first…". GOOD: "Use when implementing any feature or bugfix, before writing implementation code".
