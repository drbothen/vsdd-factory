...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L418"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.19.003: repo-initialization: develop branch is the protected default

## Description

repo-initialization: develop branch is the protected default. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/repo-initialization/SKILL.md` (lines 45-48, 124-141).

## Preconditions

1. Step 1 (gather requirements) and Step 3 (create + protect).

## Postconditions

1. Default branch name is `develop` (VSDD standard, NOT main); branch protection applied via `gh api repos/.../branches/develop/protection`.
...
| **Source Lines** | 45-48, 124-141 |
| **Audit ID** | BC-AUDIT-640 |
