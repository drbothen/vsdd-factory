...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1162"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.14.026: systematic-debugging: 8-row red-flag rationalization table

## Description

systematic-debugging: 8-row red-flag rationalization table. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/systematic-debugging/SKILL.md` (lines 106-118; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Self-check during debugging.

## Postconditions

1. Catches "quick fix for now", "just try X", "multiple changes", "skip the test", "probably X let me fix", "don't fully understand", "one more attempt", "I see the problem".
...
| **Source Lines** | 106-118 |
| **Audit ID** | BC-AUDIT-716 |
