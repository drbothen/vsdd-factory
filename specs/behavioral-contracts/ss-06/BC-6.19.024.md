...
setup-env: factory-health invocation + final missing-tools list. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/setup-env/SKILL.md` (lines 68-105).
