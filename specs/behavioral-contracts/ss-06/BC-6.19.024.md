...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L886"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.19.024: setup-env: factory-health invocation + final missing-tools list

## Description

setup-env: factory-health invocation + final missing-tools list. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/setup-env/SKILL.md` (lines 68-105; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Runs `/factory-health`; output enumerates Required/Optional/MCP/Git/Factory status with checkmark/warning/cross + missing-required and missing-optional lists.
...
| Architecture Module | plugins/vsdd-factory/skills/setup-env/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/setup-env/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/setup-env/SKILL.md` — defining skill body for this contract
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/setup-env/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 68-105 |
| **Audit ID** | BC-AUDIT-688 |
