...
state-update: enumerates 5 pipeline statuses + 7 phase IDs. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/state-update/SKILL.md` (lines 67-90; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
