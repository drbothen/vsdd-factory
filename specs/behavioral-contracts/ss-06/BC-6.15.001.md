...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | TBD — assertion derived from acceptance: "Skill produces report and a selected direction before any downstream skill is invoked." | manual |
