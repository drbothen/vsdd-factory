...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-584"
ss_section: "Factory operations and dashboards skills"
skill: "policy-add"
---

# Behavioral Contract BC-6.11.042: policy-add: Prerequisite — policies.yaml must exist; otherwise run policy-registry init first

## Description

".factory/policies.yaml must exist. If it doesn't, run `/vsdd-factory:policy-registry init` first.". Acceptance: Prerequisite ordering.
...
1. ".factory/policies.yaml must exist. If it doesn't, run `/vsdd-factory:policy-registry init` first."
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/policy-registry/SKILL.md` (110 LOC)` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-584 |
