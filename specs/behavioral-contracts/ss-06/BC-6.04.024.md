...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-409"
ss_section: "Adversarial and review skills"
skill: "fix-pr-delivery"
---

# Behavioral Contract BC-6.04.024: fix-pr-delivery: Output is fix PR merged to develop with worktree cleaned up

## Description

github-ops merges via squash + delete-branch; devops-engineer removes worktree; state-manager updates STATE.md with completion (PR number, timestamp). Acceptance: Quality Gate: "Worktree cleaned up after merge".

## Preconditions

1. Review convergence achieves APPROVE.

## Postconditions

1. github-ops merges via squash + delete-branch; devops-engineer removes worktree; state-manager updates STATE.md with completion (PR number, timestamp).

## Invariants

1. Quality Gate: "Worktree cleaned up after merge".
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/formal-verify/SKILL.md` (175 LOC)` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-409 |
