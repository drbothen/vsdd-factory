...
register-artifact: type identification by path pattern (4-row table). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/register-artifact/SKILL.md` (lines 17-28).
