...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-439"
ss_section: "Brownfield, discovery, research skills"
skill: "intelligence-synthesis"
---

# Behavioral Contract BC-6.05.025: intelligence-synthesis: Market research is the only required input; works with partial data

## Description

Market research required. Customer feedback, competitive intel, usage analytics optional. Synthesis layer degrades gracefully — only market research → 0.3-0.5 evidence; all sources → 0.9-1.0. Acceptance: Quality Criteria: "Works with partial data".
...
1. Market research required. Customer feedback, competitive intel, usage analytics optional. Synthesis layer degrades gracefully — only market research → 0.3-0.5 evidence; all sources → 0.9-1.0.

## Invariants

1. Quality Criteria: "Works with partial data".
