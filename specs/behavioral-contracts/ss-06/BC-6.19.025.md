...
toolchain-provisioning: identity & 4 trigger points. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/toolchain-provisioning/SKILL.md` (lines 1-33).
