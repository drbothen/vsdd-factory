...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1184"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.19.025: toolchain-provisioning: identity & 4 trigger points

## Description

toolchain-provisioning: identity & 4 trigger points. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/toolchain-provisioning/SKILL.md` (lines 1-33; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. After architecture (Greenfield); after codebase ingestion (Brownfield); after spec evolution (Feature Mode introduces new language); on-demand request.

## Postconditions

1. Provisions verification toolchain dynamically based on detected language(s).
