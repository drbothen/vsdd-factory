...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-467"
ss_section: "Factory operations and dashboards skills"
skill: "multi-repo-health"
---

# Behavioral Contract BC-6.11.034: multi-repo-health: Read-only — does not mutate any repo

## Description

"Read-only. Does not mutate any repo.". Acceptance: No write operations performed.
...
1. "Read-only. Does not mutate any repo."

## Invariants

1. No write operations performed.
