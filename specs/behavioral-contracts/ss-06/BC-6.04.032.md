...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L801"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.04.032: session-review: identity, trigger, primary agent

## Description

session-review: identity, trigger, primary agent. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/session-review/SKILL.md` (lines 1-38; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Final step in every top-level Lobster workflow, after all pipeline work (including release), before pipeline marked DONE.

## Postconditions

1. Primary agent session-review (T1, adversary model); supporting state-manager.
...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | Acceptance: No top-level workflow can mark COMPLETE before this skill runs. | manual |
...
| Architecture Module | plugins/vsdd-factory/skills/session-review/SKILL.md |
| Stories | TBD |

## Related BCs (Recommended)

- TBD — sibling BCs in same skill (see other BCs for `plugins/vsdd-factory/skills/session-review/SKILL.md` in this directory)

## Architecture Anchors (Recommended)

- `plugins/vsdd-factory/skills/session-review/SKILL.md` — defining skill body for this contract
...
- [TBD — to be assigned in Phase 1.6c] — No top-level workflow can mark COMPLETE before this skill runs.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/session-review/SKILL.md` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Lines** | 1-38 |
| **Audit ID** | BC-AUDIT-679 |
