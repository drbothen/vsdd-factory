...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L676"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.19.014: sdk-generation: identity & trigger triad

## Description

sdk-generation: identity & trigger triad. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/sdk-generation/SKILL.md` (lines 1-25; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Contracts approved (story decomposition); contract change detected (Feature Mode); periodic check (Maintenance Mode).

## Postconditions

1. Generates SDKs (TS/Python/Go/proto) from API contracts; idiomatic per language.
