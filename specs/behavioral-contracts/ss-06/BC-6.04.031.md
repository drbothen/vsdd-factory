...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-518"
ss_section: "Adversarial and review skills"
skill: "phase-4-holdout-evaluation"
---

# Behavioral Contract BC-6.04.031: phase-4-holdout-evaluation: Direct command is /vsdd-factory:holdout-eval

## Description

Direct work command is `/vsdd-factory:holdout-eval`. Acceptance: Command syntax.
...
1. Direct work command is `/vsdd-factory:holdout-eval`.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/phase-5-adversarial-refinement/SKILL.md` (37 LOC)` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-518 |
| **Source Line(s)** | 24-26 |
