...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1581"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.060: validate-consistency: report format with Failures/Warnings/All Passed

## Description

validate-consistency: report format with Failures/Warnings/All Passed. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-consistency/SKILL.md` (lines 65-87; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Template-driven output: Summary (checks/passed/failed/warnings), Failures table, Warnings table, All Passed list.
