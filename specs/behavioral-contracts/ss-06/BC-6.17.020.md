...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-547"
ss_section: "Feature-mode phase skills (f1-f7)"
skill: "phase-f4-delta-implementation"
---

# Behavioral Contract BC-6.17.020: phase-f4-delta-implementation: Identity — TDD scoped to new stories with full regression as safety net

## Description

TDD implementation scoped to new stories only. Full existing test suite (regression) is the safety net. Per-story delivery (DF-024) organized in waves. Acceptance: Frontmatter `name: phase-f4-delta-implementation`.

## Preconditions

1. Phase F3 complete and human-approved.

## Postconditions

1. TDD implementation scoped to new stories only. Full existing test suite (regression) is the safety net. Per-story delivery (DF-024) organized in waves.

## Invariants

1. Frontmatter `name: phase-f4-delta-implementation`.
