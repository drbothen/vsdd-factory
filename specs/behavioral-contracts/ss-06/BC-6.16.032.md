...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-520"
ss_section: "Phase orchestration and mode skills"
skill: "phase-5-adversarial-refinement"
---

# Behavioral Contract BC-6.16.032: phase-5-adversarial-refinement: Gate — novelty=0, all findings addressed/accepted, ≥3 clean passes minimum

## Description

Finding novelty decayed to zero (CONVERGENCE_REACHED); all findings addressed or accepted; minimum 3 clean passes. Acceptance: Three gate items including the "minimum 3 clean passes" rule.
...
1. Finding novelty decayed to zero (CONVERGENCE_REACHED); all findings addressed or accepted; minimum 3 clean passes.

## Invariants

1. Three gate items including the "minimum 3 clean passes" rule.
