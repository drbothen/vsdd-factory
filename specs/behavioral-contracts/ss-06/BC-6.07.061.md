...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1594"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.061: validate-template-compliance: identity & three scopes (file/dir/all)

## Description

validate-template-compliance: identity & three scopes (file/dir/all). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-template-compliance/SKILL.md` (lines 1-26; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. `/vsdd-factory:validate-template-compliance <path>`.

## Postconditions

1. Single file (.factory/specs/prd.md), directory (recurse `.md`), or `.factory/` for full audit. Read-only — never modifies files.
