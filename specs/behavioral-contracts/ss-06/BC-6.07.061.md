...
validate-template-compliance: identity & three scopes (file/dir/all). Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-template-compliance/SKILL.md` (lines 1-26).
