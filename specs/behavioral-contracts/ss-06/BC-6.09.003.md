...
|--------|----------|-------------|
| (TBD — to be assigned in Phase 1.6c) | TBD — assertion derived from acceptance: "validation-report.md exists per clone with test results; Schemathesis used when spec available." | manual |
