...
record-demo: tool-unavailable fallback never skips evidence. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/record-demo/SKILL.md` (lines 88-96).
