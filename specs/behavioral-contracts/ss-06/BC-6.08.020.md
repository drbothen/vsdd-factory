...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L195"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.08.020: record-demo: tool-unavailable fallback never skips evidence

## Description

record-demo: tool-unavailable fallback never skips evidence. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/record-demo/SKILL.md` (lines 88-96; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).

## Preconditions

1. Recording tools (asciinema, Playwright, termshot) not available.

## Postconditions

1. Creates text-based evidence report describing steps and observed behavior; never skips demo evidence.
