...
origin: brownfield
extracted_from: ".factory/phase-0-ingestion/pass-3-deep-skills-batch-3.md#L1505"
subsystem: "SS-06"
capability: "CAP-TBD"
...
# Behavioral Contract BC-6.07.052: validate-brief: identity & step-file note

## Description

validate-brief: identity & step-file note. Confidence: HIGH. Extracted from `plugins/vsdd-factory/skills/validate-brief/SKILL.md` (lines 1-15; source-range carve-out: SKILL.md line ranges are unstable; stable anchor is section content).
...
1. Skill explicitly does NOT use step-file decomposition; checks run as parallel checks within a single context load.
