...
removed: null
removal_reason: null
audit_source_id: "BC-AUDIT-521"
ss_section: "Phase orchestration and mode skills"
skill: "phase-5-adversarial-refinement"
---

# Behavioral Contract BC-6.16.033: phase-5-adversarial-refinement: Direct command is /vsdd-factory:adversarial-review implementation

## Description

Direct work command is `/vsdd-factory:adversarial-review implementation`. Acceptance: Command syntax.
...
1. Direct work command is `/vsdd-factory:adversarial-review implementation`.
...
| Property | Value |
|----------|-------|
| **Path** | `plugins/vsdd-factory/skills/phase-6-formal-hardening/SKILL.md` (44 LOC)` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Audit Source ID** | BC-AUDIT-521 |
| **Source Line(s)** | 24-26 |
