...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1377"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.034: validate-pr-description-completeness: blocks missing 6 required H2 sections

## Description

validate-pr-description-completeness: blocks missing 6 required H2 sections. Per missing section, error "Missing required section: ## <name>". Block reason `pr_description_incomplete`. Exit 2.

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1125` (extracted from `pass-3-deep-hooks.md` line 1377).
**Hook script:** ``plugins/vsdd-factory/hooks/validate-pr-description-completeness.sh``.

## Preconditions

1. Trigger: REQUIRED_SECTIONS array: `Architecture Changes`, `Story Dependencies`, `Spec Traceability`, `Test Evidence`, `Demo Evidence`, `Pre-Merge Checklist`. Each must appear as `## <name>`.

## Postconditions

1. Behavior: Per missing section, error "Missing required section: ## <name>". Block reason `pr_description_incomplete`. Exit 2.
2. Exit codes: 2.
...
| Property | Value |
|----------|-------|
| **Path** | ``plugins/vsdd-factory/hooks/validate-pr-description-completeness.sh`` |
| **Confidence** | high |
| **Extraction Date** | 2026-04-25 |
| **Source Document** | `pass-3-deep-hooks.md` line 1377 |
| **Audit ID** | `BC-AUDIT-1125` |
| **Source Line(s) (within hook)** | 40-56. |
