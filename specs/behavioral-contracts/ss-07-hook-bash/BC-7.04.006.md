...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1094"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.006: validate-bc-title: scopes to behavioral-contracts/BC-*.md, skips BC-INDEX

## Description

validate-bc-title: scopes to behavioral-contracts/BC-*.md, skips BC-INDEX

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1097` (extracted from `pass-3-deep-hooks.md` line 1094).
**Hook script:** ``plugins/vsdd-factory/hooks/validate-bc-title.sh``.

## Preconditions

1. Trigger: Path matches `*behavioral-contracts/BC-*.md` AND not BC-INDEX.md.

## Postconditions

1. Exit codes: 0 (skip path).
...
| **Source Document** | `pass-3-deep-hooks.md` line 1094 |
| **Audit ID** | `BC-AUDIT-1097` |
| **Source Line(s) (within hook)** | 35-43. |
