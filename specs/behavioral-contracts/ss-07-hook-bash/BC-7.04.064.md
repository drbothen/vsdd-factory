...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1677"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.064: validate-template-compliance: skips INDEX/yaml/json/current-cycle files

## Description

validate-template-compliance: skips INDEX/yaml/json/current-cycle files

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1155` (extracted from `pass-3-deep-hooks.md` line 1677).
**Hook script:** ``plugins/vsdd-factory/hooks/validate-template-compliance.sh``.

## Preconditions

1. Trigger: file_path matches *INDEX.md (any of 9 INDEX patterns), `*.yaml`, `*.json`, or `*current-cycle`.
...
| **Source Document** | `pass-3-deep-hooks.md` line 1677 |
| **Audit ID** | `BC-AUDIT-1155` |
| **Source Line(s) (within hook)** | 41-56. |
