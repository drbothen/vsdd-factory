...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:973"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.03.087: verify-git-push: identity & registry binding

## Description

verify-git-push: identity & registry binding. Force-push and protected-branch guard. binary_allow includes git, gh, jq.
...
2. Trigger: Every Bash command; early-exits unless command contains `git push`.

## Postconditions

1. Behavior: Force-push and protected-branch guard. binary_allow includes git, gh, jq.
2. Exit codes: 0 / 2.
...
| **Source Document** | `pass-3-deep-hooks.md` line 973 |
| **Audit ID** | `BC-AUDIT-1086` |
| **Source Line(s) (within hook)** | Header 1-21. |
