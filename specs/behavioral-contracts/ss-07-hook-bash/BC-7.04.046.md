...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1498"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.046: validate-state-index-status-coherence: scopes to STATE.md or cycles/*/INDEX.md

## Description

validate-state-index-status-coherence: scopes to STATE.md or cycles/*/INDEX.md

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1137` (extracted from `pass-3-deep-hooks.md` line 1498).
**Hook script:** ``plugins/vsdd-factory/hooks/validate-state-index-status-coherence.sh``.

## Preconditions

1. Trigger: file_path matches `*.factory/STATE.md` or `*.factory/cycles/*/INDEX.md`.
...
| **Source Document** | `pass-3-deep-hooks.md` line 1498 |
| **Audit ID** | `BC-AUDIT-1137` |
| **Source Line(s) (within hook)** | 36-52. |
