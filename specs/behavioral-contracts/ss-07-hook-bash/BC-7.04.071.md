...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1742"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.071: validate-vp-consistency: blocks VPs in INDEX missing from coverage-matrix

## Description

validate-vp-consistency: blocks VPs in INDEX missing from coverage-matrix. Symmetric check.

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1162` (extracted from `pass-3-deep-hooks.md` line 1742).
...
| **Source Document** | `pass-3-deep-hooks.md` line 1742 |
| **Audit ID** | `BC-AUDIT-1162` |
| **Source Line(s) (within hook)** | 88-93. |
