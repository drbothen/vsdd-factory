...
origin: brownfield
extracted_from: "pass-3-behavioral-contracts-deep-r1.md:241"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.02.008: Hook capability model: every legacy-routed hook declares `[hooks.capabilities.exec_subprocess]` w...
...
1. Hook entry routes through `legacy-bash-adapter.wasm`.
...
| **Source Document** | `pass-3-behavioral-contracts-deep-r1.md` line 241 |
| **Audit ID** | `BC-AUDIT-106` |
