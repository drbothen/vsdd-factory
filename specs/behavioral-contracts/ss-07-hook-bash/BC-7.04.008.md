...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1114"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.008: validate-changelog-monotonicity: identity & registry binding

## Description

validate-changelog-monotonicity: identity & registry binding. Validates changelog table ordering.
...
1. Behavior: Validates changelog table ordering.
2. Exit codes: 0 / 2.
...
| **Source Document** | `pass-3-deep-hooks.md` line 1114 |
| **Audit ID** | `BC-AUDIT-1099` |
