...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:755"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.03.067: red-gate: scopes to known source extensions

## Description

red-gate: scopes to known source extensions. All other extensions exit 0.

**Source category:** Routing hooks (PreToolUse, PostToolUse, lifecycle).
**Audit ID:** `BC-AUDIT-1066` (extracted from `pass-3-deep-hooks.md` line 755).
**Hook script:** ``plugins/vsdd-factory/hooks/red-gate.sh``.

## Preconditions

1. Trigger: Extension is one of `.rs`, `.ts`, `.tsx`, `.js`, `.jsx`, `.py`, `.go`, `.java`, `.kt`, `.swift`.

## Postconditions

1. Behavior: All other extensions exit 0.
2. Exit codes: 0.
...
|-------|-----------------|----------|
| Acceptance criterion (see below) | Markdown, YAML, JSON edits unaffected. | happy-path |
...
| **Source Document** | `pass-3-deep-hooks.md` line 755 |
| **Audit ID** | `BC-AUDIT-1066` |
| **Source Line(s) (within hook)** | 47-50. |
