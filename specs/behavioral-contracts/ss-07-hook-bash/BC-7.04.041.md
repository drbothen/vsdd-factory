...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1449"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.041: validate-pr-review-posted: scopes to pr-reviewer / pr-review-triage

## Description

validate-pr-review-posted: scopes to pr-reviewer / pr-review-triage

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1132` (extracted from `pass-3-deep-hooks.md` line 1449).
**Hook script:** ``plugins/vsdd-factory/hooks/validate-pr-review-posted.sh``.

## Preconditions

1. Trigger: Agent name matches `*pr-reviewer*`, `*pr_reviewer*`, or `*pr-review-triage*`.
...
| **Source Document** | `pass-3-deep-hooks.md` line 1449 |
| **Audit ID** | `BC-AUDIT-1132` |
| **Source Line(s) (within hook)** | 31-35. |
