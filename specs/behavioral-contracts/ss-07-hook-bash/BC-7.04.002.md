...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1054"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.002: validate-anchor-capabilities-union: scopes to .factory/stories/S-*.md or STORY-*.md

## Description

validate-anchor-capabilities-union: scopes to .factory/stories/S-*.md or STORY-*.md. Other paths exit 0.

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1093` (extracted from `pass-3-deep-hooks.md` line 1054).
**Hook script:** ``plugins/vsdd-factory/hooks/validate-anchor-capabilities-union.sh``.

## Preconditions

1. Trigger: file_path matches story pattern AND not an INDEX file.
...
| **Source Document** | `pass-3-deep-hooks.md` line 1054 |
| **Audit ID** | `BC-AUDIT-1093` |
| **Source Line(s) (within hook)** | 38-46. |
