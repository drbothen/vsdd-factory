...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:713"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.03.063: purity-check: scopes to pure/core/kernel paths or *_pure.rs / *.pure.ts

## Description

purity-check: scopes to pure/core/kernel paths or *_pure.rs / *.pure.ts. All other paths exit 0 immediately.

**Source category:** Routing hooks (PreToolUse, PostToolUse, lifecycle).
**Audit ID:** `BC-AUDIT-1062` (extracted from `pass-3-deep-hooks.md` line 713).
**Hook script:** ``plugins/vsdd-factory/hooks/purity-check.sh``.

## Preconditions

1. Trigger: file_path matches `*/pure/*`, `*/core/*`, `*/kernel/*`, `*_pure.rs`, or `*.pure.ts`.

## Postconditions

1. Behavior: All other paths exit 0 immediately.
2. Exit codes: 0.
...
| **Source Document** | `pass-3-deep-hooks.md` line 713 |
| **Audit ID** | `BC-AUDIT-1062` |
| **Source Line(s) (within hook)** | 36-39. |
