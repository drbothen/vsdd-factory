...
origin: brownfield
extracted_from: "pass-3-deep-hooks.md:1369"
subsystem: "SS-07"
capability: "TBD"
...
# Behavioral Contract BC-7.04.033: validate-pr-description-completeness: scopes to code-delivery/<STORY>/pr-description.md

## Description

validate-pr-description-completeness: scopes to code-delivery/<STORY>/pr-description.md

**Source category:** Validator hook scripts (validate-* and verify-*).
**Audit ID:** `BC-AUDIT-1124` (extracted from `pass-3-deep-hooks.md` line 1369).
**Hook script:** ``plugins/vsdd-factory/hooks/validate-pr-description-completeness.sh``.

## Preconditions

1. Trigger: file_path matches `*code-delivery/*/pr-description.md`.
...
| **Source Document** | `pass-3-deep-hooks.md` line 1369 |
| **Audit ID** | `BC-AUDIT-1124` |
| **Source Line(s) (within hook)** | 34-38. |
