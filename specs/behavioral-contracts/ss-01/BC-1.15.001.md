...
- VP-086 — Dispatcher Exit-2 Propagation for PreCompact Block-Intent (allocated in ADR-026 v1.4 §VP Allocations; introduced v1.1, unchanged through v1.4; VP-INDEX v2.07→v2.08)
...
| ADR | ADR-026 v1.4 Decision 11 (introduced v1.1, unchanged through v1.4) — S-18.00 dispatcher routing verification/addition; VP-086 allocated for exit-2 propagation verification |
| Stories | S-18.00 |
