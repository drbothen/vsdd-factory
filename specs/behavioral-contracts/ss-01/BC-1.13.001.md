...
bc_id: BC-1.13.001
section: "1.13"
last_amended: "2026-06-22 (v1.10) — S-18.14 confirmatory-pass-13 fix burst F-1: volatile ADR version-pins removed from normative body (POLICY 19 / TD-VSDD-091) — PC-10 `§Decision 5 v1.7` → `§Decision 5`; Architecture Anchors `main.rs` `ADR-024 §Decision 5 v1.7` → `ADR-024 §Decision 5`. Exhaustive sibling-sweep (POLICY 5) confirmed zero remaining normative version-pins."
---
