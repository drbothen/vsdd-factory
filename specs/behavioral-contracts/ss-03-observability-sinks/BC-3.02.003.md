...
origin: brownfield
extracted_from: "pass-3-deep-rust-tests.md:879"
subsystem: "SS-03"
capability: "TBD"
...
# Behavioral Contract BC-3.02.003: sink-file::template_project_basename: `{project}` substitutes to the basename of project_dir

> Section: File sink behavior
> Source BC (audit ID): BC-AUDIT-2370

## Description

Given project_dir = `/home/dev/vsdd-factory`, template = `{project}/logs/{date}.jsonl`. When Resolved.. Then Returns `vsdd-factory/logs/2026-04-24.jsonl` — only the basename of project_dir is used.

## Preconditions

1. project_dir = `/home/dev/vsdd-factory`, template = `{project}/logs/{date}.jsonl`.

## Postconditions

1. Returns `vsdd-factory/logs/2026-04-24.jsonl` — only the basename of project_dir is used.

## Invariants

1. Operators get clean per-project output files without leaking absolute paths into log filenames.
...
|-------|----------------|----------|
| project_dir = `/home/dev/vsdd-factory`, template = `{project}/logs/{date}.jsonl`. | Returns `vsdd-factory/logs/2026-04-24.jsonl` — only the basename of project_dir is used. | happy-path |
| TBD | TBD | edge-case |
| TBD | TBD | error |
...
| **Confidence** | high |
| **Original audit ID** | BC-AUDIT-2370 |
| **Pass-3 source** | `pass-3-deep-rust-tests.md:879` |
| **Extraction Date** | 2026-04-25 |
| **Pinned test** | ``crates/sink-file/src/lib.rs::tests::template_project_basename`` |
| **Test type** | unit |
