...
| Invariants | invariants.md v1.30 | ~1,400 | product-owner, architect | DI-001..DI-025 domain invariants with SS-NN enforcement owner and `Cited by: VP-NNN` back-refs |
...
|---------|------|--------|-------|
| 1.0.15 | 2026-07-13 | state-manager | D-838 W2-CASCADE-RECORDS: Document Map invariants.md v1.25→v1.30 (S-19.05 cascade passes 9-12; BA advanced invariants.md through v1.26 backfill, v1.27/v1.28 test-support qualifications, v1.29 Cited-by VP-100+VP-093 backfills, v1.30 v1.26-row backfill). F-P12-001 HIGH (L2-INDEX stale) CLOSED. 4-index: BC-INDEX v4.02 / VP-INDEX v2.68 / STORY-INDEX v4.185 / ARCH-INDEX v3.01. |
