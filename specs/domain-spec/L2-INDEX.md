...
last_amended: 2026-06-15 (v1.0.9); prior: 2026-06-15 (v1.0.8)
phase: 1.3
inputs:
...
|---------|------|--------|-------|
| 1.0.9 | 2026-06-15 | state-manager | D-587 F2 E-18 ADV PASS-24 NOT-CLEAN COMPREHENSIVE CLEANUP: invariants.md bumped v1.19→v1.20 (DI-022 field-4 canonical (B) reconciliation — shell hook MAY exec `git cat-file -t SHA_B` at write time or embed literal `commit`; WASM reads field-4 STATICALLY from persisted log). Document Map updated invariants.md v1.19→v1.20. Refs: F-P24-001, D-587. |
