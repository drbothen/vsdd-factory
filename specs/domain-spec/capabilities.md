...
Subsystems: SS-06, SS-09. <!-- Expanded SS-09 → SS-06,SS-09 per Wave 6 F-005 sanctioned per Wave 3 F-007 precedent (FR-029 activation skill consumes marketplace-installed plugin) --> <!-- F-101 (Wave 6 pass-2): SS-06 enforcer-BC pending — install/update flows through SS-06 activate skill (BC-6.12.x family per FR-029). Specific BC IDs TBD when SS-06 BC backfill closes. Mirrors CAP-007 line 46 inline-comment pattern. --> Outcome: `/plugin install vsdd-factory` succeeds and reports `1.0.0-beta.4`.
