...
Enforcement owner: SS-05 (wave-gate + wave-handoff skill) for wave-boundary transitions; SS-07 (precompact-flush.sh) for intra-wave PreCompact transitions; SS-04 (validate-wave-handoff-completeness WASM gate) as parse-layer enforcer; SS-06 (check-state-health skill — BC-6.25.001) as preventive-advisory verifier that the CLAUDE_AUTOCOMPACT_PCT_OVERRIDE env-var prerequisite is configured, preventing the Part-B mid-wave-compaction losslessness arm from degrading silently. BC range: BC-5.41.001, BC-5.41.003, BC-4.14.001, BC-1.15.001, BC-6.25.001.
