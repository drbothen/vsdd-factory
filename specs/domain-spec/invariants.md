...
- A last-line FIELD-4 token that is absent, empty, or anything other than `commit` indicates log corruption or truncation; treat as stale/absent and deny the exemption.
