...
**Positive control verification:** The algorithm correctly detects the following injected violation in a BC's normative sections:
...
**Empirical validation (as of ADR-026 v1.31, run against full corpus):**
...
Positive control (injected violation in Edge Cases): HITS=1 (PASS)
```
