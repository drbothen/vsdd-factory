...
SS-01/SS-07 concerns); CAP-043's `SS-01/SS-07`-only subsystem list (business-analyst domain) is
correspondingly incomplete and is flagged as a product-owner follow-up in the companion S-25.02 F2
gate-audit report, not amended here.
