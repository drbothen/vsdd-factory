...
| VP-096 | extract_frontmatter Purity — Output Byte-Equals File Prefix Through Second --- Delimiter; Deterministic for Any Input | proptest | BC-4.13.001 INV9 | draft |
