...
| VP-095 | verify-factory-lock Reads STATE.md Without output_too_large Denial for Sizes up to 262144 Bytes | integration | BC-4.13.001 PC3 | draft |
...
| VP-099 | hooks-registry Tool-Filter Anchoring Invariant — Every tool= Value Starts With ^ or Carries # intent: Comment | integration | — | draft |
