...
> total row. The per-tool column sums (K+P+U+I+M+S) must equal 134. This invariant
...
per-tool column sums equal 134 (total_vps POST-INTEGRATION).

| Subsystem | K | P | U | I | M | S | Row Total |
|-----------|---|---|---|---|---|---|-----------|
| SS-01 | 4 | 6 | 33 | 14 | 0 | 2 | 59 |
| SS-02 | 0 | 0 | 5 | 0 | 0 | 0 | 5 |
...
| SS-09 | 0 | 0 | 0 | 0 | 1 | 0 | 1 |
| SS-10 | 0 | 0 | 5 | 0 | 0 | 0 | 5 |
| **Grand Total** | **6** | **10** | **65** | **39** | **10** | **4** | **134** |

**Per-tool arithmetic check:** 6 + 10 + 65 + 39 + 10 + 4 = **134** ✓

**Per-subsystem row-sum check:** 59 + 5 + 14 + 17 + 14 + 5 + 14 + 1 + 5 = **134** ✓
...
- unit-test: **65** ✓ (64 prior + VP-131)
- integration: **39** ✓ (38 prior + VP-133)
- manual: **10** ✓ (unchanged from VP-INDEX v2.29)
- static-check: **4** ✓ (VP-061 + VP-126 + VP-129 + VP-134)

**SS-01 row detail:** K=4 (VP-074, VP-077, VP-097, VP-116), P=6 (VP-075, VP-119, VP-121, VP-123,
VP-125, VP-132), U=33 (VP-003..010, VP-014, VP-016..024, VP-026..027, VP-050, VP-052, VP-102, VP-103,
VP-104, VP-106, VP-107, VP-108, VP-117, VP-120, VP-122, VP-127, VP-131), I=14 (VP-001, VP-002, VP-025,
VP-051, VP-073, VP-086, VP-093, VP-098, VP-100, VP-101, VP-118, VP-124, VP-128, VP-133), M=0, S=2
(VP-126, VP-134). Row sum = 4+6+33+14+0+2 = **59** ✓

All 134 VPs are accounted for with no omissions and no double-counts.
