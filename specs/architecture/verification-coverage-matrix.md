...
> total row. The per-tool column sums (K+P+U+I+M+S) must equal 115. This invariant
...
per-tool column sums equal 115 (total_vps POST-INTEGRATION).
...
| SS-09 | 0 | 0 | 0 | 0 | 1 | 0 | 1 |
| SS-10 | 0 | 0 | 5 | 0 | 0 | 0 | 5 |
| **Grand Total** | **5** | **5** | **60** | **34** | **10** | **1** | **115** |

**Per-tool arithmetic check:** 5 + 5 + 60 + 34 + 10 + 1 = **115** ✓

**Per-subsystem row-sum check:** 42 + 5 + 14 + 17 + 14 + 5 + 12 + 1 + 5 = **115** ✓
...
- unit-test: **60** ✓ (42 from VP-INDEX v2.29 + VP-089 + VP-090 + VP-091 + VP-092 + VP-095 + VP-102 + VP-103 + VP-104 + VP-106 + VP-107 + VP-108 + VP-109 + VP-110 + VP-111 + VP-112 + VP-113 + VP-114 + VP-115)
