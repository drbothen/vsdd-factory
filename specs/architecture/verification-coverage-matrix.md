...
> total row. The per-tool column sums (K+P+U+I+M+S) must equal 130. This invariant
...
| VP-118 | Roll Seal→Create→Atomic-Index-Publish Before Block; Same-Invocation Atomicity (BC-1.18.006) | SS-01 | | | | ✓ | | |
| VP-119 | No Sealed Shard Over Recorded Cap; Canonical Filename Never Renamed Away (BC-1.18.006) | SS-01 | | ✓ | | | | |
| VP-120 | Retry-Wording Determinism; Seal-Rename Failure Fails Loud (BC-1.18.006) | SS-01 | | | ✓ | | | |
...
| VP-126 | BC-INDEX changelog: Rotation Reuses rotate_changelog — No Reimplemented Logic (BC-1.18.009) | SS-01 | | | | | | ✓ |
...
per-tool column sums equal 130 (total_vps POST-INTEGRATION).

| Subsystem | K | P | U | I | M | S | Row Total |
|-----------|---|---|---|---|---|---|-----------|
| SS-01 | 4 | 5 | 32 | 13 | 0 | 1 | 55 |
| SS-02 | 0 | 0 | 5 | 0 | 0 | 0 | 5 |
...
| SS-09 | 0 | 0 | 0 | 0 | 1 | 0 | 1 |
| SS-10 | 0 | 0 | 5 | 0 | 0 | 0 | 5 |
| **Grand Total** | **6** | **9** | **64** | **38** | **10** | **3** | **130** |

**Per-tool arithmetic check:** 6 + 9 + 64 + 38 + 10 + 3 = **130** ✓

**Per-subsystem row-sum check:** 55 + 5 + 14 + 17 + 14 + 5 + 14 + 1 + 5 = **130** ✓
...
- unit-test: **64** ✓ (60 prior + VP-117 + VP-120 + VP-122 + VP-127)
- integration: **38** ✓ (34 prior + VP-118 + VP-124 + VP-128 + VP-130)
- manual: **10** ✓ (unchanged from VP-INDEX v2.29)
- static-check: **3** ✓ (VP-061 + VP-126 + VP-129)

**SS-01 row detail:** K=4 (VP-074, VP-077, VP-097, VP-116), P=5 (VP-075, VP-119, VP-121, VP-123,
VP-125), U=32 (VP-003..010, VP-014, VP-016..024, VP-026..027, VP-050, VP-052, VP-102, VP-103,
VP-104, VP-106, VP-107, VP-108, VP-117, VP-120, VP-122, VP-127), I=13 (VP-001, VP-002, VP-025,
VP-051, VP-073, VP-086, VP-093, VP-098, VP-100, VP-101, VP-118, VP-124, VP-128), M=0, S=1 (VP-126).
Row sum = 4+5+32+13+0+1 = **55** ✓

All 130 VPs are accounted for with no omissions and no double-counts.
