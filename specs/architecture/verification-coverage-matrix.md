...
> total row. The per-tool column sums (K+P+U+I+M+S) must equal 139. This invariant
...
per-tool column sums equal 139 (total_vps POST-INTEGRATION).

| Subsystem | K | P | U | I | M | S | Row Total |
|-----------|---|---|---|---|---|---|-----------|
| SS-01 | 4 | 7 | 33 | 17 | 0 | 3 | 64 |
| SS-02 | 0 | 0 | 5 | 0 | 0 | 0 | 5 |
...
| SS-09 | 0 | 0 | 0 | 0 | 1 | 0 | 1 |
| SS-10 | 0 | 0 | 5 | 0 | 0 | 0 | 5 |
| **Grand Total** | **6** | **11** | **65** | **42** | **10** | **5** | **139** |

**Per-tool arithmetic check:** 6 + 11 + 65 + 42 + 10 + 5 = **139** ✓

**Per-subsystem row-sum check:** 64 + 5 + 14 + 17 + 14 + 5 + 14 + 1 + 5 = **139** ✓
...
VP-104, VP-106, VP-107, VP-108, VP-117, VP-120, VP-122, VP-127, VP-131), I=17 (VP-001, VP-002, VP-025,
VP-051, VP-073, VP-086, VP-093, VP-098, VP-100, VP-101, VP-118, VP-124, VP-128, VP-133, VP-136, VP-138,
VP-139), M=0, S=3 (VP-126, VP-134, VP-137). Row sum = 4+7+33+17+0+3 = **64** ✓

All 139 VPs are accounted for with no omissions and no double-counts.
