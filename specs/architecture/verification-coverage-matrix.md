...
> total row. The per-tool column sums (K+P+U+I+M+S) must equal 108. This invariant
...
| VP-108 | marker.cleared Audited-Clear Event — Clear Path Emission Correctness (BC-1.18.003 PC1/PC3/PC4, BC-3.08.001 Event 9; ADR-048 §D4) | SS-01 | | | ✓ | | | |
| **SS-01 subtotal** | | | **3** | **1** | **28** | **10** | **0** | **0** |
...
per-tool column sums equal 108 (total_vps POST-INTEGRATION).

| Subsystem | K | P | U | I | M | S | Row Total |
|-----------|---|---|---|---|---|---|-----------|
| SS-01 | 3 | 1 | 28 | 10 | 0 | 0 | 42 |
| SS-02 | 0 | 0 | 5 | 0 | 0 | 0 | 5 |
...
| SS-09 | 0 | 0 | 0 | 0 | 1 | 0 | 1 |
| **Grand Total** | **5** | **5** | **53** | **34** | **10** | **1** | **108** |

**Per-tool arithmetic check:** 5 + 5 + 53 + 34 + 10 + 1 = **108** ✓

**Per-subsystem row-sum check:** 42 + 5 + 14 + 16 + 13 + 5 + 12 + 1 = **108** ✓
...
- unit-test: **53** ✓ (42 from VP-INDEX v2.29 + VP-089 + VP-090 + VP-091 + VP-092 + VP-095 + VP-102 + VP-103 + VP-104 + VP-106 + VP-107 + VP-108)
...
**SS-01 row detail:** K=3 (VP-074, VP-077, VP-097), P=1 (VP-075), U=28 (VP-003..010,
VP-014, VP-016..024, VP-026..027, VP-050, VP-052, VP-102, VP-103, VP-104, VP-106, VP-107, VP-108),
I=10 (VP-001, VP-002, VP-025, VP-051, VP-073, VP-086, VP-093, VP-098, VP-100, VP-101),
M=0, S=0. Row sum = 3+1+28+10+0+0 = **42** ✓

All 108 VPs are accounted for with no omissions and no double-counts.
