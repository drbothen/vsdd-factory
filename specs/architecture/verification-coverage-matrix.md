...
> total row. The per-tool column sums (K+P+U+I+M+S) must equal 107. This invariant
...
| VP-107 | Ungated-Escape Invariant: Three Escape Paths Are Never Gated Regardless of Marker State | SS-01 | | | ✓ | | | |
| **SS-01 subtotal** | | | **3** | **1** | **27** | **10** | **0** | **0** |
...
per-tool column sums equal 107 (total_vps POST-INTEGRATION).

| Subsystem | K | P | U | I | M | S | Row Total |
|-----------|---|---|---|---|---|---|-----------|
| SS-01 | 3 | 1 | 27 | 10 | 0 | 0 | 41 |
| SS-02 | 0 | 0 | 5 | 0 | 0 | 0 | 5 |
...
| SS-09 | 0 | 0 | 0 | 0 | 1 | 0 | 1 |
| **Grand Total** | **5** | **5** | **52** | **34** | **10** | **1** | **107** |

**Per-tool arithmetic check:** 5 + 5 + 52 + 34 + 10 + 1 = **107** ✓

**Per-subsystem row-sum check:** 41 + 5 + 14 + 16 + 13 + 5 + 12 + 1 = **107** ✓
...
- unit-test: **52** ✓ (42 from VP-INDEX v2.29 + VP-089 + VP-090 + VP-091 + VP-092 + VP-095 + VP-102 + VP-103 + VP-104 + VP-106 + VP-107)
...
**SS-01 row detail:** K=3 (VP-074, VP-077, VP-097), P=1 (VP-075), U=27 (VP-003..010,
VP-014, VP-016..024, VP-026..027, VP-050, VP-052, VP-102, VP-103, VP-104, VP-106, VP-107),
I=10 (VP-001, VP-002, VP-025, VP-051, VP-073, VP-086, VP-093, VP-098, VP-100, VP-101),
M=0, S=0. Row sum = 3+1+27+10+0+0 = **41** ✓

All 107 VPs are accounted for with no omissions and no double-counts.
