...
| VP-140 | Item-Count Trigger Off-By-One (`current_item_count + 1 > N`) + `low_water_mark` Config Validation (Default `floor(N/2)`; Fail-Loud on `>= N`/Negative) — dedicated PC8 item-count-trigger VP (BC-1.18.005) | SS-01 | | | ✓ | | | |
