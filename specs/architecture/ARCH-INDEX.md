...
|-------|------|--------------|-------------------------------|-------------|-----|-------|
| SS-01 | Hook Dispatcher Core | SS-01-hook-dispatcher.md | `crates/factory-dispatcher/src/{main,registry,routing,executor,invoke,engine,plugin_loader,payload}.rs` | BC-1 | 115 (106 prior + 4 Phase 1a BC-1.12.001–004 + 4 Phase 1b BC-1.12.005/006/007/009 per ADR-015 D-15.1/D-15.2/D-15.3 + 1 D-362 BC-1.13.001 resolver-registry loading) | Phase 1 |
