...
//! DEFERRED per BC-5.39.010 v1.19 §File Structure / Task 12 (target: S-21.08)
//! and does not exist in this crate.
//!
//! # Compliance notes (BC-5.39.010 v1.19)
...
//! - `event = "PostToolUse"`, `tool = "^(Edit|Write|MultiEdit)$"` (BC-5.39.010 v1.19 §Gate Spec).
