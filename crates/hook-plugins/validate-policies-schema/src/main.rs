//! WASI command entry point for validate-policies-schema.
//!
...
//! - `tool = "Edit|Write"` is the canonical Q5 form for this hook's registry entry.

use validate_policies_schema::on_post_tool_use;
