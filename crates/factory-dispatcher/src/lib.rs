...
pub use internal_log::{
    ...
    INTERNAL_EVENT_SCHEMA_VERSION, INTERNAL_HOST_FUNCTION_PANIC, INTERNAL_SINK_CIRCUIT_CLOSED,
    INTERNAL_SINK_CIRCUIT_OPENED, INTERNAL_SINK_ERROR, INTERNAL_SINK_QUEUE_FULL, InternalEvent,
