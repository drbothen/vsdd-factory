...
//! # BC traces
//!
//! - BC-7.06.001 v1.5 Invariant 6: nine telemetry-only plugins must be async=true
//! - BC-7.06.001 v1.5 Invariant 7: (name, event, tool) tuple is unique per registry
...
/// as (name, event, tool) tuples per BC-7.06.001 v1.5 Invariant 7.
///
...
/// (F-P1-008 fix).
///
/// Canonical list: BC-7.06.001 v1.5 Invariant 6 / VP-078 v1.8 Harness 3.
